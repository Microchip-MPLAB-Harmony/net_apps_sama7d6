...
#ifndef _SAMA7D6_RSTC_COMPONENT_H_
#define _SAMA7D6_RSTC_COMPONENT_H_
...
#define RSTC_MR_SYSFEN(value)                 (RSTC_MR_SYSFEN_Msk & (_UINT32_(value) << RSTC_MR_SYSFEN_Pos)) /* Assigment of value for SYSFEN in the RSTC_MR register */
...
#define RSTC_MR_ENGCLR(value)                 (RSTC_MR_ENGCLR_Msk & (_UINT32_(value) << RSTC_MR_ENGCLR_Pos)) /* Assigment of value for ENGCLR in the RSTC_MR register */
...
#endif /* _SAMA7D6_RSTC_COMPONENT_H_ */
