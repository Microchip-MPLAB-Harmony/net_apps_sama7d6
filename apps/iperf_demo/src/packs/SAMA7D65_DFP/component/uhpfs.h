...
#ifndef _SAMA7D6_UHPFS_COMPONENT_H_
#define _SAMA7D6_UHPFS_COMPONENT_H_
...
#define UHPFS_HcControl_RESETVALUE            _UINT32_(0x00)                                       /*  (UHPFS_HcControl) HC Operating Mode Register  Reset Value */
...
#define   UHPFS_HcControl_CBSR_0_Val          _UINT32_(0x0)                                        /* (UHPFS_HcControl) 1 control ED per bulk ED.  */
#define   UHPFS_HcControl_CBSR_0x1_Val        _UINT32_(0x1)                                        /* (UHPFS_HcControl) 2 control EDs per bulk ED.  */
#define   UHPFS_HcControl_CBSR_0x2_Val        _UINT32_(0x2)                                        /* (UHPFS_HcControl) 3 control EDs per bulk ED.  */
#define   UHPFS_HcControl_CBSR_0x3_Val        _UINT32_(0x3)                                        /* (UHPFS_HcControl) 4 control EDs per bulk ED.  */
...
#define   UHPFS_HcControl_PLE_0_Val           _UINT32_(0x0)                                        /* (UHPFS_HcControl) Periodic ED lists are not processed. Periodic list processing is disabled beginning with the next frame.  */
#define   UHPFS_HcControl_PLE_1_Val           _UINT32_(0x1)                                        /* (UHPFS_HcControl) Enables processing of the periodic ED lists. Periodic list processing begins in the next frame.  */
...
#define   UHPFS_HcControl_IE_0_Val            _UINT32_(0x0)                                        /* (UHPFS_HcControl) Isochronous EDs are not processed. The USB1.1 host controller checks this bit every time it finds an isochronous ED in the periodic list.  */
#define   UHPFS_HcControl_IE_1_Val            _UINT32_(0x1)                                        /* (UHPFS_HcControl) Enables processing of isochronous EDs in the next frame, if not in the current frame.  */
...
#define   UHPFS_HcControl_CLE_0_Val           _UINT32_(0x0)                                        /* (UHPFS_HcControl) The control ED list is not processed in the next 1 ms frame. The host controller driver can modify the control ED list. If the driver removes the ED pointed to by the UHPFS_HcControlCurrentED register from the ED list, it must update the UHPFS_HcControlCurrentED register to point to a current ED before it reenables the control list.  */
#define   UHPFS_HcControl_CLE_1_Val           _UINT32_(0x1)                                        /* (UHPFS_HcControl) Enables processing of the control ED list. The UHPFS_HcControlHeadED register must be 0 or point to a valid ED before setting this bit. The UHPFS_HcControlCurrentED register must be 0 or point to a valid ED before setting this bit.  */
...
#define   UHPFS_HcControl_BLE_0_Val           _UINT32_(0x0)                                        /* (UHPFS_HcControl) The bulk ED list is not processed in the next 1 ms frame. The host controller driver can modify the bulk ED list. If the driver removes the ED pointed to by the UHPFS_HcBulkCurrentED register from the ED list, it must update the UHPFS_HcBulkCurrentED register to point to a current ED before it reenables the bulk list.  */
#define   UHPFS_HcControl_BLE_1_Val           _UINT32_(0x1)                                        /* (UHPFS_HcControl) Enables processing of the bulk ED list. The UHPFS_HcBulkHeadED register must be 0 or point to a valid ED before setting this bit. The UHPFS_HcBulkCurrentED register must be 0 or point to a valid ED before setting this bit.  */
...
#define   UHPFS_HcControl_HCFS_0_Val          _UINT32_(0x0)                                        /* (UHPFS_HcControl) USB reset.  */
#define   UHPFS_HcControl_HCFS_0x1_Val        _UINT32_(0x1)                                        /* (UHPFS_HcControl) USB resume.  */
#define   UHPFS_HcControl_HCFS_0x2_Val        _UINT32_(0x2)                                        /* (UHPFS_HcControl) USB operational.  */
#define   UHPFS_HcControl_HCFS_0x3_Val        _UINT32_(0x3)                                        /* (UHPFS_HcControl) USB suspend.  */
...
#define   UHPFS_HcControl_IR_0_Val            _UINT32_(0x0)                                        /* (UHPFS_HcControl) The USB1.1 host controller does not provide an SMI interrupt. This bit must be 0 to allow the USB1.1 host controller interrupt to propagate to the MPU level 2 interrupt controller.  */
...
#define UHPFS_HcInterruptEnable_RESETVALUE    _UINT32_(0x00)                                       /*  (UHPFS_HcInterruptEnable) HC Interrupt Enable Register  Reset Value */
...
#define   UHPFS_HcInterruptEnable_SO_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Scheduling overrun interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_SO_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows scheduling overrun interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_WDH_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Write done head interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_WDH_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows write done head interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_SF_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Start of frame interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_SF_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows start of frame interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_RD_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Resume detected interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_RD_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows resume detected interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_UE_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Unrecoverable error interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_UE_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows unrecoverable error interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_FNO_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Frame number overflow interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_FNO_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows frame number overflow interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_RHSC_0_Val  _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Root hub status change interrupts do not propagate.  */
#define   UHPFS_HcInterruptEnable_RHSC_1_Val  _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) When MIE is 1, allows root hub status change interrupts to propagate to the level 2 interrupt controller.  */
...
#define   UHPFS_HcInterruptEnable_OC_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) Ignore.  */
#define   UHPFS_HcInterruptEnable_OC_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) Enable interrupt generation due to Ownership Change.  */
...
#define   UHPFS_HcInterruptEnable_MIE_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcInterruptEnable) OHCI interrupt sources are ignored and USB1.1 host controller interrupts are not propagated to the level 2 interrupt controller.  */
#define   UHPFS_HcInterruptEnable_MIE_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcInterruptEnable) Allows other enabled OHCI interrupt sources to propagate to the level 2 interrupt controller.  */
...
#define UHPFS_HcPeriodCurrentED_RESETVALUE    _UINT32_(0x00)                                       /*  (UHPFS_HcPeriodCurrentED) HC Current Periodic Register  Reset Value */
...
#define UHPFS_HcRhDescriptorA_RESETVALUE      _UINT32_(0xA001203)                                  /*  (UHPFS_HcRhDescriptorA) HC Root Hub A Register  Reset Value */
...
#define   UHPFS_HcRhDescriptorA_PSM_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorA) Because the device does not provide signals from the USB1.1 host controller to control external VBUS switching, this bit defaults to 0 that indicates that all ports are powered at the same time.  */
...
#define   UHPFS_HcRhDescriptorA_NPS_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorA) Because the device does not provide connections from the USB1.1 host controller to control external VBUS switching, this bit defaults to 1 that indicates that VBUS power switching is not supported and that power is available to all downstream ports when the USB1.1 host controller is powered. This bit has no relationship to the OTG controller register bits that relate to VBUS. System software can update this register to simplify host controller driver and/or OTG driver coding.  */
...
#define   UHPFS_HcRhDescriptorA_DT_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorA) This bit is always 0, which indicates that the USB1.1 host controller implemented is not a compound device.  */
...
#define   UHPFS_HcRhDescriptorA_OCPM_0_Val    _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorA) Because the device does not provide host controller overcurrent protection input signals, this bit has no effect. This bit has no relationship to the OTG controller register bits that relate to VBUS.  */
...
#define   UHPFS_HcRhDescriptorA_NOCP_1_Val    _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorA) Because the device does not provide signals to allow connection of external overcurrent indication signals to the USB1.1 host controller, this bit defaults to 1 that indicates that the USB1.1 host controller does not implement overcurrent protection inputs. This bit has no relationship to the OTG controller register bits that relate to VBUS.  */
...
#define UHPFS_HcRhDescriptorB_RESETVALUE      _UINT32_(0x00)                                       /*  (UHPFS_HcRhDescriptorB) HC Root Hub B Register  Reset Value */
...
#define   UHPFS_HcRhDescriptorB_DR1_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 1 may have a removable device attached.  */
#define   UHPFS_HcRhDescriptorB_DR1_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 1 has a nonremovable device attached.  */
...
#define   UHPFS_HcRhDescriptorB_DR2_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 2 may have a removable device attached.  */
#define   UHPFS_HcRhDescriptorB_DR2_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 2 has a nonremovable device attached.  */
...
#define   UHPFS_HcRhDescriptorB_DR3_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 3 may have a removable device attached.  */
#define   UHPFS_HcRhDescriptorB_DR3_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Downstream port 3 has a nonremovable device attached.  */
...
#define   UHPFS_HcRhDescriptorB_PPCM1_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Global power control is implemented for downstream port 1.  */
#define   UHPFS_HcRhDescriptorB_PPCM1_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Per-port power control is implemented for downstream port 1.  */
...
#define   UHPFS_HcRhDescriptorB_PPCM2_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Global power control is implemented for downstream port 2.  */
#define   UHPFS_HcRhDescriptorB_PPCM2_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Per-port power control is implemented for downstream port 2.  */
...
#define   UHPFS_HcRhDescriptorB_PPCM3_0_Val   _UINT32_(0x0)                                        /* (UHPFS_HcRhDescriptorB) Global power control is implemented for downstream port 3.  */
#define   UHPFS_HcRhDescriptorB_PPCM3_1_Val   _UINT32_(0x1)                                        /* (UHPFS_HcRhDescriptorB) Per-port power control is implemented for downstream port 3.  */
...
#define   UHPFS_HcRhPortStatus_CCS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) No USB device is attached to port x.  */
#define   UHPFS_HcRhPortStatus_CCS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) USB device is attached to port x.  */
...
#define   UHPFS_HcRhPortStatus_CPE_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) No USB device is attached to port x.  */
#define   UHPFS_HcRhPortStatus_CPE_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) USB device is attached to port x.  */
...
#define   UHPFS_HcRhPortStatus_PES_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x is disabled.  */
#define   UHPFS_HcRhPortStatus_PES_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is enabled.  */
...
#define   UHPFS_HcRhPortStatus_SPE_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x is disabled.  */
#define   UHPFS_HcRhPortStatus_SPE_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is enabled.  */
...
#define   UHPFS_HcRhPortStatus_PSS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x is not in the USB suspend state.  */
#define   UHPFS_HcRhPortStatus_PSS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is in the USB suspend state or is in the resume sequence.  */
...
#define   UHPFS_HcRhPortStatus_SPS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x is not in the USB suspend state.  */
#define   UHPFS_HcRhPortStatus_SPS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is in the USB suspend state or is in the resume sequence.  */
...
#define   UHPFS_HcRhPortStatus_CSS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x port overcurrent condition has not occurred.  */
#define   UHPFS_HcRhPortStatus_CSS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x port overcurrent condition has occurred.  */
...
#define   UHPFS_HcRhPortStatus_POCI_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x port overcurrent condition has not occurred.  */
#define   UHPFS_HcRhPortStatus_POCI_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x port overcurrent condition has occurred.  */
...
#define   UHPFS_HcRhPortStatus_PRS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) USB reset is not being sent to port x.  */
#define   UHPFS_HcRhPortStatus_PRS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is signaling the USB reset.  */
...
#define   UHPFS_HcRhPortStatus_SPR_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) USB reset is not being sent to port x.  */
#define   UHPFS_HcRhPortStatus_SPR_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x is signaling the USB reset.  */
...
#define   UHPFS_HcRhPortStatus_PPS_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x power is disabled.  */
#define   UHPFS_HcRhPortStatus_PPS_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x power is enabled.  */
...
#define   UHPFS_HcRhPortStatus_SPP_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x power is disabled.  */
#define   UHPFS_HcRhPortStatus_SPP_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x power is enabled.  */
...
#define   UHPFS_HcRhPortStatus_CPP_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Full-speed device is attached to port x.  */
#define   UHPFS_HcRhPortStatus_CPP_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Low-speed device is attached to port x.  */
...
#define   UHPFS_HcRhPortStatus_LSDA_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Full-speed device is attached to port x.  */
#define   UHPFS_HcRhPortStatus_LSDA_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Low-speed device is attached to port x.  */
...
#define   UHPFS_HcRhPortStatus_CSC_0_Val      _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x current connect status has not changed.  */
#define   UHPFS_HcRhPortStatus_CSC_1_Val      _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x current connect status has changed due to a connect or disconnect event. If current connect status is 0 when a set port reset, set port enable, or set port suspend write occurs, then this bit is set.  */
...
#define   UHPFS_HcRhPortStatus_PESC_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x port enable status has not changed.  */
#define   UHPFS_HcRhPortStatus_PESC_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x port enable status has changed.  */
...
#define   UHPFS_HcRhPortStatus_PSSC_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x port suspend status has not changed.  */
#define   UHPFS_HcRhPortStatus_PSSC_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x port suspend status has changed. Suspend status is considered to have changed only after the resume pulse, low-speed EOP, and 3-ms synchronization delays have been completed.  */
...
#define   UHPFS_HcRhPortStatus_OCIC_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Because the device does not provide inputs for signaling external overcurrent indication to the USB1.1 host controller, this bit is always 0. Overcurrent monitoring, if required, must be handled through some other mechanism. This bit has no relationship to the OTG controller register bits that relate to VBUS.  */
...
#define   UHPFS_HcRhPortStatus_PRSC_0_Val     _UINT32_(0x0)                                        /* (UHPFS_HcRhPortStatus) Port x port reset status bit has not changed.  */
#define   UHPFS_HcRhPortStatus_PRSC_1_Val     _UINT32_(0x1)                                        /* (UHPFS_HcRhPortStatus) Port x port reset status bit has changed.  */
...
#endif /* _SAMA7D6_UHPFS_COMPONENT_H_ */
