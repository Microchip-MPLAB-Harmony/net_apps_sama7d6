...
#ifndef _SAMA7D6_OTPC_COMPONENT_H_
#define _SAMA7D6_OTPC_COMPONENT_H_
...
#define OTPC_SCAR_RESETVALUE                  _UINT32_(0x00)                                       /*  (OTPC_SCAR) Secure Custom Address Register  Reset Value */

#define OTPC_SCAR_SCADDR_Pos                  _UINT32_(0)                                          /* (OTPC_SCAR) Secure Custom Address Position */
...
#define OTPC_UHC0R_SECDBG_Pos                 _UINT32_(8)                                          /* (OTPC_UHC0R) Secure Debug Position */
#define OTPC_UHC0R_SECDBG_Msk                 (_UINT32_(0xFF) << OTPC_UHC0R_SECDBG_Pos)            /* (OTPC_UHC0R) Secure Debug Mask */
#define OTPC_UHC0R_SECDBG(value)              (OTPC_UHC0R_SECDBG_Msk & (_UINT32_(value) << OTPC_UHC0R_SECDBG_Pos)) /* Assigment of value for SECDBG in the OTPC_UHC0R register */
#define   OTPC_UHC0R_SECDBG_0_Val             _UINT32_(0x0)                                        /* (OTPC_UHC0R) The secure debug is allowed.  */
#define OTPC_UHC0R_SECDBG_0                   (OTPC_UHC0R_SECDBG_0_Val << OTPC_UHC0R_SECDBG_Pos)   /* (OTPC_UHC0R) The secure debug is allowed. Position  */
#define OTPC_UHC0R_Msk                        _UINT32_(0x0000FFFF)                                 /* (OTPC_UHC0R) Register Mask  */
...
#define OTPC_UHC1R_SCINVDIS_Pos               _UINT32_(11)                                         /* (OTPC_UHC1R) Secure Custom Packet Invalidation Disable Position */
#define OTPC_UHC1R_SCINVDIS_Msk               (_UINT32_(0x1) << OTPC_UHC1R_SCINVDIS_Pos)           /* (OTPC_UHC1R) Secure Custom Packet Invalidation Disable Mask */
#define OTPC_UHC1R_SCINVDIS(value)            (OTPC_UHC1R_SCINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCINVDIS_Pos)) /* Assigment of value for SCINVDIS in the OTPC_UHC1R register */
#define   OTPC_UHC1R_SCINVDIS_0_Val           _UINT32_(0x0)                                        /* (OTPC_UHC1R) The invalidation of the Secure Custom Special Packet is allowed.  */
#define   OTPC_UHC1R_SCINVDIS_1_Val           _UINT32_(0x1)                                        /* (OTPC_UHC1R) The invalidation of the Secure Custom Special Packet is forbidden.  */
...
#define OTPC_UHC1R_SCLKDIS_Pos                _UINT32_(12)                                         /* (OTPC_UHC1R) Secure Custom Packet Lock Disable Position */
#define OTPC_UHC1R_SCLKDIS_Msk                (_UINT32_(0x1) << OTPC_UHC1R_SCLKDIS_Pos)            /* (OTPC_UHC1R) Secure Custom Packet Lock Disable Mask */
#define OTPC_UHC1R_SCLKDIS(value)             (OTPC_UHC1R_SCLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCLKDIS_Pos)) /* Assigment of value for SCLKDIS in the OTPC_UHC1R register */
#define   OTPC_UHC1R_SCLKDIS_0_Val            _UINT32_(0x0)                                        /* (OTPC_UHC1R) The generation of the checksum (lock) of the Secure Custom Special Packet is allowed.  */
#define   OTPC_UHC1R_SCLKDIS_1_Val            _UINT32_(0x1)                                        /* (OTPC_UHC1R) The generation of the checksum (lock) of the Secure Custom Special Packet is forbidden.  */
...
#define OTPC_UHC1R_SCPGDIS_Pos                _UINT32_(13)                                         /* (OTPC_UHC1R) Secure Custom Packet Program Disable Position */
#define OTPC_UHC1R_SCPGDIS_Msk                (_UINT32_(0x1) << OTPC_UHC1R_SCPGDIS_Pos)            /* (OTPC_UHC1R) Secure Custom Packet Program Disable Mask */
#define OTPC_UHC1R_SCPGDIS(value)             (OTPC_UHC1R_SCPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCPGDIS_Pos)) /* Assigment of value for SCPGDIS in the OTPC_UHC1R register */
#define   OTPC_UHC1R_SCPGDIS_0_Val            _UINT32_(0x0)                                        /* (OTPC_UHC1R) The programming of Secure Custom Special Packet is allowed.  */
#define   OTPC_UHC1R_SCPGDIS_1_Val            _UINT32_(0x1)                                        /* (OTPC_UHC1R) The programming of Secure Custom Special Packet is forbidden.  */
...
#define OTPC_UHC1R_Msk                        _UINT32_(0x0003FFFF)                                 /* (OTPC_UHC1R) Register Mask  */
...
#endif /* _SAMA7D6_OTPC_COMPONENT_H_ */
