...
#ifndef _SAMA7D6_ICM_COMPONENT_H_
#define _SAMA7D6_ICM_COMPONENT_H_
...
#define   ICM_CFG_WBDIS_0_Val                 _UINT32_(0x0)                                        /* (ICM_CFG) Write-back operations are permitted.  */
#define   ICM_CFG_WBDIS_1_Val                 _UINT32_(0x1)                                        /* (ICM_CFG) Write-back operations are forbidden. Context register CDWBN bit is internally set to one and cannot be modified by a linked list element. ICM_RCFG.CDWBN has no effect.  */
...
#define   ICM_CFG_EOMDIS_0_Val                _UINT32_(0x0)                                        /* (ICM_CFG) End of Monitoring is permitted.  */
#define   ICM_CFG_EOMDIS_1_Val                _UINT32_(0x1)                                        /* (ICM_CFG) End of Monitoring is forbidden. The EOM bit of the ICM_RCFG structure member has no effect.  */
...
#define   ICM_CFG_SLBDIS_0_Val                _UINT32_(0x0)                                        /* (ICM_CFG) Branching to the Secondary List is permitted.  */
#define   ICM_CFG_SLBDIS_1_Val                _UINT32_(0x1)                                        /* (ICM_CFG) Branching to the Secondary List is forbidden. The NEXT field of the ICM_RNEXT structure member has no effect and is always considered as zero.  */
...
#define   ICM_CFG_ASCD_0_Val                  _UINT32_(0x0)                                        /* (ICM_CFG) Automatic monitoring mode is disabled.  */
#define   ICM_CFG_ASCD_1_Val                  _UINT32_(0x1)                                        /* (ICM_CFG) The ICM passes through the Main List once to calculate the message digest of the monitored area. When WRAP = 1 in ICM_RCFG, the ICM begins monitoring.  */
...
#define   ICM_CFG_DUALBUFF_0_Val              _UINT32_(0x0)                                        /* (ICM_CFG) Dual Input Buffer mode is disabled.  */
#define   ICM_CFG_DUALBUFF_1_Val              _UINT32_(0x1)                                        /* (ICM_CFG) Dual Input Buffer mode is enabled (better performances, higher bandwidth required on system bus).  */
...
#define   ICM_CFG_UIHASH_0_Val                _UINT32_(0x0)                                        /* (ICM_CFG) The secure hash standard provides the initial hash value.  */
#define   ICM_CFG_UIHASH_1_Val                _UINT32_(0x1)                                        /* (ICM_CFG) The initial hash value is programmable. Field UALGO provides the SHA algorithm. The ALGO field of the ICM_RCFG structure member has no effect.  */
...
#define   ICM_CTRL_ENABLE_0_Val               _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_ENABLE_1_Val               _UINT32_(0x1)                                        /* (ICM_CTRL) When set to one, the ICM is activated.  */
...
#define   ICM_CTRL_DISABLE_0_Val              _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_DISABLE_1_Val              _UINT32_(0x1)                                        /* (ICM_CTRL) The ICM is disabled. If a region is active, this region is terminated.  */
...
#define   ICM_CTRL_SWRST_0_Val                _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_SWRST_1_Val                _UINT32_(0x1)                                        /* (ICM_CTRL) Resets the ICM.  */
...
#define   ICM_CTRL_REHASH_0_Val               _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_REHASH_1_Val               _UINT32_(0x1)                                        /* (ICM_CTRL) When REHASH[i] is set to one, Region i digest is re-computed. This bit is only available when region monitoring is disabled.  */
...
#define   ICM_CTRL_RMDIS_0_Val                _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_RMDIS_1_Val                _UINT32_(0x1)                                        /* (ICM_CTRL) When bit RMDIS[i] is set to one, the monitoring of region with identifier i is disabled.  */
...
#define   ICM_CTRL_RMEN_0_Val                 _UINT32_(0x0)                                        /* (ICM_CTRL) No effect  */
#define   ICM_CTRL_RMEN_1_Val                 _UINT32_(0x1)                                        /* (ICM_CTRL) When bit RMEN[i] is set to one, the monitoring of region with identifier i is activated.  */
...
#define ICM_SR_RESETVALUE                     _UINT32_(0x00)                                       /*  (ICM_SR) Status Register  Reset Value */
...
#define   ICM_SR_ENABLE_0_Val                 _UINT32_(0x0)                                        /* (ICM_SR) ICM is disabled.  */
#define   ICM_SR_ENABLE_1_Val                 _UINT32_(0x1)                                        /* (ICM_SR) ICM is activated.  */
...
#define   ICM_SR_RAWRMDIS_0_Val               _UINT32_(0x0)                                        /* (ICM_SR) Region i monitoring has been activated by writing a 1 in RMEN[i] of ICM_CTRL.  */
#define   ICM_SR_RAWRMDIS_1_Val               _UINT32_(0x1)                                        /* (ICM_SR) Region i monitoring has been deactivated by writing a 1 in RMDIS[i] of ICM_CTRL.  */
...
#define   ICM_SR_RMDIS_0_Val                  _UINT32_(0x0)                                        /* (ICM_SR) Region i is being monitored (occurs after integrity check value has been calculated and written to Hash area).  */
#define   ICM_SR_RMDIS_1_Val                  _UINT32_(0x1)                                        /* (ICM_SR) Region i monitoring is not being monitored.  */
...
#define   ICM_IER_RHC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_RHC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When RHC[i] is set to one, the Region i Hash Completed interrupt is enabled.  */
...
#define   ICM_IER_RDM_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_RDM_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When RDM[i] is set to one, the Region i Digest Mismatch interrupt is enabled.  */
...
#define   ICM_IER_RBE_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_RBE_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When RBE[i] is set to one, the Region i Bus Error interrupt is enabled.  */
...
#define   ICM_IER_RWC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_RWC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When RWC[i] is set to one, the Region i Wrap Condition interrupt is enabled.  */
...
#define   ICM_IER_REC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_REC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When REC[i] is set to one, the region i End bit Condition interrupt is enabled.  */
...
#define   ICM_IER_RSU_0_Val                   _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_RSU_1_Val                   _UINT32_(0x1)                                        /* (ICM_IER) When RSU[i] is set to one, the region i Status Updated interrupt is enabled.  */
...
#define   ICM_IER_URAD_0_Val                  _UINT32_(0x0)                                        /* (ICM_IER) No effect.  */
#define   ICM_IER_URAD_1_Val                  _UINT32_(0x1)                                        /* (ICM_IER) The Undefined Register Access interrupt is enabled.  */
...
#define   ICM_IDR_RHC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_RHC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When RHC[i] is set to one, the Region i Hash Completed interrupt is disabled.  */
...
#define   ICM_IDR_RDM_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_RDM_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When RDM[i] is set to one, the Region i Digest Mismatch interrupt is disabled.  */
...
#define   ICM_IDR_RBE_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_RBE_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When RBE[i] is set to one, the Region i Bus Error interrupt is disabled.  */
...
#define   ICM_IDR_RWC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_RWC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When RWC[i] is set to one, the Region i Wrap Condition interrupt is disabled.  */
...
#define   ICM_IDR_REC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_REC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When REC[i] is set to one, the region i End bit Condition interrupt is disabled.  */
...
#define   ICM_IDR_RSU_0_Val                   _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_RSU_1_Val                   _UINT32_(0x1)                                        /* (ICM_IDR) When RSU[i] is set to one, the region i Status Updated interrupt is disabled.  */
...
#define   ICM_IDR_URAD_0_Val                  _UINT32_(0x0)                                        /* (ICM_IDR) No effect.  */
#define   ICM_IDR_URAD_1_Val                  _UINT32_(0x1)                                        /* (ICM_IDR) Undefined Register Access Detection interrupt is disabled.  */
...
#define ICM_IMR_RESETVALUE                    _UINT32_(0x00)                                       /*  (ICM_IMR) Interrupt Mask Register  Reset Value */
...
#define   ICM_IMR_RHC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When RHC[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_RHC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When RHC[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_RDM_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When RDM[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_RDM_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When RDM[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_RBE_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When RBE[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_RBE_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When RBE[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_RWC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When RWC[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_RWC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When RWC[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_REC_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When REC[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_REC_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When REC[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_RSU_0_Val                   _UINT32_(0x0)                                        /* (ICM_IMR) When RSU[i] is set to zero, the interrupt is disabled for region i.  */
#define   ICM_IMR_RSU_1_Val                   _UINT32_(0x1)                                        /* (ICM_IMR) When RSU[i] is set to one, the interrupt is enabled for region i.  */
...
#define   ICM_IMR_URAD_0_Val                  _UINT32_(0x0)                                        /* (ICM_IMR) Interrupt is disabled  */
#define   ICM_IMR_URAD_1_Val                  _UINT32_(0x1)                                        /* (ICM_IMR) Interrupt is enabled.  */
...
#define ICM_ISR_RESETVALUE                    _UINT32_(0x00)                                       /*  (ICM_ISR) Interrupt Status Register  Reset Value */

#define ICM_ISR_RHC_Pos                       _UINT32_(0)                                          /* (ICM_ISR) Region Hash Completed (cleared on read) Position */
#define ICM_ISR_RHC_Msk                       (_UINT32_(0xF) << ICM_ISR_RHC_Pos)                   /* (ICM_ISR) Region Hash Completed (cleared on read) Mask */
...
#define ICM_ISR_RDM_Pos                       _UINT32_(4)                                          /* (ICM_ISR) Region Digest Mismatch (cleared on read) Position */
#define ICM_ISR_RDM_Msk                       (_UINT32_(0xF) << ICM_ISR_RDM_Pos)                   /* (ICM_ISR) Region Digest Mismatch (cleared on read) Mask */
...
#define ICM_ISR_RBE_Pos                       _UINT32_(8)                                          /* (ICM_ISR) Region Bus Error (cleared on read) Position */
#define ICM_ISR_RBE_Msk                       (_UINT32_(0xF) << ICM_ISR_RBE_Pos)                   /* (ICM_ISR) Region Bus Error (cleared on read) Mask */
...
#define ICM_ISR_RWC_Pos                       _UINT32_(12)                                         /* (ICM_ISR) Region Wrap Condition Detected (cleared on read) Position */
#define ICM_ISR_RWC_Msk                       (_UINT32_(0xF) << ICM_ISR_RWC_Pos)                   /* (ICM_ISR) Region Wrap Condition Detected (cleared on read) Mask */
...
#define ICM_ISR_REC_Pos                       _UINT32_(16)                                         /* (ICM_ISR) Region End Bit Condition Detected (cleared on read) Position */
#define ICM_ISR_REC_Msk                       (_UINT32_(0xF) << ICM_ISR_REC_Pos)                   /* (ICM_ISR) Region End Bit Condition Detected (cleared on read) Mask */
...
#define ICM_ISR_RSU_Pos                       _UINT32_(20)                                         /* (ICM_ISR) Region Status Updated Detected (cleared on read) Position */
#define ICM_ISR_RSU_Msk                       (_UINT32_(0xF) << ICM_ISR_RSU_Pos)                   /* (ICM_ISR) Region Status Updated Detected (cleared on read) Mask */
...
#define   ICM_ISR_URAD_0_Val                  _UINT32_(0x0)                                        /* (ICM_ISR) No undefined register access has been detected since the last SWRST.  */
#define   ICM_ISR_URAD_1_Val                  _UINT32_(0x1)                                        /* (ICM_ISR) At least one undefined register access has been detected since the last SWRST.  */
...
#define ICM_UASR_RESETVALUE                   _UINT32_(0x00)                                       /*  (ICM_UASR) Undefined Access Status Register  Reset Value */
...
#define ICM_DSCR_RESETVALUE                   _UINT32_(0x00)                                       /*  (ICM_DSCR) Region Descriptor Area Start Address Register  Reset Value */
...
#define ICM_HASH_RESETVALUE                   _UINT32_(0x00)                                       /*  (ICM_HASH) Region Hash Area Start Address Register  Reset Value */
...
#define ICM_WPMR_RESETVALUE                   _UINT32_(0x00)                                       /*  (ICM_WPMR) Write Protection Mode Register  Reset Value */
...
#define   ICM_WPMR_WPEN_0_Val                 _UINT32_(0x0)                                        /* (ICM_WPMR) Disables the write protection if WPKEY corresponds to 0x49434D ("ICM" in ASCII)  */
#define   ICM_WPMR_WPEN_1_Val                 _UINT32_(0x1)                                        /* (ICM_WPMR) Enables the write protection if WPKEY corresponds to 0x49434D ("ICM" in ASCII)  */
...
#define   ICM_WPMR_WPITEN_0_Val               _UINT32_(0x0)                                        /* (ICM_WPMR) Disables the write protection on interrupt registers if WPKEY corresponds to 0x49434D ("ICM" in ASCII).  */
#define   ICM_WPMR_WPITEN_1_Val               _UINT32_(0x1)                                        /* (ICM_WPMR) Enables the write protection on interrupt registers if WPKEY corresponds to 0x49434D ("ICM" in ASCII).  */
...
#define   ICM_WPMR_WPCREN_0_Val               _UINT32_(0x0)                                        /* (ICM_WPMR) Disables the write protection on control register if WPKEY corresponds to 0x49434D ("ICM" in ASCII).  */
#define   ICM_WPMR_WPCREN_1_Val               _UINT32_(0x1)                                        /* (ICM_WPMR) Enables the write protection on control register if WPKEY corresponds to 0x49434D ("ICM" in ASCII).  */
...
#define ICM_WPSR_RESETVALUE                   _UINT32_(0x00)                                       /*  (ICM_WPSR) Write Protection Status Register  Reset Value */
...
#define   ICM_WPSR_WPVS_0_Val                 _UINT32_(0x0)                                        /* (ICM_WPSR) No write protect violation has occurred since the last read of ICM_WPSR.  */
#define   ICM_WPSR_WPVS_1_Val                 _UINT32_(0x1)                                        /* (ICM_WPSR) A write protect violation has occurred since the last read of ICM_WPSR. If this violation is an unauthorized attempt to write a protected register, the associated violation is reported into field WPVSRC.  */
...
#define ICM_UIHVAL_REG_OFST            _UINT32_(0x38)      /* (ICM_UIHVAL) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL0_REG_OFST           _UINT32_(0x38)      /* (ICM_UIHVAL0) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL1_REG_OFST           _UINT32_(0x3C)      /* (ICM_UIHVAL1) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL2_REG_OFST           _UINT32_(0x40)      /* (ICM_UIHVAL2) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL3_REG_OFST           _UINT32_(0x44)      /* (ICM_UIHVAL3) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL4_REG_OFST           _UINT32_(0x48)      /* (ICM_UIHVAL4) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL5_REG_OFST           _UINT32_(0x4C)      /* (ICM_UIHVAL5) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL6_REG_OFST           _UINT32_(0x50)      /* (ICM_UIHVAL6) User Initial Hash Value x Register Offset */
#define ICM_UIHVAL7_REG_OFST           _UINT32_(0x54)      /* (ICM_UIHVAL7) User Initial Hash Value x Register Offset */
...
#endif /* _SAMA7D6_ICM_COMPONENT_H_ */
