...
#ifndef _SAMA7D6_SYSCWP_COMPONENT_H_
#define _SAMA7D6_SYSCWP_COMPONENT_H_
...
#define SYSCWP_SYSC_WPMR_WPEN(value)          (SYSCWP_SYSC_WPMR_WPEN_Msk & (_UINT32_(value) << SYSCWP_SYSC_WPMR_WPEN_Pos)) /* Assigment of value for WPEN in the SYSCWP_SYSC_WPMR register */
...
#define SYSCWP_SYSC_WPMR_WPITEN(value)        (SYSCWP_SYSC_WPMR_WPITEN_Msk & (_UINT32_(value) << SYSCWP_SYSC_WPMR_WPITEN_Pos)) /* Assigment of value for WPITEN in the SYSCWP_SYSC_WPMR register */
...
#define SYSCWP_SYSC_WPMR_WPKEY(value)         (SYSCWP_SYSC_WPMR_WPKEY_Msk & (_UINT32_(value) << SYSCWP_SYSC_WPMR_WPKEY_Pos)) /* Assigment of value for WPKEY in the SYSCWP_SYSC_WPMR register */
...
#define SYSCWP_SYSC_WPSR_WPVS(value)          (SYSCWP_SYSC_WPSR_WPVS_Msk & (_UINT32_(value) << SYSCWP_SYSC_WPSR_WPVS_Pos)) /* Assigment of value for WPVS in the SYSCWP_SYSC_WPSR register */
...
#define SYSCWP_SYSC_WPSR_WVSRC(value)         (SYSCWP_SYSC_WPSR_WVSRC_Msk & (_UINT32_(value) << SYSCWP_SYSC_WPSR_WVSRC_Pos)) /* Assigment of value for WVSRC in the SYSCWP_SYSC_WPSR register */
...
#endif /* _SAMA7D6_SYSCWP_COMPONENT_H_ */
