...
#define SECUMOD_CR_NIMP_EN(value)             (SECUMOD_CR_NIMP_EN_Msk & (_UINT32_(value) << SECUMOD_CR_NIMP_EN_Pos)) /* Assigment of value for NIMP_EN in the SECUMOD_CR register */
...
#define SECUMOD_CR_AUTOBKP(value)             (SECUMOD_CR_AUTOBKP_Msk & (_UINT32_(value) << SECUMOD_CR_AUTOBKP_Pos)) /* Assigment of value for AUTOBKP in the SECUMOD_CR register */
...
#define SECUMOD_SYSR_NIMP_EN(value)           (SECUMOD_SYSR_NIMP_EN_Msk & (_UINT32_(value) << SECUMOD_SYSR_NIMP_EN_Pos)) /* Assigment of value for NIMP_EN in the SECUMOD_SYSR register */
...
#define SECUMOD_SYSR_NIMP_IDLE(value)         (SECUMOD_SYSR_NIMP_IDLE_Msk & (_UINT32_(value) << SECUMOD_SYSR_NIMP_IDLE_Pos)) /* Assigment of value for NIMP_IDLE in the SECUMOD_SYSR register */
...
#define SECUMOD_SR_DWDT_SW(value)             (SECUMOD_SR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_SR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_SR register */
...
#define SECUMOD_SR_DBLFM(value)               (SECUMOD_SR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_SR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_SR register */
...
#define SECUMOD_SR_TST(value)                 (SECUMOD_SR_TST_Msk & (_UINT32_(value) << SECUMOD_SR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_SR register */
...
#define SECUMOD_SR_JTAG(value)                (SECUMOD_SR_JTAG_Msk & (_UINT32_(value) << SECUMOD_SR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_SR register */
...
#define SECUMOD_SR_REGANA(value)              (SECUMOD_SR_REGANA_Msk & (_UINT32_(value) << SECUMOD_SR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_SR register */
...
#define SECUMOD_SR_TPML(value)                (SECUMOD_SR_TPML_Msk & (_UINT32_(value) << SECUMOD_SR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_SR register */
...
#define SECUMOD_SR_TPMH(value)                (SECUMOD_SR_TPMH_Msk & (_UINT32_(value) << SECUMOD_SR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_SR register */
...
#define SECUMOD_SR_VBATL(value)               (SECUMOD_SR_VBATL_Msk & (_UINT32_(value) << SECUMOD_SR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_SR register */
...
#define SECUMOD_SR_VBATH(value)               (SECUMOD_SR_VBATH_Msk & (_UINT32_(value) << SECUMOD_SR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_SR register */
...
#define SECUMOD_SR_VDDCOREL(value)            (SECUMOD_SR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_SR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_SR register */
...
#define SECUMOD_SR_VDDCPUL(value)             (SECUMOD_SR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_SR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_SR register */
...
#define SECUMOD_SR_VDDCOREH(value)            (SECUMOD_SR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_SR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_SR register */
...
#define SECUMOD_SR_VDDCPUH(value)             (SECUMOD_SR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_SR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_SR register */
...
#define SECUMOD_ASR_REGANA_LO(value)          (SECUMOD_ASR_REGANA_LO_Msk & (_UINT32_(value) << SECUMOD_ASR_REGANA_LO_Pos)) /* Assigment of value for REGANA_LO in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_REGANA_HI(value)          (SECUMOD_ASR_REGANA_HI_Msk & (_UINT32_(value) << SECUMOD_ASR_REGANA_HI_Pos)) /* Assigment of value for REGANA_HI in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_JTAG(value)               (SECUMOD_ASR_JTAG_Msk & (_UINT32_(value) << SECUMOD_ASR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_TCK(value)                (SECUMOD_ASR_TCK_Msk & (_UINT32_(value) << SECUMOD_ASR_TCK_Pos)) /* Assigment of value for TCK in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_BULO(value)               (SECUMOD_ASR_BULO_Msk & (_UINT32_(value) << SECUMOD_ASR_BULO_Pos)) /* Assigment of value for BULO in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_PSWLO(value)              (SECUMOD_ASR_PSWLO_Msk & (_UINT32_(value) << SECUMOD_ASR_PSWLO_Pos)) /* Assigment of value for PSWLO in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_BUHI(value)               (SECUMOD_ASR_BUHI_Msk & (_UINT32_(value) << SECUMOD_ASR_BUHI_Pos)) /* Assigment of value for BUHI in the SECUMOD_ASR register */
...
#define SECUMOD_ASR_PSWHI(value)              (SECUMOD_ASR_PSWHI_Msk & (_UINT32_(value) << SECUMOD_ASR_PSWHI_Pos)) /* Assigment of value for PSWHI in the SECUMOD_ASR register */
...
#define SECUMOD_SCR_DWDT_SW(value)            (SECUMOD_SCR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_SCR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_DBLFM(value)              (SECUMOD_SCR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_SCR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_TST(value)                (SECUMOD_SCR_TST_Msk & (_UINT32_(value) << SECUMOD_SCR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_JTAG(value)               (SECUMOD_SCR_JTAG_Msk & (_UINT32_(value) << SECUMOD_SCR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_REGANA(value)             (SECUMOD_SCR_REGANA_Msk & (_UINT32_(value) << SECUMOD_SCR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_TPML(value)               (SECUMOD_SCR_TPML_Msk & (_UINT32_(value) << SECUMOD_SCR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_TPMH(value)               (SECUMOD_SCR_TPMH_Msk & (_UINT32_(value) << SECUMOD_SCR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VBATL(value)              (SECUMOD_SCR_VBATL_Msk & (_UINT32_(value) << SECUMOD_SCR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VBATH(value)              (SECUMOD_SCR_VBATH_Msk & (_UINT32_(value) << SECUMOD_SCR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VDDCOREL(value)           (SECUMOD_SCR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_SCR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VDDCPUL(value)            (SECUMOD_SCR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_SCR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VDDCOREH(value)           (SECUMOD_SCR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_SCR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_SCR register */
...
#define SECUMOD_SCR_VDDCPUH(value)            (SECUMOD_SCR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_SCR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_SCR register */
...
#define SECUMOD_PIOBU_DYNSTAT(value)          (SECUMOD_PIOBU_DYNSTAT_Msk & (_UINT32_(value) << SECUMOD_PIOBU_DYNSTAT_Pos)) /* Assigment of value for DYNSTAT in the SECUMOD_PIOBU register */
...
#define SECUMOD_PIOBU_FILTER3_5(value)        (SECUMOD_PIOBU_FILTER3_5_Msk & (_UINT32_(value) << SECUMOD_PIOBU_FILTER3_5_Pos)) /* Assigment of value for FILTER3_5 in the SECUMOD_PIOBU register */
...
#define SECUMOD_VBUFR_VBATFV(value)           (SECUMOD_VBUFR_VBATFV_Msk & (_UINT32_(value) << SECUMOD_VBUFR_VBATFV_Pos)) /* Assigment of value for VBATFV in the SECUMOD_VBUFR register */
...
#define SECUMOD_VCOREFR_VDDCORE_DBTV(value)   (SECUMOD_VCOREFR_VDDCORE_DBTV_Msk & (_UINT32_(value) << SECUMOD_VCOREFR_VDDCORE_DBTV_Pos)) /* Assigment of value for VDDCORE_DBTV in the SECUMOD_VCOREFR register */
...
#define SECUMOD_VCPUFR_VDDCPU_DBTV(value)     (SECUMOD_VCPUFR_VDDCPU_DBTV_Msk & (_UINT32_(value) << SECUMOD_VCPUFR_VDDCPU_DBTV_Pos)) /* Assigment of value for VDDCPU_DBTV in the SECUMOD_VCPUFR register */
...
#define SECUMOD_JTAGCR_FNTRST_DEBUG(value)    (SECUMOD_JTAGCR_FNTRST_DEBUG_Msk & (_UINT32_(value) << SECUMOD_JTAGCR_FNTRST_DEBUG_Pos)) /* Assigment of value for FNTRST_DEBUG in the SECUMOD_JTAGCR register */
...
#define SECUMOD_JTAGCR_PROC_DEBUG_MODE(value) (SECUMOD_JTAGCR_PROC_DEBUG_MODE_Msk & (_UINT32_(value) << SECUMOD_JTAGCR_PROC_DEBUG_MODE_Pos)) /* Assigment of value for PROC_DEBUG_MODE in the SECUMOD_JTAGCR register */
...
#define SECUMOD_JTAGCR_PROC_DEBUG_MON(value)  (SECUMOD_JTAGCR_PROC_DEBUG_MON_Msk & (_UINT32_(value) << SECUMOD_JTAGCR_PROC_DEBUG_MON_Pos)) /* Assigment of value for PROC_DEBUG_MON in the SECUMOD_JTAGCR register */
...
#define SECUMOD_JTAGCR_FNTRST_BSD(value)      (SECUMOD_JTAGCR_FNTRST_BSD_Msk & (_UINT32_(value) << SECUMOD_JTAGCR_FNTRST_BSD_Pos)) /* Assigment of value for FNTRST_BSD in the SECUMOD_JTAGCR register */
...
#define SECUMOD_DYSTUNE_RX_ERROR_THRESHOLD(value) (SECUMOD_DYSTUNE_RX_ERROR_THRESHOLD_Msk & (_UINT32_(value) << SECUMOD_DYSTUNE_RX_ERROR_THRESHOLD_Pos)) /* Assigment of value for RX_ERROR_THRESHOLD in the SECUMOD_DYSTUNE register */
...
#define SECUMOD_DYSTUNE_NOPA(value)           (SECUMOD_DYSTUNE_NOPA_Msk & (_UINT32_(value) << SECUMOD_DYSTUNE_NOPA_Pos)) /* Assigment of value for NOPA in the SECUMOD_DYSTUNE register */
...
#define SECUMOD_DYSTUNE_RX_OK_CORREL_NUMBER(value) (SECUMOD_DYSTUNE_RX_OK_CORREL_NUMBER_Msk & (_UINT32_(value) << SECUMOD_DYSTUNE_RX_OK_CORREL_NUMBER_Pos)) /* Assigment of value for RX_OK_CORREL_NUMBER in the SECUMOD_DYSTUNE register */
...
#define SECUMOD_DYSTUNE_PERIOD(value)         (SECUMOD_DYSTUNE_PERIOD_Msk & (_UINT32_(value) << SECUMOD_DYSTUNE_PERIOD_Pos)) /* Assigment of value for PERIOD in the SECUMOD_DYSTUNE register */
...
#define SECUMOD_BMPR_DBLFM(value)             (SECUMOD_BMPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_BMPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_BMPR register */
...
#define SECUMOD_BMPR_TST(value)               (SECUMOD_BMPR_TST_Msk & (_UINT32_(value) << SECUMOD_BMPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_BMPR register */
...
#define SECUMOD_BMPR_TPML(value)              (SECUMOD_BMPR_TPML_Msk & (_UINT32_(value) << SECUMOD_BMPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_BMPR register */
...
#define SECUMOD_BMPR_TPMH(value)              (SECUMOD_BMPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_BMPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_BMPR register */
...
#define SECUMOD_BMPR_VBATL(value)             (SECUMOD_BMPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_BMPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_BMPR register */
...
#define SECUMOD_BMPR_VBATH(value)             (SECUMOD_BMPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_BMPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_BMPR register */
...
#define SECUMOD_NMPR_DWDT_SW(value)           (SECUMOD_NMPR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_NMPR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_DBLFM(value)             (SECUMOD_NMPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_NMPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_TST(value)               (SECUMOD_NMPR_TST_Msk & (_UINT32_(value) << SECUMOD_NMPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_JTAG(value)              (SECUMOD_NMPR_JTAG_Msk & (_UINT32_(value) << SECUMOD_NMPR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_REGANA(value)            (SECUMOD_NMPR_REGANA_Msk & (_UINT32_(value) << SECUMOD_NMPR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_TPML(value)              (SECUMOD_NMPR_TPML_Msk & (_UINT32_(value) << SECUMOD_NMPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_TPMH(value)              (SECUMOD_NMPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_NMPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VBATL(value)             (SECUMOD_NMPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_NMPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VBATH(value)             (SECUMOD_NMPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_NMPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VDDCOREL(value)          (SECUMOD_NMPR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_NMPR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VDDCPUL(value)           (SECUMOD_NMPR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_NMPR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VDDCOREH(value)          (SECUMOD_NMPR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_NMPR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_NMPR register */
...
#define SECUMOD_NMPR_VDDCPUH(value)           (SECUMOD_NMPR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_NMPR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_NMPR register */
...
#define SECUMOD_NIEPR_DWDT_SW(value)          (SECUMOD_NIEPR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_NIEPR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_DBLFM(value)            (SECUMOD_NIEPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_NIEPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_TST(value)              (SECUMOD_NIEPR_TST_Msk & (_UINT32_(value) << SECUMOD_NIEPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_JTAG(value)             (SECUMOD_NIEPR_JTAG_Msk & (_UINT32_(value) << SECUMOD_NIEPR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_REGANA(value)           (SECUMOD_NIEPR_REGANA_Msk & (_UINT32_(value) << SECUMOD_NIEPR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_TPML(value)             (SECUMOD_NIEPR_TPML_Msk & (_UINT32_(value) << SECUMOD_NIEPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_TPMH(value)             (SECUMOD_NIEPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_NIEPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VBATL(value)            (SECUMOD_NIEPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VBATH(value)            (SECUMOD_NIEPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VDDCOREL(value)         (SECUMOD_NIEPR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VDDCPUL(value)          (SECUMOD_NIEPR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VDDCOREH(value)         (SECUMOD_NIEPR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIEPR_VDDCPUH(value)          (SECUMOD_NIEPR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_NIEPR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_NIEPR register */
...
#define SECUMOD_NIDPR_DWDT_SW(value)          (SECUMOD_NIDPR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_NIDPR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_DBLFM(value)            (SECUMOD_NIDPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_NIDPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_TST(value)              (SECUMOD_NIDPR_TST_Msk & (_UINT32_(value) << SECUMOD_NIDPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_JTAG(value)             (SECUMOD_NIDPR_JTAG_Msk & (_UINT32_(value) << SECUMOD_NIDPR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_REGANA(value)           (SECUMOD_NIDPR_REGANA_Msk & (_UINT32_(value) << SECUMOD_NIDPR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_TPML(value)             (SECUMOD_NIDPR_TPML_Msk & (_UINT32_(value) << SECUMOD_NIDPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_TPMH(value)             (SECUMOD_NIDPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_NIDPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VBATL(value)            (SECUMOD_NIDPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VBATH(value)            (SECUMOD_NIDPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VDDCOREL(value)         (SECUMOD_NIDPR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VDDCPUL(value)          (SECUMOD_NIDPR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VDDCOREH(value)         (SECUMOD_NIDPR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIDPR_VDDCPUH(value)          (SECUMOD_NIDPR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_NIDPR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_NIDPR register */
...
#define SECUMOD_NIMPR_DWDT_SW(value)          (SECUMOD_NIMPR_DWDT_SW_Msk & (_UINT32_(value) << SECUMOD_NIMPR_DWDT_SW_Pos)) /* Assigment of value for DWDT_SW in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_DBLFM(value)            (SECUMOD_NIMPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_NIMPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_TST(value)              (SECUMOD_NIMPR_TST_Msk & (_UINT32_(value) << SECUMOD_NIMPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_JTAG(value)             (SECUMOD_NIMPR_JTAG_Msk & (_UINT32_(value) << SECUMOD_NIMPR_JTAG_Pos)) /* Assigment of value for JTAG in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_REGANA(value)           (SECUMOD_NIMPR_REGANA_Msk & (_UINT32_(value) << SECUMOD_NIMPR_REGANA_Pos)) /* Assigment of value for REGANA in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_TPML(value)             (SECUMOD_NIMPR_TPML_Msk & (_UINT32_(value) << SECUMOD_NIMPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_TPMH(value)             (SECUMOD_NIMPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_NIMPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VBATL(value)            (SECUMOD_NIMPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VBATH(value)            (SECUMOD_NIMPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VDDCOREL(value)         (SECUMOD_NIMPR_VDDCOREL_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VDDCOREL_Pos)) /* Assigment of value for VDDCOREL in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VDDCPUL(value)          (SECUMOD_NIMPR_VDDCPUL_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VDDCPUL_Pos)) /* Assigment of value for VDDCPUL in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VDDCOREH(value)         (SECUMOD_NIMPR_VDDCOREH_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VDDCOREH_Pos)) /* Assigment of value for VDDCOREH in the SECUMOD_NIMPR register */
...
#define SECUMOD_NIMPR_VDDCPUH(value)          (SECUMOD_NIMPR_VDDCPUH_Msk & (_UINT32_(value) << SECUMOD_NIMPR_VDDCPUH_Pos)) /* Assigment of value for VDDCPUH in the SECUMOD_NIMPR register */
...
#define SECUMOD_WKPR_DBLFM(value)             (SECUMOD_WKPR_DBLFM_Msk & (_UINT32_(value) << SECUMOD_WKPR_DBLFM_Pos)) /* Assigment of value for DBLFM in the SECUMOD_WKPR register */
...
#define SECUMOD_WKPR_TST(value)               (SECUMOD_WKPR_TST_Msk & (_UINT32_(value) << SECUMOD_WKPR_TST_Pos)) /* Assigment of value for TST in the SECUMOD_WKPR register */
...
#define SECUMOD_WKPR_TPML(value)              (SECUMOD_WKPR_TPML_Msk & (_UINT32_(value) << SECUMOD_WKPR_TPML_Pos)) /* Assigment of value for TPML in the SECUMOD_WKPR register */
...
#define SECUMOD_WKPR_TPMH(value)              (SECUMOD_WKPR_TPMH_Msk & (_UINT32_(value) << SECUMOD_WKPR_TPMH_Pos)) /* Assigment of value for TPMH in the SECUMOD_WKPR register */
...
#define SECUMOD_WKPR_VBATL(value)             (SECUMOD_WKPR_VBATL_Msk & (_UINT32_(value) << SECUMOD_WKPR_VBATL_Pos)) /* Assigment of value for VBATL in the SECUMOD_WKPR register */
...
#define SECUMOD_WKPR_VBATH(value)             (SECUMOD_WKPR_VBATH_Msk & (_UINT32_(value) << SECUMOD_WKPR_VBATH_Pos)) /* Assigment of value for VBATH in the SECUMOD_WKPR register */
...
#define SECUMOD_GPSBR_PSWBU(value)            (SECUMOD_GPSBR_PSWBU_Msk & (_UINT32_(value) << SECUMOD_GPSBR_PSWBU_Pos)) /* Assigment of value for PSWBU in the SECUMOD_GPSBR register */
...
#define SECUMOD_GPSBR_TSRANGE(value)          (SECUMOD_GPSBR_TSRANGE_Msk & (_UINT32_(value) << SECUMOD_GPSBR_TSRANGE_Pos)) /* Assigment of value for TSRANGE in the SECUMOD_GPSBR register */
...
#define SECUMOD_GPSBR_SMCPURANGE(value)       (SECUMOD_GPSBR_SMCPURANGE_Msk & (_UINT32_(value) << SECUMOD_GPSBR_SMCPURANGE_Pos)) /* Assigment of value for SMCPURANGE in the SECUMOD_GPSBR register */
...
#define SECUMOD_GPSBR_EXTIRQSEL(value)        (SECUMOD_GPSBR_EXTIRQSEL_Msk & (_UINT32_(value) << SECUMOD_GPSBR_EXTIRQSEL_Pos)) /* Assigment of value for EXTIRQSEL in the SECUMOD_GPSBR register */
...
#define SECUMOD_GPSBR_KEY(value)              (SECUMOD_GPSBR_KEY_Msk & (_UINT32_(value) << SECUMOD_GPSBR_KEY_Pos)) /* Assigment of value for KEY in the SECUMOD_GPSBR register */
...
#endif /* _SAMA7D6_SECUMOD_COMPONENT_H_ */
