...
#define LVDSC_ACR_DCBCAL(value)               (LVDSC_ACR_DCBCAL_Msk & (_UINT32_(value) << LVDSC_ACR_DCBCAL_Pos)) /* Assigment of value for DCBCAL in the LVDSC_ACR register */
...
#endif /* _SAMA7D6_LVDSC_COMPONENT_H_ */
