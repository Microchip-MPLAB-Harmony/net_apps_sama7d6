...
#define LCDC_LCDISR_OVR_Msk                   (_UINT32_(0x1) << LCDC_LCDISR_OVR_Pos)               /* (LCDC_LCDISR Mask) OVR */
...
#define LCDC_ATTRE_OVR_Msk                    (_UINT32_(0x1) << LCDC_ATTRE_OVR_Pos)                /* (LCDC_ATTRE Mask) OVR */
...
#define LCDC_ATTRS_OVR_Msk                    (_UINT32_(0x1) << LCDC_ATTRS_OVR_Pos)                /* (LCDC_ATTRS Mask) OVR */
...
/* -------- LCDC_FICR : (LCDC Offset: 0xD4) (R/W 32) Fault Injection Control Register -------- */
#define LCDC_FICR_RESETVALUE                  _UINT32_(0x00)                                       /*  (LCDC_FICR) Fault Injection Control Register  Reset Value */
...
/* -------- LCDC_FICFG : (LCDC Offset: 0xD8) (R/W 32) Fault Injection Configuration Register -------- */
#define LCDC_FICFG_RESETVALUE                 _UINT32_(0x00)                                       /*  (LCDC_FICFG) Fault Injection Configuration Register  Reset Value */
...
/* -------- LCDC_FDSR : (LCDC Offset: 0xDC) ( R/ 32) Fault Detection Status Register -------- */
#define LCDC_FDSR_RESETVALUE                  _UINT32_(0x00)                                       /*  (LCDC_FDSR) Fault Detection Status Register  Reset Value */
...
#define LCDC_FICR_REG_OFST             _UINT32_(0xD4)      /* (LCDC_FICR) Fault Injection Control Register Offset */
#define LCDC_FICFG_REG_OFST            _UINT32_(0xD8)      /* (LCDC_FICFG) Fault Injection Configuration Register Offset */
#define LCDC_FDSR_REG_OFST             _UINT32_(0xDC)      /* (LCDC_FDSR) Fault Detection Status Register Offset */
...
#endif /* _SAMA7D6_LCDC_COMPONENT_H_ */
