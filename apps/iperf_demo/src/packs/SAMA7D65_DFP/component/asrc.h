...
#define ASRC_CR_SWRST(value)                  (ASRC_CR_SWRST_Msk & (_UINT32_(value) << ASRC_CR_SWRST_Pos)) /* Assigment of value for SWRST in the ASRC_CR register */
...
#define ASRC_CR_MEMCHECK(value)               (ASRC_CR_MEMCHECK_Msk & (_UINT32_(value) << ASRC_CR_MEMCHECK_Pos)) /* Assigment of value for MEMCHECK in the ASRC_CR register */
...
#define ASRC_CR_DSPMEMSEL(value)              (ASRC_CR_DSPMEMSEL_Msk & (_UINT32_(value) << ASRC_CR_DSPMEMSEL_Pos)) /* Assigment of value for DSPMEMSEL in the ASRC_CR register */
...
#define ASRC_MR_ASRCEN0(value)                (ASRC_MR_ASRCEN0_Msk & (_UINT32_(value) << ASRC_MR_ASRCEN0_Pos)) /* Assigment of value for ASRCEN0 in the ASRC_MR register */
...
#define ASRC_MR_ASRCEN1(value)                (ASRC_MR_ASRCEN1_Msk & (_UINT32_(value) << ASRC_MR_ASRCEN1_Pos)) /* Assigment of value for ASRCEN1 in the ASRC_MR register */
...
#define ASRC_MR_ASRCEN2(value)                (ASRC_MR_ASRCEN2_Msk & (_UINT32_(value) << ASRC_MR_ASRCEN2_Pos)) /* Assigment of value for ASRCEN2 in the ASRC_MR register */
...
#define ASRC_MR_ASRCEN3(value)                (ASRC_MR_ASRCEN3_Msk & (_UINT32_(value) << ASRC_MR_ASRCEN3_Pos)) /* Assigment of value for ASRCEN3 in the ASRC_MR register */
...
#define ASRC_MR_DATHRM(value)                 (ASRC_MR_DATHRM_Msk & (_UINT32_(value) << ASRC_MR_DATHRM_Pos)) /* Assigment of value for DATHRM in the ASRC_MR register */
...
#define ASRC_MR_DARHRM(value)                 (ASRC_MR_DARHRM_Msk & (_UINT32_(value) << ASRC_MR_DARHRM_Pos)) /* Assigment of value for DARHRM in the ASRC_MR register */
...
#define ASRC_MR_DATHR0(value)                 (ASRC_MR_DATHR0_Msk & (_UINT32_(value) << ASRC_MR_DATHR0_Pos)) /* Assigment of value for DATHR0 in the ASRC_MR register */
...
#define ASRC_MR_DATHR1(value)                 (ASRC_MR_DATHR1_Msk & (_UINT32_(value) << ASRC_MR_DATHR1_Pos)) /* Assigment of value for DATHR1 in the ASRC_MR register */
...
#define ASRC_MR_DATHR2(value)                 (ASRC_MR_DATHR2_Msk & (_UINT32_(value) << ASRC_MR_DATHR2_Pos)) /* Assigment of value for DATHR2 in the ASRC_MR register */
...
#define ASRC_MR_DATHR3(value)                 (ASRC_MR_DATHR3_Msk & (_UINT32_(value) << ASRC_MR_DATHR3_Pos)) /* Assigment of value for DATHR3 in the ASRC_MR register */
...
#define ASRC_MR_DARHR0(value)                 (ASRC_MR_DARHR0_Msk & (_UINT32_(value) << ASRC_MR_DARHR0_Pos)) /* Assigment of value for DARHR0 in the ASRC_MR register */
...
#define ASRC_MR_DARHR1(value)                 (ASRC_MR_DARHR1_Msk & (_UINT32_(value) << ASRC_MR_DARHR1_Pos)) /* Assigment of value for DARHR1 in the ASRC_MR register */
...
#define ASRC_MR_DARHR2(value)                 (ASRC_MR_DARHR2_Msk & (_UINT32_(value) << ASRC_MR_DARHR2_Pos)) /* Assigment of value for DARHR2 in the ASRC_MR register */
...
#define ASRC_MR_DARHR3(value)                 (ASRC_MR_DARHR3_Msk & (_UINT32_(value) << ASRC_MR_DARHR3_Pos)) /* Assigment of value for DARHR3 in the ASRC_MR register */
...
#define ASRC_RATIO_INRATIO(value)             (ASRC_RATIO_INRATIO_Msk & (_UINT32_(value) << ASRC_RATIO_INRATIO_Pos)) /* Assigment of value for INRATIO in the ASRC_RATIO register */
...
#define ASRC_VBPS_IN_VBPS_IN0(value)          (ASRC_VBPS_IN_VBPS_IN0_Msk & (_UINT32_(value) << ASRC_VBPS_IN_VBPS_IN0_Pos)) /* Assigment of value for VBPS_IN0 in the ASRC_VBPS_IN register */
...
#define ASRC_VBPS_IN_VBPS_IN1(value)          (ASRC_VBPS_IN_VBPS_IN1_Msk & (_UINT32_(value) << ASRC_VBPS_IN_VBPS_IN1_Pos)) /* Assigment of value for VBPS_IN1 in the ASRC_VBPS_IN register */
...
#define ASRC_VBPS_IN_VBPS_IN2(value)          (ASRC_VBPS_IN_VBPS_IN2_Msk & (_UINT32_(value) << ASRC_VBPS_IN_VBPS_IN2_Pos)) /* Assigment of value for VBPS_IN2 in the ASRC_VBPS_IN register */
...
#define ASRC_VBPS_IN_VBPS_IN3(value)          (ASRC_VBPS_IN_VBPS_IN3_Msk & (_UINT32_(value) << ASRC_VBPS_IN_VBPS_IN3_Pos)) /* Assigment of value for VBPS_IN3 in the ASRC_VBPS_IN register */
...
#define ASRC_VBPS_OUT_VBPS_OUT0(value)        (ASRC_VBPS_OUT_VBPS_OUT0_Msk & (_UINT32_(value) << ASRC_VBPS_OUT_VBPS_OUT0_Pos)) /* Assigment of value for VBPS_OUT0 in the ASRC_VBPS_OUT register */
...
#define ASRC_VBPS_OUT_VBPS_OUT1(value)        (ASRC_VBPS_OUT_VBPS_OUT1_Msk & (_UINT32_(value) << ASRC_VBPS_OUT_VBPS_OUT1_Pos)) /* Assigment of value for VBPS_OUT1 in the ASRC_VBPS_OUT register */
...
#define ASRC_VBPS_OUT_VBPS_OUT2(value)        (ASRC_VBPS_OUT_VBPS_OUT2_Msk & (_UINT32_(value) << ASRC_VBPS_OUT_VBPS_OUT2_Pos)) /* Assigment of value for VBPS_OUT2 in the ASRC_VBPS_OUT register */
...
#define ASRC_VBPS_OUT_VBPS_OUT3(value)        (ASRC_VBPS_OUT_VBPS_OUT3_Msk & (_UINT32_(value) << ASRC_VBPS_OUT_VBPS_OUT3_Pos)) /* Assigment of value for VBPS_OUT3 in the ASRC_VBPS_OUT register */
...
#define ASRC_IER_EOMCP(value)                 (ASRC_IER_EOMCP_Msk & (_UINT32_(value) << ASRC_IER_EOMCP_Pos)) /* Assigment of value for EOMCP in the ASRC_IER register */
...
#define ASRC_IER_FSINLOSS(value)              (ASRC_IER_FSINLOSS_Msk & (_UINT32_(value) << ASRC_IER_FSINLOSS_Pos)) /* Assigment of value for FSINLOSS in the ASRC_IER register */
...
#define ASRC_IER_FSOUTLOSS(value)             (ASRC_IER_FSOUTLOSS_Msk & (_UINT32_(value) << ASRC_IER_FSOUTLOSS_Pos)) /* Assigment of value for FSOUTLOSS in the ASRC_IER register */
...
#define ASRC_IDR_EOMCP(value)                 (ASRC_IDR_EOMCP_Msk & (_UINT32_(value) << ASRC_IDR_EOMCP_Pos)) /* Assigment of value for EOMCP in the ASRC_IDR register */
...
#define ASRC_IDR_FSINLOSS(value)              (ASRC_IDR_FSINLOSS_Msk & (_UINT32_(value) << ASRC_IDR_FSINLOSS_Pos)) /* Assigment of value for FSINLOSS in the ASRC_IDR register */
...
#define ASRC_IDR_FSOUTLOSS(value)             (ASRC_IDR_FSOUTLOSS_Msk & (_UINT32_(value) << ASRC_IDR_FSOUTLOSS_Pos)) /* Assigment of value for FSOUTLOSS in the ASRC_IDR register */
...
#define ASRC_IMR_EOMCP(value)                 (ASRC_IMR_EOMCP_Msk & (_UINT32_(value) << ASRC_IMR_EOMCP_Pos)) /* Assigment of value for EOMCP in the ASRC_IMR register */
...
#define ASRC_IMR_FSINLOSS(value)              (ASRC_IMR_FSINLOSS_Msk & (_UINT32_(value) << ASRC_IMR_FSINLOSS_Pos)) /* Assigment of value for FSINLOSS in the ASRC_IMR register */
...
#define ASRC_IMR_FSOUTLOSS(value)             (ASRC_IMR_FSOUTLOSS_Msk & (_UINT32_(value) << ASRC_IMR_FSOUTLOSS_Pos)) /* Assigment of value for FSOUTLOSS in the ASRC_IMR register */
...
#define ASRC_ISR_EOMCP(value)                 (ASRC_ISR_EOMCP_Msk & (_UINT32_(value) << ASRC_ISR_EOMCP_Pos)) /* Assigment of value for EOMCP in the ASRC_ISR register */
...
#define ASRC_ISR_FSINLOSS(value)              (ASRC_ISR_FSINLOSS_Msk & (_UINT32_(value) << ASRC_ISR_FSINLOSS_Pos)) /* Assigment of value for FSINLOSS in the ASRC_ISR register */
...
#define ASRC_ISR_FSOUTLOSS(value)             (ASRC_ISR_FSOUTLOSS_Msk & (_UINT32_(value) << ASRC_ISR_FSOUTLOSS_Pos)) /* Assigment of value for FSOUTLOSS in the ASRC_ISR register */
...
#define ASRC_ESR_SRAMS(value)                 (ASRC_ESR_SRAMS_Msk & (_UINT32_(value) << ASRC_ESR_SRAMS_Pos)) /* Assigment of value for SRAMS in the ASRC_ESR register */
...
#define ASRC_ESR_ROMS(value)                  (ASRC_ESR_ROMS_Msk & (_UINT32_(value) << ASRC_ESR_ROMS_Pos)) /* Assigment of value for ROMS in the ASRC_ESR register */
...
#define ASRC_ESR_DAPSELIMAXERR(value)         (ASRC_ESR_DAPSELIMAXERR_Msk & (_UINT32_(value) << ASRC_ESR_DAPSELIMAXERR_Pos)) /* Assigment of value for DAPSELIMAXERR in the ASRC_ESR register */
...
#define ASRC_ESR_DAPSELOMAXERR(value)         (ASRC_ESR_DAPSELOMAXERR_Msk & (_UINT32_(value) << ASRC_ESR_DAPSELOMAXERR_Pos)) /* Assigment of value for DAPSELOMAXERR in the ASRC_ESR register */
...
#define ASRC_ESR_DAPSELIREDERR(value)         (ASRC_ESR_DAPSELIREDERR_Msk & (_UINT32_(value) << ASRC_ESR_DAPSELIREDERR_Pos)) /* Assigment of value for DAPSELIREDERR in the ASRC_ESR register */
...
#define ASRC_ESR_DAPSELOREDERR(value)         (ASRC_ESR_DAPSELOREDERR_Msk & (_UINT32_(value) << ASRC_ESR_DAPSELOREDERR_Pos)) /* Assigment of value for DAPSELOREDERR in the ASRC_ESR register */
...
#define ASRC_ESR_DATHXERR(value)              (ASRC_ESR_DATHXERR_Msk & (_UINT32_(value) << ASRC_ESR_DATHXERR_Pos)) /* Assigment of value for DATHXERR in the ASRC_ESR register */
...
#define ASRC_ESR_DARHXERR(value)              (ASRC_ESR_DARHXERR_Msk & (_UINT32_(value) << ASRC_ESR_DARHXERR_Pos)) /* Assigment of value for DARHXERR in the ASRC_ESR register */
...
#define ASRC_ESR_ITRIGERR(value)              (ASRC_ESR_ITRIGERR_Msk & (_UINT32_(value) << ASRC_ESR_ITRIGERR_Pos)) /* Assigment of value for ITRIGERR in the ASRC_ESR register */
...
#define ASRC_ESR_OTRIGERR(value)              (ASRC_ESR_OTRIGERR_Msk & (_UINT32_(value) << ASRC_ESR_OTRIGERR_Pos)) /* Assigment of value for OTRIGERR in the ASRC_ESR register */
...
#define ASRC_ESR_DAIERR0(value)               (ASRC_ESR_DAIERR0_Msk & (_UINT32_(value) << ASRC_ESR_DAIERR0_Pos)) /* Assigment of value for DAIERR0 in the ASRC_ESR register */
...
#define ASRC_ESR_DAIERR1(value)               (ASRC_ESR_DAIERR1_Msk & (_UINT32_(value) << ASRC_ESR_DAIERR1_Pos)) /* Assigment of value for DAIERR1 in the ASRC_ESR register */
...
#define ASRC_ESR_DAIERR2(value)               (ASRC_ESR_DAIERR2_Msk & (_UINT32_(value) << ASRC_ESR_DAIERR2_Pos)) /* Assigment of value for DAIERR2 in the ASRC_ESR register */
...
#define ASRC_ESR_DAIERR3(value)               (ASRC_ESR_DAIERR3_Msk & (_UINT32_(value) << ASRC_ESR_DAIERR3_Pos)) /* Assigment of value for DAIERR3 in the ASRC_ESR register */
...
#define ASRC_ESR_DAOERR0(value)               (ASRC_ESR_DAOERR0_Msk & (_UINT32_(value) << ASRC_ESR_DAOERR0_Pos)) /* Assigment of value for DAOERR0 in the ASRC_ESR register */
...
#define ASRC_ESR_DAOERR1(value)               (ASRC_ESR_DAOERR1_Msk & (_UINT32_(value) << ASRC_ESR_DAOERR1_Pos)) /* Assigment of value for DAOERR1 in the ASRC_ESR register */
...
#define ASRC_ESR_DAOERR2(value)               (ASRC_ESR_DAOERR2_Msk & (_UINT32_(value) << ASRC_ESR_DAOERR2_Pos)) /* Assigment of value for DAOERR2 in the ASRC_ESR register */
...
#define ASRC_ESR_DAOERR3(value)               (ASRC_ESR_DAOERR3_Msk & (_UINT32_(value) << ASRC_ESR_DAOERR3_Pos)) /* Assigment of value for DAOERR3 in the ASRC_ESR register */
...
#define ASRC_DAVCR_DA0CH0(value)              (ASRC_DAVCR_DA0CH0_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH0_Pos)) /* Assigment of value for DA0CH0 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH1(value)              (ASRC_DAVCR_DA0CH1_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH1_Pos)) /* Assigment of value for DA0CH1 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH2(value)              (ASRC_DAVCR_DA0CH2_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH2_Pos)) /* Assigment of value for DA0CH2 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH3(value)              (ASRC_DAVCR_DA0CH3_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH3_Pos)) /* Assigment of value for DA0CH3 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH4(value)              (ASRC_DAVCR_DA0CH4_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH4_Pos)) /* Assigment of value for DA0CH4 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH5(value)              (ASRC_DAVCR_DA0CH5_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH5_Pos)) /* Assigment of value for DA0CH5 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH6(value)              (ASRC_DAVCR_DA0CH6_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH6_Pos)) /* Assigment of value for DA0CH6 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA0CH7(value)              (ASRC_DAVCR_DA0CH7_Msk & (_UINT32_(value) << ASRC_DAVCR_DA0CH7_Pos)) /* Assigment of value for DA0CH7 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH0(value)              (ASRC_DAVCR_DA1CH0_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH0_Pos)) /* Assigment of value for DA1CH0 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH1(value)              (ASRC_DAVCR_DA1CH1_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH1_Pos)) /* Assigment of value for DA1CH1 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH2(value)              (ASRC_DAVCR_DA1CH2_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH2_Pos)) /* Assigment of value for DA1CH2 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH3(value)              (ASRC_DAVCR_DA1CH3_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH3_Pos)) /* Assigment of value for DA1CH3 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH4(value)              (ASRC_DAVCR_DA1CH4_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH4_Pos)) /* Assigment of value for DA1CH4 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH5(value)              (ASRC_DAVCR_DA1CH5_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH5_Pos)) /* Assigment of value for DA1CH5 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH6(value)              (ASRC_DAVCR_DA1CH6_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH6_Pos)) /* Assigment of value for DA1CH6 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA1CH7(value)              (ASRC_DAVCR_DA1CH7_Msk & (_UINT32_(value) << ASRC_DAVCR_DA1CH7_Pos)) /* Assigment of value for DA1CH7 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH0(value)              (ASRC_DAVCR_DA2CH0_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH0_Pos)) /* Assigment of value for DA2CH0 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH1(value)              (ASRC_DAVCR_DA2CH1_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH1_Pos)) /* Assigment of value for DA2CH1 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH2(value)              (ASRC_DAVCR_DA2CH2_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH2_Pos)) /* Assigment of value for DA2CH2 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH3(value)              (ASRC_DAVCR_DA2CH3_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH3_Pos)) /* Assigment of value for DA2CH3 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH4(value)              (ASRC_DAVCR_DA2CH4_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH4_Pos)) /* Assigment of value for DA2CH4 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH5(value)              (ASRC_DAVCR_DA2CH5_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH5_Pos)) /* Assigment of value for DA2CH5 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH6(value)              (ASRC_DAVCR_DA2CH6_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH6_Pos)) /* Assigment of value for DA2CH6 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA2CH7(value)              (ASRC_DAVCR_DA2CH7_Msk & (_UINT32_(value) << ASRC_DAVCR_DA2CH7_Pos)) /* Assigment of value for DA2CH7 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH0(value)              (ASRC_DAVCR_DA3CH0_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH0_Pos)) /* Assigment of value for DA3CH0 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH1(value)              (ASRC_DAVCR_DA3CH1_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH1_Pos)) /* Assigment of value for DA3CH1 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH2(value)              (ASRC_DAVCR_DA3CH2_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH2_Pos)) /* Assigment of value for DA3CH2 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH3(value)              (ASRC_DAVCR_DA3CH3_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH3_Pos)) /* Assigment of value for DA3CH3 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH4(value)              (ASRC_DAVCR_DA3CH4_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH4_Pos)) /* Assigment of value for DA3CH4 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH5(value)              (ASRC_DAVCR_DA3CH5_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH5_Pos)) /* Assigment of value for DA3CH5 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH6(value)              (ASRC_DAVCR_DA3CH6_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH6_Pos)) /* Assigment of value for DA3CH6 in the ASRC_DAVCR register */
...
#define ASRC_DAVCR_DA3CH7(value)              (ASRC_DAVCR_DA3CH7_Msk & (_UINT32_(value) << ASRC_DAVCR_DA3CH7_Pos)) /* Assigment of value for DA3CH7 in the ASRC_DAVCR register */
...
#define ASRC_FIR_F0(value)                    (ASRC_FIR_F0_Msk & (_UINT32_(value) << ASRC_FIR_F0_Pos)) /* Assigment of value for F0 in the ASRC_FIR register */
...
#define ASRC_FIR_F1(value)                    (ASRC_FIR_F1_Msk & (_UINT32_(value) << ASRC_FIR_F1_Pos)) /* Assigment of value for F1 in the ASRC_FIR register */
...
#define ASRC_FIR_F2(value)                    (ASRC_FIR_F2_Msk & (_UINT32_(value) << ASRC_FIR_F2_Pos)) /* Assigment of value for F2 in the ASRC_FIR register */
...
#define ASRC_FIR_F3(value)                    (ASRC_FIR_F3_Msk & (_UINT32_(value) << ASRC_FIR_F3_Pos)) /* Assigment of value for F3 in the ASRC_FIR register */
...
#define ASRC_FIR_FPARE(value)                 (ASRC_FIR_FPARE_Msk & (_UINT32_(value) << ASRC_FIR_FPARE_Pos)) /* Assigment of value for FPARE in the ASRC_FIR register */
...
#define ASRC_FIR_FIRDIS(value)                (ASRC_FIR_FIRDIS_Msk & (_UINT32_(value) << ASRC_FIR_FIRDIS_Pos)) /* Assigment of value for FIRDIS in the ASRC_FIR register */
...
#define ASRC_FIR_FIKEY(value)                 (ASRC_FIR_FIKEY_Msk & (_UINT32_(value) << ASRC_FIR_FIKEY_Pos)) /* Assigment of value for FIKEY in the ASRC_FIR register */
...
#define ASRC_DAPSELR_IN_CH0(value)            (ASRC_DAPSELR_IN_CH0_Msk & (_UINT32_(value) << ASRC_DAPSELR_IN_CH0_Pos)) /* Assigment of value for IN_CH0 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_IN_CH1(value)            (ASRC_DAPSELR_IN_CH1_Msk & (_UINT32_(value) << ASRC_DAPSELR_IN_CH1_Pos)) /* Assigment of value for IN_CH1 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_IN_CH2(value)            (ASRC_DAPSELR_IN_CH2_Msk & (_UINT32_(value) << ASRC_DAPSELR_IN_CH2_Pos)) /* Assigment of value for IN_CH2 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_IN_CH3(value)            (ASRC_DAPSELR_IN_CH3_Msk & (_UINT32_(value) << ASRC_DAPSELR_IN_CH3_Pos)) /* Assigment of value for IN_CH3 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_OUT_CH0(value)           (ASRC_DAPSELR_OUT_CH0_Msk & (_UINT32_(value) << ASRC_DAPSELR_OUT_CH0_Pos)) /* Assigment of value for OUT_CH0 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_OUT_CH1(value)           (ASRC_DAPSELR_OUT_CH1_Msk & (_UINT32_(value) << ASRC_DAPSELR_OUT_CH1_Pos)) /* Assigment of value for OUT_CH1 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_OUT_CH2(value)           (ASRC_DAPSELR_OUT_CH2_Msk & (_UINT32_(value) << ASRC_DAPSELR_OUT_CH2_Pos)) /* Assigment of value for OUT_CH2 in the ASRC_DAPSELR register */
...
#define ASRC_DAPSELR_OUT_CH3(value)           (ASRC_DAPSELR_OUT_CH3_Msk & (_UINT32_(value) << ASRC_DAPSELR_OUT_CH3_Pos)) /* Assigment of value for OUT_CH3 in the ASRC_DAPSELR register */
...
#define ASRC_DABMR_BREN0(value)               (ASRC_DABMR_BREN0_Msk & (_UINT32_(value) << ASRC_DABMR_BREN0_Pos)) /* Assigment of value for BREN0 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BREN1(value)               (ASRC_DABMR_BREN1_Msk & (_UINT32_(value) << ASRC_DABMR_BREN1_Pos)) /* Assigment of value for BREN1 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BREN2(value)               (ASRC_DABMR_BREN2_Msk & (_UINT32_(value) << ASRC_DABMR_BREN2_Pos)) /* Assigment of value for BREN2 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BREN3(value)               (ASRC_DABMR_BREN3_Msk & (_UINT32_(value) << ASRC_DABMR_BREN3_Pos)) /* Assigment of value for BREN3 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BRMONO0(value)             (ASRC_DABMR_BRMONO0_Msk & (_UINT32_(value) << ASRC_DABMR_BRMONO0_Pos)) /* Assigment of value for BRMONO0 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BRMONO1(value)             (ASRC_DABMR_BRMONO1_Msk & (_UINT32_(value) << ASRC_DABMR_BRMONO1_Pos)) /* Assigment of value for BRMONO1 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BRMONO2(value)             (ASRC_DABMR_BRMONO2_Msk & (_UINT32_(value) << ASRC_DABMR_BRMONO2_Pos)) /* Assigment of value for BRMONO2 in the ASRC_DABMR register */
...
#define ASRC_DABMR_BRMONO3(value)             (ASRC_DABMR_BRMONO3_Msk & (_UINT32_(value) << ASRC_DABMR_BRMONO3_Pos)) /* Assigment of value for BRMONO3 in the ASRC_DABMR register */
...
#define ASRC_SR_FIFOFULL0(value)              (ASRC_SR_FIFOFULL0_Msk & (_UINT32_(value) << ASRC_SR_FIFOFULL0_Pos)) /* Assigment of value for FIFOFULL0 in the ASRC_SR register */
...
#define ASRC_SR_FIFOEMPTY0(value)             (ASRC_SR_FIFOEMPTY0_Msk & (_UINT32_(value) << ASRC_SR_FIFOEMPTY0_Pos)) /* Assigment of value for FIFOEMPTY0 in the ASRC_SR register */
...
#define ASRC_SR_DPLL0(value)                  (ASRC_SR_DPLL0_Msk & (_UINT32_(value) << ASRC_SR_DPLL0_Pos)) /* Assigment of value for DPLL0 in the ASRC_SR register */
...
#define ASRC_SR_FSINERR0(value)               (ASRC_SR_FSINERR0_Msk & (_UINT32_(value) << ASRC_SR_FSINERR0_Pos)) /* Assigment of value for FSINERR0 in the ASRC_SR register */
...
#define ASRC_SR_FSOUTERR0(value)              (ASRC_SR_FSOUTERR0_Msk & (_UINT32_(value) << ASRC_SR_FSOUTERR0_Pos)) /* Assigment of value for FSOUTERR0 in the ASRC_SR register */
...
#define ASRC_SR_FIFOFULL1(value)              (ASRC_SR_FIFOFULL1_Msk & (_UINT32_(value) << ASRC_SR_FIFOFULL1_Pos)) /* Assigment of value for FIFOFULL1 in the ASRC_SR register */
...
#define ASRC_SR_FIFOEMPTY1(value)             (ASRC_SR_FIFOEMPTY1_Msk & (_UINT32_(value) << ASRC_SR_FIFOEMPTY1_Pos)) /* Assigment of value for FIFOEMPTY1 in the ASRC_SR register */
...
#define ASRC_SR_DPLL1(value)                  (ASRC_SR_DPLL1_Msk & (_UINT32_(value) << ASRC_SR_DPLL1_Pos)) /* Assigment of value for DPLL1 in the ASRC_SR register */
...
#define ASRC_SR_FSINERR1(value)               (ASRC_SR_FSINERR1_Msk & (_UINT32_(value) << ASRC_SR_FSINERR1_Pos)) /* Assigment of value for FSINERR1 in the ASRC_SR register */
...
#define ASRC_SR_FSOUTERR1(value)              (ASRC_SR_FSOUTERR1_Msk & (_UINT32_(value) << ASRC_SR_FSOUTERR1_Pos)) /* Assigment of value for FSOUTERR1 in the ASRC_SR register */
...
#define ASRC_SR_FIFOFULL2(value)              (ASRC_SR_FIFOFULL2_Msk & (_UINT32_(value) << ASRC_SR_FIFOFULL2_Pos)) /* Assigment of value for FIFOFULL2 in the ASRC_SR register */
...
#define ASRC_SR_FIFOEMPTY2(value)             (ASRC_SR_FIFOEMPTY2_Msk & (_UINT32_(value) << ASRC_SR_FIFOEMPTY2_Pos)) /* Assigment of value for FIFOEMPTY2 in the ASRC_SR register */
...
#define ASRC_SR_DPLL2(value)                  (ASRC_SR_DPLL2_Msk & (_UINT32_(value) << ASRC_SR_DPLL2_Pos)) /* Assigment of value for DPLL2 in the ASRC_SR register */
...
#define ASRC_SR_FSINERR2(value)               (ASRC_SR_FSINERR2_Msk & (_UINT32_(value) << ASRC_SR_FSINERR2_Pos)) /* Assigment of value for FSINERR2 in the ASRC_SR register */
...
#define ASRC_SR_FSOUTERR2(value)              (ASRC_SR_FSOUTERR2_Msk & (_UINT32_(value) << ASRC_SR_FSOUTERR2_Pos)) /* Assigment of value for FSOUTERR2 in the ASRC_SR register */
...
#define ASRC_SR_FIFOFULL3(value)              (ASRC_SR_FIFOFULL3_Msk & (_UINT32_(value) << ASRC_SR_FIFOFULL3_Pos)) /* Assigment of value for FIFOFULL3 in the ASRC_SR register */
...
#define ASRC_SR_FIFOEMPTY3(value)             (ASRC_SR_FIFOEMPTY3_Msk & (_UINT32_(value) << ASRC_SR_FIFOEMPTY3_Pos)) /* Assigment of value for FIFOEMPTY3 in the ASRC_SR register */
...
#define ASRC_SR_DPLL3(value)                  (ASRC_SR_DPLL3_Msk & (_UINT32_(value) << ASRC_SR_DPLL3_Pos)) /* Assigment of value for DPLL3 in the ASRC_SR register */
...
#define ASRC_SR_FSINERR3(value)               (ASRC_SR_FSINERR3_Msk & (_UINT32_(value) << ASRC_SR_FSINERR3_Pos)) /* Assigment of value for FSINERR3 in the ASRC_SR register */
...
#define ASRC_SR_FSOUTERR3(value)              (ASRC_SR_FSOUTERR3_Msk & (_UINT32_(value) << ASRC_SR_FSOUTERR3_Pos)) /* Assigment of value for FSOUTERR3 in the ASRC_SR register */
...
#define ASRC_WPMR_WPEN(value)                 (ASRC_WPMR_WPEN_Msk & (_UINT32_(value) << ASRC_WPMR_WPEN_Pos)) /* Assigment of value for WPEN in the ASRC_WPMR register */
...
#define ASRC_WPMR_WPITEN(value)               (ASRC_WPMR_WPITEN_Msk & (_UINT32_(value) << ASRC_WPMR_WPITEN_Pos)) /* Assigment of value for WPITEN in the ASRC_WPMR register */
...
#define ASRC_WPMR_WPCREN(value)               (ASRC_WPMR_WPCREN_Msk & (_UINT32_(value) << ASRC_WPMR_WPCREN_Pos)) /* Assigment of value for WPCREN in the ASRC_WPMR register */
...
#define ASRC_WPMR_WPKEY(value)                (ASRC_WPMR_WPKEY_Msk & (_UINT32_(value) << ASRC_WPMR_WPKEY_Pos)) /* Assigment of value for WPKEY in the ASRC_WPMR register */
...
#define ASRC_WPSR_WPVS(value)                 (ASRC_WPSR_WPVS_Msk & (_UINT32_(value) << ASRC_WPSR_WPVS_Pos)) /* Assigment of value for WPVS in the ASRC_WPSR register */
...
#define ASRC_WPSR_CFGERR(value)               (ASRC_WPSR_CFGERR_Msk & (_UINT32_(value) << ASRC_WPSR_CFGERR_Pos)) /* Assigment of value for CFGERR in the ASRC_WPSR register */
...
#define ASRC_WPSR_SEQE(value)                 (ASRC_WPSR_SEQE_Msk & (_UINT32_(value) << ASRC_WPSR_SEQE_Pos)) /* Assigment of value for SEQE in the ASRC_WPSR register */
...
#define ASRC_WPSR_SWE(value)                  (ASRC_WPSR_SWE_Msk & (_UINT32_(value) << ASRC_WPSR_SWE_Pos)) /* Assigment of value for SWE in the ASRC_WPSR register */
...
#define ASRC_WPSR_SDEE(value)                 (ASRC_WPSR_SDEE_Msk & (_UINT32_(value) << ASRC_WPSR_SDEE_Pos)) /* Assigment of value for SDEE in the ASRC_WPSR register */
...
#define ASRC_WPSR_WPSRC(value)                (ASRC_WPSR_WPSRC_Msk & (_UINT32_(value) << ASRC_WPSR_WPSRC_Pos)) /* Assigment of value for WPSRC in the ASRC_WPSR register */
...
#define ASRC_WPSR_SWETYP(value)               (ASRC_WPSR_SWETYP_Msk & (_UINT32_(value) << ASRC_WPSR_SWETYP_Pos)) /* Assigment of value for SWETYP in the ASRC_WPSR register */
