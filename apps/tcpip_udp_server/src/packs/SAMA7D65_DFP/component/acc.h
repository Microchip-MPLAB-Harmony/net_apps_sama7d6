...
#ifndef _SAMA7D6_ACC_COMPONENT_H_
#define _SAMA7D6_ACC_COMPONENT_H_
...
#define ACC_ISR_RESETVALUE                    _UINT32_(0x80000000)                                 /*  (ACC_ISR) Interrupt Status Register  Reset Value */
...
#define   ACC_WPSR_WPVS_0_Val                 _UINT32_(0x0)                                        /* (ACC_WPSR) No write protection violation has occurred since the last  command ACC_CR.SWRST=1.  */
#define   ACC_WPSR_WPVS_1_Val                 _UINT32_(0x1)                                        /* (ACC_WPSR) A write protection violation (WPEN = 1) has occurred since the last  command ACC_CR.SWRST=1.  */
#define ACC_WPSR_WPVS_0                       (ACC_WPSR_WPVS_0_Val << ACC_WPSR_WPVS_Pos)           /* (ACC_WPSR) No write protection violation has occurred since the last  command ACC_CR.SWRST=1. Position  */
#define ACC_WPSR_WPVS_1                       (ACC_WPSR_WPVS_1_Val << ACC_WPSR_WPVS_Pos)           /* (ACC_WPSR) A write protection violation (WPEN = 1) has occurred since the last  command ACC_CR.SWRST=1. Position  */
...
#endif /* _SAMA7D6_ACC_COMPONENT_H_ */
