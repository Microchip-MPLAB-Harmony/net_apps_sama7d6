...
#ifndef _SAMA7D6_RTT_COMPONENT_H_
#define _SAMA7D6_RTT_COMPONENT_H_
...
#define RTT_TSR_TS_OVF(value)                 (RTT_TSR_TS_OVF_Msk & (_UINT32_(value) << RTT_TSR_TS_OVF_Pos)) /* Assigment of value for TS_OVF in the RTT_TSR register */
...
#endif /* _SAMA7D6_RTT_COMPONENT_H_ */
