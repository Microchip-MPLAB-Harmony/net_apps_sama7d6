...
#define   AES_CR_KSWP_0_Val                   _UINT32_(0x0)                                        /* (AES_CR) No effect.  */
#define   AES_CR_KSWP_1_Val                   _UINT32_(0x1)                                        /* (AES_CR) Activates the set of key registers defined by AES_EMR if AES_EMR.PKRS has been changed.  */
#define AES_CR_KSWP_0                         (AES_CR_KSWP_0_Val << AES_CR_KSWP_Pos)               /* (AES_CR) No effect. Position  */
#define AES_CR_KSWP_1                         (AES_CR_KSWP_1_Val << AES_CR_KSWP_Pos)               /* (AES_CR) Activates the set of key registers defined by AES_EMR if AES_EMR.PKRS has been changed. Position  */
...
#define AES_MR_RESETVALUE                     _UINT32_(0x80000)                                    /*  (AES_MR) Mode Register  Reset Value */
...
#define   AES_EMR_KSEL_0_Val                  _UINT32_(0x0)                                        /* (AES_EMR) Selects the first key loaded by software.  */
#define   AES_EMR_KSEL_1_Val                  _UINT32_(0x1)                                        /* (AES_EMR) Selects the second key loaded by software.  */
#define AES_EMR_KSEL_0                        (AES_EMR_KSEL_0_Val << AES_EMR_KSEL_Pos)             /* (AES_EMR) Selects the first key loaded by software. Position  */
#define AES_EMR_KSEL_1                        (AES_EMR_KSEL_1_Val << AES_EMR_KSEL_Pos)             /* (AES_EMR) Selects the second key loaded by software. Position  */
...
#define   AES_EMR_PKWL_0_Val                  _UINT32_(0x0)                                        /* (AES_EMR) The Private Key internal registers can be written multiple times via the Private Key bus.  */
#define   AES_EMR_PKWL_1_Val                  _UINT32_(0x1)                                        /* (AES_EMR) The Private Key internal registers can be written only once via the Private Key bus until hardware reset.  */
...
#define AES_EMR_Msk                           _UINT32_(0x80FFFFF7)                                 /* (AES_EMR) Register Mask  */
...
#endif /* _SAMA7D6_AES_COMPONENT_H_ */
