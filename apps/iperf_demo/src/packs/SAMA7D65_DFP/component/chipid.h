...
#define CHIPID_CIDR_RESETVALUE                _UINT32_(0x80262110)                                 /*  (CHIPID_CIDR) Chip ID Register  Reset Value */
...
#define CHIPID_CIDR_ONE(value)                (CHIPID_CIDR_ONE_Msk & (_UINT32_(value) << CHIPID_CIDR_ONE_Pos)) /* Assigment of value for ONE in the CHIPID_CIDR register */
...
#define CHIPID_CIDR_ID(value)                 (CHIPID_CIDR_ID_Msk & (_UINT32_(value) << CHIPID_CIDR_ID_Pos)) /* Assigment of value for ID in the CHIPID_CIDR register */
...
#endif /* _SAMA7D6_CHIPID_COMPONENT_H_ */
