...
#ifndef _SAMA7D6_MATRIX_COMPONENT_H_
#define _SAMA7D6_MATRIX_COMPONENT_H_
...
#define MATRIX_SSR_DSSOA0(value)              (MATRIX_SSR_DSSOA0_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA0_Pos)) /* Assigment of value for DSSOA0 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA1(value)              (MATRIX_SSR_DSSOA1_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA1_Pos)) /* Assigment of value for DSSOA1 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA2(value)              (MATRIX_SSR_DSSOA2_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA2_Pos)) /* Assigment of value for DSSOA2 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA3(value)              (MATRIX_SSR_DSSOA3_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA3_Pos)) /* Assigment of value for DSSOA3 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA4(value)              (MATRIX_SSR_DSSOA4_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA4_Pos)) /* Assigment of value for DSSOA4 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA5(value)              (MATRIX_SSR_DSSOA5_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA5_Pos)) /* Assigment of value for DSSOA5 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA6(value)              (MATRIX_SSR_DSSOA6_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA6_Pos)) /* Assigment of value for DSSOA6 in the MATRIX_SSR register */
...
#define MATRIX_SSR_DSSOA7(value)              (MATRIX_SSR_DSSOA7_Msk & (_UINT32_(value) << MATRIX_SSR_DSSOA7_Pos)) /* Assigment of value for DSSOA7 in the MATRIX_SSR register */
...
#endif /* _SAMA7D6_MATRIX_COMPONENT_H_ */
