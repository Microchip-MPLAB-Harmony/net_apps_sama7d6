...
/* M_ARG2 mode */
#define SDMMC_SSAR_M_ARG2_ARG2_Pos            _UINT32_(0)                                          /* (SDMMC_SSAR) Argument 2 Position */
#define SDMMC_SSAR_M_ARG2_ARG2_Msk            (_UINT32_(0xFFFFFFFF) << SDMMC_SSAR_M_ARG2_ARG2_Pos) /* (SDMMC_SSAR) Argument 2 Mask */
#define SDMMC_SSAR_M_ARG2_ARG2(value)         (SDMMC_SSAR_M_ARG2_ARG2_Msk & (_UINT32_(value) << SDMMC_SSAR_M_ARG2_ARG2_Pos))
#define SDMMC_SSAR_M_ARG2_Msk                 _UINT32_(0xFFFFFFFF)                                  /* (SDMMC_SSAR_M_ARG2) Register Mask  */


/* -------- SDMMC_BSR : (SDMMC Offset: 0x04) (R/W 16) Block Size Register -------- */
#define SDMMC_BSR_RESETVALUE                  _UINT16_(0x00)                                       /*  (SDMMC_BSR) Block Size Register  Reset Value */
...
#define SDMMC_BCR_RESETVALUE                  _UINT16_(0x00)                                       /*  (SDMMC_BCR) Block Count Register  Reset Value */
...
#define SDMMC_ARG1R_RESETVALUE                _UINT32_(0x00)                                       /*  (SDMMC_ARG1R) Argument 1 Register  Reset Value */
...
#define SDMMC_TMR_RESETVALUE                  _UINT16_(0x00)                                       /*  (SDMMC_TMR) Transfer Mode Register  Reset Value */
...
#define SDMMC_CR_RESETVALUE                   _UINT16_(0x00)                                       /*  (SDMMC_CR) Command Register  Reset Value */
...
#define   SDMMC_CR_DPSEL_0_Val                _UINT16_(0x0)                                        /* (SDMMC_CR) No data present  */
#define   SDMMC_CR_DPSEL_1_Val                _UINT16_(0x1)                                        /* (SDMMC_CR) Data present  */
...
#define SDMMC_RR_RESETVALUE                   _UINT32_(0x00)                                       /*  (SDMMC_RR) Response Register x  Reset Value */
...
#define   SDMMC_PSR_CMDINHC_0_Val             _UINT32_(0x0)                                        /* (SDMMC_PSR) Can issue a command using only CMD line.  */
#define   SDMMC_PSR_CMDINHC_1_Val             _UINT32_(0x1)                                        /* (SDMMC_PSR) Cannot issue a command.  */
...
#define   SDMMC_PSR_CMDINHD_0_Val             _UINT32_(0x0)                                        /* (SDMMC_PSR) Can issue a command which uses the DAT line(s).  */
#define   SDMMC_PSR_CMDINHD_1_Val             _UINT32_(0x1)                                        /* (SDMMC_PSR) Cannot issue a command which uses the DAT line(s).  */
...
#define   SDMMC_PSR_DLACT_0_Val               _UINT32_(0x0)                                        /* (SDMMC_PSR) DAT line inactive.  */
#define   SDMMC_PSR_DLACT_1_Val               _UINT32_(0x1)                                        /* (SDMMC_PSR) DAT line active.  */
...
#define   SDMMC_PSR_CARDSS_0_Val              _UINT32_(0x0)                                        /* (SDMMC_PSR) Reset or debouncing.  */
#define   SDMMC_PSR_CARDSS_1_Val              _UINT32_(0x1)                                        /* (SDMMC_PSR) No card or card inserted.  */
...
#define   SDMMC_PSR_CARDDPL_0_Val             _UINT32_(0x0)                                        /* (SDMMC_PSR) No card present (SDMMC_CD = 1).  */
#define   SDMMC_PSR_CARDDPL_1_Val             _UINT32_(0x1)                                        /* (SDMMC_PSR) Card present (SDMMC_CD = 0).  */
...
#define   SDMMC_PSR_WRPPL_0_Val               _UINT32_(0x0)                                        /* (SDMMC_PSR) Write protected (SDMMC_WP = 0)  */
#define   SDMMC_PSR_WRPPL_1_Val               _UINT32_(0x1)                                        /* (SDMMC_PSR) Write enabled (SDMMC_WP = 1)  */
...
#define SDMMC_HC1R_RESETVALUE                 _UINT8_(0x00)                                        /*  (SDMMC_HC1R) Host Control 1 Register  Reset Value */

#define SDMMC_HC1R_Msk                        _UINT8_(0x00)                                        /* (SDMMC_HC1R) Register Mask  */

/* EMMC mode */
#define SDMMC_HC1R_EMMC_DW_Pos                _UINT8_(1)                                           /* (SDMMC_HC1R) Data Width Position */
#define SDMMC_HC1R_EMMC_DW_Msk                (_UINT8_(0x1) << SDMMC_HC1R_EMMC_DW_Pos)             /* (SDMMC_HC1R) Data Width Mask */
#define SDMMC_HC1R_EMMC_DW(value)             (SDMMC_HC1R_EMMC_DW_Msk & (_UINT8_(value) << SDMMC_HC1R_EMMC_DW_Pos))
#define   SDMMC_HC1R_EMMC_DW_1_BIT_Val        _UINT8_(0x0)                                         /* (SDMMC_HC1R) 1-bit mode.  */
#define   SDMMC_HC1R_EMMC_DW_4_BIT_Val        _UINT8_(0x1)                                         /* (SDMMC_HC1R) 4-bit mode.  */
...
#define SDMMC_HC1R_EMMC_HSEN_Pos              _UINT8_(2)                                           /* (SDMMC_HC1R) High Speed Enable Position */
#define SDMMC_HC1R_EMMC_HSEN_Msk              (_UINT8_(0x1) << SDMMC_HC1R_EMMC_HSEN_Pos)           /* (SDMMC_HC1R) High Speed Enable Mask */
#define SDMMC_HC1R_EMMC_HSEN(value)           (SDMMC_HC1R_EMMC_HSEN_Msk & (_UINT8_(value) << SDMMC_HC1R_EMMC_HSEN_Pos))
#define   SDMMC_HC1R_EMMC_HSEN_0_Val          _UINT8_(0x0)                                         /* (SDMMC_HC1R) Normal Speed mode.  */
#define   SDMMC_HC1R_EMMC_HSEN_1_Val          _UINT8_(0x1)                                         /* (SDMMC_HC1R) High Speed mode.  */
...
#define SDMMC_HC1R_EMMC_DMASEL_Pos            _UINT8_(3)                                           /* (SDMMC_HC1R) DMA Select Position */
#define SDMMC_HC1R_EMMC_DMASEL_Msk            (_UINT8_(0x3) << SDMMC_HC1R_EMMC_DMASEL_Pos)         /* (SDMMC_HC1R) DMA Select Mask */
#define SDMMC_HC1R_EMMC_DMASEL(value)         (SDMMC_HC1R_EMMC_DMASEL_Msk & (_UINT8_(value) << SDMMC_HC1R_EMMC_DMASEL_Pos))
#define   SDMMC_HC1R_EMMC_DMASEL_SDMA_Val     _UINT8_(0x0)                                         /* (SDMMC_HC1R) SDMA is selected  */
#define   SDMMC_HC1R_EMMC_DMASEL_ADMA32_Val   _UINT8_(0x2)                                         /* (SDMMC_HC1R) 32-bit Address ADMA2 is selected  */
...
#define SDMMC_HC1R_EMMC_EXTDW_Pos             _UINT8_(5)                                           /* (SDMMC_HC1R) Extended Data Width Position */
#define SDMMC_HC1R_EMMC_EXTDW_Msk             (_UINT8_(0x1) << SDMMC_HC1R_EMMC_EXTDW_Pos)          /* (SDMMC_HC1R) Extended Data Width Mask */
#define SDMMC_HC1R_EMMC_EXTDW(value)          (SDMMC_HC1R_EMMC_EXTDW_Msk & (_UINT8_(value) << SDMMC_HC1R_EMMC_EXTDW_Pos))
#define SDMMC_HC1R_EMMC_Msk                   _UINT8_(0x3E)                                         /* (SDMMC_HC1R_EMMC) Register Mask  */
...
#define   SDMMC_HC1R_SD_SDIO_HSEN_0_Val       _UINT8_(0x0)                                         /* (SDMMC_HC1R) Normal Speed mode.  */
#define   SDMMC_HC1R_SD_SDIO_HSEN_1_Val       _UINT8_(0x1)                                         /* (SDMMC_HC1R) High Speed mode.  */
...
#define   SDMMC_HC1R_SD_SDIO_CARDDTL_0_Val    _UINT8_(0x0)                                         /* (SDMMC_HC1R) No card.  */
#define   SDMMC_HC1R_SD_SDIO_CARDDTL_1_Val    _UINT8_(0x1)                                         /* (SDMMC_HC1R) Card inserted.  */
...
#define   SDMMC_HC1R_SD_SDIO_CARDDSEL_0_Val   _UINT8_(0x0)                                         /* (SDMMC_HC1R) The SDMMC_CD pin is selected.  */
#define   SDMMC_HC1R_SD_SDIO_CARDDSEL_1_Val   _UINT8_(0x1)                                         /* (SDMMC_HC1R) The Card Detect Test Level (CARDDTL) is selected (for test purpose).  */
...
#define SDMMC_PCR_RESETVALUE                  _UINT8_(0x0E)                                        /*  (SDMMC_PCR) Power Control Register  Reset Value */
...
#define SDMMC_BGCR_RESETVALUE                 _UINT8_(0x00)                                        /*  (SDMMC_BGCR) Block Gap Control Register  Reset Value */

#define SDMMC_BGCR_Msk                        _UINT8_(0x00)                                        /* (SDMMC_BGCR) Register Mask  */

/* EMMC mode */
#define SDMMC_BGCR_EMMC_STPBGR_Pos            _UINT8_(0)                                           /* (SDMMC_BGCR) Stop At Block Gap Request Position */
#define SDMMC_BGCR_EMMC_STPBGR_Msk            (_UINT8_(0x1) << SDMMC_BGCR_EMMC_STPBGR_Pos)         /* (SDMMC_BGCR) Stop At Block Gap Request Mask */
#define SDMMC_BGCR_EMMC_STPBGR(value)         (SDMMC_BGCR_EMMC_STPBGR_Msk & (_UINT8_(value) << SDMMC_BGCR_EMMC_STPBGR_Pos))
#define   SDMMC_BGCR_EMMC_STPBGR_0_Val        _UINT8_(0x0)                                         /* (SDMMC_BGCR) Transfer  */
#define   SDMMC_BGCR_EMMC_STPBGR_1_Val        _UINT8_(0x1)                                         /* (SDMMC_BGCR) Stop  */
...
#define SDMMC_BGCR_EMMC_CONTR_Pos             _UINT8_(1)                                           /* (SDMMC_BGCR) Continue Request Position */
#define SDMMC_BGCR_EMMC_CONTR_Msk             (_UINT8_(0x1) << SDMMC_BGCR_EMMC_CONTR_Pos)          /* (SDMMC_BGCR) Continue Request Mask */
#define SDMMC_BGCR_EMMC_CONTR(value)          (SDMMC_BGCR_EMMC_CONTR_Msk & (_UINT8_(value) << SDMMC_BGCR_EMMC_CONTR_Pos))
#define   SDMMC_BGCR_EMMC_CONTR_0_Val         _UINT8_(0x0)                                         /* (SDMMC_BGCR) No effect.  */
#define   SDMMC_BGCR_EMMC_CONTR_1_Val         _UINT8_(0x1)                                         /* (SDMMC_BGCR) Restart.  */
...
#define SDMMC_BGCR_EMMC_Msk                   _UINT8_(0x03)                                         /* (SDMMC_BGCR_EMMC) Register Mask  */
...
#define   SDMMC_BGCR_SD_SDIO_STPBGR_0_Val     _UINT8_(0x0)                                         /* (SDMMC_BGCR) Transfer  */
#define   SDMMC_BGCR_SD_SDIO_STPBGR_1_Val     _UINT8_(0x1)                                         /* (SDMMC_BGCR) Stop  */
...
#define   SDMMC_BGCR_SD_SDIO_CONTR_0_Val      _UINT8_(0x0)                                         /* (SDMMC_BGCR) No effect.  */
#define   SDMMC_BGCR_SD_SDIO_CONTR_1_Val      _UINT8_(0x1)                                         /* (SDMMC_BGCR) Restart.  */
...
#define   SDMMC_BGCR_SD_SDIO_RWCTRL_0_Val     _UINT8_(0x0)                                         /* (SDMMC_BGCR) Disables Read Wait control.  */
#define   SDMMC_BGCR_SD_SDIO_RWCTRL_1_Val     _UINT8_(0x1)                                         /* (SDMMC_BGCR) Enables Read Wait control.  */
...
#define SDMMC_CCR_RESETVALUE                  _UINT16_(0x00)                                       /*  (SDMMC_CCR) Clock Control Register  Reset Value */
...
#define   SDMMC_CCR_INTCLKEN_0_Val            _UINT16_(0x0)                                        /* (SDMMC_CCR) The internal clock stops.  */
#define   SDMMC_CCR_INTCLKEN_1_Val            _UINT16_(0x1)                                        /* (SDMMC_CCR) The internal clock oscillates.  */
...
#define   SDMMC_CCR_INTCLKS_0_Val             _UINT16_(0x0)                                        /* (SDMMC_CCR) Internal clock not ready.  */
#define   SDMMC_CCR_INTCLKS_1_Val             _UINT16_(0x1)                                        /* (SDMMC_CCR) Internal clock ready.  */
...
#define   SDMMC_CCR_SDCLKEN_0_Val             _UINT16_(0x0)                                        /* (SDMMC_CCR) SD Clock disabled  */
#define   SDMMC_CCR_SDCLKEN_1_Val             _UINT16_(0x1)                                        /* (SDMMC_CCR) SD Clock enabled  */
...
#define   SDMMC_CCR_CLKGSEL_0_Val             _UINT16_(0x0)                                        /* (SDMMC_CCR) Divided Clock mode (BASECLK is used to generate SDCLK).  */
#define   SDMMC_CCR_CLKGSEL_1_Val             _UINT16_(0x1)                                        /* (SDMMC_CCR) Programmable Clock mode (MULTCLK is used to generate SDCLK).  */
...
#define SDMMC_TCR_RESETVALUE                  _UINT8_(0x00)                                        /*  (SDMMC_TCR) Timeout Control Register  Reset Value */
...
#define SDMMC_SRR_RESETVALUE                  _UINT8_(0x00)                                        /*  (SDMMC_SRR) Software Reset Register  Reset Value */
...
#define   SDMMC_SRR_SWRSTALL_0_Val            _UINT8_(0x0)                                         /* (SDMMC_SRR) Work  */
#define   SDMMC_SRR_SWRSTALL_1_Val            _UINT8_(0x1)                                         /* (SDMMC_SRR) Reset  */
...
#define   SDMMC_SRR_SWRSTCMD_0_Val            _UINT8_(0x0)                                         /* (SDMMC_SRR) Work  */
#define   SDMMC_SRR_SWRSTCMD_1_Val            _UINT8_(0x1)                                         /* (SDMMC_SRR) Reset  */
...
#define   SDMMC_SRR_SWRSTDAT_0_Val            _UINT8_(0x0)                                         /* (SDMMC_SRR) Work  */
#define   SDMMC_SRR_SWRSTDAT_1_Val            _UINT8_(0x1)                                         /* (SDMMC_SRR) Reset  */
...
#define SDMMC_NISTR_RESETVALUE                _UINT16_(0x00)                                       /*  (SDMMC_NISTR) Normal Interrupt Status Register  Reset Value */
...
#define   SDMMC_NISTR_EMMC_CMDC_0_Val         _UINT16_(0x0)                                        /* (SDMMC_NISTR) No command complete.  */
#define   SDMMC_NISTR_EMMC_CMDC_1_Val         _UINT16_(0x1)                                        /* (SDMMC_NISTR) Command complete.  */
...
#define   SDMMC_NISTR_EMMC_BLKGE_0_Val        _UINT16_(0x0)                                        /* (SDMMC_NISTR) No block gap event.  */
#define   SDMMC_NISTR_EMMC_BLKGE_1_Val        _UINT16_(0x1)                                        /* (SDMMC_NISTR) Transaction stopped at block gap.  */
...
#define   SDMMC_NISTR_EMMC_DMAINT_0_Val       _UINT16_(0x0)                                        /* (SDMMC_NISTR) No DMA interrupt.  */
...
#define   SDMMC_NISTR_EMMC_BWRRDY_0_Val       _UINT16_(0x0)                                        /* (SDMMC_NISTR) Not ready to write buffer.  */
#define   SDMMC_NISTR_EMMC_BWRRDY_1_Val       _UINT16_(0x1)                                        /* (SDMMC_NISTR) Ready to write buffer.  */
...
#define SDMMC_NISTR_EMMC_BRDRDY_Pos           _UINT16_(5)                                          /* (SDMMC_NISTR) Buffer Read Ready Position */
#define SDMMC_NISTR_EMMC_BRDRDY_Msk           (_UINT16_(0x1) << SDMMC_NISTR_EMMC_BRDRDY_Pos)       /* (SDMMC_NISTR) Buffer Read Ready Mask */
#define SDMMC_NISTR_EMMC_BRDRDY(value)        (SDMMC_NISTR_EMMC_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISTR_EMMC_BRDRDY_Pos))
#define   SDMMC_NISTR_EMMC_BRDRDY_0_Val       _UINT16_(0x0)                                        /* (SDMMC_NISTR) Not ready to read buffer.  */
#define   SDMMC_NISTR_EMMC_BRDRDY_1_Val       _UINT16_(0x1)                                        /* (SDMMC_NISTR) Ready to read buffer.  */
...
#define   SDMMC_NISTR_EMMC_ERRINT_0_Val       _UINT16_(0x0)                                        /* (SDMMC_NISTR) No error.  */
...
#define   SDMMC_NISTR_SD_SDIO_CMDC_0_Val      _UINT16_(0x0)                                        /* (SDMMC_NISTR) No command complete.  */
#define   SDMMC_NISTR_SD_SDIO_CMDC_1_Val      _UINT16_(0x1)                                        /* (SDMMC_NISTR) Command complete.  */
...
#define   SDMMC_NISTR_SD_SDIO_TRFC_0_Val      _UINT16_(0x0)                                        /* (SDMMC_NISTR) Command execution is not complete.  */
#define   SDMMC_NISTR_SD_SDIO_TRFC_1_Val      _UINT16_(0x1)                                        /* (SDMMC_NISTR) Command execution is complete.  */
...
#define   SDMMC_NISTR_SD_SDIO_BLKGE_0_Val     _UINT16_(0x0)                                        /* (SDMMC_NISTR) No block gap event.  */
#define   SDMMC_NISTR_SD_SDIO_BLKGE_1_Val     _UINT16_(0x1)                                        /* (SDMMC_NISTR) Transaction stopped at block gap.  */
...
#define   SDMMC_NISTR_SD_SDIO_DMAINT_0_Val    _UINT16_(0x0)                                        /* (SDMMC_NISTR) No DMA Interrupt.  */
#define   SDMMC_NISTR_SD_SDIO_DMAINT_1_Val    _UINT16_(0x1)                                        /* (SDMMC_NISTR) DMA Interrupt.  */
...
#define   SDMMC_NISTR_SD_SDIO_BWRRDY_0_Val    _UINT16_(0x0)                                        /* (SDMMC_NISTR) Not ready to write buffer.  */
#define   SDMMC_NISTR_SD_SDIO_BWRRDY_1_Val    _UINT16_(0x1)                                        /* (SDMMC_NISTR) Ready to write buffer.  */
...
#define   SDMMC_NISTR_SD_SDIO_BRDRDY_0_Val    _UINT16_(0x0)                                        /* (SDMMC_NISTR) Not ready to read buffer.  */
#define   SDMMC_NISTR_SD_SDIO_BRDRDY_1_Val    _UINT16_(0x1)                                        /* (SDMMC_NISTR) Ready to read buffer.  */
...
#define   SDMMC_NISTR_SD_SDIO_CINS_0_Val      _UINT16_(0x0)                                        /* (SDMMC_NISTR) Card state unstable or card removed.  */
#define   SDMMC_NISTR_SD_SDIO_CINS_1_Val      _UINT16_(0x1)                                        /* (SDMMC_NISTR) Card inserted.  */
...
#define   SDMMC_NISTR_SD_SDIO_CREM_0_Val      _UINT16_(0x0)                                        /* (SDMMC_NISTR) Card state unstable or card inserted.  */
#define   SDMMC_NISTR_SD_SDIO_CREM_1_Val      _UINT16_(0x1)                                        /* (SDMMC_NISTR) Card removed.  */
...
#define   SDMMC_NISTR_SD_SDIO_CINT_0_Val      _UINT16_(0x0)                                        /* (SDMMC_NISTR) No card interrupt.  */
#define   SDMMC_NISTR_SD_SDIO_CINT_1_Val      _UINT16_(0x1)                                        /* (SDMMC_NISTR) Card interrupt.  */
...
#define   SDMMC_NISTR_SD_SDIO_ERRINT_0_Val    _UINT16_(0x0)                                        /* (SDMMC_NISTR) No error.  */
#define   SDMMC_NISTR_SD_SDIO_ERRINT_1_Val    _UINT16_(0x1)                                        /* (SDMMC_NISTR) Error.  */
...
#define SDMMC_EISTR_RESETVALUE                _UINT16_(0x00)                                       /*  (SDMMC_EISTR) Error Interrupt Status Register  Reset Value */

#define SDMMC_EISTR_Msk                       _UINT16_(0x0000)                                     /* (SDMMC_EISTR) Register Mask  */

/* EMMC mode */
#define SDMMC_EISTR_EMMC_CMDTEO_Pos           _UINT16_(0)                                          /* (SDMMC_EISTR) Command Timeout Error Position */
#define SDMMC_EISTR_EMMC_CMDTEO_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_CMDTEO_Pos)       /* (SDMMC_EISTR) Command Timeout Error Mask */
#define SDMMC_EISTR_EMMC_CMDTEO(value)        (SDMMC_EISTR_EMMC_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_CMDTEO_Pos))
#define SDMMC_EISTR_EMMC_CMDCRC_Pos           _UINT16_(1)                                          /* (SDMMC_EISTR) Command CRC Error Position */
#define SDMMC_EISTR_EMMC_CMDCRC_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_CMDCRC_Pos)       /* (SDMMC_EISTR) Command CRC Error Mask */
#define SDMMC_EISTR_EMMC_CMDCRC(value)        (SDMMC_EISTR_EMMC_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_CMDCRC_Pos))
#define SDMMC_EISTR_EMMC_CMDEND_Pos           _UINT16_(2)                                          /* (SDMMC_EISTR) Command End Bit Error Position */
#define SDMMC_EISTR_EMMC_CMDEND_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_CMDEND_Pos)       /* (SDMMC_EISTR) Command End Bit Error Mask */
#define SDMMC_EISTR_EMMC_CMDEND(value)        (SDMMC_EISTR_EMMC_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_CMDEND_Pos))
#define   SDMMC_EISTR_EMMC_CMDEND_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_CMDEND_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_CMDIDX_Pos           _UINT16_(3)                                          /* (SDMMC_EISTR) Command Index Error Position */
#define SDMMC_EISTR_EMMC_CMDIDX_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_CMDIDX_Pos)       /* (SDMMC_EISTR) Command Index Error Mask */
#define SDMMC_EISTR_EMMC_CMDIDX(value)        (SDMMC_EISTR_EMMC_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_CMDIDX_Pos))
#define   SDMMC_EISTR_EMMC_CMDIDX_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_CMDIDX_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_DATTEO_Pos           _UINT16_(4)                                          /* (SDMMC_EISTR) Data Timeout error Position */
#define SDMMC_EISTR_EMMC_DATTEO_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_DATTEO_Pos)       /* (SDMMC_EISTR) Data Timeout error Mask */
#define SDMMC_EISTR_EMMC_DATTEO(value)        (SDMMC_EISTR_EMMC_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_DATTEO_Pos))
#define   SDMMC_EISTR_EMMC_DATTEO_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_DATTEO_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_DATCRC_Pos           _UINT16_(5)                                          /* (SDMMC_EISTR) Data CRC Error Position */
#define SDMMC_EISTR_EMMC_DATCRC_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_DATCRC_Pos)       /* (SDMMC_EISTR) Data CRC Error Mask */
#define SDMMC_EISTR_EMMC_DATCRC(value)        (SDMMC_EISTR_EMMC_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_DATCRC_Pos))
#define   SDMMC_EISTR_EMMC_DATCRC_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_DATCRC_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_DATEND_Pos           _UINT16_(6)                                          /* (SDMMC_EISTR) Data End Bit Error Position */
#define SDMMC_EISTR_EMMC_DATEND_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_DATEND_Pos)       /* (SDMMC_EISTR) Data End Bit Error Mask */
#define SDMMC_EISTR_EMMC_DATEND(value)        (SDMMC_EISTR_EMMC_DATEND_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_DATEND_Pos))
#define   SDMMC_EISTR_EMMC_DATEND_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_DATEND_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_CURLIM_Pos           _UINT16_(7)                                          /* (SDMMC_EISTR) Current Limit Error Position */
#define SDMMC_EISTR_EMMC_CURLIM_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_CURLIM_Pos)       /* (SDMMC_EISTR) Current Limit Error Mask */
#define SDMMC_EISTR_EMMC_CURLIM(value)        (SDMMC_EISTR_EMMC_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_CURLIM_Pos))
#define   SDMMC_EISTR_EMMC_CURLIM_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_CURLIM_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_ACMD_Pos             _UINT16_(8)                                          /* (SDMMC_EISTR) Auto CMD Error Position */
#define SDMMC_EISTR_EMMC_ACMD_Msk             (_UINT16_(0x1) << SDMMC_EISTR_EMMC_ACMD_Pos)         /* (SDMMC_EISTR) Auto CMD Error Mask */
#define SDMMC_EISTR_EMMC_ACMD(value)          (SDMMC_EISTR_EMMC_ACMD_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_ACMD_Pos))
#define   SDMMC_EISTR_EMMC_ACMD_0_Val         _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_ACMD_1_Val         _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_ADMA_Pos             _UINT16_(9)                                          /* (SDMMC_EISTR) ADMA Error Position */
#define SDMMC_EISTR_EMMC_ADMA_Msk             (_UINT16_(0x1) << SDMMC_EISTR_EMMC_ADMA_Pos)         /* (SDMMC_EISTR) ADMA Error Mask */
#define SDMMC_EISTR_EMMC_ADMA(value)          (SDMMC_EISTR_EMMC_ADMA_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_ADMA_Pos))
#define   SDMMC_EISTR_EMMC_ADMA_0_Val         _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_ADMA_1_Val         _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_EMMC_TUNING_Pos           _UINT16_(10)                                         /* (SDMMC_EISTR) Tuning Error Position */
#define SDMMC_EISTR_EMMC_TUNING_Msk           (_UINT16_(0x1) << SDMMC_EISTR_EMMC_TUNING_Pos)       /* (SDMMC_EISTR) Tuning Error Mask */
#define SDMMC_EISTR_EMMC_TUNING(value)        (SDMMC_EISTR_EMMC_TUNING_Msk & (_UINT16_(value) << SDMMC_EISTR_EMMC_TUNING_Pos))
#define   SDMMC_EISTR_EMMC_TUNING_0_Val       _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_EMMC_TUNING_1_Val       _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_CMDEND_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_CMDEND_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_CMDIDX_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_CMDIDX_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_DATTEO_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_DATTEO_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_DATCRC_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_DATCRC_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_DATEND_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_DATEND_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_CURLIM_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_CURLIM_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_ACMD_0_Val      _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_ACMD_1_Val      _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define   SDMMC_EISTR_SD_SDIO_ADMA_0_Val      _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_ADMA_1_Val      _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_SD_SDIO_TUNING_Pos        _UINT16_(10)                                         /* (SDMMC_EISTR) Tuning Error Position */
#define SDMMC_EISTR_SD_SDIO_TUNING_Msk        (_UINT16_(0x1) << SDMMC_EISTR_SD_SDIO_TUNING_Pos)    /* (SDMMC_EISTR) Tuning Error Mask */
#define SDMMC_EISTR_SD_SDIO_TUNING(value)     (SDMMC_EISTR_SD_SDIO_TUNING_Msk & (_UINT16_(value) << SDMMC_EISTR_SD_SDIO_TUNING_Pos))
#define   SDMMC_EISTR_SD_SDIO_TUNING_0_Val    _UINT16_(0x0)                                        /* (SDMMC_EISTR) No error.  */
#define   SDMMC_EISTR_SD_SDIO_TUNING_1_Val    _UINT16_(0x1)                                        /* (SDMMC_EISTR) Error.  */
...
#define SDMMC_EISTR_SD_SDIO_Msk               _UINT16_(0x07FF)                                      /* (SDMMC_EISTR_SD_SDIO) Register Mask  */


/* -------- SDMMC_NISTER : (SDMMC Offset: 0x34) (R/W 16) Normal Interrupt Status Enable Register -------- */
#define SDMMC_NISTER_RESETVALUE               _UINT16_(0x00)                                       /*  (SDMMC_NISTER) Normal Interrupt Status Enable Register  Reset Value */

#define SDMMC_NISTER_Msk                      _UINT16_(0x0000)                                     /* (SDMMC_NISTER) Register Mask  */

/* EMMC mode */
#define SDMMC_NISTER_EMMC_CMDC_Pos            _UINT16_(0)                                          /* (SDMMC_NISTER) Command Complete Status Enable Position */
#define SDMMC_NISTER_EMMC_CMDC_Msk            (_UINT16_(0x1) << SDMMC_NISTER_EMMC_CMDC_Pos)        /* (SDMMC_NISTER) Command Complete Status Enable Mask */
#define SDMMC_NISTER_EMMC_CMDC(value)         (SDMMC_NISTER_EMMC_CMDC_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_CMDC_Pos))
#define   SDMMC_NISTER_EMMC_CMDC_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_NISTER) The CMDC status flag in SDMMC_NISTR is masked.  */
#define   SDMMC_NISTER_EMMC_CMDC_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_NISTER) The CMDC status flag in SDMMC_NISTR is enabled.  */
...
#define SDMMC_NISTER_EMMC_TRFC_Pos            _UINT16_(1)                                          /* (SDMMC_NISTER) Transfer Complete Status Enable Position */
#define SDMMC_NISTER_EMMC_TRFC_Msk            (_UINT16_(0x1) << SDMMC_NISTER_EMMC_TRFC_Pos)        /* (SDMMC_NISTER) Transfer Complete Status Enable Mask */
#define SDMMC_NISTER_EMMC_TRFC(value)         (SDMMC_NISTER_EMMC_TRFC_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_TRFC_Pos))
#define   SDMMC_NISTER_EMMC_TRFC_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_NISTER) The TRFC status flag in SDMMC_NISTR is masked.  */
#define   SDMMC_NISTER_EMMC_TRFC_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_NISTER) The TRFC status flag in SDMMC_NISTR is enabled.  */
...
#define SDMMC_NISTER_EMMC_BLKGE_Pos           _UINT16_(2)                                          /* (SDMMC_NISTER) Block Gap Event Status Enable Position */
#define SDMMC_NISTER_EMMC_BLKGE_Msk           (_UINT16_(0x1) << SDMMC_NISTER_EMMC_BLKGE_Pos)       /* (SDMMC_NISTER) Block Gap Event Status Enable Mask */
#define SDMMC_NISTER_EMMC_BLKGE(value)        (SDMMC_NISTER_EMMC_BLKGE_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_BLKGE_Pos))
#define   SDMMC_NISTER_EMMC_BLKGE_MASKED_Val  _UINT16_(0x0)                                        /* (SDMMC_NISTER) The BLKGE status flag in SDMMC_NISTR is masked.  */
#define   SDMMC_NISTER_EMMC_BLKGE_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISTER) The BLKGE status flag in SDMMC_NISTR is enabled.  */
...
#define SDMMC_NISTER_EMMC_DMAINT_Pos          _UINT16_(3)                                          /* (SDMMC_NISTER) DMA Interrupt Status Enable Position */
#define SDMMC_NISTER_EMMC_DMAINT_Msk          (_UINT16_(0x1) << SDMMC_NISTER_EMMC_DMAINT_Pos)      /* (SDMMC_NISTER) DMA Interrupt Status Enable Mask */
#define SDMMC_NISTER_EMMC_DMAINT(value)       (SDMMC_NISTER_EMMC_DMAINT_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_DMAINT_Pos))
#define   SDMMC_NISTER_EMMC_DMAINT_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISTER) The DMAINT status flag in SDMMC_NISTR is masked.  */
#define   SDMMC_NISTER_EMMC_DMAINT_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISTER) The DMAINT status flag in SDMMC_NISTR is enabled.  */
...
#define SDMMC_NISTER_EMMC_BWRRDY_Pos          _UINT16_(4)                                          /* (SDMMC_NISTER) Buffer Write Ready Status Enable Position */
#define SDMMC_NISTER_EMMC_BWRRDY_Msk          (_UINT16_(0x1) << SDMMC_NISTER_EMMC_BWRRDY_Pos)      /* (SDMMC_NISTER) Buffer Write Ready Status Enable Mask */
#define SDMMC_NISTER_EMMC_BWRRDY(value)       (SDMMC_NISTER_EMMC_BWRRDY_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_BWRRDY_Pos))
#define   SDMMC_NISTER_EMMC_BWRRDY_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISTER) The BWRRDY status flag in SDMMC_NISTR is masked.  */
#define   SDMMC_NISTER_EMMC_BWRRDY_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISTER) The BWRRDY status flag in SDMMC_NISTR is enabled.  */
...
#define SDMMC_NISTER_EMMC_BRDRDY_Pos          _UINT16_(5)                                          /* (SDMMC_NISTER) Buffer Read Ready Status Enable Position */
#define SDMMC_NISTER_EMMC_BRDRDY_Msk          (_UINT16_(0x1) << SDMMC_NISTER_EMMC_BRDRDY_Pos)      /* (SDMMC_NISTER) Buffer Read Ready Status Enable Mask */
#define SDMMC_NISTER_EMMC_BRDRDY(value)       (SDMMC_NISTER_EMMC_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISTER_EMMC_BRDRDY_Pos))
#define   SDMMC_NISTER_EMMC_BRDRDY_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISTER) The BRDRDY status flag in SDMMC_NISTR is masked.  */
...
#define SDMMC_EISTER_RESETVALUE               _UINT16_(0x00)                                       /*  (SDMMC_EISTER) Error Interrupt Status Enable Register  Reset Value */

#define SDMMC_EISTER_Msk                      _UINT16_(0x0000)                                     /* (SDMMC_EISTER) Register Mask  */

/* EMMC mode */
#define SDMMC_EISTER_EMMC_CMDTEO_Pos          _UINT16_(0)                                          /* (SDMMC_EISTER) Command Timeout Error Status Enable Position */
#define SDMMC_EISTER_EMMC_CMDTEO_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_CMDTEO_Pos)      /* (SDMMC_EISTER) Command Timeout Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_CMDTEO(value)       (SDMMC_EISTER_EMMC_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_CMDTEO_Pos))
#define   SDMMC_EISTER_EMMC_CMDTEO_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The CMDTEO status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_CMDTEO_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The CMDTEO status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_CMDCRC_Pos          _UINT16_(1)                                          /* (SDMMC_EISTER) Command CRC Error Status Enable Position */
#define SDMMC_EISTER_EMMC_CMDCRC_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_CMDCRC_Pos)      /* (SDMMC_EISTER) Command CRC Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_CMDCRC(value)       (SDMMC_EISTER_EMMC_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_CMDCRC_Pos))
#define   SDMMC_EISTER_EMMC_CMDCRC_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The CMDCRC status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_CMDCRC_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The CMDCRC status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_CMDEND_Pos          _UINT16_(2)                                          /* (SDMMC_EISTER) Command End Bit Error Status Enable Position */
#define SDMMC_EISTER_EMMC_CMDEND_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_CMDEND_Pos)      /* (SDMMC_EISTER) Command End Bit Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_CMDEND(value)       (SDMMC_EISTER_EMMC_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_CMDEND_Pos))
#define   SDMMC_EISTER_EMMC_CMDEND_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The CMDEND status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_CMDEND_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The CMDEND status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_CMDIDX_Pos          _UINT16_(3)                                          /* (SDMMC_EISTER) Command Index Error Status Enable Position */
#define SDMMC_EISTER_EMMC_CMDIDX_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_CMDIDX_Pos)      /* (SDMMC_EISTER) Command Index Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_CMDIDX(value)       (SDMMC_EISTER_EMMC_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_CMDIDX_Pos))
#define   SDMMC_EISTER_EMMC_CMDIDX_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The CMDIDX status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_CMDIDX_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The CMDIDX status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_DATTEO_Pos          _UINT16_(4)                                          /* (SDMMC_EISTER) Data Timeout Error Status Enable Position */
#define SDMMC_EISTER_EMMC_DATTEO_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_DATTEO_Pos)      /* (SDMMC_EISTER) Data Timeout Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_DATTEO(value)       (SDMMC_EISTER_EMMC_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_DATTEO_Pos))
#define   SDMMC_EISTER_EMMC_DATTEO_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The DATTEO status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_DATTEO_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The DATTEO status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_DATCRC_Pos          _UINT16_(5)                                          /* (SDMMC_EISTER) Data CRC Error Status Enable Position */
#define SDMMC_EISTER_EMMC_DATCRC_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_DATCRC_Pos)      /* (SDMMC_EISTER) Data CRC Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_DATCRC(value)       (SDMMC_EISTER_EMMC_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_DATCRC_Pos))
#define   SDMMC_EISTER_EMMC_DATCRC_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The DATCRC status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_DATCRC_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The DATCRC status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_DATEND_Pos          _UINT16_(6)                                          /* (SDMMC_EISTER) Data End Bit Error Status Enable Position */
#define SDMMC_EISTER_EMMC_DATEND_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_DATEND_Pos)      /* (SDMMC_EISTER) Data End Bit Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_DATEND(value)       (SDMMC_EISTER_EMMC_DATEND_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_DATEND_Pos))
#define   SDMMC_EISTER_EMMC_DATEND_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The DATEND status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_DATEND_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The DATEND status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_CURLIM_Pos          _UINT16_(7)                                          /* (SDMMC_EISTER) Current Limit Error Status Enable Position */
#define SDMMC_EISTER_EMMC_CURLIM_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_CURLIM_Pos)      /* (SDMMC_EISTER) Current Limit Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_CURLIM(value)       (SDMMC_EISTER_EMMC_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_CURLIM_Pos))
#define   SDMMC_EISTER_EMMC_CURLIM_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The CURLIM status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_CURLIM_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The CURLIM status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_ACMD_Pos            _UINT16_(8)                                          /* (SDMMC_EISTER) Auto CMD Error Status Enable Position */
#define SDMMC_EISTER_EMMC_ACMD_Msk            (_UINT16_(0x1) << SDMMC_EISTER_EMMC_ACMD_Pos)        /* (SDMMC_EISTER) Auto CMD Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_ACMD(value)         (SDMMC_EISTER_EMMC_ACMD_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_ACMD_Pos))
#define   SDMMC_EISTER_EMMC_ACMD_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_EISTER) The ACMD status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_ACMD_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_EISTER) The ACMD status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_ADMA_Pos            _UINT16_(9)                                          /* (SDMMC_EISTER) ADMA Error Status Enable Position */
#define SDMMC_EISTER_EMMC_ADMA_Msk            (_UINT16_(0x1) << SDMMC_EISTER_EMMC_ADMA_Pos)        /* (SDMMC_EISTER) ADMA Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_ADMA(value)         (SDMMC_EISTER_EMMC_ADMA_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_ADMA_Pos))
#define   SDMMC_EISTER_EMMC_ADMA_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_EISTER) The ADMA status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_EMMC_ADMA_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_EISTER) The ADMA status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_EMMC_TUNING_Pos          _UINT16_(10)                                         /* (SDMMC_EISTER) Tuning Error Status Enable Position */
#define SDMMC_EISTER_EMMC_TUNING_Msk          (_UINT16_(0x1) << SDMMC_EISTER_EMMC_TUNING_Pos)      /* (SDMMC_EISTER) Tuning Error Status Enable Mask */
#define SDMMC_EISTER_EMMC_TUNING(value)       (SDMMC_EISTER_EMMC_TUNING_Msk & (_UINT16_(value) << SDMMC_EISTER_EMMC_TUNING_Pos))
#define   SDMMC_EISTER_EMMC_TUNING_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The TUNING status flag in SDMMC_EISTR is masked.  */
...
#define SDMMC_EISTER_SD_SDIO_TUNING_Pos       _UINT16_(10)                                         /* (SDMMC_EISTER) Tuning Error Status Enable Position */
#define SDMMC_EISTER_SD_SDIO_TUNING_Msk       (_UINT16_(0x1) << SDMMC_EISTER_SD_SDIO_TUNING_Pos)   /* (SDMMC_EISTER) Tuning Error Status Enable Mask */
#define SDMMC_EISTER_SD_SDIO_TUNING(value)    (SDMMC_EISTER_SD_SDIO_TUNING_Msk & (_UINT16_(value) << SDMMC_EISTER_SD_SDIO_TUNING_Pos))
#define   SDMMC_EISTER_SD_SDIO_TUNING_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISTER) The TUNING status flag in SDMMC_EISTR is masked.  */
#define   SDMMC_EISTER_SD_SDIO_TUNING_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISTER) The TUNING status flag in SDMMC_EISTR is enabled.  */
...
#define SDMMC_EISTER_SD_SDIO_Msk              _UINT16_(0x07FF)                                      /* (SDMMC_EISTER_SD_SDIO) Register Mask  */


/* -------- SDMMC_NISIER : (SDMMC Offset: 0x38) (R/W 16) Normal Interrupt Signal Enable Register -------- */
#define SDMMC_NISIER_RESETVALUE               _UINT16_(0x00)                                       /*  (SDMMC_NISIER) Normal Interrupt Signal Enable Register  Reset Value */

#define SDMMC_NISIER_Msk                      _UINT16_(0x0000)                                     /* (SDMMC_NISIER) Register Mask  */

/* EMMC mode */
#define SDMMC_NISIER_EMMC_CMDC_Pos            _UINT16_(0)                                          /* (SDMMC_NISIER) Command Complete Signal Enable Position */
#define SDMMC_NISIER_EMMC_CMDC_Msk            (_UINT16_(0x1) << SDMMC_NISIER_EMMC_CMDC_Pos)        /* (SDMMC_NISIER) Command Complete Signal Enable Mask */
#define SDMMC_NISIER_EMMC_CMDC(value)         (SDMMC_NISIER_EMMC_CMDC_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_CMDC_Pos))
#define   SDMMC_NISIER_EMMC_CMDC_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the CMDC status rises in SDMMC_NISTR.  */
#define   SDMMC_NISIER_EMMC_CMDC_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_NISIER) An interrupt is generated when the CMDC status rises in SDMMC_NISTR.  */
...
#define SDMMC_NISIER_EMMC_TRFC_Pos            _UINT16_(1)                                          /* (SDMMC_NISIER) Transfer Complete Signal Enable Position */
#define SDMMC_NISIER_EMMC_TRFC_Msk            (_UINT16_(0x1) << SDMMC_NISIER_EMMC_TRFC_Pos)        /* (SDMMC_NISIER) Transfer Complete Signal Enable Mask */
#define SDMMC_NISIER_EMMC_TRFC(value)         (SDMMC_NISIER_EMMC_TRFC_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_TRFC_Pos))
#define   SDMMC_NISIER_EMMC_TRFC_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the TRFC status rises in SDMMC_NISTR.  */
#define   SDMMC_NISIER_EMMC_TRFC_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_NISIER) An interrupt is generated when the TRFC status rises in SDMMC_NISTR.  */
...
#define SDMMC_NISIER_EMMC_BLKGE_Pos           _UINT16_(2)                                          /* (SDMMC_NISIER) Block Gap Event Signal Enable Position */
#define SDMMC_NISIER_EMMC_BLKGE_Msk           (_UINT16_(0x1) << SDMMC_NISIER_EMMC_BLKGE_Pos)       /* (SDMMC_NISIER) Block Gap Event Signal Enable Mask */
#define SDMMC_NISIER_EMMC_BLKGE(value)        (SDMMC_NISIER_EMMC_BLKGE_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_BLKGE_Pos))
#define   SDMMC_NISIER_EMMC_BLKGE_MASKED_Val  _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the BLKGE status rises in SDMMC_NISTR.  */
#define   SDMMC_NISIER_EMMC_BLKGE_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISIER) An interrupt is generated when the BLKGE status rises in SDMMC_NISTR.  */
...
#define SDMMC_NISIER_EMMC_DMAINT_Pos          _UINT16_(3)                                          /* (SDMMC_NISIER) DMA Interrupt Signal Enable Position */
#define SDMMC_NISIER_EMMC_DMAINT_Msk          (_UINT16_(0x1) << SDMMC_NISIER_EMMC_DMAINT_Pos)      /* (SDMMC_NISIER) DMA Interrupt Signal Enable Mask */
#define SDMMC_NISIER_EMMC_DMAINT(value)       (SDMMC_NISIER_EMMC_DMAINT_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_DMAINT_Pos))
#define   SDMMC_NISIER_EMMC_DMAINT_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the DMAINT status rises in SDMMC_NISTR.  */
#define   SDMMC_NISIER_EMMC_DMAINT_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISIER) An interrupt is generated when the DMAINT status rises in SDMMC_NISTR.  */
...
#define SDMMC_NISIER_EMMC_BWRRDY_Pos          _UINT16_(4)                                          /* (SDMMC_NISIER) Buffer Write Ready Signal Enable Position */
#define SDMMC_NISIER_EMMC_BWRRDY_Msk          (_UINT16_(0x1) << SDMMC_NISIER_EMMC_BWRRDY_Pos)      /* (SDMMC_NISIER) Buffer Write Ready Signal Enable Mask */
#define SDMMC_NISIER_EMMC_BWRRDY(value)       (SDMMC_NISIER_EMMC_BWRRDY_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_BWRRDY_Pos))
#define   SDMMC_NISIER_EMMC_BWRRDY_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the BWRRDY status rises in SDMMC_NISTR.  */
#define   SDMMC_NISIER_EMMC_BWRRDY_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_NISIER) An interrupt is generated when the BWRRDY status rises in SDMMC_NISTR.  */
...
#define SDMMC_NISIER_EMMC_BRDRDY_Pos          _UINT16_(5)                                          /* (SDMMC_NISIER) Buffer Read Ready Signal Enable Position */
#define SDMMC_NISIER_EMMC_BRDRDY_Msk          (_UINT16_(0x1) << SDMMC_NISIER_EMMC_BRDRDY_Pos)      /* (SDMMC_NISIER) Buffer Read Ready Signal Enable Mask */
#define SDMMC_NISIER_EMMC_BRDRDY(value)       (SDMMC_NISIER_EMMC_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISIER_EMMC_BRDRDY_Pos))
#define   SDMMC_NISIER_EMMC_BRDRDY_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_NISIER) No interrupt is generated when the BRDRDY status rises in SDMMC_NISTR.  */
...
#define SDMMC_EISIER_RESETVALUE               _UINT16_(0x00)                                       /*  (SDMMC_EISIER) Error Interrupt Signal Enable Register  Reset Value */

#define SDMMC_EISIER_Msk                      _UINT16_(0x0000)                                     /* (SDMMC_EISIER) Register Mask  */

/* EMMC mode */
#define SDMMC_EISIER_EMMC_CMDTEO_Pos          _UINT16_(0)                                          /* (SDMMC_EISIER) Command Timeout Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_CMDTEO_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_CMDTEO_Pos)      /* (SDMMC_EISIER) Command Timeout Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_CMDTEO(value)       (SDMMC_EISIER_EMMC_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_CMDTEO_Pos))
#define   SDMMC_EISIER_EMMC_CMDTEO_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the CMDTEO status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_CMDTEO_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the CMDTEO status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_CMDCRC_Pos          _UINT16_(1)                                          /* (SDMMC_EISIER) Command CRC Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_CMDCRC_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_CMDCRC_Pos)      /* (SDMMC_EISIER) Command CRC Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_CMDCRC(value)       (SDMMC_EISIER_EMMC_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_CMDCRC_Pos))
#define   SDMMC_EISIER_EMMC_CMDCRC_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the CDMCRC status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_CMDCRC_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the CMDCRC status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_CMDEND_Pos          _UINT16_(2)                                          /* (SDMMC_EISIER) Command End Bit Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_CMDEND_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_CMDEND_Pos)      /* (SDMMC_EISIER) Command End Bit Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_CMDEND(value)       (SDMMC_EISIER_EMMC_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_CMDEND_Pos))
#define   SDMMC_EISIER_EMMC_CMDEND_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the CMDEND status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_CMDEND_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the CMDEND status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_CMDIDX_Pos          _UINT16_(3)                                          /* (SDMMC_EISIER) Command Index Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_CMDIDX_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_CMDIDX_Pos)      /* (SDMMC_EISIER) Command Index Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_CMDIDX(value)       (SDMMC_EISIER_EMMC_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_CMDIDX_Pos))
#define   SDMMC_EISIER_EMMC_CMDIDX_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the CMDIDX status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_CMDIDX_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the CMDIDX status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_DATTEO_Pos          _UINT16_(4)                                          /* (SDMMC_EISIER) Data Timeout Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_DATTEO_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_DATTEO_Pos)      /* (SDMMC_EISIER) Data Timeout Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_DATTEO(value)       (SDMMC_EISIER_EMMC_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_DATTEO_Pos))
#define   SDMMC_EISIER_EMMC_DATTEO_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the DATTEO status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_DATTEO_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the DATTEO status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_DATCRC_Pos          _UINT16_(5)                                          /* (SDMMC_EISIER) Data CRC Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_DATCRC_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_DATCRC_Pos)      /* (SDMMC_EISIER) Data CRC Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_DATCRC(value)       (SDMMC_EISIER_EMMC_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_DATCRC_Pos))
#define   SDMMC_EISIER_EMMC_DATCRC_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the DATCRC status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_DATCRC_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the DATCRC status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_DATEND_Pos          _UINT16_(6)                                          /* (SDMMC_EISIER) Data End Bit Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_DATEND_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_DATEND_Pos)      /* (SDMMC_EISIER) Data End Bit Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_DATEND(value)       (SDMMC_EISIER_EMMC_DATEND_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_DATEND_Pos))
#define   SDMMC_EISIER_EMMC_DATEND_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the DATEND status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_DATEND_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the DATEND status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_CURLIM_Pos          _UINT16_(7)                                          /* (SDMMC_EISIER) Current Limit Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_CURLIM_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_CURLIM_Pos)      /* (SDMMC_EISIER) Current Limit Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_CURLIM(value)       (SDMMC_EISIER_EMMC_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_CURLIM_Pos))
#define   SDMMC_EISIER_EMMC_CURLIM_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the CURLIM status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_CURLIM_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the CURLIM status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_ACMD_Pos            _UINT16_(8)                                          /* (SDMMC_EISIER) Auto CMD Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_ACMD_Msk            (_UINT16_(0x1) << SDMMC_EISIER_EMMC_ACMD_Pos)        /* (SDMMC_EISIER) Auto CMD Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_ACMD(value)         (SDMMC_EISIER_EMMC_ACMD_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_ACMD_Pos))
#define   SDMMC_EISIER_EMMC_ACMD_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the ACMD status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_ACMD_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the ACMD status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_ADMA_Pos            _UINT16_(9)                                          /* (SDMMC_EISIER) ADMA Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_ADMA_Msk            (_UINT16_(0x1) << SDMMC_EISIER_EMMC_ADMA_Pos)        /* (SDMMC_EISIER) ADMA Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_ADMA(value)         (SDMMC_EISIER_EMMC_ADMA_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_ADMA_Pos))
#define   SDMMC_EISIER_EMMC_ADMA_MASKED_Val   _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the ADMA status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_EMMC_ADMA_ENABLED_Val  _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the ADMA status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_EMMC_TUNING_Pos          _UINT16_(10)                                         /* (SDMMC_EISIER) Tuning Error Signal Enable Position */
#define SDMMC_EISIER_EMMC_TUNING_Msk          (_UINT16_(0x1) << SDMMC_EISIER_EMMC_TUNING_Pos)      /* (SDMMC_EISIER) Tuning Error Signal Enable Mask */
#define SDMMC_EISIER_EMMC_TUNING(value)       (SDMMC_EISIER_EMMC_TUNING_Msk & (_UINT16_(value) << SDMMC_EISIER_EMMC_TUNING_Pos))
#define   SDMMC_EISIER_EMMC_TUNING_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the TUNING status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_SD_SDIO_TUNING_Pos       _UINT16_(10)                                         /* (SDMMC_EISIER) Tuning Error Signal Enable Position */
#define SDMMC_EISIER_SD_SDIO_TUNING_Msk       (_UINT16_(0x1) << SDMMC_EISIER_SD_SDIO_TUNING_Pos)   /* (SDMMC_EISIER) Tuning Error Signal Enable Mask */
#define SDMMC_EISIER_SD_SDIO_TUNING(value)    (SDMMC_EISIER_SD_SDIO_TUNING_Msk & (_UINT16_(value) << SDMMC_EISIER_SD_SDIO_TUNING_Pos))
#define   SDMMC_EISIER_SD_SDIO_TUNING_MASKED_Val _UINT16_(0x0)                                        /* (SDMMC_EISIER) No interrupt is generated when the TUNING status rises in SDMMC_EISTR.  */
#define   SDMMC_EISIER_SD_SDIO_TUNING_ENABLED_Val _UINT16_(0x1)                                        /* (SDMMC_EISIER) An interrupt is generated when the TUNING status rises in SDMMC_EISTR.  */
...
#define SDMMC_EISIER_SD_SDIO_Msk              _UINT16_(0x07FF)                                      /* (SDMMC_EISIER_SD_SDIO) Register Mask  */


/* -------- SDMMC_ACESR : (SDMMC Offset: 0x3C) ( R/ 16) Auto CMD Error Status Register -------- */
#define SDMMC_ACESR_RESETVALUE                _UINT16_(0x00)                                       /*  (SDMMC_ACESR) Auto CMD Error Status Register  Reset Value */
...
#define   SDMMC_ACESR_ACMD12NE_0_Val          _UINT16_(0x0)                                        /* (SDMMC_ACESR) No error.  */
#define   SDMMC_ACESR_ACMD12NE_1_Val          _UINT16_(0x1)                                        /* (SDMMC_ACESR) Error.  */
...
#define   SDMMC_ACESR_ACMDEND_0_Val           _UINT16_(0x0)                                        /* (SDMMC_ACESR) No error.  */
#define   SDMMC_ACESR_ACMDEND_1_Val           _UINT16_(0x1)                                        /* (SDMMC_ACESR) Error.  */
...
#define   SDMMC_ACESR_ACMDIDX_0_Val           _UINT16_(0x0)                                        /* (SDMMC_ACESR) No error.  */
#define   SDMMC_ACESR_ACMDIDX_1_Val           _UINT16_(0x1)                                        /* (SDMMC_ACESR) Error.  */
...
#define   SDMMC_ACESR_CMDNI_0_Val             _UINT16_(0x0)                                        /* (SDMMC_ACESR) No error.  */
#define   SDMMC_ACESR_CMDNI_1_Val             _UINT16_(0x1)                                        /* (SDMMC_ACESR) Error.  */
...
#define SDMMC_HC2R_RESETVALUE                 _UINT16_(0x00)                                       /*  (SDMMC_HC2R) Host Control 2 Register  Reset Value */
...
#define SDMMC_HC2R_EMMC_DRVSEL_Pos            _UINT16_(4)                                          /* (SDMMC_HC2R) Driver Strength Select Position */
#define SDMMC_HC2R_EMMC_DRVSEL_Msk            (_UINT16_(0x3) << SDMMC_HC2R_EMMC_DRVSEL_Pos)        /* (SDMMC_HC2R) Driver Strength Select Mask */
#define SDMMC_HC2R_EMMC_DRVSEL(value)         (SDMMC_HC2R_EMMC_DRVSEL_Msk & (_UINT16_(value) << SDMMC_HC2R_EMMC_DRVSEL_Pos))
#define   SDMMC_HC2R_EMMC_DRVSEL_TYPEB_Val    _UINT16_(0x0)                                        /* (SDMMC_HC2R) Driver Type B is selected (Default)  */
#define   SDMMC_HC2R_EMMC_DRVSEL_TYPEA_Val    _UINT16_(0x1)                                        /* (SDMMC_HC2R) Driver Type A is selected  */
#define   SDMMC_HC2R_EMMC_DRVSEL_TYPEC_Val    _UINT16_(0x2)                                        /* (SDMMC_HC2R) Driver Type C is selected  */
#define   SDMMC_HC2R_EMMC_DRVSEL_TYPED_Val    _UINT16_(0x3)                                        /* (SDMMC_HC2R) Driver Type D is selected  */
...
#define SDMMC_HC2R_EMMC_EXTUN_Pos             _UINT16_(6)                                          /* (SDMMC_HC2R) Execute Tuning Position */
#define SDMMC_HC2R_EMMC_EXTUN_Msk             (_UINT16_(0x1) << SDMMC_HC2R_EMMC_EXTUN_Pos)         /* (SDMMC_HC2R) Execute Tuning Mask */
#define SDMMC_HC2R_EMMC_EXTUN(value)          (SDMMC_HC2R_EMMC_EXTUN_Msk & (_UINT16_(value) << SDMMC_HC2R_EMMC_EXTUN_Pos))
#define   SDMMC_HC2R_EMMC_EXTUN_0_Val         _UINT16_(0x0)                                        /* (SDMMC_HC2R) Not tuned or tuning completed  */
#define   SDMMC_HC2R_EMMC_EXTUN_1_Val         _UINT16_(0x1)                                        /* (SDMMC_HC2R) Execute tuning  */
...
#define SDMMC_HC2R_EMMC_SCLKSEL_Pos           _UINT16_(7)                                          /* (SDMMC_HC2R) Sampling Clock Select Position */
#define SDMMC_HC2R_EMMC_SCLKSEL_Msk           (_UINT16_(0x1) << SDMMC_HC2R_EMMC_SCLKSEL_Pos)       /* (SDMMC_HC2R) Sampling Clock Select Mask */
#define SDMMC_HC2R_EMMC_SCLKSEL(value)        (SDMMC_HC2R_EMMC_SCLKSEL_Msk & (_UINT16_(value) << SDMMC_HC2R_EMMC_SCLKSEL_Pos))
#define   SDMMC_HC2R_EMMC_SCLKSEL_0_Val       _UINT16_(0x0)                                        /* (SDMMC_HC2R) The fixed clock is used to sample data.  */
#define   SDMMC_HC2R_EMMC_SCLKSEL_1_Val       _UINT16_(0x1)                                        /* (SDMMC_HC2R) The tuned clock is used to sample data.  */
...
#define SDMMC_HC2R_EMMC_PVALEN_Pos            _UINT16_(15)                                         /* (SDMMC_HC2R) Preset Value Enable Position */
#define SDMMC_HC2R_EMMC_PVALEN_Msk            (_UINT16_(0x1) << SDMMC_HC2R_EMMC_PVALEN_Pos)        /* (SDMMC_HC2R) Preset Value Enable Mask */
#define SDMMC_HC2R_EMMC_PVALEN(value)         (SDMMC_HC2R_EMMC_PVALEN_Msk & (_UINT16_(value) << SDMMC_HC2R_EMMC_PVALEN_Pos))
#define   SDMMC_HC2R_EMMC_PVALEN_0_Val        _UINT16_(0x0)                                        /* (SDMMC_HC2R) SDCLK and Driver strength are controlled by the user.  */
#define   SDMMC_HC2R_EMMC_PVALEN_1_Val        _UINT16_(0x1)                                        /* (SDMMC_HC2R) Automatic selection by Preset Value is enabled.  */
...
#define SDMMC_HC2R_EMMC_Msk                   _UINT16_(0x80FF)                                      /* (SDMMC_HC2R_EMMC) Register Mask  */
...
#define   SDMMC_HC2R_SD_SDIO_VS18EN_0_Val     _UINT16_(0x0)                                        /* (SDMMC_HC2R) 3.3V signaling.  */
#define   SDMMC_HC2R_SD_SDIO_VS18EN_1_Val     _UINT16_(0x1)                                        /* (SDMMC_HC2R) 1.8V signaling.  */
...
#define   SDMMC_HC2R_SD_SDIO_EXTUN_0_Val      _UINT16_(0x0)                                        /* (SDMMC_HC2R) Not tuned or tuning completed.  */
#define   SDMMC_HC2R_SD_SDIO_EXTUN_1_Val      _UINT16_(0x1)                                        /* (SDMMC_HC2R) Execute tuning.  */
...
#define   SDMMC_HC2R_SD_SDIO_SCLKSEL_0_Val    _UINT16_(0x0)                                        /* (SDMMC_HC2R) The fixed clock is used to sample data.  */
#define   SDMMC_HC2R_SD_SDIO_SCLKSEL_1_Val    _UINT16_(0x1)                                        /* (SDMMC_HC2R) The tuned clock is used to sample data.  */
...
#define   SDMMC_HC2R_SD_SDIO_ASINTEN_0_Val    _UINT16_(0x0)                                        /* (SDMMC_HC2R) Disabled  */
#define   SDMMC_HC2R_SD_SDIO_ASINTEN_1_Val    _UINT16_(0x1)                                        /* (SDMMC_HC2R) Enabled  */
...
#define   SDMMC_HC2R_SD_SDIO_PVALEN_0_Val     _UINT16_(0x0)                                        /* (SDMMC_HC2R) SDCLK and Driver strength are controlled by the user.  */
#define   SDMMC_HC2R_SD_SDIO_PVALEN_1_Val     _UINT16_(0x1)                                        /* (SDMMC_HC2R) Automatic selection by Preset Value is enabled.  */
...
#define SDMMC_CA0R_RESETVALUE                 _UINT32_(0x27EC6499)                                 /*  (SDMMC_CA0R) Capabilities 0 Register  Reset Value */
...
#define   SDMMC_CA0R_TEOCLKU_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA0R) KHz  */
#define   SDMMC_CA0R_TEOCLKU_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA0R) MHz  */
...
#define   SDMMC_CA0R_V33VSUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA0R) 3.3V Voltage supply not supported.  */
#define   SDMMC_CA0R_V33VSUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA0R) 3.3V Voltage supply supported.  */
...
#define   SDMMC_CA0R_V30VSUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA0R) 3.0V Voltage supply not supported.  */
#define   SDMMC_CA0R_V30VSUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA0R) 3.0V Voltage supply supported.  */
...
#define   SDMMC_CA0R_V18VSUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA0R) 1.8V Voltage supply not supported.  */
#define   SDMMC_CA0R_V18VSUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA0R) 1.8V Voltage supply supported.  */
...
#define   SDMMC_CA0R_SB64SUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA0R) 64-bit address bus not supported.  */
#define   SDMMC_CA0R_SB64SUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA0R) 64-bit address bus supported.  */
...
#define   SDMMC_CA0R_ASINTSUP_0_Val           _UINT32_(0x0)                                        /* (SDMMC_CA0R) Asynchronous interrupt not supported.  */
#define   SDMMC_CA0R_ASINTSUP_1_Val           _UINT32_(0x1)                                        /* (SDMMC_CA0R) Asynchronous interrupt supported.  */
...
#define   SDMMC_CA0R_SLTYPE_REMOVABLECARD_Val _UINT32_(0x0)                                        /* (SDMMC_CA0R) Removable Card Slot  */
...
#define SDMMC_CA1R_RESETVALUE                 _UINT32_(0x10F77)                                    /*  (SDMMC_CA1R) Capabilities 1 Register  Reset Value */
...
#define   SDMMC_CA1R_SDR50SUP_0_Val           _UINT32_(0x0)                                        /* (SDMMC_CA1R) SDR50 mode is not supported.  */
#define   SDMMC_CA1R_SDR50SUP_1_Val           _UINT32_(0x1)                                        /* (SDMMC_CA1R) SDR50 mode is supported.  */
...
#define   SDMMC_CA1R_SDR104SUP_0_Val          _UINT32_(0x0)                                        /* (SDMMC_CA1R) SDR104 mode is not supported.  */
#define   SDMMC_CA1R_SDR104SUP_1_Val          _UINT32_(0x1)                                        /* (SDMMC_CA1R) SDR104 mode is supported.  */
...
#define   SDMMC_CA1R_DDR50SUP_0_Val           _UINT32_(0x0)                                        /* (SDMMC_CA1R) DDR50 mode is not supported.  */
#define   SDMMC_CA1R_DDR50SUP_1_Val           _UINT32_(0x1)                                        /* (SDMMC_CA1R) DDR50 mode is supported.  */
...
#define   SDMMC_CA1R_DRVASUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA1R) Driver type A is not supported.  */
#define   SDMMC_CA1R_DRVASUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA1R) Driver type A is supported.  */
...
#define   SDMMC_CA1R_DRVCSUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA1R) Driver type C is not supported.  */
#define   SDMMC_CA1R_DRVCSUP_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CA1R) Driver type C is supported.  */
...
#define   SDMMC_CA1R_DRVDSUP_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CA1R) Driver type D is not supported.  */
...
#define SDMMC_AESR_RESETVALUE                 _UINT8_(0x00)                                        /*  (SDMMC_AESR) ADMA Error Status Register  Reset Value */
...
#define   SDMMC_AESR_ERRST_STOP_Val           _UINT8_(0x0)                                         /* (SDMMC_AESR) (Stop DMA) SDMMC_ASAR points to the descriptor following the error descriptor  */
#define   SDMMC_AESR_ERRST_FDS_Val            _UINT8_(0x1)                                         /* (SDMMC_AESR) (Fetch Descriptor) SDMMC_ASAR points to the error descriptor  */
#define   SDMMC_AESR_ERRST_TFR_Val            _UINT8_(0x3)                                         /* (SDMMC_AESR) (Transfer Data) SDMMC_ASAR points to the descriptor following the error descriptor  */
...
#define   SDMMC_AESR_LMIS_0_Val               _UINT8_(0x0)                                         /* (SDMMC_AESR) No error.  */
#define   SDMMC_AESR_LMIS_1_Val               _UINT8_(0x1)                                         /* (SDMMC_AESR) Error.  */
...
#define SDMMC_ASAR0_RESETVALUE                _UINT32_(0x00)                                       /*  (SDMMC_ASAR0) ADMA System Address Register 0  Reset Value */
...
#define SDMMC_SISR_RESETVALUE                 _UINT16_(0x00)                                       /*  (SDMMC_SISR) Slot Interrupt Status Register  Reset Value */
...
#define SDMMC_APSR_RESETVALUE                 _UINT32_(0x0F)                                       /*  (SDMMC_APSR) Additional Present State Register  Reset Value */
...
#define SDMMC_MC1R_RESETVALUE                 _UINT8_(0x00)                                        /*  (SDMMC_MC1R) e.MMC Control 1 Register  Reset Value */
...
#define   SDMMC_MC1R_DDR_0_Val                _UINT8_(0x0)                                         /* (SDMMC_MC1R) High Speed DDR is not selected.  */
#define   SDMMC_MC1R_DDR_1_Val                _UINT8_(0x1)                                         /* (SDMMC_MC1R) High Speed DDR is selected.  */
...
#define   SDMMC_MC1R_OPD_0_Val                _UINT8_(0x0)                                         /* (SDMMC_MC1R) The command line is in push-pull.  */
...
#define   SDMMC_MC1R_RSTN_0_Val               _UINT8_(0x0)                                         /* (SDMMC_MC1R) Reset signal is inactive.  */
#define   SDMMC_MC1R_RSTN_1_Val               _UINT8_(0x1)                                         /* (SDMMC_MC1R) Reset signal is active.  */
...
#define   SDMMC_MC1R_FCD_DISABLED_Val         _UINT8_(0x0)                                         /* (SDMMC_MC1R) E.MMC Forced Card Detect is disabled. The SDMMC_CD signal is used and debounce timing is applied.  */
...
#define SDMMC_CC2R_RESETVALUE                 _UINT32_(0x00)                                       /*  (SDMMC_CC2R) Clock Control 2 Register  Reset Value */
...
#define   SDMMC_CC2R_FSDCLKD_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CC2R) The SDCLK is forced and it cannot be stopped immediately after the transaction.  */
#define   SDMMC_CC2R_FSDCLKD_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CC2R) The SDCLK is not forced and it can be stopped immediately after the transaction.  */
...
#define SDMMC_CACR_RESETVALUE                 _UINT32_(0x00)                                       /*  (SDMMC_CACR) Capabilities Control Register  Reset Value */
...
#define   SDMMC_CACR_CAPWREN_0_Val            _UINT32_(0x0)                                        /* (SDMMC_CACR) Capabilities registers (SDMMC_CA0R, SDMMC_CA1R and SDMMC_MCCAR) cannot be written.  */
#define   SDMMC_CACR_CAPWREN_1_Val            _UINT32_(0x1)                                        /* (SDMMC_CACR) Capabilities registers (SDMMC_CA0R, SDMMC_CA1R and SDMMC_MCCAR) can be written.  */
...
#define   SDMMC_CACR_KEY_KEY_Val              _UINT32_(0x46)                                       /* (SDMMC_CACR) Writing any other value in this field aborts the write operation of the CAPWREN bit. Always reads as 0.  */
...
#define SDMMC_DBGR_RESETVALUE                 _UINT32_(0x00)                                       /*  (SDMMC_DBGR) Debug Register  Reset Value */

#define SDMMC_DBGR_NIDBG_Pos                  _UINT32_(0)                                          /* (SDMMC_DBGR) Nonintrusive Debug Position */
#define SDMMC_DBGR_NIDBG_Msk                  (_UINT32_(0x1) << SDMMC_DBGR_NIDBG_Pos)              /* (SDMMC_DBGR) Nonintrusive Debug Mask */
...
#define   SDMMC_DBGR_NIDBG_DISABLED_Val       _UINT32_(0x0)                                        /* (SDMMC_DBGR) Reading the SDMMC_BDPR via debugger increments the dual port RAM read pointer.  */
#define   SDMMC_DBGR_NIDBG_ENABLED_Val        _UINT32_(0x1)                                        /* (SDMMC_DBGR) Reading the SDMMC_BDPR via debugger does not increment the dual port RAM read pointer.  */
...
#define SDMMC_RR_REG_OFST              _UINT32_(0x10)      /* (SDMMC_RR) Response Register x Offset */
#define SDMMC_RR0_REG_OFST             _UINT32_(0x10)      /* (SDMMC_RR0) Response Register x Offset */
#define SDMMC_RR1_REG_OFST             _UINT32_(0x14)      /* (SDMMC_RR1) Response Register x Offset */
#define SDMMC_RR2_REG_OFST             _UINT32_(0x18)      /* (SDMMC_RR2) Response Register x Offset */
#define SDMMC_RR3_REG_OFST             _UINT32_(0x1C)      /* (SDMMC_RR3) Response Register x Offset */
...
#endif /* _SAMA7D6_SDMMC_COMPONENT_H_ */
