...
#define HSMC_SETUP_RESETVALUE                 _UINT32_(0x1010101)                                  /*  (HSMC_SETUP) Setup Register   Reset Value */
...
#define HSMC_PULSE_RESETVALUE                 _UINT32_(0x1010101)                                  /*  (HSMC_PULSE) Pulse Register   Reset Value */
...
#define HSMC_CYCLE_RESETVALUE                 _UINT32_(0x30003)                                    /*  (HSMC_CYCLE) Cycle Register   Reset Value */
...
#define HSMC_TIMINGS_RESETVALUE               _UINT32_(0x00)                                       /*  (HSMC_TIMINGS) Timings Register   Reset Value */
...
#define HSMC_MODE_RESETVALUE                  _UINT32_(0x10000003)                                 /*  (HSMC_MODE) Mode Register   Reset Value */
...
#define   HSMC_MODE_TDF_MODE_0_Val            _UINT32_(0x0)                                        /* (HSMC_MODE) TDF optimization disabled  */
...
#define HSMC_MODE_PS(value)                   (HSMC_MODE_PS_Msk & (_UINT32_(value) << HSMC_MODE_PS_Pos)) /* Assigment of value for PS in the HSMC_MODE register */
...
#define HSMC_PMECC_RESETVALUE                 _UINT32_(0xFFFFFFFF)                                 /*  (HSMC_PMECC) PMECC Redundancy x Register   Reset Value */
...
#define HSMC_REM_RESETVALUE                   _UINT32_(0x00)                                       /*  (HSMC_REM) PMECC Remainder x Register   Reset Value */

#define HSMC_REM_REM2NP1_Pos                  _UINT32_(0)                                          /* (HSMC_REM) BCH Remainder 2 * N + 1 Position */
#define HSMC_REM_REM2NP1_Msk                  (_UINT32_(0x3FFF) << HSMC_REM_REM2NP1_Pos)           /* (HSMC_REM) BCH Remainder 2 * N + 1 Mask */
#define HSMC_REM_REM2NP1(value)               (HSMC_REM_REM2NP1_Msk & (_UINT32_(value) << HSMC_REM_REM2NP1_Pos)) /* Assigment of value for REM2NP1 in the HSMC_REM register */
#define HSMC_REM_REM2NP3_Pos                  _UINT32_(16)                                         /* (HSMC_REM) BCH Remainder 2 * N + 3 Position */
#define HSMC_REM_REM2NP3_Msk                  (_UINT32_(0x3FFF) << HSMC_REM_REM2NP3_Pos)           /* (HSMC_REM) BCH Remainder 2 * N + 3 Mask */
#define HSMC_REM_REM2NP3(value)               (HSMC_REM_REM2NP3_Msk & (_UINT32_(value) << HSMC_REM_REM2NP3_Pos)) /* Assigment of value for REM2NP3 in the HSMC_REM register */
#define HSMC_REM_Msk                          _UINT32_(0x3FFF3FFF)                                 /* (HSMC_REM) Register Mask  */


/* -------- HSMC_CFG : (SMC Offset: 0x00) (R/W 32) NFC Configuration Register -------- */
#define HSMC_CFG_RESETVALUE                   _UINT32_(0x00)                                       /*  (HSMC_CFG) NFC Configuration Register  Reset Value */
...
#define   HSMC_CFG_WSPARE_0_Val               _UINT32_(0x0)                                        /* (HSMC_CFG) The NFC skips the spare area in Write mode.  */
#define   HSMC_CFG_WSPARE_1_Val               _UINT32_(0x1)                                        /* (HSMC_CFG) The NFC writes both main area and spare area in Write mode.  */
...
#define   HSMC_CFG_RSPARE_0_Val               _UINT32_(0x0)                                        /* (HSMC_CFG) The NFC skips the spare area in Read mode.  */
#define   HSMC_CFG_RSPARE_1_Val               _UINT32_(0x1)                                        /* (HSMC_CFG) The NFC reads both main area and spare area in Read mode.  */
...
#define   HSMC_CFG_EDGECTRL_0_Val             _UINT32_(0x0)                                        /* (HSMC_CFG) Rising edge is detected  */
#define   HSMC_CFG_EDGECTRL_1_Val             _UINT32_(0x1)                                        /* (HSMC_CFG) Falling edge is detected  */
...
#define   HSMC_CFG_RBEDGE_0_Val               _UINT32_(0x0)                                        /* (HSMC_CFG) RBEDGE indicates the level of the Ready/Busy line.  */
#define   HSMC_CFG_RBEDGE_1_Val               _UINT32_(0x1)                                        /* (HSMC_CFG) RBEDGE indicates a transition has occurred on the on Ready/Busy lines.  */
...
#define   HSMC_CTRL_NFCEN_0_Val               _UINT32_(0x0)                                        /* (HSMC_CTRL) No effect  */
#define   HSMC_CTRL_NFCEN_1_Val               _UINT32_(0x1)                                        /* (HSMC_CTRL) Enable the NAND Flash controller.  */
...
#define   HSMC_CTRL_NFCDIS_0_Val              _UINT32_(0x0)                                        /* (HSMC_CTRL) No effect  */
#define   HSMC_CTRL_NFCDIS_1_Val              _UINT32_(0x1)                                        /* (HSMC_CTRL) Disable the NAND Flash controller.  */
...
#define HSMC_SR_RESETVALUE                    _UINT32_(0x00)                                       /*  (HSMC_SR) NFC Status Register  Reset Value */
...
#define   HSMC_SR_SMCSTS_0_Val                _UINT32_(0x0)                                        /* (HSMC_SR) NAND Flash Controller disabled  */
#define   HSMC_SR_SMCSTS_1_Val                _UINT32_(0x1)                                        /* (HSMC_SR) NAND Flash Controller enabled  */
...
#define   HSMC_IER_RB_RISE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_RB_RISE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_RB_FALL_0_Val              _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_RB_FALL_1_Val              _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_XFRDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_XFRDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_CMDDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_CMDDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_DTOE_0_Val                 _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_DTOE_1_Val                 _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_UNDEF_0_Val                _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_UNDEF_1_Val                _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_AWB_0_Val                  _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_AWB_1_Val                  _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_NFCASE_0_Val               _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_NFCASE_1_Val               _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IER_RB_EDGE0_0_Val             _UINT32_(0x0)                                        /* (HSMC_IER) No effect  */
#define   HSMC_IER_RB_EDGE0_1_Val             _UINT32_(0x1)                                        /* (HSMC_IER) Interrupt source enabled  */
...
#define   HSMC_IDR_RB_RISE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_RB_RISE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_RB_FALL_0_Val              _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_RB_FALL_1_Val              _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_XFRDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_XFRDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_CMDDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_CMDDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_DTOE_0_Val                 _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_DTOE_1_Val                 _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_UNDEF_0_Val                _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_UNDEF_1_Val                _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_AWB_0_Val                  _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_AWB_1_Val                  _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_NFCASE_0_Val               _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_NFCASE_1_Val               _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define   HSMC_IDR_RB_EDGE0_0_Val             _UINT32_(0x0)                                        /* (HSMC_IDR) No effect  */
#define   HSMC_IDR_RB_EDGE0_1_Val             _UINT32_(0x1)                                        /* (HSMC_IDR) Interrupt source disabled  */
...
#define HSMC_IMR_RESETVALUE                   _UINT32_(0x00)                                       /*  (HSMC_IMR) NFC Interrupt Mask Register  Reset Value */
...
#define   HSMC_IMR_RB_RISE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_RB_RISE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_RB_FALL_0_Val              _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_RB_FALL_1_Val              _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_XFRDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_XFRDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_CMDDONE_0_Val              _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_CMDDONE_1_Val              _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_DTOE_0_Val                 _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_DTOE_1_Val                 _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_UNDEF_0_Val                _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_UNDEF_1_Val                _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_AWB_0_Val                  _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_AWB_1_Val                  _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_NFCASE_0_Val               _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_NFCASE_1_Val               _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define   HSMC_IMR_RB_EDGE0_0_Val             _UINT32_(0x0)                                        /* (HSMC_IMR) Interrupt source disabled  */
#define   HSMC_IMR_RB_EDGE0_1_Val             _UINT32_(0x1)                                        /* (HSMC_IMR) Interrupt source enabled  */
...
#define HSMC_ADDR_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_ADDR) NFC Address Cycle Zero Register  Reset Value */
...
#define HSMC_BANK_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_BANK) Bank Address Register  Reset Value */
...
#define   HSMC_BANK_BANK_0_Val                _UINT32_(0x0)                                        /* (HSMC_BANK) Bank 0 is used.  */
#define   HSMC_BANK_BANK_1_Val                _UINT32_(0x1)                                        /* (HSMC_BANK) Bank 1 is used.  */
...
#define HSMC_PMECCFG_RESETVALUE               _UINT32_(0x00)                                       /*  (HSMC_PMECCFG) PMECC Configuration Register  Reset Value */
...
#define   HSMC_PMECCFG_SECTORSZ_0_Val         _UINT32_(0x0)                                        /* (HSMC_PMECCFG) The ECC computation is based on a sector of 512 bytes.  */
#define   HSMC_PMECCFG_SECTORSZ_1_Val         _UINT32_(0x1)                                        /* (HSMC_PMECCFG) The ECC computation is based on a sector of 1024 bytes.  */
...
#define   HSMC_PMECCFG_NANDWR_0_Val           _UINT32_(0x0)                                        /* (HSMC_PMECCFG) NAND read access  */
#define   HSMC_PMECCFG_NANDWR_1_Val           _UINT32_(0x1)                                        /* (HSMC_PMECCFG) NAND write access  */
...
#define   HSMC_PMECCFG_AUTO_0_Val             _UINT32_(0x0)                                        /* (HSMC_PMECCFG) Indicates that the ECC computation is not retrieved automatically and must be read via User mode.  */
#define   HSMC_PMECCFG_AUTO_1_Val             _UINT32_(0x1)                                        /* (HSMC_PMECCFG) Indicates that the ECC computation is retrieved automatically via Data mode.  */
#define HSMC_PMECCFG_AUTO_0                   (HSMC_PMECCFG_AUTO_0_Val << HSMC_PMECCFG_AUTO_Pos)   /* (HSMC_PMECCFG) Indicates that the ECC computation is not retrieved automatically and must be read via User mode. Position  */
#define HSMC_PMECCFG_AUTO_1                   (HSMC_PMECCFG_AUTO_1_Val << HSMC_PMECCFG_AUTO_Pos)   /* (HSMC_PMECCFG) Indicates that the ECC computation is retrieved automatically via Data mode. Position  */
...
#define HSMC_PMECCSAREA_RESETVALUE            _UINT32_(0x00)                                       /*  (HSMC_PMECCSAREA) PMECC Spare Area Size Register  Reset Value */
...
#define HSMC_PMECCSADDR_RESETVALUE            _UINT32_(0x00)                                       /*  (HSMC_PMECCSADDR) PMECC Start Address Register  Reset Value */
...
#define HSMC_PMECCEADDR_RESETVALUE            _UINT32_(0x00)                                       /*  (HSMC_PMECCEADDR) PMECC End Address Register  Reset Value */
...
#define   HSMC_PMECCTRL_RST_0_Val             _UINT32_(0x0)                                        /* (HSMC_PMECCTRL) No effect  */
#define   HSMC_PMECCTRL_RST_1_Val             _UINT32_(0x1)                                        /* (HSMC_PMECCTRL) Reset the PMECC controller.  */
...
#define   HSMC_PMECCTRL_DATA_0_Val            _UINT32_(0x0)                                        /* (HSMC_PMECCTRL) No effect  */
#define   HSMC_PMECCTRL_DATA_1_Val            _UINT32_(0x1)                                        /* (HSMC_PMECCTRL) The PMECC controller enters a Data phase.  */
...
#define   HSMC_PMECCTRL_USER_0_Val            _UINT32_(0x0)                                        /* (HSMC_PMECCTRL) No effect  */
#define   HSMC_PMECCTRL_USER_1_Val            _UINT32_(0x1)                                        /* (HSMC_PMECCTRL) The PMECC controller enters a User mode phase.  */
...
#define   HSMC_PMECCTRL_ENABLE_0_Val          _UINT32_(0x0)                                        /* (HSMC_PMECCTRL) No effect  */
...
#define HSMC_PMECCSR_RESETVALUE               _UINT32_(0x00)                                       /*  (HSMC_PMECCSR) PMECC Status Register  Reset Value */
...
#define   HSMC_PMECCSR_BUSY_0_Val             _UINT32_(0x0)                                        /* (HSMC_PMECCSR) PMECC controller finite state machine reached idle state  */
#define   HSMC_PMECCSR_BUSY_1_Val             _UINT32_(0x1)                                        /* (HSMC_PMECCSR) PMECC controller finite state machine is processing the incoming byte stream  */
...
#define   HSMC_PMECCSR_ENABLE_0_Val           _UINT32_(0x0)                                        /* (HSMC_PMECCSR) PMECC controller disabled  */
#define   HSMC_PMECCSR_ENABLE_1_Val           _UINT32_(0x1)                                        /* (HSMC_PMECCSR) PMECC controller enabled  */
...
#define   HSMC_PMECCIER_ERRIE_0_Val           _UINT32_(0x0)                                        /* (HSMC_PMECCIER) No effect  */
#define   HSMC_PMECCIER_ERRIE_1_Val           _UINT32_(0x1)                                        /* (HSMC_PMECCIER) The Multibit Error interrupt is enabled. An interrupt will be raised if at least one error is detected in at least one sector.  */
...
#define   HSMC_PMECCIDR_ERRID_0_Val           _UINT32_(0x0)                                        /* (HSMC_PMECCIDR) No effect  */
#define   HSMC_PMECCIDR_ERRID_1_Val           _UINT32_(0x1)                                        /* (HSMC_PMECCIDR) Multibit Error interrupt disabled  */
...
#define HSMC_PMECCIMR_RESETVALUE              _UINT32_(0x00)                                       /*  (HSMC_PMECCIMR) PMECC Interrupt Mask Register  Reset Value */
...
#define   HSMC_PMECCIMR_ERRIM_0_Val           _UINT32_(0x0)                                        /* (HSMC_PMECCIMR) Multibit Error disabled  */
#define   HSMC_PMECCIMR_ERRIM_1_Val           _UINT32_(0x1)                                        /* (HSMC_PMECCIMR) Multibit Error enabled  */
...
#define HSMC_PMECCISR_RESETVALUE              _UINT32_(0x00)                                       /*  (HSMC_PMECCISR) PMECC Interrupt Status Register  Reset Value */
...
#define HSMC_ELCFG_RESETVALUE                 _UINT32_(0x00)                                       /*  (HSMC_ELCFG) PMECC Error Location Configuration Register  Reset Value */
...
#define   HSMC_ELCFG_SECTORSZ_0_Val           _UINT32_(0x0)                                        /* (HSMC_ELCFG) The ECC computation is based on a 512 bytes sector.  */
#define   HSMC_ELCFG_SECTORSZ_1_Val           _UINT32_(0x1)                                        /* (HSMC_ELCFG) The ECC computation is based on a 1024 bytes sector.  */
...
#define HSMC_ELPRIM_RESETVALUE                _UINT32_(0x201B)                                     /*  (HSMC_ELPRIM) PMECC Error Location Primitive Register  Reset Value */
...
#define   HSMC_ELDIS_DIS_0_Val                _UINT32_(0x0)                                        /* (HSMC_ELDIS) No effect  */
#define   HSMC_ELDIS_DIS_1_Val                _UINT32_(0x1)                                        /* (HSMC_ELDIS) Disable the Error location engine.  */
...
#define HSMC_ELSR_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_ELSR) PMECC Error Location Status Register  Reset Value */
...
#define   HSMC_ELSR_BUSY_0_Val                _UINT32_(0x0)                                        /* (HSMC_ELSR) Error location engine is disabled.  */
#define   HSMC_ELSR_BUSY_1_Val                _UINT32_(0x1)                                        /* (HSMC_ELSR) Error location engine is enabled and is finding roots of the polynomial.  */
...
#define   HSMC_ELIER_DONE_0_Val               _UINT32_(0x0)                                        /* (HSMC_ELIER) No effect  */
#define   HSMC_ELIER_DONE_1_Val               _UINT32_(0x1)                                        /* (HSMC_ELIER) Interrupt enable  */
...
#define   HSMC_ELIDR_DONE_0_Val               _UINT32_(0x0)                                        /* (HSMC_ELIDR) No effect  */
#define   HSMC_ELIDR_DONE_1_Val               _UINT32_(0x1)                                        /* (HSMC_ELIDR) Interrupt disable.  */
...
#define HSMC_ELIMR_RESETVALUE                 _UINT32_(0x00)                                       /*  (HSMC_ELIMR) PMECC Error Location Interrupt Mask Register  Reset Value */
...
#define   HSMC_ELIMR_DONE_0_Val               _UINT32_(0x0)                                        /* (HSMC_ELIMR) Computation Terminated interrupt disabled  */
#define   HSMC_ELIMR_DONE_1_Val               _UINT32_(0x1)                                        /* (HSMC_ELIMR) Computation Terminated interrupt enabled  */
...
#define HSMC_ELISR_RESETVALUE                 _UINT32_(0x00)                                       /*  (HSMC_ELISR) PMECC Error Location Interrupt Status Register  Reset Value */
...
#define HSMC_SIGMA0_RESETVALUE                _UINT32_(0x01)                                       /*  (HSMC_SIGMA0) PMECC Error Location SIGMA 0 Register  Reset Value */
...
#define HSMC_ERRLOC_RESETVALUE                _UINT32_(0x00)                                       /*  (HSMC_ERRLOC) PMECC Error Location x Register  Reset Value */
...
#define HSMC_OCMS_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_OCMS) Off Chip Memory Scrambling Register  Reset Value */
...
#define   HSMC_OCMS_SMSE_0_Val                _UINT32_(0x0)                                        /* (HSMC_OCMS) Disable "Off Chip" Scrambling for SMC access.  */
#define   HSMC_OCMS_SMSE_1_Val                _UINT32_(0x1)                                        /* (HSMC_OCMS) Enable "Off Chip" Scrambling for SMC access. (If OCMS bit is set in the corresponding HSMC_TIMINGSx register.)  */
...
#define   HSMC_OCMS_SRSE_0_Val                _UINT32_(0x0)                                        /* (HSMC_OCMS) Disable Scrambling for NFC internal SRAM access.  */
#define   HSMC_OCMS_SRSE_1_Val                _UINT32_(0x1)                                        /* (HSMC_OCMS) Enable Scrambling for NFC internal SRAM access. (OCMS bit must be cleared in the corresponding HSMC_TIMINGSx register.)  */
...
#define HSMC_KEY1_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_KEY1) Off Chip Memory Scrambling KEY1 Register  Reset Value */
...
#define HSMC_KEY2_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_KEY2) Off Chip Memory Scrambling KEY2 Register  Reset Value */
...
#define HSMC_CLKCFG_RESETVALUE                _UINT32_(0x00)                                       /*  (HSMC_CLKCFG) Clock Configuration Register  Reset Value */

#define HSMC_CLKCFG_CLKDIV_Pos                _UINT32_(0)                                          /* (HSMC_CLKCFG) SMC Clock Divider Position */
#define HSMC_CLKCFG_CLKDIV_Msk                (_UINT32_(0x1FF) << HSMC_CLKCFG_CLKDIV_Pos)          /* (HSMC_CLKCFG) SMC Clock Divider Mask */
#define HSMC_CLKCFG_CLKDIV(value)             (HSMC_CLKCFG_CLKDIV_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKDIV_Pos)) /* Assigment of value for CLKDIV in the HSMC_CLKCFG register */
#define HSMC_CLKCFG_CLKEN_Pos                 _UINT32_(16)                                         /* (HSMC_CLKCFG) SMC Clock Enable Position */
#define HSMC_CLKCFG_CLKEN_Msk                 (_UINT32_(0x1) << HSMC_CLKCFG_CLKEN_Pos)             /* (HSMC_CLKCFG) SMC Clock Enable Mask */
#define HSMC_CLKCFG_CLKEN(value)              (HSMC_CLKCFG_CLKEN_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKEN_Pos)) /* Assigment of value for CLKEN in the HSMC_CLKCFG register */
#define HSMC_CLKCFG_CLKEDGE_Pos               _UINT32_(17)                                         /* (HSMC_CLKCFG) SMC Clock Edge Position */
#define HSMC_CLKCFG_CLKEDGE_Msk               (_UINT32_(0x1) << HSMC_CLKCFG_CLKEDGE_Pos)           /* (HSMC_CLKCFG) SMC Clock Edge Mask */
#define HSMC_CLKCFG_CLKEDGE(value)            (HSMC_CLKCFG_CLKEDGE_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKEDGE_Pos)) /* Assigment of value for CLKEDGE in the HSMC_CLKCFG register */
#define HSMC_CLKCFG_Msk                       _UINT32_(0x000301FF)                                 /* (HSMC_CLKCFG) Register Mask  */


/* -------- HSMC_WPMR : (SMC Offset: 0x7E4) (R/W 32) Write Protection Mode Register -------- */
#define HSMC_WPMR_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_WPMR) Write Protection Mode Register  Reset Value */
...
#define   HSMC_WPMR_WPEN_0_Val                _UINT32_(0x0)                                        /* (HSMC_WPMR) Disables write protection if WPKEY value corresponds to 0x534D43 ("SMC" in ASCII)  */
#define   HSMC_WPMR_WPEN_1_Val                _UINT32_(0x1)                                        /* (HSMC_WPMR) Enables write protection if WPKEY value corresponds to 0x534D43 ("SMC" in ASCII)  */
...
#define HSMC_WPSR_RESETVALUE                  _UINT32_(0x00)                                       /*  (HSMC_WPSR) Write Protection Status Register  Reset Value */
...
#define   HSMC_WPSR_WPVS_0_Val                _UINT32_(0x0)                                        /* (HSMC_WPSR) No write protect violation has occurred since the last read of the HSMC_WPSR.  */
#define   HSMC_WPSR_WPVS_1_Val                _UINT32_(0x1)                                        /* (HSMC_WPSR) A write protect violation has occurred since the last read of the HSMC_WPSR. If this violation is an unauthorized attempt to write a protected register, the associated violation is reported into field WPVSRC.  */
...
#define HSMC_PMECC_REG_OFST            _UINT32_(0x00)      /* (HSMC_PMECC) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC0_REG_OFST           _UINT32_(0x00)      /* (HSMC_PMECC0) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC1_REG_OFST           _UINT32_(0x04)      /* (HSMC_PMECC1) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC2_REG_OFST           _UINT32_(0x08)      /* (HSMC_PMECC2) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC3_REG_OFST           _UINT32_(0x0C)      /* (HSMC_PMECC3) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC4_REG_OFST           _UINT32_(0x10)      /* (HSMC_PMECC4) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC5_REG_OFST           _UINT32_(0x14)      /* (HSMC_PMECC5) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC6_REG_OFST           _UINT32_(0x18)      /* (HSMC_PMECC6) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC7_REG_OFST           _UINT32_(0x1C)      /* (HSMC_PMECC7) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC8_REG_OFST           _UINT32_(0x20)      /* (HSMC_PMECC8) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC9_REG_OFST           _UINT32_(0x24)      /* (HSMC_PMECC9) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC10_REG_OFST          _UINT32_(0x28)      /* (HSMC_PMECC10) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC11_REG_OFST          _UINT32_(0x2C)      /* (HSMC_PMECC11) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC12_REG_OFST          _UINT32_(0x30)      /* (HSMC_PMECC12) PMECC Redundancy x Register  Offset */
#define HSMC_PMECC13_REG_OFST          _UINT32_(0x34)      /* (HSMC_PMECC13) PMECC Redundancy x Register  Offset */
#define HSMC_REM_REG_OFST              _UINT32_(0x00)      /* (HSMC_REM) PMECC Remainder x Register  Offset */
#define HSMC_REM0_REG_OFST             _UINT32_(0x00)      /* (HSMC_REM0) PMECC Remainder x Register  Offset */
#define HSMC_REM1_REG_OFST             _UINT32_(0x04)      /* (HSMC_REM1) PMECC Remainder x Register  Offset */
#define HSMC_REM2_REG_OFST             _UINT32_(0x08)      /* (HSMC_REM2) PMECC Remainder x Register  Offset */
#define HSMC_REM3_REG_OFST             _UINT32_(0x0C)      /* (HSMC_REM3) PMECC Remainder x Register  Offset */
#define HSMC_REM4_REG_OFST             _UINT32_(0x10)      /* (HSMC_REM4) PMECC Remainder x Register  Offset */
#define HSMC_REM5_REG_OFST             _UINT32_(0x14)      /* (HSMC_REM5) PMECC Remainder x Register  Offset */
#define HSMC_REM6_REG_OFST             _UINT32_(0x18)      /* (HSMC_REM6) PMECC Remainder x Register  Offset */
#define HSMC_REM7_REG_OFST             _UINT32_(0x1C)      /* (HSMC_REM7) PMECC Remainder x Register  Offset */
#define HSMC_REM8_REG_OFST             _UINT32_(0x20)      /* (HSMC_REM8) PMECC Remainder x Register  Offset */
#define HSMC_REM9_REG_OFST             _UINT32_(0x24)      /* (HSMC_REM9) PMECC Remainder x Register  Offset */
#define HSMC_REM10_REG_OFST            _UINT32_(0x28)      /* (HSMC_REM10) PMECC Remainder x Register  Offset */
#define HSMC_REM11_REG_OFST            _UINT32_(0x2C)      /* (HSMC_REM11) PMECC Remainder x Register  Offset */
#define HSMC_REM12_REG_OFST            _UINT32_(0x30)      /* (HSMC_REM12) PMECC Remainder x Register  Offset */
#define HSMC_REM13_REG_OFST            _UINT32_(0x34)      /* (HSMC_REM13) PMECC Remainder x Register  Offset */
#define HSMC_REM14_REG_OFST            _UINT32_(0x38)      /* (HSMC_REM14) PMECC Remainder x Register  Offset */
#define HSMC_REM15_REG_OFST            _UINT32_(0x3C)      /* (HSMC_REM15) PMECC Remainder x Register  Offset */
...
#define HSMC_ERRLOC_REG_OFST           _UINT32_(0x5AC)     /* (HSMC_ERRLOC) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC0_REG_OFST          _UINT32_(0x5AC)     /* (HSMC_ERRLOC0) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC1_REG_OFST          _UINT32_(0x5B0)     /* (HSMC_ERRLOC1) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC2_REG_OFST          _UINT32_(0x5B4)     /* (HSMC_ERRLOC2) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC3_REG_OFST          _UINT32_(0x5B8)     /* (HSMC_ERRLOC3) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC4_REG_OFST          _UINT32_(0x5BC)     /* (HSMC_ERRLOC4) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC5_REG_OFST          _UINT32_(0x5C0)     /* (HSMC_ERRLOC5) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC6_REG_OFST          _UINT32_(0x5C4)     /* (HSMC_ERRLOC6) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC7_REG_OFST          _UINT32_(0x5C8)     /* (HSMC_ERRLOC7) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC8_REG_OFST          _UINT32_(0x5CC)     /* (HSMC_ERRLOC8) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC9_REG_OFST          _UINT32_(0x5D0)     /* (HSMC_ERRLOC9) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC10_REG_OFST         _UINT32_(0x5D4)     /* (HSMC_ERRLOC10) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC11_REG_OFST         _UINT32_(0x5D8)     /* (HSMC_ERRLOC11) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC12_REG_OFST         _UINT32_(0x5DC)     /* (HSMC_ERRLOC12) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC13_REG_OFST         _UINT32_(0x5E0)     /* (HSMC_ERRLOC13) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC14_REG_OFST         _UINT32_(0x5E4)     /* (HSMC_ERRLOC14) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC15_REG_OFST         _UINT32_(0x5E8)     /* (HSMC_ERRLOC15) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC16_REG_OFST         _UINT32_(0x5EC)     /* (HSMC_ERRLOC16) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC17_REG_OFST         _UINT32_(0x5F0)     /* (HSMC_ERRLOC17) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC18_REG_OFST         _UINT32_(0x5F4)     /* (HSMC_ERRLOC18) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC19_REG_OFST         _UINT32_(0x5F8)     /* (HSMC_ERRLOC19) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC20_REG_OFST         _UINT32_(0x5FC)     /* (HSMC_ERRLOC20) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC21_REG_OFST         _UINT32_(0x600)     /* (HSMC_ERRLOC21) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC22_REG_OFST         _UINT32_(0x604)     /* (HSMC_ERRLOC22) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC23_REG_OFST         _UINT32_(0x608)     /* (HSMC_ERRLOC23) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC24_REG_OFST         _UINT32_(0x60C)     /* (HSMC_ERRLOC24) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC25_REG_OFST         _UINT32_(0x610)     /* (HSMC_ERRLOC25) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC26_REG_OFST         _UINT32_(0x614)     /* (HSMC_ERRLOC26) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC27_REG_OFST         _UINT32_(0x618)     /* (HSMC_ERRLOC27) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC28_REG_OFST         _UINT32_(0x61C)     /* (HSMC_ERRLOC28) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC29_REG_OFST         _UINT32_(0x620)     /* (HSMC_ERRLOC29) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC30_REG_OFST         _UINT32_(0x624)     /* (HSMC_ERRLOC30) PMECC Error Location x Register Offset */
#define HSMC_ERRLOC31_REG_OFST         _UINT32_(0x628)     /* (HSMC_ERRLOC31) PMECC Error Location x Register Offset */
...
#define HSMC_CLKCFG_REG_OFST           _UINT32_(0x7AC)     /* (HSMC_CLKCFG) Clock Configuration Register Offset */
...
#endif /* _SAMA7D6_SMC_COMPONENT_H_ */
