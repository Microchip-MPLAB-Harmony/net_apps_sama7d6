...
#ifndef _SAMA7D6_TZAESB_COMPONENT_H_
#define _SAMA7D6_TZAESB_COMPONENT_H_
...
#define TZAESB_CR_START_Pos                   _UINT32_(0)                                          /* (TZAESB_CR) Start Processing Position */
#define TZAESB_CR_START_Msk                   (_UINT32_(0x1) << TZAESB_CR_START_Pos)               /* (TZAESB_CR) Start Processing Mask */
#define TZAESB_CR_START(value)                (TZAESB_CR_START_Msk & (_UINT32_(value) << TZAESB_CR_START_Pos)) /* Assigment of value for START in the TZAESB_CR register */
#define   TZAESB_CR_START_0_Val               _UINT32_(0x0)                                        /* (TZAESB_CR) No effect.  */
#define   TZAESB_CR_START_1_Val               _UINT32_(0x1)                                        /* (TZAESB_CR) Starts manual encryption/decryption process.  */
...
#define TZAESB_CR_SWRST_Pos                   _UINT32_(8)                                          /* (TZAESB_CR) Software Reset Position */
#define TZAESB_CR_SWRST_Msk                   (_UINT32_(0x1) << TZAESB_CR_SWRST_Pos)               /* (TZAESB_CR) Software Reset Mask */
#define TZAESB_CR_SWRST(value)                (TZAESB_CR_SWRST_Msk & (_UINT32_(value) << TZAESB_CR_SWRST_Pos)) /* Assigment of value for SWRST in the TZAESB_CR register */
#define   TZAESB_CR_SWRST_0_Val               _UINT32_(0x0)                                        /* (TZAESB_CR) No effect.  */
#define   TZAESB_CR_SWRST_1_Val               _UINT32_(0x1)                                        /* (TZAESB_CR) Resets the TZAESB. A software triggered hardware reset of the TZAESB interface is performed.  */
...
#define TZAESB_CR_UNLOCK_Pos                  _UINT32_(24)                                         /* (TZAESB_CR) Unlock Processing Position */
#define TZAESB_CR_UNLOCK_Msk                  (_UINT32_(0x1) << TZAESB_CR_UNLOCK_Pos)              /* (TZAESB_CR) Unlock Processing Mask */
#define TZAESB_CR_UNLOCK(value)               (TZAESB_CR_UNLOCK_Msk & (_UINT32_(value) << TZAESB_CR_UNLOCK_Pos)) /* Assigment of value for UNLOCK in the TZAESB_CR register */
#define   TZAESB_CR_UNLOCK_0_Val              _UINT32_(0x0)                                        /* (TZAESB_CR) No effect.  */
#define   TZAESB_CR_UNLOCK_1_Val              _UINT32_(0x1)                                        /* (TZAESB_CR) Unlocks the processing in case of abnormal event detection if TZAESB_WPMR.ACTION > 0.  */
...
#define TZAESB_IDR_URAD_Pos                   _UINT32_(8)                                          /* (TZAESB_IDR) Unspecified Register Access Detection Interrupt Disable Position */
#define TZAESB_IDR_URAD_Msk                   (_UINT32_(0x1) << TZAESB_IDR_URAD_Pos)               /* (TZAESB_IDR) Unspecified Register Access Detection Interrupt Disable Mask */
#define TZAESB_IDR_URAD(value)                (TZAESB_IDR_URAD_Msk & (_UINT32_(value) << TZAESB_IDR_URAD_Pos)) /* Assigment of value for URAD in the TZAESB_IDR register */
#define TZAESB_IDR_SECE_Pos                   _UINT32_(19)                                         /* (TZAESB_IDR) Security and/or Safety Event Position */
...
#define TZAESB_IMR_RESETVALUE                 _UINT32_(0x00)                                       /*  (TZAESB_IMR) Interrupt Mask Register  Reset Value */

#define TZAESB_IMR_URAD_Pos                   _UINT32_(8)                                          /* (TZAESB_IMR) Unspecified Register Access Detection Interrupt Mask Position */
#define TZAESB_IMR_URAD_Msk                   (_UINT32_(0x1) << TZAESB_IMR_URAD_Pos)               /* (TZAESB_IMR) Unspecified Register Access Detection Interrupt Mask Mask */
#define TZAESB_IMR_URAD(value)                (TZAESB_IMR_URAD_Msk & (_UINT32_(value) << TZAESB_IMR_URAD_Pos)) /* Assigment of value for URAD in the TZAESB_IMR register */
#define TZAESB_IMR_SECE_Pos                   _UINT32_(19)                                         /* (TZAESB_IMR) Security and/or Safety Event Position */
#define TZAESB_IMR_SECE_Msk                   (_UINT32_(0x1) << TZAESB_IMR_SECE_Pos)               /* (TZAESB_IMR) Security and/or Safety Event Mask */
#define TZAESB_IMR_SECE(value)                (TZAESB_IMR_SECE_Msk & (_UINT32_(value) << TZAESB_IMR_SECE_Pos)) /* Assigment of value for SECE in the TZAESB_IMR register */
#define TZAESB_IMR_Msk                        _UINT32_(0x00080100)                                 /* (TZAESB_IMR) Register Mask  */


/* -------- TZAESB_ISR : (TZAESB Offset: 0x1C) ( R/ 32) Interrupt Status Register -------- */
#define TZAESB_ISR_RESETVALUE                 _UINT32_(0x00)                                       /*  (TZAESB_ISR) Interrupt Status Register  Reset Value */

#define TZAESB_ISR_URAD_Pos                   _UINT32_(8)                                          /* (TZAESB_ISR) Unspecified Register Access Detection Status Position */
#define TZAESB_ISR_URAD_Msk                   (_UINT32_(0x1) << TZAESB_ISR_URAD_Pos)               /* (TZAESB_ISR) Unspecified Register Access Detection Status Mask */
#define TZAESB_ISR_URAD(value)                (TZAESB_ISR_URAD_Msk & (_UINT32_(value) << TZAESB_ISR_URAD_Pos)) /* Assigment of value for URAD in the TZAESB_ISR register */
#define   TZAESB_ISR_URAD_0_Val               _UINT32_(0x0)                                        /* (TZAESB_ISR) No unspecified register access has been detected since the last SWRST.  */
#define   TZAESB_ISR_URAD_1_Val               _UINT32_(0x1)                                        /* (TZAESB_ISR) At least one unspecified register access has been detected since the last SWRST.  */
...
#define TZAESB_ISR_URAT_Pos                   _UINT32_(12)                                         /* (TZAESB_ISR) Unspecified Register Access Position */
#define TZAESB_ISR_URAT_Msk                   (_UINT32_(0xF) << TZAESB_ISR_URAT_Pos)               /* (TZAESB_ISR) Unspecified Register Access Mask */
#define TZAESB_ISR_URAT(value)                (TZAESB_ISR_URAT_Msk & (_UINT32_(value) << TZAESB_ISR_URAT_Pos)) /* Assigment of value for URAT in the TZAESB_ISR register */
#define   TZAESB_ISR_URAT_IDR_WR_PROCESSING_Val _UINT32_(0x0)                                        /* (TZAESB_ISR) Input Data register written during the data processing  */
#define   TZAESB_ISR_URAT_ODR_RD_PROCESSING_Val _UINT32_(0x1)                                        /* (TZAESB_ISR) Output Data register read during the data processing  */
#define   TZAESB_ISR_URAT_MR_WR_PROCESSING_Val _UINT32_(0x2)                                        /* (TZAESB_ISR) Mode register written during the data processing  */
#define   TZAESB_ISR_URAT_ODR_RD_SUBKGEN_Val  _UINT32_(0x3)                                        /* (TZAESB_ISR) Output Data register read during the sub-keys generation  */
#define   TZAESB_ISR_URAT_MR_WR_SUBKGEN_Val   _UINT32_(0x4)                                        /* (TZAESB_ISR) Mode register written during the sub-keys generation  */
#define   TZAESB_ISR_URAT_WOR_RD_ACCESS_Val   _UINT32_(0x5)                                        /* (TZAESB_ISR) Write-only register read access  */
...
#define TZAESB_ISR_SECE_Pos                   _UINT32_(19)                                         /* (TZAESB_ISR) Security and/or Safety Event Position */
#define TZAESB_ISR_SECE_Msk                   (_UINT32_(0x1) << TZAESB_ISR_SECE_Pos)               /* (TZAESB_ISR) Security and/or Safety Event Mask */
#define TZAESB_ISR_SECE(value)                (TZAESB_ISR_SECE_Msk & (_UINT32_(value) << TZAESB_ISR_SECE_Pos)) /* Assigment of value for SECE in the TZAESB_ISR register */
#define   TZAESB_ISR_SECE_0_Val               _UINT32_(0x0)                                        /* (TZAESB_ISR) There is no security report in TZAESB_WPSR.  */
#define   TZAESB_ISR_SECE_1_Val               _UINT32_(0x1)                                        /* (TZAESB_ISR) One security flag is set in TZAESB_WPSR.  */
...
#define TZAESB_IVR_IV(value)                  (TZAESB_IVR_IV_Msk & (_UINT32_(value) << TZAESB_IVR_IV_Pos)) /* Assigment of value for IV in the TZAESB_IVR register */
...
#define TZAESB_WPMR_RESETVALUE                _UINT32_(0x00)                                       /*  (TZAESB_WPMR) Write Protection Mode Register  Reset Value */

#define TZAESB_WPMR_WPEN_Pos                  _UINT32_(0)                                          /* (TZAESB_WPMR) Write Protection Configuration Enable Position */
#define TZAESB_WPMR_WPEN_Msk                  (_UINT32_(0x1) << TZAESB_WPMR_WPEN_Pos)              /* (TZAESB_WPMR) Write Protection Configuration Enable Mask */
#define TZAESB_WPMR_WPEN(value)               (TZAESB_WPMR_WPEN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPEN_Pos)) /* Assigment of value for WPEN in the TZAESB_WPMR register */
#define   TZAESB_WPMR_WPEN_0_Val              _UINT32_(0x0)                                        /* (TZAESB_WPMR) Disables the write protection on configuration registers if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
#define   TZAESB_WPMR_WPEN_1_Val              _UINT32_(0x1)                                        /* (TZAESB_WPMR) Enables the write protection on configuration registers if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
...
#define TZAESB_WPMR_WPITEN_Pos                _UINT32_(1)                                          /* (TZAESB_WPMR) Write Protection Interruption Enable Position */
#define TZAESB_WPMR_WPITEN_Msk                (_UINT32_(0x1) << TZAESB_WPMR_WPITEN_Pos)            /* (TZAESB_WPMR) Write Protection Interruption Enable Mask */
#define TZAESB_WPMR_WPITEN(value)             (TZAESB_WPMR_WPITEN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPITEN_Pos)) /* Assigment of value for WPITEN in the TZAESB_WPMR register */
#define   TZAESB_WPMR_WPITEN_0_Val            _UINT32_(0x0)                                        /* (TZAESB_WPMR) Disables the write protection on interrupt registers if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
#define   TZAESB_WPMR_WPITEN_1_Val            _UINT32_(0x1)                                        /* (TZAESB_WPMR) Enables the write protection on interrupt registers if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
...
#define TZAESB_WPMR_WPCREN_Pos                _UINT32_(2)                                          /* (TZAESB_WPMR) Write Protection Control Enable Position */
#define TZAESB_WPMR_WPCREN_Msk                (_UINT32_(0x1) << TZAESB_WPMR_WPCREN_Pos)            /* (TZAESB_WPMR) Write Protection Control Enable Mask */
#define TZAESB_WPMR_WPCREN(value)             (TZAESB_WPMR_WPCREN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPCREN_Pos)) /* Assigment of value for WPCREN in the TZAESB_WPMR register */
#define   TZAESB_WPMR_WPCREN_0_Val            _UINT32_(0x0)                                        /* (TZAESB_WPMR) Disables the write protection on control register if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
#define   TZAESB_WPMR_WPCREN_1_Val            _UINT32_(0x1)                                        /* (TZAESB_WPMR) Enables the write protection on control register if WPKEY corresponds to 0x414553 ("AES" in ASCII).  */
...
#define TZAESB_WPMR_FIRSTE_Pos                _UINT32_(4)                                          /* (TZAESB_WPMR) First Error Report Enable Position */
#define TZAESB_WPMR_FIRSTE_Msk                (_UINT32_(0x1) << TZAESB_WPMR_FIRSTE_Pos)            /* (TZAESB_WPMR) First Error Report Enable Mask */
#define TZAESB_WPMR_FIRSTE(value)             (TZAESB_WPMR_FIRSTE_Msk & (_UINT32_(value) << TZAESB_WPMR_FIRSTE_Pos)) /* Assigment of value for FIRSTE in the TZAESB_WPMR register */
#define   TZAESB_WPMR_FIRSTE_0_Val            _UINT32_(0x0)                                        /* (TZAESB_WPMR) The last write protection violation source is reported in TZAESB_WPSR.WPVSRC and the last software control error type is reported in TZAESB_WPSR.SWETYP. The TZAESB_ISR.SECE flag is set at the first error occurrence within a series.  */
#define   TZAESB_WPMR_FIRSTE_1_Val            _UINT32_(0x1)                                        /* (TZAESB_WPMR) Only the first write protection violation source is reported in TZAESB_WPSR.WPVSRC and only the first software control error type is reported in TZAESB_WPSR.SWETYP. The TZAESB_ISR.SECE flag is set at the first error occurrence within a series.  */
...
#define TZAESB_WPMR_ACTION_Pos                _UINT32_(5)                                          /* (TZAESB_WPMR) Action on Abnormal Event Detection Position */
#define TZAESB_WPMR_ACTION_Msk                (_UINT32_(0x7) << TZAESB_WPMR_ACTION_Pos)            /* (TZAESB_WPMR) Action on Abnormal Event Detection Mask */
#define TZAESB_WPMR_ACTION(value)             (TZAESB_WPMR_ACTION_Msk & (_UINT32_(value) << TZAESB_WPMR_ACTION_Pos)) /* Assigment of value for ACTION in the TZAESB_WPMR register */
#define   TZAESB_WPMR_ACTION_REPORT_ONLY_Val  _UINT32_(0x0)                                        /* (TZAESB_WPMR) No action (stop or clear key) is performed when one of PKRPVS, WPVS, CGD, SEQE, or SWE flags is set.  */
#define   TZAESB_WPMR_ACTION_LOCK_PKRPVS_WPVS_SWE_Val _UINT32_(0x1)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.PKRPVS/WPVS/SWE event detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued.  */
#define   TZAESB_WPMR_ACTION_LOCK_CGD_SEQE_Val _UINT32_(0x2)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.CGD/SEQE event detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued.  */
#define   TZAESB_WPMR_ACTION_LOCK_ANY_EV_Val  _UINT32_(0x3)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.PKRPVS/WPVS/CGD/SEQE/SWE events detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued.  */
#define   TZAESB_WPMR_ACTION_CLEAR_PKRPVS_WPVS_SWE_Val _UINT32_(0x4)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.PKRPVS/WPVS/SWE events detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued. Moreover, the TZAESB_KEYWRx key is immediately cleared.  */
#define   TZAESB_WPMR_ACTION_CLEAR_CGD_SEQE_Val _UINT32_(0x5)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.CGD/SEQE events detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued. Moreover, the TZAESB_KEYWRx key is immediately cleared.  */
#define   TZAESB_WPMR_ACTION_CLEAR_ANY_EV_Val _UINT32_(0x6)                                        /* (TZAESB_WPMR) If a processing is in progress when the TZAESB_WPSR.PKRPVS/WPVS/CGD/SEQE/SWE events detection occurs, the current processing is ended normally but no other processing is started while a TZAESB_CR.UNLOCK command is issued. Moreover, the TZAESB_KEYWRx key is immediately cleared.  */
...
#define TZAESB_WPMR_WPKEY_Pos                 _UINT32_(8)                                          /* (TZAESB_WPMR) Write Protection Key Position */
#define TZAESB_WPMR_WPKEY_Msk                 (_UINT32_(0xFFFFFF) << TZAESB_WPMR_WPKEY_Pos)        /* (TZAESB_WPMR) Write Protection Key Mask */
#define TZAESB_WPMR_WPKEY(value)              (TZAESB_WPMR_WPKEY_Msk & (_UINT32_(value) << TZAESB_WPMR_WPKEY_Pos)) /* Assigment of value for WPKEY in the TZAESB_WPMR register */
#define   TZAESB_WPMR_WPKEY_PASSWD_Val        _UINT32_(0x414553)                                   /* (TZAESB_WPMR) Writing any other value in this field aborts the write operation of the WPEN, WPITEN and WPCREN bits. Always reads as 0.  */
...
#define TZAESB_WPMR_Msk                       _UINT32_(0xFFFFFFF7)                                 /* (TZAESB_WPMR) Register Mask  */


/* -------- TZAESB_WPSR : (TZAESB Offset: 0xE8) ( R/ 32) Write Protection Status Register -------- */
#define TZAESB_WPSR_RESETVALUE                _UINT32_(0x00)                                       /*  (TZAESB_WPSR) Write Protection Status Register  Reset Value */

#define TZAESB_WPSR_WPVS_Pos                  _UINT32_(0)                                          /* (TZAESB_WPSR) Write Protection Violation Status (cleared on read) Position */
#define TZAESB_WPSR_WPVS_Msk                  (_UINT32_(0x1) << TZAESB_WPSR_WPVS_Pos)              /* (TZAESB_WPSR) Write Protection Violation Status (cleared on read) Mask */
#define TZAESB_WPSR_WPVS(value)               (TZAESB_WPSR_WPVS_Msk & (_UINT32_(value) << TZAESB_WPSR_WPVS_Pos)) /* Assigment of value for WPVS in the TZAESB_WPSR register */
#define   TZAESB_WPSR_WPVS_0_Val              _UINT32_(0x0)                                        /* (TZAESB_WPSR) No write protect violation has occurred since the last read of TZAESB_WPSR.  */
#define   TZAESB_WPSR_WPVS_1_Val              _UINT32_(0x1)                                        /* (TZAESB_WPSR) A write protect violation has occurred since the last read of TZAESB_WPSR. The address offset of the violated register is reported into field WPVSRC.  */
...
#define TZAESB_WPSR_CGD_Pos                   _UINT32_(1)                                          /* (TZAESB_WPSR) Clock Glitch Detected (cleared on read) Position */
#define TZAESB_WPSR_CGD_Msk                   (_UINT32_(0x1) << TZAESB_WPSR_CGD_Pos)               /* (TZAESB_WPSR) Clock Glitch Detected (cleared on read) Mask */
#define TZAESB_WPSR_CGD(value)                (TZAESB_WPSR_CGD_Msk & (_UINT32_(value) << TZAESB_WPSR_CGD_Pos)) /* Assigment of value for CGD in the TZAESB_WPSR register */
#define   TZAESB_WPSR_CGD_0_Val               _UINT32_(0x0)                                        /* (TZAESB_WPSR) No clock glitch has occurred since the last read of TZAESB_WPSR. Under normal operating conditions, this bit is always cleared.  */
#define   TZAESB_WPSR_CGD_1_Val               _UINT32_(0x1)                                        /* (TZAESB_WPSR) A clock glitch has occurred since the last read of TZAESB_WPSR. This flag can only be set in case of an abnormal clock signal waveform (glitch).  */
...
#define TZAESB_WPSR_SEQE_Pos                  _UINT32_(2)                                          /* (TZAESB_WPSR) Internal Sequencer Error (cleared on read) Position */
#define TZAESB_WPSR_SEQE_Msk                  (_UINT32_(0x1) << TZAESB_WPSR_SEQE_Pos)              /* (TZAESB_WPSR) Internal Sequencer Error (cleared on read) Mask */
#define TZAESB_WPSR_SEQE(value)               (TZAESB_WPSR_SEQE_Msk & (_UINT32_(value) << TZAESB_WPSR_SEQE_Pos)) /* Assigment of value for SEQE in the TZAESB_WPSR register */
#define   TZAESB_WPSR_SEQE_0_Val              _UINT32_(0x0)                                        /* (TZAESB_WPSR) No peripheral internal sequencer error has occurred since the last read of TZAESB_WPSR.  */
#define   TZAESB_WPSR_SEQE_1_Val              _UINT32_(0x1)                                        /* (TZAESB_WPSR) A peripheral internal sequencer error has occurred since the last read of TZAESB_WPSR. This flag can only be set under abnormal operating conditions.  */
...
#define TZAESB_WPSR_SWE_Pos                   _UINT32_(3)                                          /* (TZAESB_WPSR) Software Control Error (cleared on read) Position */
#define TZAESB_WPSR_SWE_Msk                   (_UINT32_(0x1) << TZAESB_WPSR_SWE_Pos)               /* (TZAESB_WPSR) Software Control Error (cleared on read) Mask */
#define TZAESB_WPSR_SWE(value)                (TZAESB_WPSR_SWE_Msk & (_UINT32_(value) << TZAESB_WPSR_SWE_Pos)) /* Assigment of value for SWE in the TZAESB_WPSR register */
#define   TZAESB_WPSR_SWE_0_Val               _UINT32_(0x0)                                        /* (TZAESB_WPSR) No software error has occurred since the last read of TZAESB_WPSR.  */
#define   TZAESB_WPSR_SWE_1_Val               _UINT32_(0x1)                                        /* (TZAESB_WPSR) A software error has occurred since the last read of TZAESB_WPSR. The field SWETYP details the type of software error; the associated incorrect software access is reported in the field WPVSRC (if WPVS=0).  */
...
#define TZAESB_WPSR_PKRPVS_Pos                _UINT32_(4)                                          /* (TZAESB_WPSR) Private Key Internal Register Protection Violation Status (cleared on read) Position */
#define TZAESB_WPSR_PKRPVS_Msk                (_UINT32_(0x1) << TZAESB_WPSR_PKRPVS_Pos)            /* (TZAESB_WPSR) Private Key Internal Register Protection Violation Status (cleared on read) Mask */
#define TZAESB_WPSR_PKRPVS(value)             (TZAESB_WPSR_PKRPVS_Msk & (_UINT32_(value) << TZAESB_WPSR_PKRPVS_Pos)) /* Assigment of value for PKRPVS in the TZAESB_WPSR register */
#define   TZAESB_WPSR_PKRPVS_0_Val            _UINT32_(0x0)                                        /* (TZAESB_WPSR) No Private Key internal register access violation has occurred since the last read of TZAESB_WPSR.  */
#define   TZAESB_WPSR_PKRPVS_1_Val            _UINT32_(0x1)                                        /* (TZAESB_WPSR) A Private Key internal register access violation has occurred since the last read of TZAESB_WPSR.  */
...
#define TZAESB_WPSR_WPVSRC_Pos                _UINT32_(8)                                          /* (TZAESB_WPSR) Write Protection Violation Source Position */
#define TZAESB_WPSR_WPVSRC_Msk                (_UINT32_(0xFF) << TZAESB_WPSR_WPVSRC_Pos)           /* (TZAESB_WPSR) Write Protection Violation Source Mask */
#define TZAESB_WPSR_WPVSRC(value)             (TZAESB_WPSR_WPVSRC_Msk & (_UINT32_(value) << TZAESB_WPSR_WPVSRC_Pos)) /* Assigment of value for WPVSRC in the TZAESB_WPSR register */
#define TZAESB_WPSR_SWETYP_Pos                _UINT32_(24)                                         /* (TZAESB_WPSR) Software Error Type (cleared on read) Position */
#define TZAESB_WPSR_SWETYP_Msk                (_UINT32_(0xF) << TZAESB_WPSR_SWETYP_Pos)            /* (TZAESB_WPSR) Software Error Type (cleared on read) Mask */
#define TZAESB_WPSR_SWETYP(value)             (TZAESB_WPSR_SWETYP_Msk & (_UINT32_(value) << TZAESB_WPSR_SWETYP_Pos)) /* Assigment of value for SWETYP in the TZAESB_WPSR register */
#define   TZAESB_WPSR_SWETYP_READ_WO_Val      _UINT32_(0x0)                                        /* (TZAESB_WPSR) A write-only register has been read (Warning).  */
#define   TZAESB_WPSR_SWETYP_WRITE_RO_Val     _UINT32_(0x1)                                        /* (TZAESB_WPSR) TZAESB is enabled and a write access has been performed on a read-only register (Warning).  */
#define   TZAESB_WPSR_SWETYP_UNDEF_RW_Val     _UINT32_(0x2)                                        /* (TZAESB_WPSR) Access to an undefined address (Warning).  */
#define   TZAESB_WPSR_SWETYP_CTRL_START_Val   _UINT32_(0x3)                                        /* (TZAESB_WPSR) Abnormal use of TZAESB_CR.START command when DMA access is configured.  */
#define   TZAESB_WPSR_SWETYP_WEIRD_ACTION_Val _UINT32_(0x4)                                        /* (TZAESB_WPSR) A Private Key bus access, key write, init value write, output data read or TZAESB_MR and TZAESB_EMR write has been performed while a process is in progress (abnormal).  */
#define   TZAESB_WPSR_SWETYP_INCOMPLETE_KEY_Val _UINT32_(0x5)                                        /* (TZAESB_WPSR) A tentative of start is required while the key is not fully loaded into the TZAESB_KEYWRx registers.  */
...
#define TZAESB_WPSR_ECLASS_Pos                _UINT32_(31)                                         /* (TZAESB_WPSR) Software Error Class (cleared on read) Position */
#define TZAESB_WPSR_ECLASS_Msk                (_UINT32_(0x1) << TZAESB_WPSR_ECLASS_Pos)            /* (TZAESB_WPSR) Software Error Class (cleared on read) Mask */
#define TZAESB_WPSR_ECLASS(value)             (TZAESB_WPSR_ECLASS_Msk & (_UINT32_(value) << TZAESB_WPSR_ECLASS_Pos)) /* Assigment of value for ECLASS in the TZAESB_WPSR register */
#define   TZAESB_WPSR_ECLASS_WARNING_Val      _UINT32_(0x0)                                        /* (TZAESB_WPSR) An abnormal access that does not affect system functionality  */
#define   TZAESB_WPSR_ECLASS_ERROR_Val        _UINT32_(0x1)                                        /* (TZAESB_WPSR) An access is performed into key, input data, control registers while the TZAESB is performing an encryption/decryption or a start is request by software or DMA while the key is not fully configured.  */
...
#define TZAESB_WPSR_Msk                       _UINT32_(0x8F00FF1F)                                 /* (TZAESB_WPSR) Register Mask  */
...
#endif /* _SAMA7D6_TZAESB_COMPONENT_H_ */
