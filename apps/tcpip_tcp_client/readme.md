...
[Click here](https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=NET_APPS_SAMA7D6_TCP_IP_TCP_CLIENT&redirect=true) to view documentation for this application.