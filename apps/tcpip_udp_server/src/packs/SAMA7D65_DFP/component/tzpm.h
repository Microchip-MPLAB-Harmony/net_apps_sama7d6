...
#ifndef _SAMA7D6_TZPM_COMPONENT_H_
#define _SAMA7D6_TZPM_COMPONENT_H_

/* ************************************************************************** */
/*   SOFTWARE API DEFINITION FOR TZPM                                         */
/* ************************************************************************** */

/* -------- TZPM_KEY : (TZPM Offset: 0x04) (R/W 32) Key Register -------- */
#define TZPM_KEY_RESETVALUE                   _UINT32_(0x00)                                       /*  (TZPM_KEY) Key Register  Reset Value */

#define TZPM_KEY_TZPMKEY_Pos                  _UINT32_(0)                                          /* (TZPM_KEY) Write Protection Key Position */
#define TZPM_KEY_TZPMKEY_Msk                  (_UINT32_(0xFFFFFFFF) << TZPM_KEY_TZPMKEY_Pos)       /* (TZPM_KEY) Write Protection Key Mask */
...
typedef struct
{  /* TrustZone Peripheral Manager */
  __I   uint8_t                        Reserved1[0x04];
  __IO  uint32_t                       TZPM_KEY;           /**< Offset: 0x04 (R/W  32) Key Register */
  __IO  uint32_t                       TZPM_PIDR0;         /**< Offset: 0x08 (R/W  32) Peripheral ID Register 0 */
...
#endif /* _SAMA7D6_TZPM_COMPONENT_H_ */
