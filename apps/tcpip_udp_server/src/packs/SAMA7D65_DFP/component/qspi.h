...
#define QSPI_CR_STPCAL_Pos                    _UINT32_(4)                                          /* (QSPI_CR) Start Pad Calibration Position */
#define QSPI_CR_STPCAL_Msk                    (_UINT32_(0x1) << QSPI_CR_STPCAL_Pos)                /* (QSPI_CR) Start Pad Calibration Mask */
#define QSPI_CR_STPCAL(value)                 (QSPI_CR_STPCAL_Msk & (_UINT32_(value) << QSPI_CR_STPCAL_Pos)) /* Assigment of value for STPCAL in the QSPI_CR register */
#define   QSPI_CR_STPCAL_0_Val                _UINT32_(0x0)                                        /* (QSPI_CR) No effect.  */
#define   QSPI_CR_STPCAL_1_Val                _UINT32_(0x1)                                        /* (QSPI_CR) Starts a QSPI pad calibration. QSPI_SR.CALBSY indicates the state of the calibration.  */
...
#define QSPI_CR_Msk                           _UINT32_(0x010007B3)                                 /* (QSPI_CR) Register Mask  */
...
#define QSPI_SR_CALBSY_Pos                    _UINT32_(6)                                          /* (QSPI_SR) Pad Calibration Busy Position */
#define QSPI_SR_CALBSY_Msk                    (_UINT32_(0x1) << QSPI_SR_CALBSY_Pos)                /* (QSPI_SR) Pad Calibration Busy Mask */
#define QSPI_SR_CALBSY(value)                 (QSPI_SR_CALBSY_Msk & (_UINT32_(value) << QSPI_SR_CALBSY_Pos)) /* Assigment of value for CALBSY in the QSPI_SR register */
#define   QSPI_SR_CALBSY_0_Val                _UINT32_(0x0)                                        /* (QSPI_SR) Pad calibration is not ongoing.  */
#define   QSPI_SR_CALBSY_1_Val                _UINT32_(0x1)                                        /* (QSPI_SR) Pad calibration is ongoing.  */
...
#define QSPI_SR_Msk                           _UINT32_(0x0000005F)                                 /* (QSPI_SR) Register Mask  */
...
#define QSPI_PCALCFG_RESETVALUE               _UINT32_(0x19030)                                    /*  (QSPI_PCALCFG) Pad Calibration Configuration Register  Reset Value */

#define QSPI_PCALCFG_AAON_Pos                 _UINT32_(0)                                          /* (QSPI_PCALCFG) Analog Always On Position */
#define QSPI_PCALCFG_AAON_Msk                 (_UINT32_(0x1) << QSPI_PCALCFG_AAON_Pos)             /* (QSPI_PCALCFG) Analog Always On Mask */
#define QSPI_PCALCFG_AAON(value)              (QSPI_PCALCFG_AAON_Msk & (_UINT32_(value) << QSPI_PCALCFG_AAON_Pos)) /* Assigment of value for AAON in the QSPI_PCALCFG register */
#define   QSPI_PCALCFG_AAON_0_Val             _UINT32_(0x0)                                        /* (QSPI_PCALCFG) The analog part of the pad calibration circuitry is switched off after each calibration (long delay for each calibration).  */
#define   QSPI_PCALCFG_AAON_1_Val             _UINT32_(0x1)                                        /* (QSPI_PCALCFG) The analog part of the pad calibration circuitry is not switched off after each calibration (shorter delay after the first calibration).  */
...
#define QSPI_PCALCFG_DAPCAL_Pos               _UINT32_(1)                                          /* (QSPI_PCALCFG) Disable Automatic Pad Calibration Position */
#define QSPI_PCALCFG_DAPCAL_Msk               (_UINT32_(0x1) << QSPI_PCALCFG_DAPCAL_Pos)           /* (QSPI_PCALCFG) Disable Automatic Pad Calibration Mask */
#define QSPI_PCALCFG_DAPCAL(value)            (QSPI_PCALCFG_DAPCAL_Msk & (_UINT32_(value) << QSPI_PCALCFG_DAPCAL_Pos)) /* Assigment of value for DAPCAL in the QSPI_PCALCFG register */
#define   QSPI_PCALCFG_DAPCAL_0_Val           _UINT32_(0x0)                                        /* (QSPI_PCALCFG) Pad calibration is started automatically depending on the configuration of QSPI_REFRESH.  */
#define   QSPI_PCALCFG_DAPCAL_1_Val           _UINT32_(0x1)                                        /* (QSPI_PCALCFG) Pad calibration is not started automatically.  */
...
#define QSPI_PCALCFG_CLKDIV_Pos               _UINT32_(4)                                          /* (QSPI_PCALCFG) Calibration Clock Division Position */
#define QSPI_PCALCFG_CLKDIV_Msk               (_UINT32_(0x7) << QSPI_PCALCFG_CLKDIV_Pos)           /* (QSPI_PCALCFG) Calibration Clock Division Mask */
#define QSPI_PCALCFG_CLKDIV(value)            (QSPI_PCALCFG_CLKDIV_Msk & (_UINT32_(value) << QSPI_PCALCFG_CLKDIV_Pos)) /* Assigment of value for CLKDIV in the QSPI_PCALCFG register */
#define QSPI_PCALCFG_CALCNT_Pos               _UINT32_(8)                                          /* (QSPI_PCALCFG) Pad Calibration Counter Position */
#define QSPI_PCALCFG_CALCNT_Msk               (_UINT32_(0x1FF) << QSPI_PCALCFG_CALCNT_Pos)         /* (QSPI_PCALCFG) Pad Calibration Counter Mask */
#define QSPI_PCALCFG_CALCNT(value)            (QSPI_PCALCFG_CALCNT_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALCNT_Pos)) /* Assigment of value for CALCNT in the QSPI_PCALCFG register */
#define QSPI_PCALCFG_CALP_Pos                 _UINT32_(24)                                         /* (QSPI_PCALCFG) Calibration Code for P-channel (Read-only) Position */
#define QSPI_PCALCFG_CALP_Msk                 (_UINT32_(0xF) << QSPI_PCALCFG_CALP_Pos)             /* (QSPI_PCALCFG) Calibration Code for P-channel (Read-only) Mask */
#define QSPI_PCALCFG_CALP(value)              (QSPI_PCALCFG_CALP_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALP_Pos)) /* Assigment of value for CALP in the QSPI_PCALCFG register */
#define QSPI_PCALCFG_CALN_Pos                 _UINT32_(28)                                         /* (QSPI_PCALCFG) Calibration Code for N-channel (Read-only) Position */
#define QSPI_PCALCFG_CALN_Msk                 (_UINT32_(0xF) << QSPI_PCALCFG_CALN_Pos)             /* (QSPI_PCALCFG) Calibration Code for N-channel (Read-only) Mask */
#define QSPI_PCALCFG_CALN(value)              (QSPI_PCALCFG_CALN_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALN_Pos)) /* Assigment of value for CALN in the QSPI_PCALCFG register */
#define QSPI_PCALCFG_Msk                      _UINT32_(0xFF01FF77)                                 /* (QSPI_PCALCFG) Register Mask  */


/* -------- QSPI_PCALBP : (QSPI Offset: 0x60) (R/W 32) Pad Calibration Bypass Register -------- */
#define QSPI_PCALBP_RESETVALUE                _UINT32_(0x00)                                       /*  (QSPI_PCALBP) Pad Calibration Bypass Register  Reset Value */

#define QSPI_PCALBP_BPEN_Pos                  _UINT32_(0)                                          /* (QSPI_PCALBP) Bypass Enable Position */
#define QSPI_PCALBP_BPEN_Msk                  (_UINT32_(0x1) << QSPI_PCALBP_BPEN_Pos)              /* (QSPI_PCALBP) Bypass Enable Mask */
#define QSPI_PCALBP_BPEN(value)               (QSPI_PCALBP_BPEN_Msk & (_UINT32_(value) << QSPI_PCALBP_BPEN_Pos)) /* Assigment of value for BPEN in the QSPI_PCALBP register */
#define   QSPI_PCALBP_BPEN_0_Val              _UINT32_(0x0)                                        /* (QSPI_PCALBP) The calibration code is not overridden by values of CALNBP and CALPBP.  */
#define   QSPI_PCALBP_BPEN_1_Val              _UINT32_(0x1)                                        /* (QSPI_PCALBP) The calibration code is overridden by values of CALNBP and CALPBP.  */
#define QSPI_PCALBP_BPEN_0                    (QSPI_PCALBP_BPEN_0_Val << QSPI_PCALBP_BPEN_Pos)     /* (QSPI_PCALBP) The calibration code is not overridden by values of CALNBP and CALPBP. Position  */
#define QSPI_PCALBP_BPEN_1                    (QSPI_PCALBP_BPEN_1_Val << QSPI_PCALBP_BPEN_Pos)     /* (QSPI_PCALBP) The calibration code is overridden by values of CALNBP and CALPBP. Position  */
#define QSPI_PCALBP_CALPBP_Pos                _UINT32_(8)                                          /* (QSPI_PCALBP) Calibration Code Bypass for P-channel Position */
#define QSPI_PCALBP_CALPBP_Msk                (_UINT32_(0xF) << QSPI_PCALBP_CALPBP_Pos)            /* (QSPI_PCALBP) Calibration Code Bypass for P-channel Mask */
#define QSPI_PCALBP_CALPBP(value)             (QSPI_PCALBP_CALPBP_Msk & (_UINT32_(value) << QSPI_PCALBP_CALPBP_Pos)) /* Assigment of value for CALPBP in the QSPI_PCALBP register */
#define QSPI_PCALBP_CALNBP_Pos                _UINT32_(16)                                         /* (QSPI_PCALBP) Calibration Code Bypass for N-channel Position */
#define QSPI_PCALBP_CALNBP_Msk                (_UINT32_(0xF) << QSPI_PCALBP_CALNBP_Pos)            /* (QSPI_PCALBP) Calibration Code Bypass for N-channel Mask */
#define QSPI_PCALBP_CALNBP(value)             (QSPI_PCALBP_CALNBP_Msk & (_UINT32_(value) << QSPI_PCALBP_CALNBP_Pos)) /* Assigment of value for CALNBP in the QSPI_PCALBP register */
#define QSPI_PCALBP_Msk                       _UINT32_(0x000F0F01)                                 /* (QSPI_PCALBP) Register Mask  */
...
#define QSPI_PCALBP_REG_OFST           _UINT32_(0x60)      /* (QSPI_PCALBP) Pad Calibration Bypass Register Offset */
...
#endif /* _SAMA7D6_QSPI_COMPONENT_H_ */
