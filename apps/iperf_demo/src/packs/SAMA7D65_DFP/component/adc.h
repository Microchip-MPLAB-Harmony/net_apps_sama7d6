...
#ifndef _SAMA7D6_ADC_COMPONENT_H_
#define _SAMA7D6_ADC_COMPONENT_H_
...
#define   ADC_CR_SWRST_1_Val                  _UINT32_(0x1)                                        /* (ADC_CR) Resets the ADC, simulating a hardware reset.  */
...
#define   ADC_MR_USEQ_REG_ORDER_Val           _UINT32_(0x1)                                        /* (ADC_MR) User Sequence mode: The sequence respects what is defined in ADC_SEQR1 and ADC_SEQR2 and can be used to convert the same channel several times.  */
...
#define ADC_SEQR2_RESETVALUE                  _UINT32_(0x00)                                       /*  (ADC_SEQR2) Channel Sequence Register 2  Reset Value */
...
#define   ADC_CHER_CH8_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH8_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH9_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH9_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH10_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH10_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH11_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH11_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH12_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH12_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH13_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH13_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH14_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH14_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define   ADC_CHER_CH15_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH15_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define ADC_CHER_CH30_Pos                     _UINT32_(30)                                         /* (ADC_CHER) Channel 30 Enable Position */
#define ADC_CHER_CH30_Msk                     (_UINT32_(0x1) << ADC_CHER_CH30_Pos)                 /* (ADC_CHER) Channel 30 Enable Mask */
#define ADC_CHER_CH30(value)                  (ADC_CHER_CH30_Msk & (_UINT32_(value) << ADC_CHER_CH30_Pos)) /* Assigment of value for CH30 in the ADC_CHER register */
#define   ADC_CHER_CH30_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH30_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define ADC_CHER_CH31_Pos                     _UINT32_(31)                                         /* (ADC_CHER) Channel 31 Enable Position */
#define ADC_CHER_CH31_Msk                     (_UINT32_(0x1) << ADC_CHER_CH31_Pos)                 /* (ADC_CHER) Channel 31 Enable Mask */
#define ADC_CHER_CH31(value)                  (ADC_CHER_CH31_Msk & (_UINT32_(value) << ADC_CHER_CH31_Pos)) /* Assigment of value for CH31 in the ADC_CHER register */
#define   ADC_CHER_CH31_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHER) No effect.  */
#define   ADC_CHER_CH31_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHER) Enables the corresponding channel.  */
...
#define ADC_CHER_Msk                          _UINT32_(0xC000FFFF)                                 /* (ADC_CHER) Register Mask  */

#define ADC_CHER_CH_Pos                       _UINT32_(0)                                          /* (ADC_CHER Position) Channel 3x Enable */
#define ADC_CHER_CH_Msk                       (_UINT32_(0x3FFFF) << ADC_CHER_CH_Pos)               /* (ADC_CHER Mask) CH */
...
#define   ADC_CHDR_CH8_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH8_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH9_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH9_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH10_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH10_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH11_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH11_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH12_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH12_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH13_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH13_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH14_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH14_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define   ADC_CHDR_CH15_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH15_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define ADC_CHDR_CH30_Pos                     _UINT32_(30)                                         /* (ADC_CHDR) Channel 30 Disable Position */
#define ADC_CHDR_CH30_Msk                     (_UINT32_(0x1) << ADC_CHDR_CH30_Pos)                 /* (ADC_CHDR) Channel 30 Disable Mask */
#define ADC_CHDR_CH30(value)                  (ADC_CHDR_CH30_Msk & (_UINT32_(value) << ADC_CHDR_CH30_Pos)) /* Assigment of value for CH30 in the ADC_CHDR register */
#define   ADC_CHDR_CH30_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH30_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define ADC_CHDR_CH31_Pos                     _UINT32_(31)                                         /* (ADC_CHDR) Channel 31 Disable Position */
#define ADC_CHDR_CH31_Msk                     (_UINT32_(0x1) << ADC_CHDR_CH31_Pos)                 /* (ADC_CHDR) Channel 31 Disable Mask */
#define ADC_CHDR_CH31(value)                  (ADC_CHDR_CH31_Msk & (_UINT32_(value) << ADC_CHDR_CH31_Pos)) /* Assigment of value for CH31 in the ADC_CHDR register */
#define   ADC_CHDR_CH31_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHDR) No effect.  */
#define   ADC_CHDR_CH31_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHDR) Disables the corresponding channel.  */
...
#define ADC_CHDR_Msk                          _UINT32_(0xC000FFFF)                                 /* (ADC_CHDR) Register Mask  */

#define ADC_CHDR_CH_Pos                       _UINT32_(0)                                          /* (ADC_CHDR Position) Channel 3x Disable */
#define ADC_CHDR_CH_Msk                       (_UINT32_(0x3FFFF) << ADC_CHDR_CH_Pos)               /* (ADC_CHDR Mask) CH */
...
#define   ADC_CHSR_CH8_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH8_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH9_0_Val                  _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH9_1_Val                  _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH10_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH10_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH11_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH11_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH12_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH12_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH13_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH13_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH14_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH14_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define   ADC_CHSR_CH15_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH15_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define ADC_CHSR_CH30_Pos                     _UINT32_(30)                                         /* (ADC_CHSR) Channel 30 Status Position */
#define ADC_CHSR_CH30_Msk                     (_UINT32_(0x1) << ADC_CHSR_CH30_Pos)                 /* (ADC_CHSR) Channel 30 Status Mask */
#define ADC_CHSR_CH30(value)                  (ADC_CHSR_CH30_Msk & (_UINT32_(value) << ADC_CHSR_CH30_Pos)) /* Assigment of value for CH30 in the ADC_CHSR register */
#define   ADC_CHSR_CH30_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH30_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define ADC_CHSR_CH31_Pos                     _UINT32_(31)                                         /* (ADC_CHSR) Channel 31 Status Position */
#define ADC_CHSR_CH31_Msk                     (_UINT32_(0x1) << ADC_CHSR_CH31_Pos)                 /* (ADC_CHSR) Channel 31 Status Mask */
#define ADC_CHSR_CH31(value)                  (ADC_CHSR_CH31_Msk & (_UINT32_(value) << ADC_CHSR_CH31_Pos)) /* Assigment of value for CH31 in the ADC_CHSR register */
#define   ADC_CHSR_CH31_0_Val                 _UINT32_(0x0)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is disabled.  */
#define   ADC_CHSR_CH31_1_Val                 _UINT32_(0x1)                                        /* (ADC_CHSR) The corresponding channel (or part of sequence, see ADC_SEQyR.USCHx) is enabled.  */
...
#define ADC_CHSR_Msk                          _UINT32_(0xC000FFFF)                                 /* (ADC_CHSR) Register Mask  */

#define ADC_CHSR_CH_Pos                       _UINT32_(0)                                          /* (ADC_CHSR Position) Channel 3x Status */
#define ADC_CHSR_CH_Msk                       (_UINT32_(0x3FFFF) << ADC_CHSR_CH_Pos)               /* (ADC_CHSR Mask) CH */
...
#define ADC_IER_Msk                           _UINT32_(0x070C003F)                                 /* (ADC_IER) Register Mask  */
...
#define ADC_IDR_Msk                           _UINT32_(0x070C003F)                                 /* (ADC_IDR) Register Mask  */
...
#define ADC_IMR_RXRDY_Pos                     _UINT32_(0)                                          /* (ADC_IMR) Receive Ready Interrupt Disable Position */
#define ADC_IMR_RXRDY_Msk                     (_UINT32_(0x1) << ADC_IMR_RXRDY_Pos)                 /* (ADC_IMR) Receive Ready Interrupt Disable Mask */
...
#define ADC_IMR_RXEMPTY_Pos                   _UINT32_(1)                                          /* (ADC_IMR) Receive FIFO Empty Interrupt Disable Position */
#define ADC_IMR_RXEMPTY_Msk                   (_UINT32_(0x1) << ADC_IMR_RXEMPTY_Pos)               /* (ADC_IMR) Receive FIFO Empty Interrupt Disable Mask */
...
#define ADC_IMR_RXFULL_Pos                    _UINT32_(2)                                          /* (ADC_IMR) Receive FIFO Full Interrupt Disable Position */
#define ADC_IMR_RXFULL_Msk                    (_UINT32_(0x1) << ADC_IMR_RXFULL_Pos)                /* (ADC_IMR) Receive FIFO Full Interrupt Disable Mask */
...
#define ADC_IMR_RXCHUNK_Pos                   _UINT32_(3)                                          /* (ADC_IMR) Receive FIFO Chunk Interrupt Disable Position */
#define ADC_IMR_RXCHUNK_Msk                   (_UINT32_(0x1) << ADC_IMR_RXCHUNK_Pos)               /* (ADC_IMR) Receive FIFO Chunk Interrupt Disable Mask */
...
#define ADC_IMR_RXUDR_Pos                     _UINT32_(4)                                          /* (ADC_IMR) Receive Under Flow Interrupt Disable Position */
#define ADC_IMR_RXUDR_Msk                     (_UINT32_(0x1) << ADC_IMR_RXUDR_Pos)                 /* (ADC_IMR) Receive Under Flow Interrupt Disable Mask */
...
#define ADC_IMR_RXOVR_Pos                     _UINT32_(5)                                          /* (ADC_IMR) Receive Over Flow Interrupt Disable Position */
#define ADC_IMR_RXOVR_Msk                     (_UINT32_(0x1) << ADC_IMR_RXOVR_Pos)                 /* (ADC_IMR) Receive Over Flow Interrupt Disable Mask */
...
#define ADC_IMR_Msk                           _UINT32_(0x070C003F)                                 /* (ADC_IMR) Register Mask  */
...
#define   ADC_ISR_RXRDY_0_Val                 _UINT32_(0x0)                                        /* (ADC_ISR) FIFO has been empty since the last read of ADC_ISR.  */
#define   ADC_ISR_RXRDY_1_Val                 _UINT32_(0x1)                                        /* (ADC_ISR) One element has been written since the last read of ADC_ISR.  */
...
#define   ADC_ISR_RXEMPTY_0_Val               _UINT32_(0x0)                                        /* (ADC_ISR) FIFO has not been empty since the last read of ADC_ISR.  */
#define   ADC_ISR_RXEMPTY_1_Val               _UINT32_(0x1)                                        /* (ADC_ISR) FIFO has been empty since the last read of ADC_ISR.  */
...
#define   ADC_ISR_RXFULL_0_Val                _UINT32_(0x0)                                        /* (ADC_ISR) FIFO has not been full since the last read of ADC_ISR.  */
#define   ADC_ISR_RXFULL_1_Val                _UINT32_(0x1)                                        /* (ADC_ISR) FIFO has been full since the last read of ADC_ISR.  */
...
#define   ADC_ISR_RXCHUNK_0_Val               _UINT32_(0x0)                                        /* (ADC_ISR) The number of written elements in the FIFO has been lower than or not equal to chunk_size since the last read of ADC_ISR.  */
#define   ADC_ISR_RXCHUNK_1_Val               _UINT32_(0x1)                                        /* (ADC_ISR) The number of written elements in the FIFO has been greater than or equal to chunk_size since the last read of ADC_ISR.  */
...
#define   ADC_ISR_RXUDR_0_Val                 _UINT32_(0x0)                                        /* (ADC_ISR) No general underrun error occurred since the last read of ADC_ISR.  */
#define   ADC_ISR_RXUDR_1_Val                 _UINT32_(0x1)                                        /* (ADC_ISR) At least one general underrun error has occurred since the last read of ADC_ISR.  */
...
#define   ADC_ISR_RXOVR_0_Val                 _UINT32_(0x0)                                        /* (ADC_ISR) No general overrun error occurred since the last read of ADC_ISR.  */
#define   ADC_ISR_RXOVR_1_Val                 _UINT32_(0x1)                                        /* (ADC_ISR) At least one general overrun error has occurred since the last read of ADC_ISR.  */
...
#define   ADC_ISR_EOS_0_Val                   _UINT32_(0x0)                                        /* (ADC_ISR) No sequence is in progress or the sequence is not finished. This flag is cleared when reading ADC_ISR.  */
#define   ADC_ISR_EOS_1_Val                   _UINT32_(0x1)                                        /* (ADC_ISR) The sequence is complete.  */
...
#define   ADC_ISR_TEMPCHG_0_Val               _UINT32_(0x0)                                        /* (ADC_ISR) There is no comparison match (defined in the Temperature Compare Window register (ADC_TEMPCWR) since the last read of ADC_ISR.  */
#define   ADC_ISR_TEMPCHG_1_Val               _UINT32_(0x1)                                        /* (ADC_ISR) The temperature value reported on ADC_CDRmax (max=highest index) has changed since the last read of ADC_ISR, according to what is defined in ADC_TEMPTMR and ADC_TEMPCWR.  */
...
#define   ADC_ISR_COMPE_0_Val                 _UINT32_(0x0)                                        /* (ADC_ISR) No comparison event occurred since the last read of ADC_ISR.  */
...
#define ADC_ISR_Msk                           _UINT32_(0x070C003F)                                 /* (ADC_ISR) Register Mask  */
...
#define   ADC_EOC_IER_EOC0_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC0_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC1_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC1_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC2_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC2_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC3_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC3_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC4_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC4_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC5_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC5_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC6_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC6_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define   ADC_EOC_IER_EOC7_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC7_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC8_Pos                  _UINT32_(8)                                          /* (ADC_EOC_IER) End of Conversion Interrupt Enable 8 Position */
#define ADC_EOC_IER_EOC8_Msk                  (_UINT32_(0x1) << ADC_EOC_IER_EOC8_Pos)              /* (ADC_EOC_IER) End of Conversion Interrupt Enable 8 Mask */
#define ADC_EOC_IER_EOC8(value)               (ADC_EOC_IER_EOC8_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC8_Pos)) /* Assigment of value for EOC8 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC8_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC8_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC9_Pos                  _UINT32_(9)                                          /* (ADC_EOC_IER) End of Conversion Interrupt Enable 9 Position */
#define ADC_EOC_IER_EOC9_Msk                  (_UINT32_(0x1) << ADC_EOC_IER_EOC9_Pos)              /* (ADC_EOC_IER) End of Conversion Interrupt Enable 9 Mask */
#define ADC_EOC_IER_EOC9(value)               (ADC_EOC_IER_EOC9_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC9_Pos)) /* Assigment of value for EOC9 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC9_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC9_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC10_Pos                 _UINT32_(10)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 10 Position */
#define ADC_EOC_IER_EOC10_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC10_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 10 Mask */
#define ADC_EOC_IER_EOC10(value)              (ADC_EOC_IER_EOC10_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC10_Pos)) /* Assigment of value for EOC10 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC10_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC10_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC11_Pos                 _UINT32_(11)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 11 Position */
#define ADC_EOC_IER_EOC11_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC11_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 11 Mask */
#define ADC_EOC_IER_EOC11(value)              (ADC_EOC_IER_EOC11_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC11_Pos)) /* Assigment of value for EOC11 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC11_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC11_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC12_Pos                 _UINT32_(12)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 12 Position */
#define ADC_EOC_IER_EOC12_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC12_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 12 Mask */
#define ADC_EOC_IER_EOC12(value)              (ADC_EOC_IER_EOC12_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC12_Pos)) /* Assigment of value for EOC12 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC12_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC12_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC13_Pos                 _UINT32_(13)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 13 Position */
#define ADC_EOC_IER_EOC13_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC13_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 13 Mask */
#define ADC_EOC_IER_EOC13(value)              (ADC_EOC_IER_EOC13_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC13_Pos)) /* Assigment of value for EOC13 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC13_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC13_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC14_Pos                 _UINT32_(14)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 14 Position */
#define ADC_EOC_IER_EOC14_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC14_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 14 Mask */
#define ADC_EOC_IER_EOC14(value)              (ADC_EOC_IER_EOC14_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC14_Pos)) /* Assigment of value for EOC14 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC14_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC14_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC15_Pos                 _UINT32_(15)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 15 Position */
#define ADC_EOC_IER_EOC15_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC15_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 15 Mask */
#define ADC_EOC_IER_EOC15(value)              (ADC_EOC_IER_EOC15_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC15_Pos)) /* Assigment of value for EOC15 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC15_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC15_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC30_Pos                 _UINT32_(30)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 30 Position */
#define ADC_EOC_IER_EOC30_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC30_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 30 Mask */
#define ADC_EOC_IER_EOC30(value)              (ADC_EOC_IER_EOC30_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC30_Pos)) /* Assigment of value for EOC30 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC30_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC30_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_EOC31_Pos                 _UINT32_(31)                                         /* (ADC_EOC_IER) End of Conversion Interrupt Enable 31 Position */
#define ADC_EOC_IER_EOC31_Msk                 (_UINT32_(0x1) << ADC_EOC_IER_EOC31_Pos)             /* (ADC_EOC_IER) End of Conversion Interrupt Enable 31 Mask */
#define ADC_EOC_IER_EOC31(value)              (ADC_EOC_IER_EOC31_Msk & (_UINT32_(value) << ADC_EOC_IER_EOC31_Pos)) /* Assigment of value for EOC31 in the ADC_EOC_IER register */
#define   ADC_EOC_IER_EOC31_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IER) No effect.  */
#define   ADC_EOC_IER_EOC31_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IER) Enables the corresponding interrupt.  */
...
#define ADC_EOC_IER_Msk                       _UINT32_(0xC000FFFF)                                 /* (ADC_EOC_IER) Register Mask  */

#define ADC_EOC_IER_EOC_Pos                   _UINT32_(0)                                          /* (ADC_EOC_IER Position) End of Conversion Interrupt Enable 3x */
#define ADC_EOC_IER_EOC_Msk                   (_UINT32_(0x3FFFF) << ADC_EOC_IER_EOC_Pos)           /* (ADC_EOC_IER Mask) EOC */
...
#define   ADC_EOC_IDR_EOC0_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC0_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC1_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC1_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC2_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC2_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC3_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC3_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC4_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC4_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC5_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC5_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC6_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC6_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define   ADC_EOC_IDR_EOC7_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC7_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC8_Pos                  _UINT32_(8)                                          /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 8 Position */
#define ADC_EOC_IDR_EOC8_Msk                  (_UINT32_(0x1) << ADC_EOC_IDR_EOC8_Pos)              /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 8 Mask */
#define ADC_EOC_IDR_EOC8(value)               (ADC_EOC_IDR_EOC8_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC8_Pos)) /* Assigment of value for EOC8 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC8_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC8_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC9_Pos                  _UINT32_(9)                                          /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 9 Position */
#define ADC_EOC_IDR_EOC9_Msk                  (_UINT32_(0x1) << ADC_EOC_IDR_EOC9_Pos)              /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 9 Mask */
#define ADC_EOC_IDR_EOC9(value)               (ADC_EOC_IDR_EOC9_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC9_Pos)) /* Assigment of value for EOC9 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC9_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC9_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC10_Pos                 _UINT32_(10)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 10 Position */
#define ADC_EOC_IDR_EOC10_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC10_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 10 Mask */
#define ADC_EOC_IDR_EOC10(value)              (ADC_EOC_IDR_EOC10_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC10_Pos)) /* Assigment of value for EOC10 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC10_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC10_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC11_Pos                 _UINT32_(11)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 11 Position */
#define ADC_EOC_IDR_EOC11_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC11_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 11 Mask */
#define ADC_EOC_IDR_EOC11(value)              (ADC_EOC_IDR_EOC11_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC11_Pos)) /* Assigment of value for EOC11 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC11_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC11_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC12_Pos                 _UINT32_(12)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 12 Position */
#define ADC_EOC_IDR_EOC12_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC12_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 12 Mask */
#define ADC_EOC_IDR_EOC12(value)              (ADC_EOC_IDR_EOC12_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC12_Pos)) /* Assigment of value for EOC12 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC12_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC12_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC13_Pos                 _UINT32_(13)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 13 Position */
#define ADC_EOC_IDR_EOC13_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC13_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 13 Mask */
#define ADC_EOC_IDR_EOC13(value)              (ADC_EOC_IDR_EOC13_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC13_Pos)) /* Assigment of value for EOC13 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC13_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC13_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC14_Pos                 _UINT32_(14)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 14 Position */
#define ADC_EOC_IDR_EOC14_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC14_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 14 Mask */
#define ADC_EOC_IDR_EOC14(value)              (ADC_EOC_IDR_EOC14_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC14_Pos)) /* Assigment of value for EOC14 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC14_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC14_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC15_Pos                 _UINT32_(15)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 15 Position */
#define ADC_EOC_IDR_EOC15_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC15_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 15 Mask */
#define ADC_EOC_IDR_EOC15(value)              (ADC_EOC_IDR_EOC15_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC15_Pos)) /* Assigment of value for EOC15 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC15_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC15_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC30_Pos                 _UINT32_(30)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 30 Position */
#define ADC_EOC_IDR_EOC30_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC30_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 30 Mask */
#define ADC_EOC_IDR_EOC30(value)              (ADC_EOC_IDR_EOC30_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC30_Pos)) /* Assigment of value for EOC30 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC30_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC30_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_EOC31_Pos                 _UINT32_(31)                                         /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 31 Position */
#define ADC_EOC_IDR_EOC31_Msk                 (_UINT32_(0x1) << ADC_EOC_IDR_EOC31_Pos)             /* (ADC_EOC_IDR) End of Conversion Interrupt Disable 31 Mask */
#define ADC_EOC_IDR_EOC31(value)              (ADC_EOC_IDR_EOC31_Msk & (_UINT32_(value) << ADC_EOC_IDR_EOC31_Pos)) /* Assigment of value for EOC31 in the ADC_EOC_IDR register */
#define   ADC_EOC_IDR_EOC31_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IDR) No effect.  */
#define   ADC_EOC_IDR_EOC31_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IDR) Disables the corresponding interrupt.  */
...
#define ADC_EOC_IDR_Msk                       _UINT32_(0xC000FFFF)                                 /* (ADC_EOC_IDR) Register Mask  */

#define ADC_EOC_IDR_EOC_Pos                   _UINT32_(0)                                          /* (ADC_EOC_IDR Position) End of Conversion Interrupt Disable 3x */
#define ADC_EOC_IDR_EOC_Msk                   (_UINT32_(0x3FFFF) << ADC_EOC_IDR_EOC_Pos)           /* (ADC_EOC_IDR Mask) EOC */
...
#define ADC_EOC_IMR_RESETVALUE                _UINT32_(0x00)                                       /*  (ADC_EOC_IMR) End Of Conversion Interrupt Mask Register  Reset Value */
...
#define   ADC_EOC_IMR_EOC0_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC0_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC1_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC1_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC2_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC2_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC3_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC3_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC4_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC4_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC5_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC5_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC6_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC6_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define   ADC_EOC_IMR_EOC7_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC7_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC8_Pos                  _UINT32_(8)                                          /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 8 Position */
#define ADC_EOC_IMR_EOC8_Msk                  (_UINT32_(0x1) << ADC_EOC_IMR_EOC8_Pos)              /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 8 Mask */
#define ADC_EOC_IMR_EOC8(value)               (ADC_EOC_IMR_EOC8_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC8_Pos)) /* Assigment of value for EOC8 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC8_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC8_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC9_Pos                  _UINT32_(9)                                          /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 9 Position */
#define ADC_EOC_IMR_EOC9_Msk                  (_UINT32_(0x1) << ADC_EOC_IMR_EOC9_Pos)              /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 9 Mask */
#define ADC_EOC_IMR_EOC9(value)               (ADC_EOC_IMR_EOC9_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC9_Pos)) /* Assigment of value for EOC9 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC9_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC9_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC10_Pos                 _UINT32_(10)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 10 Position */
#define ADC_EOC_IMR_EOC10_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC10_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 10 Mask */
#define ADC_EOC_IMR_EOC10(value)              (ADC_EOC_IMR_EOC10_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC10_Pos)) /* Assigment of value for EOC10 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC10_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC10_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC11_Pos                 _UINT32_(11)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 11 Position */
#define ADC_EOC_IMR_EOC11_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC11_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 11 Mask */
#define ADC_EOC_IMR_EOC11(value)              (ADC_EOC_IMR_EOC11_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC11_Pos)) /* Assigment of value for EOC11 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC11_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC11_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC12_Pos                 _UINT32_(12)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 12 Position */
#define ADC_EOC_IMR_EOC12_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC12_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 12 Mask */
#define ADC_EOC_IMR_EOC12(value)              (ADC_EOC_IMR_EOC12_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC12_Pos)) /* Assigment of value for EOC12 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC12_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC12_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC13_Pos                 _UINT32_(13)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 13 Position */
#define ADC_EOC_IMR_EOC13_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC13_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 13 Mask */
#define ADC_EOC_IMR_EOC13(value)              (ADC_EOC_IMR_EOC13_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC13_Pos)) /* Assigment of value for EOC13 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC13_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC13_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC14_Pos                 _UINT32_(14)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 14 Position */
#define ADC_EOC_IMR_EOC14_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC14_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 14 Mask */
#define ADC_EOC_IMR_EOC14(value)              (ADC_EOC_IMR_EOC14_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC14_Pos)) /* Assigment of value for EOC14 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC14_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC14_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC15_Pos                 _UINT32_(15)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 15 Position */
#define ADC_EOC_IMR_EOC15_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC15_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 15 Mask */
#define ADC_EOC_IMR_EOC15(value)              (ADC_EOC_IMR_EOC15_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC15_Pos)) /* Assigment of value for EOC15 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC15_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC15_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC30_Pos                 _UINT32_(30)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 30 Position */
#define ADC_EOC_IMR_EOC30_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC30_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 30 Mask */
#define ADC_EOC_IMR_EOC30(value)              (ADC_EOC_IMR_EOC30_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC30_Pos)) /* Assigment of value for EOC30 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC30_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC30_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_EOC31_Pos                 _UINT32_(31)                                         /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 31 Position */
#define ADC_EOC_IMR_EOC31_Msk                 (_UINT32_(0x1) << ADC_EOC_IMR_EOC31_Pos)             /* (ADC_EOC_IMR) End of Conversion Interrupt Mask 31 Mask */
#define ADC_EOC_IMR_EOC31(value)              (ADC_EOC_IMR_EOC31_Msk & (_UINT32_(value) << ADC_EOC_IMR_EOC31_Pos)) /* Assigment of value for EOC31 in the ADC_EOC_IMR register */
#define   ADC_EOC_IMR_EOC31_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_IMR) The corresponding interrupt is disabled.  */
#define   ADC_EOC_IMR_EOC31_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_IMR) The corresponding interrupt is enabled.  */
...
#define ADC_EOC_IMR_Msk                       _UINT32_(0xC000FFFF)                                 /* (ADC_EOC_IMR) Register Mask  */

#define ADC_EOC_IMR_EOC_Pos                   _UINT32_(0)                                          /* (ADC_EOC_IMR Position) End of Conversion Interrupt Mask 3x */
#define ADC_EOC_IMR_EOC_Msk                   (_UINT32_(0x3FFFF) << ADC_EOC_IMR_EOC_Pos)           /* (ADC_EOC_IMR Mask) EOC */
...
#define ADC_EOC_ISR_RESETVALUE                _UINT32_(0x00)                                       /*  (ADC_EOC_ISR) End Of Conversion Interrupt Status Register  Reset Value */
...
#define   ADC_EOC_ISR_EOC0_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC0_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC1_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC1_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC2_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC2_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC3_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC3_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC4_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC4_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC5_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC5_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC6_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC6_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define   ADC_EOC_ISR_EOC7_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC7_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC8_Pos                  _UINT32_(8)                                          /* (ADC_EOC_ISR) End of Conversion 8 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC8_Msk                  (_UINT32_(0x1) << ADC_EOC_ISR_EOC8_Pos)              /* (ADC_EOC_ISR) End of Conversion 8 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC8(value)               (ADC_EOC_ISR_EOC8_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC8_Pos)) /* Assigment of value for EOC8 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC8_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC8_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC9_Pos                  _UINT32_(9)                                          /* (ADC_EOC_ISR) End of Conversion 9 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC9_Msk                  (_UINT32_(0x1) << ADC_EOC_ISR_EOC9_Pos)              /* (ADC_EOC_ISR) End of Conversion 9 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC9(value)               (ADC_EOC_ISR_EOC9_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC9_Pos)) /* Assigment of value for EOC9 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC9_0_Val              _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC9_1_Val              _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC10_Pos                 _UINT32_(10)                                         /* (ADC_EOC_ISR) End of Conversion 10 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC10_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC10_Pos)             /* (ADC_EOC_ISR) End of Conversion 10 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC10(value)              (ADC_EOC_ISR_EOC10_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC10_Pos)) /* Assigment of value for EOC10 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC10_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC10_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC11_Pos                 _UINT32_(11)                                         /* (ADC_EOC_ISR) End of Conversion 11 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC11_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC11_Pos)             /* (ADC_EOC_ISR) End of Conversion 11 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC11(value)              (ADC_EOC_ISR_EOC11_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC11_Pos)) /* Assigment of value for EOC11 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC11_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC11_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC12_Pos                 _UINT32_(12)                                         /* (ADC_EOC_ISR) End of Conversion 12 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC12_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC12_Pos)             /* (ADC_EOC_ISR) End of Conversion 12 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC12(value)              (ADC_EOC_ISR_EOC12_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC12_Pos)) /* Assigment of value for EOC12 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC12_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC12_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC13_Pos                 _UINT32_(13)                                         /* (ADC_EOC_ISR) End of Conversion 13 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC13_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC13_Pos)             /* (ADC_EOC_ISR) End of Conversion 13 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC13(value)              (ADC_EOC_ISR_EOC13_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC13_Pos)) /* Assigment of value for EOC13 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC13_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC13_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC14_Pos                 _UINT32_(14)                                         /* (ADC_EOC_ISR) End of Conversion 14 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC14_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC14_Pos)             /* (ADC_EOC_ISR) End of Conversion 14 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC14(value)              (ADC_EOC_ISR_EOC14_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC14_Pos)) /* Assigment of value for EOC14 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC14_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC14_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC15_Pos                 _UINT32_(15)                                         /* (ADC_EOC_ISR) End of Conversion 15 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC15_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC15_Pos)             /* (ADC_EOC_ISR) End of Conversion 15 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC15(value)              (ADC_EOC_ISR_EOC15_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC15_Pos)) /* Assigment of value for EOC15 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC15_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC15_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC30_Pos                 _UINT32_(30)                                         /* (ADC_EOC_ISR) End of Conversion 30 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC30_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC30_Pos)             /* (ADC_EOC_ISR) End of Conversion 30 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC30(value)              (ADC_EOC_ISR_EOC30_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC30_Pos)) /* Assigment of value for EOC30 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC30_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC30_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_EOC31_Pos                 _UINT32_(31)                                         /* (ADC_EOC_ISR) End of Conversion 31 (automatically set / cleared) Position */
#define ADC_EOC_ISR_EOC31_Msk                 (_UINT32_(0x1) << ADC_EOC_ISR_EOC31_Pos)             /* (ADC_EOC_ISR) End of Conversion 31 (automatically set / cleared) Mask */
#define ADC_EOC_ISR_EOC31(value)              (ADC_EOC_ISR_EOC31_Msk & (_UINT32_(value) << ADC_EOC_ISR_EOC31_Pos)) /* Assigment of value for EOC31 in the ADC_EOC_ISR register */
#define   ADC_EOC_ISR_EOC31_0_Val             _UINT32_(0x0)                                        /* (ADC_EOC_ISR) The corresponding analog channel is disabled, or the conversion is not finished. This flag is cleared when reading the corresponding ADC_CDRx registers.  */
#define   ADC_EOC_ISR_EOC31_1_Val             _UINT32_(0x1)                                        /* (ADC_EOC_ISR) The corresponding analog channel is enabled and conversion is complete.  */
...
#define ADC_EOC_ISR_Msk                       _UINT32_(0xC000FFFF)                                 /* (ADC_EOC_ISR) Register Mask  */

#define ADC_EOC_ISR_EOC_Pos                   _UINT32_(0)                                          /* (ADC_EOC_ISR Position) End of Conversion 3x (automatically set / cleared) */
#define ADC_EOC_ISR_EOC_Msk                   (_UINT32_(0x3FFFF) << ADC_EOC_ISR_EOC_Pos)           /* (ADC_EOC_ISR Mask) EOC */
...
#define ADC_TEMPMR_RESETVALUE                 _UINT32_(0x00)                                       /*  (ADC_TEMPMR) Temperature Sensor Mode Register  Reset Value */
...
#define   ADC_TEMPMR_TEMPON_0_Val             _UINT32_(0x0)                                        /* (ADC_TEMPMR) Disables the temperature sensor.  */
#define   ADC_TEMPMR_TEMPON_1_Val             _UINT32_(0x1)                                        /* (ADC_TEMPMR) Enables the temperature sensor and the measurements are performed as soon as a trigger event occurs.  */
#define ADC_TEMPMR_TEMPON_0                   (ADC_TEMPMR_TEMPON_0_Val << ADC_TEMPMR_TEMPON_Pos)   /* (ADC_TEMPMR) Disables the temperature sensor. Position  */
#define ADC_TEMPMR_TEMPON_1                   (ADC_TEMPMR_TEMPON_1_Val << ADC_TEMPMR_TEMPON_Pos)   /* (ADC_TEMPMR) Enables the temperature sensor and the measurements are performed as soon as a trigger event occurs. Position  */
...
#define ADC_TEMPCWR_RESETVALUE                _UINT32_(0x00)                                       /*  (ADC_TEMPCWR) Temperature Compare Window Register  Reset Value */
...
#define   ADC_OVER_OVRE0_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE1_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE2_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE3_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE4_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE5_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE6_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE7_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE8_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE8_1_Val                _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE9_0_Val                _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE9_1_Val                _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE10_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE10_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE11_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE11_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE12_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE12_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE13_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE13_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE14_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE14_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define   ADC_OVER_OVRE15_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE15_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define ADC_OVER_OVRE30_Pos                   _UINT32_(30)                                         /* (ADC_OVER) Overrun Error 30 Position */
#define ADC_OVER_OVRE30_Msk                   (_UINT32_(0x1) << ADC_OVER_OVRE30_Pos)               /* (ADC_OVER) Overrun Error 30 Mask */
#define ADC_OVER_OVRE30(value)                (ADC_OVER_OVRE30_Msk & (_UINT32_(value) << ADC_OVER_OVRE30_Pos)) /* Assigment of value for OVRE30 in the ADC_OVER register */
#define   ADC_OVER_OVRE30_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE30_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define ADC_OVER_OVRE31_Pos                   _UINT32_(31)                                         /* (ADC_OVER) Overrun Error 31 Position */
#define ADC_OVER_OVRE31_Msk                   (_UINT32_(0x1) << ADC_OVER_OVRE31_Pos)               /* (ADC_OVER) Overrun Error 31 Mask */
#define ADC_OVER_OVRE31(value)                (ADC_OVER_OVRE31_Msk & (_UINT32_(value) << ADC_OVER_OVRE31_Pos)) /* Assigment of value for OVRE31 in the ADC_OVER register */
#define   ADC_OVER_OVRE31_0_Val               _UINT32_(0x0)                                        /* (ADC_OVER) No overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
#define   ADC_OVER_OVRE31_1_Val               _UINT32_(0x1)                                        /* (ADC_OVER) An overrun error has occurred on the corresponding channel since the last read of ADC_OVER.  */
...
#define ADC_OVER_Msk                          _UINT32_(0xC000FFFF)                                 /* (ADC_OVER) Register Mask  */

#define ADC_OVER_OVRE_Pos                     _UINT32_(0)                                          /* (ADC_OVER Position) Overrun Error 3x */
#define ADC_OVER_OVRE_Msk                     (_UINT32_(0x3FFFF) << ADC_OVER_OVRE_Pos)             /* (ADC_OVER Mask) OVRE */
...
#define   ADC_EMR_CMPALL_0_Val                _UINT32_(0x0)                                        /* (ADC_EMR) Only the channel indicated in CMPSEL is compared.  */
...
#define ADC_EMR_ALWAYS0_Pos                   _UINT32_(21)                                         /* (ADC_EMR) Must always be written to zero Position */
#define ADC_EMR_ALWAYS0_Msk                   (_UINT32_(0x1) << ADC_EMR_ALWAYS0_Pos)               /* (ADC_EMR) Must always be written to zero Mask */
#define ADC_EMR_ALWAYS0(value)                (ADC_EMR_ALWAYS0_Msk & (_UINT32_(value) << ADC_EMR_ALWAYS0_Pos)) /* Assigment of value for ALWAYS0 in the ADC_EMR register */
...
#define   ADC_EMR_TAG_0_Val                   _UINT32_(0x0)                                        /* (ADC_EMR) Sets ADC_LCDR.NO_OSR_CHNB/CHNBOSR to zero.  */
...
#define ADC_EMR_ALTCH_Pos                     _UINT32_(30)                                         /* (ADC_EMR) Alternate Channel Selection (Safety) Position */
#define ADC_EMR_ALTCH_Msk                     (_UINT32_(0x1) << ADC_EMR_ALTCH_Pos)                 /* (ADC_EMR) Alternate Channel Selection (Safety) Mask */
#define ADC_EMR_ALTCH(value)                  (ADC_EMR_ALTCH_Msk & (_UINT32_(value) << ADC_EMR_ALTCH_Pos)) /* Assigment of value for ALTCH in the ADC_EMR register */
#define   ADC_EMR_ALTCH_0_Val                 _UINT32_(0x0)                                        /* (ADC_EMR) The regular channels are selected.  */
#define   ADC_EMR_ALTCH_1_Val                 _UINT32_(0x1)                                        /* (ADC_EMR) The alternate channels are selected.  */
...
#define ADC_EMR_Msk                           _UINT32_(0x77F733F7)                                 /* (ADC_EMR) Register Mask  */

#define ADC_EMR_ALWAYS_Pos                    _UINT32_(21)                                         /* (ADC_EMR Position) Must always be written to zero */
#define ADC_EMR_ALWAYS_Msk                    (_UINT32_(0x1) << ADC_EMR_ALWAYS_Pos)                /* (ADC_EMR Mask) ALWAYS */
#define ADC_EMR_ALWAYS(value)                 (ADC_EMR_ALWAYS_Msk & (_UINT32_(value) << ADC_EMR_ALWAYS_Pos)) 
...
#define ADC_CCR_DIFF8_Pos                     _UINT32_(8)                                          /* (ADC_CCR) Differential Inputs for Channel 8 Position */
#define ADC_CCR_DIFF8_Msk                     (_UINT32_(0x1) << ADC_CCR_DIFF8_Pos)                 /* (ADC_CCR) Differential Inputs for Channel 8 Mask */
#define ADC_CCR_DIFF8(value)                  (ADC_CCR_DIFF8_Msk & (_UINT32_(value) << ADC_CCR_DIFF8_Pos)) /* Assigment of value for DIFF8 in the ADC_CCR register */
#define   ADC_CCR_DIFF8_0_Val                 _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF8_1_Val                 _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF9_Pos                     _UINT32_(9)                                          /* (ADC_CCR) Differential Inputs for Channel 9 Position */
#define ADC_CCR_DIFF9_Msk                     (_UINT32_(0x1) << ADC_CCR_DIFF9_Pos)                 /* (ADC_CCR) Differential Inputs for Channel 9 Mask */
#define ADC_CCR_DIFF9(value)                  (ADC_CCR_DIFF9_Msk & (_UINT32_(value) << ADC_CCR_DIFF9_Pos)) /* Assigment of value for DIFF9 in the ADC_CCR register */
#define   ADC_CCR_DIFF9_0_Val                 _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF9_1_Val                 _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF10_Pos                    _UINT32_(10)                                         /* (ADC_CCR) Differential Inputs for Channel 10 Position */
#define ADC_CCR_DIFF10_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF10_Pos)                /* (ADC_CCR) Differential Inputs for Channel 10 Mask */
#define ADC_CCR_DIFF10(value)                 (ADC_CCR_DIFF10_Msk & (_UINT32_(value) << ADC_CCR_DIFF10_Pos)) /* Assigment of value for DIFF10 in the ADC_CCR register */
#define   ADC_CCR_DIFF10_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF10_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF11_Pos                    _UINT32_(11)                                         /* (ADC_CCR) Differential Inputs for Channel 11 Position */
#define ADC_CCR_DIFF11_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF11_Pos)                /* (ADC_CCR) Differential Inputs for Channel 11 Mask */
#define ADC_CCR_DIFF11(value)                 (ADC_CCR_DIFF11_Msk & (_UINT32_(value) << ADC_CCR_DIFF11_Pos)) /* Assigment of value for DIFF11 in the ADC_CCR register */
#define   ADC_CCR_DIFF11_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF11_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF12_Pos                    _UINT32_(12)                                         /* (ADC_CCR) Differential Inputs for Channel 12 Position */
#define ADC_CCR_DIFF12_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF12_Pos)                /* (ADC_CCR) Differential Inputs for Channel 12 Mask */
#define ADC_CCR_DIFF12(value)                 (ADC_CCR_DIFF12_Msk & (_UINT32_(value) << ADC_CCR_DIFF12_Pos)) /* Assigment of value for DIFF12 in the ADC_CCR register */
#define   ADC_CCR_DIFF12_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF12_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF13_Pos                    _UINT32_(13)                                         /* (ADC_CCR) Differential Inputs for Channel 13 Position */
#define ADC_CCR_DIFF13_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF13_Pos)                /* (ADC_CCR) Differential Inputs for Channel 13 Mask */
#define ADC_CCR_DIFF13(value)                 (ADC_CCR_DIFF13_Msk & (_UINT32_(value) << ADC_CCR_DIFF13_Pos)) /* Assigment of value for DIFF13 in the ADC_CCR register */
#define   ADC_CCR_DIFF13_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF13_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF14_Pos                    _UINT32_(14)                                         /* (ADC_CCR) Differential Inputs for Channel 14 Position */
#define ADC_CCR_DIFF14_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF14_Pos)                /* (ADC_CCR) Differential Inputs for Channel 14 Mask */
#define ADC_CCR_DIFF14(value)                 (ADC_CCR_DIFF14_Msk & (_UINT32_(value) << ADC_CCR_DIFF14_Pos)) /* Assigment of value for DIFF14 in the ADC_CCR register */
#define   ADC_CCR_DIFF14_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF14_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_DIFF15_Pos                    _UINT32_(15)                                         /* (ADC_CCR) Differential Inputs for Channel 15 Position */
#define ADC_CCR_DIFF15_Msk                    (_UINT32_(0x1) << ADC_CCR_DIFF15_Pos)                /* (ADC_CCR) Differential Inputs for Channel 15 Mask */
#define ADC_CCR_DIFF15(value)                 (ADC_CCR_DIFF15_Msk & (_UINT32_(value) << ADC_CCR_DIFF15_Pos)) /* Assigment of value for DIFF15 in the ADC_CCR register */
#define   ADC_CCR_DIFF15_0_Val                _UINT32_(0x0)                                        /* (ADC_CCR) Corresponding channel is set in Single-ended mode.  */
#define   ADC_CCR_DIFF15_1_Val                _UINT32_(0x1)                                        /* (ADC_CCR) Corresponding channel is set in Differential mode.  */
...
#define ADC_CCR_Msk                           _UINT32_(0x0000FFFF)                                 /* (ADC_CCR) Register Mask  */

#define ADC_CCR_DIFF_Pos                      _UINT32_(0)                                          /* (ADC_CCR Position) Differential Inputs for Channel x5 */
#define ADC_CCR_DIFF_Msk                      (_UINT32_(0xFFFF) << ADC_CCR_DIFF_Pos)               /* (ADC_CCR Mask) DIFF */
...
#define ADC_ACR_RESETVALUE                    _UINT32_(0x100)                                      /*  (ADC_ACR) Analog Control Register  Reset Value */
...
#define ADC_ACR_SRCLCH_Pos                    _UINT32_(16)                                         /* (ADC_ACR) Source Last Channel. Position */
#define ADC_ACR_SRCLCH_Msk                    (_UINT32_(0x1) << ADC_ACR_SRCLCH_Pos)                /* (ADC_ACR) Source Last Channel. Mask */
#define ADC_ACR_SRCLCH(value)                 (ADC_ACR_SRCLCH_Msk & (_UINT32_(value) << ADC_ACR_SRCLCH_Pos)) /* Assigment of value for SRCLCH in the ADC_ACR register */
#define   ADC_ACR_SRCLCH_VTEMP_Val            _UINT32_(0x0)                                        /* (ADC_ACR) The highest index channel is driven by the output of the temperature sensor.  */
#define   ADC_ACR_SRCLCH_VBG_Val              _UINT32_(0x1)                                        /* (ADC_ACR) The highest index channel is driven by the reference voltage of the temperature sensor.  */
...
#define ADC_ACR_Msk                           _UINT32_(0x00010300)                                 /* (ADC_ACR) Register Mask  */


/* -------- ADC_FMR : (ADC Offset: 0xE4) (R/W 32) FIFO Mode Register -------- */
#define ADC_FMR_RESETVALUE                    _UINT32_(0x00)                                       /*  (ADC_FMR) FIFO Mode Register  Reset Value */
...
#define ADC_COSR_RESETVALUE                   _UINT32_(0x00)                                       /*  (ADC_COSR) Correction Select Register  Reset Value */
...
#define   ADC_CECR_ECORR8_0_Val               _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR8_1_Val               _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR9_0_Val               _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR9_1_Val               _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR10_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR10_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR11_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR11_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR12_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR12_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR13_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR13_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR14_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR14_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define   ADC_CECR_ECORR15_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR15_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define ADC_CECR_ECORR30_Pos                  _UINT32_(30)                                         /* (ADC_CECR) Error Correction Enable for Channel 30 Position */
#define ADC_CECR_ECORR30_Msk                  (_UINT32_(0x1) << ADC_CECR_ECORR30_Pos)              /* (ADC_CECR) Error Correction Enable for Channel 30 Mask */
#define ADC_CECR_ECORR30(value)               (ADC_CECR_ECORR30_Msk & (_UINT32_(value) << ADC_CECR_ECORR30_Pos)) /* Assigment of value for ECORR30 in the ADC_CECR register */
#define   ADC_CECR_ECORR30_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR30_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define ADC_CECR_ECORR31_Pos                  _UINT32_(31)                                         /* (ADC_CECR) Error Correction Enable for Channel 31 Position */
#define ADC_CECR_ECORR31_Msk                  (_UINT32_(0x1) << ADC_CECR_ECORR31_Pos)              /* (ADC_CECR) Error Correction Enable for Channel 31 Mask */
#define ADC_CECR_ECORR31(value)               (ADC_CECR_ECORR31_Msk & (_UINT32_(value) << ADC_CECR_ECORR31_Pos)) /* Assigment of value for ECORR31 in the ADC_CECR register */
#define   ADC_CECR_ECORR31_0_Val              _UINT32_(0x0)                                        /* (ADC_CECR) Automatic error correction is disabled for channel x.  */
#define   ADC_CECR_ECORR31_1_Val              _UINT32_(0x1)                                        /* (ADC_CECR) Automatic error correction is enabled for channel x.  */
...
#define ADC_CECR_Msk                          _UINT32_(0xC000FFFF)                                 /* (ADC_CECR) Register Mask  */

#define ADC_CECR_ECORR_Pos                    _UINT32_(0)                                          /* (ADC_CECR Position) Error Correction Enable for Channel 3x */
#define ADC_CECR_ECORR_Msk                    (_UINT32_(0x3FFFF) << ADC_CECR_ECORR_Pos)            /* (ADC_CECR Mask) ECORR */
...
#define   ADC_WPMR_WPEN_0_Val                 _UINT32_(0x0)                                        /* (ADC_WPMR) Disables write protection if WPKEY corresponds to 0x414443 ("ADC" in ASCII).  */
#define   ADC_WPMR_WPEN_1_Val                 _UINT32_(0x1)                                        /* (ADC_WPMR) Enables write protection if WPKEY corresponds to 0x414443 ("ADC" in ASCII).  */
...
#define   ADC_WPMR_WPCREN_0_Val               _UINT32_(0x0)                                        /* (ADC_WPMR) Disables the write protection on control registers if WPKEY corresponds to 0x414443 ("ADC" in ASCII).  */
#define   ADC_WPMR_WPCREN_1_Val               _UINT32_(0x1)                                        /* (ADC_WPMR) Enables the write protection on control registers if WPKEY corresponds to 0x414443 ("ADC" in ASCII).  */
...
#define   ADC_WPSR_WPVS_1_Val                 _UINT32_(0x1)                                        /* (ADC_WPSR) A write protection violation has occurred since the last read of ADC_WPSR. If this violation is an unauthorized attempt to write a protected register, the associated violation is reported into WPVSRC.  */
...
#define ADC_CDR_REG_OFST               _UINT32_(0x60)      /* (ADC_CDR) Channel Data Register x Offset */
#define ADC_CDR0_REG_OFST              _UINT32_(0x60)      /* (ADC_CDR0) Channel Data Register x Offset */
#define ADC_CDR1_REG_OFST              _UINT32_(0x64)      /* (ADC_CDR1) Channel Data Register x Offset */
#define ADC_CDR2_REG_OFST              _UINT32_(0x68)      /* (ADC_CDR2) Channel Data Register x Offset */
#define ADC_CDR3_REG_OFST              _UINT32_(0x6C)      /* (ADC_CDR3) Channel Data Register x Offset */
#define ADC_CDR4_REG_OFST              _UINT32_(0x70)      /* (ADC_CDR4) Channel Data Register x Offset */
#define ADC_CDR5_REG_OFST              _UINT32_(0x74)      /* (ADC_CDR5) Channel Data Register x Offset */
#define ADC_CDR6_REG_OFST              _UINT32_(0x78)      /* (ADC_CDR6) Channel Data Register x Offset */
#define ADC_CDR7_REG_OFST              _UINT32_(0x7C)      /* (ADC_CDR7) Channel Data Register x Offset */
#define ADC_CDR8_REG_OFST              _UINT32_(0x80)      /* (ADC_CDR8) Channel Data Register x Offset */
#define ADC_CDR9_REG_OFST              _UINT32_(0x84)      /* (ADC_CDR9) Channel Data Register x Offset */
#define ADC_CDR10_REG_OFST             _UINT32_(0x88)      /* (ADC_CDR10) Channel Data Register x Offset */
#define ADC_CDR11_REG_OFST             _UINT32_(0x8C)      /* (ADC_CDR11) Channel Data Register x Offset */
#define ADC_CDR12_REG_OFST             _UINT32_(0x90)      /* (ADC_CDR12) Channel Data Register x Offset */
#define ADC_CDR13_REG_OFST             _UINT32_(0x94)      /* (ADC_CDR13) Channel Data Register x Offset */
#define ADC_CDR14_REG_OFST             _UINT32_(0x98)      /* (ADC_CDR14) Channel Data Register x Offset */
#define ADC_CDR15_REG_OFST             _UINT32_(0x9C)      /* (ADC_CDR15) Channel Data Register x Offset */
#define ADC_CDR16_REG_OFST             _UINT32_(0xA0)      /* (ADC_CDR16) Channel Data Register x Offset */
#define ADC_CDR17_REG_OFST             _UINT32_(0xA4)      /* (ADC_CDR17) Channel Data Register x Offset */
#define ADC_CDR18_REG_OFST             _UINT32_(0xA8)      /* (ADC_CDR18) Channel Data Register x Offset */
#define ADC_CDR19_REG_OFST             _UINT32_(0xAC)      /* (ADC_CDR19) Channel Data Register x Offset */
#define ADC_CDR20_REG_OFST             _UINT32_(0xB0)      /* (ADC_CDR20) Channel Data Register x Offset */
#define ADC_CDR21_REG_OFST             _UINT32_(0xB4)      /* (ADC_CDR21) Channel Data Register x Offset */
#define ADC_CDR22_REG_OFST             _UINT32_(0xB8)      /* (ADC_CDR22) Channel Data Register x Offset */
#define ADC_CDR23_REG_OFST             _UINT32_(0xBC)      /* (ADC_CDR23) Channel Data Register x Offset */
#define ADC_CDR24_REG_OFST             _UINT32_(0xC0)      /* (ADC_CDR24) Channel Data Register x Offset */
#define ADC_CDR25_REG_OFST             _UINT32_(0xC4)      /* (ADC_CDR25) Channel Data Register x Offset */
#define ADC_CDR26_REG_OFST             _UINT32_(0xC8)      /* (ADC_CDR26) Channel Data Register x Offset */
#define ADC_CDR27_REG_OFST             _UINT32_(0xCC)      /* (ADC_CDR27) Channel Data Register x Offset */
#define ADC_CDR28_REG_OFST             _UINT32_(0xD0)      /* (ADC_CDR28) Channel Data Register x Offset */
#define ADC_CDR29_REG_OFST             _UINT32_(0xD4)      /* (ADC_CDR29) Channel Data Register x Offset */
#define ADC_CDR30_REG_OFST             _UINT32_(0xD8)      /* (ADC_CDR30) Channel Data Register x Offset */
#define ADC_CDR31_REG_OFST             _UINT32_(0xDC)      /* (ADC_CDR31) Channel Data Register x Offset */
...
#define ADC_TRGR_REG_OFST              _UINT32_(0x100)     /* (ADC_TRGR) Trigger Register Offset */
#define ADC_COSR_REG_OFST              _UINT32_(0x104)     /* (ADC_COSR) Correction Select Register Offset */
#define ADC_CVR_REG_OFST               _UINT32_(0x108)     /* (ADC_CVR) Correction Values Register Offset */
#define ADC_CECR_REG_OFST              _UINT32_(0x10C)     /* (ADC_CECR) Channel Error Correction Register Offset */
#define ADC_WPMR_REG_OFST              _UINT32_(0x118)     /* (ADC_WPMR) Write Protection Mode Register Offset */
#define ADC_WPSR_REG_OFST              _UINT32_(0x11C)     /* (ADC_WPSR) Write Protection Status Register Offset */
...
#endif /* _SAMA7D6_ADC_COMPONENT_H_ */
