...
#define SFR_OHCIICR_SUSPEND0(value)           (SFR_OHCIICR_SUSPEND0_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND0_Pos)) /* Assigment of value for SUSPEND0 in the SFR_OHCIICR register */
...
#define SFR_OHCIICR_SUSPEND1(value)           (SFR_OHCIICR_SUSPEND1_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND1_Pos)) /* Assigment of value for SUSPEND1 in the SFR_OHCIICR register */
...
#define SFR_OHCIICR_SUSPEND2(value)           (SFR_OHCIICR_SUSPEND2_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND2_Pos)) /* Assigment of value for SUSPEND2 in the SFR_OHCIICR register */
...
#define SFR_MSK_ERR_DBG_MODE_DIS_DECERR(value) (SFR_MSK_ERR_DBG_MODE_DIS_DECERR_Msk & (_UINT32_(value) << SFR_MSK_ERR_DBG_MODE_DIS_DECERR_Pos)) /* Assigment of value for DIS_DECERR in the SFR_MSK_ERR_DBG_MODE register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK4_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK4_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK4_ENABLE_Pos)) /* Assigment of value for NIC0_MCK4_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK0_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK0_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK0_ENABLE_Pos)) /* Assigment of value for NIC0_MCK0_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK6_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK6_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK6_ENABLE_Pos)) /* Assigment of value for NIC0_MCK6_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK7_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK7_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK7_ENABLE_Pos)) /* Assigment of value for NIC0_MCK7_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK8_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK8_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK8_ENABLE_Pos)) /* Assigment of value for NIC0_MCK8_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK9_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK9_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK9_ENABLE_Pos)) /* Assigment of value for NIC0_MCK9_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK1_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK1_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK1_ENABLE_Pos)) /* Assigment of value for NIC0_MCK1_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_MCK5_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_MCK5_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_MCK5_ENABLE_Pos)) /* Assigment of value for NIC0_MCK5_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC0_GPV_ENABLE(value) (SFR_NIC_CG_CFG_NIC0_GPV_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC0_GPV_ENABLE_Pos)) /* Assigment of value for NIC0_GPV_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_NIC_CG_CFG_NIC1_MCK3_ENABLE(value) (SFR_NIC_CG_CFG_NIC1_MCK3_ENABLE_Msk & (_UINT32_(value) << SFR_NIC_CG_CFG_NIC1_MCK3_ENABLE_Pos)) /* Assigment of value for NIC1_MCK3_ENABLE in the SFR_NIC_CG_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_UDDRC(value)    (SFR_CLEAR_ONLY_SD_CFG_UDDRC_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_UDDRC_Pos)) /* Assigment of value for UDDRC in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_GPU2DC(value)   (SFR_CLEAR_ONLY_SD_CFG_GPU2DC_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_GPU2DC_Pos)) /* Assigment of value for GPU2DC in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_GMAC0(value)    (SFR_CLEAR_ONLY_SD_CFG_GMAC0_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_GMAC0_Pos)) /* Assigment of value for GMAC0 in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_GMAC1(value)    (SFR_CLEAR_ONLY_SD_CFG_GMAC1_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_GMAC1_Pos)) /* Assigment of value for GMAC1 in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_LCDC(value)     (SFR_CLEAR_ONLY_SD_CFG_LCDC_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_LCDC_Pos)) /* Assigment of value for LCDC in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_SDMMC0(value)   (SFR_CLEAR_ONLY_SD_CFG_SDMMC0_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_SDMMC0_Pos)) /* Assigment of value for SDMMC0 in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_SDMMC1(value)   (SFR_CLEAR_ONLY_SD_CFG_SDMMC1_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_SDMMC1_Pos)) /* Assigment of value for SDMMC1 in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_SDMMC2(value)   (SFR_CLEAR_ONLY_SD_CFG_SDMMC2_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_SDMMC2_Pos)) /* Assigment of value for SDMMC2 in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_UDPHSA(value)   (SFR_CLEAR_ONLY_SD_CFG_UDPHSA_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_UDPHSA_Pos)) /* Assigment of value for UDPHSA in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_UDPHSB(value)   (SFR_CLEAR_ONLY_SD_CFG_UDPHSB_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_UDPHSB_Pos)) /* Assigment of value for UDPHSB in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_EHCI(value)     (SFR_CLEAR_ONLY_SD_CFG_EHCI_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_EHCI_Pos)) /* Assigment of value for EHCI in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_CLEAR_ONLY_SD_CFG_DSI(value)      (SFR_CLEAR_ONLY_SD_CFG_DSI_Msk & (_UINT32_(value) << SFR_CLEAR_ONLY_SD_CFG_DSI_Pos)) /* Assigment of value for DSI in the SFR_CLEAR_ONLY_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_UDDRC(value)       (SFR_DISABLE_SD_CFG_UDDRC_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_UDDRC_Pos)) /* Assigment of value for UDDRC in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_GPU2DC(value)      (SFR_DISABLE_SD_CFG_GPU2DC_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_GPU2DC_Pos)) /* Assigment of value for GPU2DC in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_GMAC0(value)       (SFR_DISABLE_SD_CFG_GMAC0_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_GMAC0_Pos)) /* Assigment of value for GMAC0 in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_GMAC1(value)       (SFR_DISABLE_SD_CFG_GMAC1_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_GMAC1_Pos)) /* Assigment of value for GMAC1 in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_LCDC(value)        (SFR_DISABLE_SD_CFG_LCDC_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_LCDC_Pos)) /* Assigment of value for LCDC in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_SDMMC0(value)      (SFR_DISABLE_SD_CFG_SDMMC0_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_SDMMC0_Pos)) /* Assigment of value for SDMMC0 in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_SDMMC1(value)      (SFR_DISABLE_SD_CFG_SDMMC1_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_SDMMC1_Pos)) /* Assigment of value for SDMMC1 in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_SDMMC2(value)      (SFR_DISABLE_SD_CFG_SDMMC2_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_SDMMC2_Pos)) /* Assigment of value for SDMMC2 in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_UDPHSA(value)      (SFR_DISABLE_SD_CFG_UDPHSA_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_UDPHSA_Pos)) /* Assigment of value for UDPHSA in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_UDPHSB(value)      (SFR_DISABLE_SD_CFG_UDPHSB_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_UDPHSB_Pos)) /* Assigment of value for UDPHSB in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_EHCI(value)        (SFR_DISABLE_SD_CFG_EHCI_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_EHCI_Pos)) /* Assigment of value for EHCI in the SFR_DISABLE_SD_CFG register */
...
#define SFR_DISABLE_SD_CFG_DSI(value)         (SFR_DISABLE_SD_CFG_DSI_Msk & (_UINT32_(value) << SFR_DISABLE_SD_CFG_DSI_Pos)) /* Assigment of value for DSI in the SFR_DISABLE_SD_CFG register */
...
#define SFR_MEMPOWER_POWG_DIS_Pos             _UINT32_(0)                                          /* (SFR_MEMPOWER) Automatic Memory Power Gating Disable for ULP1 and ULP2 Modes Position */
#define SFR_MEMPOWER_POWG_DIS_Msk             (_UINT32_(0x1) << SFR_MEMPOWER_POWG_DIS_Pos)         /* (SFR_MEMPOWER) Automatic Memory Power Gating Disable for ULP1 and ULP2 Modes Mask */
#define SFR_MEMPOWER_POWG_DIS(value)          (SFR_MEMPOWER_POWG_DIS_Msk & (_UINT32_(value) << SFR_MEMPOWER_POWG_DIS_Pos)) /* Assigment of value for POWG_DIS in the SFR_MEMPOWER register */
...
#define SFR_MEMPOWER_DEEPSLEEP_Pos            _UINT32_(1)                                          /* (SFR_MEMPOWER) Automatic Memory Deep Sleep Mode for ULP1 and ULP2 Modes Position */
#define SFR_MEMPOWER_DEEPSLEEP_Msk            (_UINT32_(0x1) << SFR_MEMPOWER_DEEPSLEEP_Pos)        /* (SFR_MEMPOWER) Automatic Memory Deep Sleep Mode for ULP1 and ULP2 Modes Mask */
#define SFR_MEMPOWER_DEEPSLEEP(value)         (SFR_MEMPOWER_DEEPSLEEP_Msk & (_UINT32_(value) << SFR_MEMPOWER_DEEPSLEEP_Pos)) /* Assigment of value for DEEPSLEEP in the SFR_MEMPOWER register */
...
#define SFR_PUFRUCR_RESTRICT_USER_CONTEXT(value) (SFR_PUFRUCR_RESTRICT_USER_CONTEXT_Msk & (_UINT32_(value) << SFR_PUFRUCR_RESTRICT_USER_CONTEXT_Pos)) /* Assigment of value for RESTRICT_USER_CONTEXT in the SFR_PUFRUCR register */
...
#define SFR_PUFWORUCR_RESTRICT_USER_CONTEXT_WO(value) (SFR_PUFWORUCR_RESTRICT_USER_CONTEXT_WO_Msk & (_UINT32_(value) << SFR_PUFWORUCR_RESTRICT_USER_CONTEXT_WO_Pos)) /* Assigment of value for RESTRICT_USER_CONTEXT_WO in the SFR_PUFWORUCR register */
...
#define SFR_TSU_CFG_WIDTH_0(value)            (SFR_TSU_CFG_WIDTH_0_Msk & (_UINT32_(value) << SFR_TSU_CFG_WIDTH_0_Pos)) /* Assigment of value for WIDTH_0 in the SFR_TSU_CFG register */
...
#define SFR_TSU_CFG_WIDTH_1(value)            (SFR_TSU_CFG_WIDTH_1_Msk & (_UINT32_(value) << SFR_TSU_CFG_WIDTH_1_Pos)) /* Assigment of value for WIDTH_1 in the SFR_TSU_CFG register */
