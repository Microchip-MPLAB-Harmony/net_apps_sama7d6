...
#define GMAC_NSR_SB_PEND_XFER_Pos             _UINT32_(8)                                          /* (GMAC_NSR) System Bus Pending Transactions Position */
#define GMAC_NSR_SB_PEND_XFER_Msk             (_UINT32_(0x1) << GMAC_NSR_SB_PEND_XFER_Pos)         /* (GMAC_NSR) System Bus Pending Transactions Mask */
#define GMAC_NSR_SB_PEND_XFER(value)          (GMAC_NSR_SB_PEND_XFER_Msk & (_UINT32_(value) << GMAC_NSR_SB_PEND_XFER_Pos)) /* Assigment of value for SB_PEND_XFER in the GMAC_NSR register */
#define GMAC_NSR_Msk                          _UINT32_(0x000001C6)                                 /* (GMAC_NSR) Register Mask  */
...
#define   GMAC_DCFGR_RXBMS_EIGHTH_Val         _UINT32_(0x0)                                        /* (GMAC_DCFGR) 8/8 Kbyte Memory Size  */
#define   GMAC_DCFGR_RXBMS_QUARTER_Val        _UINT32_(0x1)                                        /* (GMAC_DCFGR) 8/4 Kbytes Memory Size  */
#define   GMAC_DCFGR_RXBMS_HALF_Val           _UINT32_(0x2)                                        /* (GMAC_DCFGR) 8/2 Kbytes Memory Size  */
#define   GMAC_DCFGR_RXBMS_FULL_Val           _UINT32_(0x3)                                        /* (GMAC_DCFGR) 8 Kbytes Memory Size  */
#define GMAC_DCFGR_RXBMS_EIGHTH               (GMAC_DCFGR_RXBMS_EIGHTH_Val << GMAC_DCFGR_RXBMS_Pos) /* (GMAC_DCFGR) 8/8 Kbyte Memory Size Position  */
#define GMAC_DCFGR_RXBMS_QUARTER              (GMAC_DCFGR_RXBMS_QUARTER_Val << GMAC_DCFGR_RXBMS_Pos) /* (GMAC_DCFGR) 8/4 Kbytes Memory Size Position  */
#define GMAC_DCFGR_RXBMS_HALF                 (GMAC_DCFGR_RXBMS_HALF_Val << GMAC_DCFGR_RXBMS_Pos)  /* (GMAC_DCFGR) 8/2 Kbytes Memory Size Position  */
#define GMAC_DCFGR_RXBMS_FULL                 (GMAC_DCFGR_RXBMS_FULL_Val << GMAC_DCFGR_RXBMS_Pos)  /* (GMAC_DCFGR) 8 Kbytes Memory Size Position  */
...
/* -------- GMAC_AMP : (GMAC Offset: 0x54) (R/W 32) System Bus Maximum Pipeline -------- */
#define GMAC_AMP_RESETVALUE                   _UINT32_(0x00)                                       /*  (GMAC_AMP) System Bus Maximum Pipeline  Reset Value */

#define GMAC_AMP_AR2R_MAX_PIPELINE_Pos        _UINT32_(0)                                          /* (GMAC_AMP) Address Read Bus to Read Data Bus Maximum Pipeline Position */
#define GMAC_AMP_AR2R_MAX_PIPELINE_Msk        (_UINT32_(0xFF) << GMAC_AMP_AR2R_MAX_PIPELINE_Pos)   /* (GMAC_AMP) Address Read Bus to Read Data Bus Maximum Pipeline Mask */
#define GMAC_AMP_AR2R_MAX_PIPELINE(value)     (GMAC_AMP_AR2R_MAX_PIPELINE_Msk & (_UINT32_(value) << GMAC_AMP_AR2R_MAX_PIPELINE_Pos)) /* Assigment of value for AR2R_MAX_PIPELINE in the GMAC_AMP register */
#define GMAC_AMP_AW2W_MAX_PIPELINE_Pos        _UINT32_(8)                                          /* (GMAC_AMP) Address Write Bus to Write Data Bus Maximum Pipeline Position */
#define GMAC_AMP_AW2W_MAX_PIPELINE_Msk        (_UINT32_(0xFF) << GMAC_AMP_AW2W_MAX_PIPELINE_Pos)   /* (GMAC_AMP) Address Write Bus to Write Data Bus Maximum Pipeline Mask */
#define GMAC_AMP_AW2W_MAX_PIPELINE(value)     (GMAC_AMP_AW2W_MAX_PIPELINE_Msk & (_UINT32_(value) << GMAC_AMP_AW2W_MAX_PIPELINE_Pos)) /* Assigment of value for AW2W_MAX_PIPELINE in the GMAC_AMP register */
#define GMAC_AMP_USE_FROM_Pos                 _UINT32_(16)                                         /* (GMAC_AMP) Address Write Bus to Write Data Bus Maximum Pipeline Position */
#define GMAC_AMP_USE_FROM_Msk                 (_UINT32_(0x1) << GMAC_AMP_USE_FROM_Pos)             /* (GMAC_AMP) Address Write Bus to Write Data Bus Maximum Pipeline Mask */
#define GMAC_AMP_USE_FROM(value)              (GMAC_AMP_USE_FROM_Msk & (_UINT32_(value) << GMAC_AMP_USE_FROM_Pos)) /* Assigment of value for USE_FROM in the GMAC_AMP register */
#define   GMAC_AMP_USE_FROM_AW2W_Val          _UINT32_(0x0)                                        /* (GMAC_AMP) Operates the AW2W_MAX_PIPELINE field between AW to W channel.  */
#define   GMAC_AMP_USE_FROM_AW2B_Val          _UINT32_(0x1)                                        /* (GMAC_AMP) Operates the AW2W_MAX_PIPELINE field between AW to B channel.  */
#define GMAC_AMP_USE_FROM_AW2W                (GMAC_AMP_USE_FROM_AW2W_Val << GMAC_AMP_USE_FROM_Pos) /* (GMAC_AMP) Operates the AW2W_MAX_PIPELINE field between AW to W channel. Position  */
#define GMAC_AMP_USE_FROM_AW2B                (GMAC_AMP_USE_FROM_AW2B_Val << GMAC_AMP_USE_FROM_Pos) /* (GMAC_AMP) Operates the AW2W_MAX_PIPELINE field between AW to B channel. Position  */
#define GMAC_AMP_Msk                          _UINT32_(0x0001FFFF)                                 /* (GMAC_AMP) Register Mask  */
...
#define GMAC_IPGS_MIN_IPG_Pos                 _UINT32_(16)                                         /* (GMAC_IPGS) Minimum Interpacket Gap Position */
#define GMAC_IPGS_MIN_IPG_Msk                 (_UINT32_(0xF) << GMAC_IPGS_MIN_IPG_Pos)             /* (GMAC_IPGS) Minimum Interpacket Gap Mask */
#define GMAC_IPGS_MIN_IPG(value)              (GMAC_IPGS_MIN_IPG_Msk & (_UINT32_(value) << GMAC_IPGS_MIN_IPG_Pos)) /* Assigment of value for MIN_IPG in the GMAC_IPGS register */
#define GMAC_IPGS_IFG_32_Pos                  _UINT32_(30)                                         /* (GMAC_IPGS) Interframe Gap 32 bytes Position */
#define GMAC_IPGS_IFG_32_Msk                  (_UINT32_(0x1) << GMAC_IPGS_IFG_32_Pos)              /* (GMAC_IPGS) Interframe Gap 32 bytes Mask */
#define GMAC_IPGS_IFG_32(value)               (GMAC_IPGS_IFG_32_Msk & (_UINT32_(value) << GMAC_IPGS_IFG_32_Pos)) /* Assigment of value for IFG_32 in the GMAC_IPGS register */
#define   GMAC_IPGS_IFG_32_0_Val              _UINT32_(0x0)                                        /* (GMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_24=0.  */
#define   GMAC_IPGS_IFG_32_1_Val              _UINT32_(0x1)                                        /* (GMAC_IPGS) Defines a minimum interframe gap of 32 bytes when MIN_IPG=0.  */
#define GMAC_IPGS_IFG_32_0                    (GMAC_IPGS_IFG_32_0_Val << GMAC_IPGS_IFG_32_Pos)     /* (GMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_24=0. Position  */
#define GMAC_IPGS_IFG_32_1                    (GMAC_IPGS_IFG_32_1_Val << GMAC_IPGS_IFG_32_Pos)     /* (GMAC_IPGS) Defines a minimum interframe gap of 32 bytes when MIN_IPG=0. Position  */
#define GMAC_IPGS_IFG_24_Pos                  _UINT32_(31)                                         /* (GMAC_IPGS) Interframe Gap 24 bytes Position */
#define GMAC_IPGS_IFG_24_Msk                  (_UINT32_(0x1) << GMAC_IPGS_IFG_24_Pos)              /* (GMAC_IPGS) Interframe Gap 24 bytes Mask */
#define GMAC_IPGS_IFG_24(value)               (GMAC_IPGS_IFG_24_Msk & (_UINT32_(value) << GMAC_IPGS_IFG_24_Pos)) /* Assigment of value for IFG_24 in the GMAC_IPGS register */
#define   GMAC_IPGS_IFG_24_0_Val              _UINT32_(0x0)                                        /* (GMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_32=0.  */
#define   GMAC_IPGS_IFG_24_1_Val              _UINT32_(0x1)                                        /* (GMAC_IPGS) Defines a minimum interframe gap of 24 bytes when MIN_IPG=0.  */
#define GMAC_IPGS_IFG_24_0                    (GMAC_IPGS_IFG_24_0_Val << GMAC_IPGS_IFG_24_Pos)     /* (GMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_32=0. Position  */
#define GMAC_IPGS_IFG_24_1                    (GMAC_IPGS_IFG_24_1_Val << GMAC_IPGS_IFG_24_Pos)     /* (GMAC_IPGS) Defines a minimum interframe gap of 24 bytes when MIN_IPG=0. Position  */
#define GMAC_IPGS_Msk                         _UINT32_(0xC00FFFFF)                                 /* (GMAC_IPGS) Register Mask  */

#define GMAC_IPGS_IFG__Pos                    _UINT32_(30)                                         /* (GMAC_IPGS Position) Interframe Gap 24 bytes */
#define GMAC_IPGS_IFG__Msk                    (_UINT32_(0x3) << GMAC_IPGS_IFG__Pos)                /* (GMAC_IPGS Mask) IFG_ */
#define GMAC_IPGS_IFG_(value)                 (GMAC_IPGS_IFG__Msk & (_UINT32_(value) << GMAC_IPGS_IFG__Pos)) 
...
/* -------- GMAC_TXPQUANT1 : (GMAC Offset: 0x260) (R/W 32) Transmit Pause Quantum 1 Register -------- */
#define GMAC_TXPQUANT1_RESETVALUE             _UINT32_(0xFFFFFFFF)                                 /*  (GMAC_TXPQUANT1) Transmit Pause Quantum 1 Register  Reset Value */

#define GMAC_TXPQUANT1_QUANT_P2_Pos           _UINT32_(0)                                          /* (GMAC_TXPQUANT1) Priority 2 Transmit Pause Quantum Position */
#define GMAC_TXPQUANT1_QUANT_P2_Msk           (_UINT32_(0xFFFF) << GMAC_TXPQUANT1_QUANT_P2_Pos)    /* (GMAC_TXPQUANT1) Priority 2 Transmit Pause Quantum Mask */
#define GMAC_TXPQUANT1_QUANT_P2(value)        (GMAC_TXPQUANT1_QUANT_P2_Msk & (_UINT32_(value) << GMAC_TXPQUANT1_QUANT_P2_Pos)) /* Assigment of value for QUANT_P2 in the GMAC_TXPQUANT1 register */
#define GMAC_TXPQUANT1_QUANT_P3_Pos           _UINT32_(16)                                         /* (GMAC_TXPQUANT1) Priority 3 Transmit Pause Quantum Position */
#define GMAC_TXPQUANT1_QUANT_P3_Msk           (_UINT32_(0xFFFF) << GMAC_TXPQUANT1_QUANT_P3_Pos)    /* (GMAC_TXPQUANT1) Priority 3 Transmit Pause Quantum Mask */
#define GMAC_TXPQUANT1_QUANT_P3(value)        (GMAC_TXPQUANT1_QUANT_P3_Msk & (_UINT32_(value) << GMAC_TXPQUANT1_QUANT_P3_Pos)) /* Assigment of value for QUANT_P3 in the GMAC_TXPQUANT1 register */
...
#define GMAC_TXPQUANT2_QUANT_P4(value)        (GMAC_TXPQUANT2_QUANT_P4_Msk & (_UINT32_(value) << GMAC_TXPQUANT2_QUANT_P4_Pos)) /* Assigment of value for QUANT_P4 in the GMAC_TXPQUANT2 register */
#define GMAC_TXPQUANT2_QUANT_P5_Pos           _UINT32_(16)                                         /* (GMAC_TXPQUANT2) Priority 5 Transmit Pause Quantum Position */
#define GMAC_TXPQUANT2_QUANT_P5_Msk           (_UINT32_(0xFFFF) << GMAC_TXPQUANT2_QUANT_P5_Pos)    /* (GMAC_TXPQUANT2) Priority 5 Transmit Pause Quantum Mask */
#define GMAC_TXPQUANT2_QUANT_P5(value)        (GMAC_TXPQUANT2_QUANT_P5_Msk & (_UINT32_(value) << GMAC_TXPQUANT2_QUANT_P5_Pos)) /* Assigment of value for QUANT_P5 in the GMAC_TXPQUANT2 register */
#define GMAC_TXPQUANT2_Msk                    _UINT32_(0xFFFFFFFF)                                 /* (GMAC_TXPQUANT2) Register Mask  */


/* -------- GMAC_TXPQUANT3 : (GMAC Offset: 0x268) (R/W 32) Transmit Pause Quantum 3 Register -------- */
#define GMAC_TXPQUANT3_RESETVALUE             _UINT32_(0xFFFFFFFF)                                 /*  (GMAC_TXPQUANT3) Transmit Pause Quantum 3 Register  Reset Value */

#define GMAC_TXPQUANT3_QUANT_P6_Pos           _UINT32_(0)                                          /* (GMAC_TXPQUANT3) Priority 6 Transmit Pause Quantum Position */
#define GMAC_TXPQUANT3_QUANT_P6_Msk           (_UINT32_(0xFFFF) << GMAC_TXPQUANT3_QUANT_P6_Pos)    /* (GMAC_TXPQUANT3) Priority 6 Transmit Pause Quantum Mask */
#define GMAC_TXPQUANT3_QUANT_P6(value)        (GMAC_TXPQUANT3_QUANT_P6_Msk & (_UINT32_(value) << GMAC_TXPQUANT3_QUANT_P6_Pos)) /* Assigment of value for QUANT_P6 in the GMAC_TXPQUANT3 register */
#define GMAC_TXPQUANT3_QUANT_P7_Pos           _UINT32_(16)                                         /* (GMAC_TXPQUANT3) Priority 7 Transmit Pause Quantum Position */
#define GMAC_TXPQUANT3_QUANT_P7_Msk           (_UINT32_(0xFFFF) << GMAC_TXPQUANT3_QUANT_P7_Pos)    /* (GMAC_TXPQUANT3) Priority 7 Transmit Pause Quantum Mask */
#define GMAC_TXPQUANT3_QUANT_P7(value)        (GMAC_TXPQUANT3_QUANT_P7_Msk & (_UINT32_(value) << GMAC_TXPQUANT3_QUANT_P7_Pos)) /* Assigment of value for QUANT_P7 in the GMAC_TXPQUANT3 register */
#define GMAC_TXPQUANT3_Msk                    _UINT32_(0xFFFFFFFF)                                 /* (GMAC_TXPQUANT3) Register Mask  */
...
/* -------- GMAC_QOS_CFG0 : (GMAC Offset: 0x2E0) (R/W 32) System Bus QoS Configuration Register 0 -------- */
#define GMAC_QOS_CFG0_RESETVALUE              _UINT32_(0x00)                                       /*  (GMAC_QOS_CFG0) System Bus QoS Configuration Register 0  Reset Value */

#define GMAC_QOS_CFG0_Q0_DATA_Pos             _UINT32_(0)                                          /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 0 Data Access Position */
#define GMAC_QOS_CFG0_Q0_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG0_Q0_DATA_Pos)         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 0 Data Access Mask */
#define GMAC_QOS_CFG0_Q0_DATA(value)          (GMAC_QOS_CFG0_Q0_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q0_DATA_Pos)) /* Assigment of value for Q0_DATA in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q0_DESCR_Pos            _UINT32_(4)                                          /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 0 Descriptor Access Position */
#define GMAC_QOS_CFG0_Q0_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG0_Q0_DESCR_Pos)        /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 0 Descriptor Access Mask */
#define GMAC_QOS_CFG0_Q0_DESCR(value)         (GMAC_QOS_CFG0_Q0_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q0_DESCR_Pos)) /* Assigment of value for Q0_DESCR in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q1_DATA_Pos             _UINT32_(8)                                          /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 1 Data Access Position */
#define GMAC_QOS_CFG0_Q1_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG0_Q1_DATA_Pos)         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 1 Data Access Mask */
#define GMAC_QOS_CFG0_Q1_DATA(value)          (GMAC_QOS_CFG0_Q1_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q1_DATA_Pos)) /* Assigment of value for Q1_DATA in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q1_DESCR_Pos            _UINT32_(12)                                         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 1 Descriptor Access Position */
#define GMAC_QOS_CFG0_Q1_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG0_Q1_DESCR_Pos)        /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 1 Descriptor Access Mask */
#define GMAC_QOS_CFG0_Q1_DESCR(value)         (GMAC_QOS_CFG0_Q1_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q1_DESCR_Pos)) /* Assigment of value for Q1_DESCR in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q2_DATA_Pos             _UINT32_(16)                                         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 2 Data Access Position */
#define GMAC_QOS_CFG0_Q2_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG0_Q2_DATA_Pos)         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 2 Data Access Mask */
#define GMAC_QOS_CFG0_Q2_DATA(value)          (GMAC_QOS_CFG0_Q2_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q2_DATA_Pos)) /* Assigment of value for Q2_DATA in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q2_DESCR_Pos            _UINT32_(20)                                         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 2 Descriptor Access Position */
#define GMAC_QOS_CFG0_Q2_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG0_Q2_DESCR_Pos)        /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 2 Descriptor Access Mask */
#define GMAC_QOS_CFG0_Q2_DESCR(value)         (GMAC_QOS_CFG0_Q2_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q2_DESCR_Pos)) /* Assigment of value for Q2_DESCR in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q3_DATA_Pos             _UINT32_(24)                                         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 3 Data Access Position */
#define GMAC_QOS_CFG0_Q3_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG0_Q3_DATA_Pos)         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 3 Data Access Mask */
#define GMAC_QOS_CFG0_Q3_DATA(value)          (GMAC_QOS_CFG0_Q3_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q3_DATA_Pos)) /* Assigment of value for Q3_DATA in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Q3_DESCR_Pos            _UINT32_(28)                                         /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 3 Descriptor Access Position */
#define GMAC_QOS_CFG0_Q3_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG0_Q3_DESCR_Pos)        /* (GMAC_QOS_CFG0) System Bus QoS Attributes for Queue 3 Descriptor Access Mask */
#define GMAC_QOS_CFG0_Q3_DESCR(value)         (GMAC_QOS_CFG0_Q3_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q3_DESCR_Pos)) /* Assigment of value for Q3_DESCR in the GMAC_QOS_CFG0 register */
#define GMAC_QOS_CFG0_Msk                     _UINT32_(0xFFFFFFFF)                                 /* (GMAC_QOS_CFG0) Register Mask  */


/* -------- GMAC_QOS_CFG1 : (GMAC Offset: 0x2E4) (R/W 32) System Bus QoS Configuration Register 1 -------- */
#define GMAC_QOS_CFG1_RESETVALUE              _UINT32_(0x00)                                       /*  (GMAC_QOS_CFG1) System Bus QoS Configuration Register 1  Reset Value */

#define GMAC_QOS_CFG1_Q5_DATA_Pos             _UINT32_(0)                                          /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 5 Data Access Position */
#define GMAC_QOS_CFG1_Q5_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG1_Q5_DATA_Pos)         /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 5 Data Access Mask */
#define GMAC_QOS_CFG1_Q5_DATA(value)          (GMAC_QOS_CFG1_Q5_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q5_DATA_Pos)) /* Assigment of value for Q5_DATA in the GMAC_QOS_CFG1 register */
#define GMAC_QOS_CFG1_Q5_DESCR_Pos            _UINT32_(4)                                          /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 5 Descriptor Access Position */
#define GMAC_QOS_CFG1_Q5_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG1_Q5_DESCR_Pos)        /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 5 Descriptor Access Mask */
#define GMAC_QOS_CFG1_Q5_DESCR(value)         (GMAC_QOS_CFG1_Q5_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q5_DESCR_Pos)) /* Assigment of value for Q5_DESCR in the GMAC_QOS_CFG1 register */
#define GMAC_QOS_CFG1_Q6_DATA_Pos             _UINT32_(8)                                          /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 6 Data Access Position */
#define GMAC_QOS_CFG1_Q6_DATA_Msk             (_UINT32_(0xF) << GMAC_QOS_CFG1_Q6_DATA_Pos)         /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 6 Data Access Mask */
#define GMAC_QOS_CFG1_Q6_DATA(value)          (GMAC_QOS_CFG1_Q6_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q6_DATA_Pos)) /* Assigment of value for Q6_DATA in the GMAC_QOS_CFG1 register */
#define GMAC_QOS_CFG1_Q6_DESCR_Pos            _UINT32_(12)                                         /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 6 Descriptor Access Position */
#define GMAC_QOS_CFG1_Q6_DESCR_Msk            (_UINT32_(0xF) << GMAC_QOS_CFG1_Q6_DESCR_Pos)        /* (GMAC_QOS_CFG1) System Bus QoS Attributes for Queue 6 Descriptor Access Mask */
#define GMAC_QOS_CFG1_Q6_DESCR(value)         (GMAC_QOS_CFG1_Q6_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q6_DESCR_Pos)) /* Assigment of value for Q6_DESCR in the GMAC_QOS_CFG1 register */
#define GMAC_QOS_CFG1_Msk                     _UINT32_(0x0000FFFF)                                 /* (GMAC_QOS_CFG1) Register Mask  */
...
/* -------- GMAC_TQBWRL1 : (GMAC Offset: 0x594) (R/W 32) Transmit Queue Bandwidth Rate Limit 1 Register -------- */
#define GMAC_TQBWRL1_RESETVALUE               _UINT32_(0x00)                                       /*  (GMAC_TQBWRL1) Transmit Queue Bandwidth Rate Limit 1 Register  Reset Value */

#define GMAC_TQBWRL1_ALLOCQ4_Pos              _UINT32_(0)                                          /* (GMAC_TQBWRL1) DWRR Weighting or ETS Bandwidth Allocation for Qx Position */
#define GMAC_TQBWRL1_ALLOCQ4_Msk              (_UINT32_(0xFF) << GMAC_TQBWRL1_ALLOCQ4_Pos)         /* (GMAC_TQBWRL1) DWRR Weighting or ETS Bandwidth Allocation for Qx Mask */
#define GMAC_TQBWRL1_ALLOCQ4(value)           (GMAC_TQBWRL1_ALLOCQ4_Msk & (_UINT32_(value) << GMAC_TQBWRL1_ALLOCQ4_Pos)) /* Assigment of value for ALLOCQ4 in the GMAC_TQBWRL1 register */
#define GMAC_TQBWRL1_ALLOCQ5_Pos              _UINT32_(8)                                          /* (GMAC_TQBWRL1) DWRR Weighting or ETS Bandwidth Allocation for Qx Position */
#define GMAC_TQBWRL1_ALLOCQ5_Msk              (_UINT32_(0xFF) << GMAC_TQBWRL1_ALLOCQ5_Pos)         /* (GMAC_TQBWRL1) DWRR Weighting or ETS Bandwidth Allocation for Qx Mask */
#define GMAC_TQBWRL1_ALLOCQ5(value)           (GMAC_TQBWRL1_ALLOCQ5_Msk & (_UINT32_(value) << GMAC_TQBWRL1_ALLOCQ5_Pos)) /* Assigment of value for ALLOCQ5 in the GMAC_TQBWRL1 register */
#define GMAC_TQBWRL1_Msk                      _UINT32_(0x0000FFFF)                                 /* (GMAC_TQBWRL1) Register Mask  */
...
#define   GMAC_EMAC_NCFGR_JFRAME_1_Val        _UINT32_(0x1)                                        /* (GMAC_EMAC_NCFGR) Enables jumbo frames up to 16383 bytes to be accepted. The default length is 10240 bytes.  */
...
#define GMAC_EMAC_NCFGR_JFRAME_1              (GMAC_EMAC_NCFGR_JFRAME_1_Val << GMAC_EMAC_NCFGR_JFRAME_Pos) /* (GMAC_EMAC_NCFGR) Enables jumbo frames up to 16383 bytes to be accepted. The default length is 10240 bytes. Position  */
...
#define GMAC_EMAC_NCFGR_DBW_Pos               _UINT32_(21)                                         /* (GMAC_EMAC_NCFGR) Always Written to 1 Position */
#define GMAC_EMAC_NCFGR_DBW_Msk               (_UINT32_(0x3) << GMAC_EMAC_NCFGR_DBW_Pos)           /* (GMAC_EMAC_NCFGR) Always Written to 1 Mask */
...
#define GMAC_EMAC_NSR_SB_PEND_XFER_Pos        _UINT32_(8)                                          /* (GMAC_EMAC_NSR) System Bus Pending Transactions Position */
#define GMAC_EMAC_NSR_SB_PEND_XFER_Msk        (_UINT32_(0x1) << GMAC_EMAC_NSR_SB_PEND_XFER_Pos)    /* (GMAC_EMAC_NSR) System Bus Pending Transactions Mask */
#define GMAC_EMAC_NSR_SB_PEND_XFER(value)     (GMAC_EMAC_NSR_SB_PEND_XFER_Msk & (_UINT32_(value) << GMAC_EMAC_NSR_SB_PEND_XFER_Pos)) /* Assigment of value for SB_PEND_XFER in the GMAC_EMAC_NSR register */
#define GMAC_EMAC_NSR_Msk                     _UINT32_(0x000001C6)                                 /* (GMAC_EMAC_NSR) Register Mask  */
...
#define   GMAC_EMAC_DCFGR_RXBMS_EIGHTH_Val    _UINT32_(0x0)                                        /* (GMAC_EMAC_DCFGR) 8/8 Kbyte Memory Size  */
#define   GMAC_EMAC_DCFGR_RXBMS_QUARTER_Val   _UINT32_(0x1)                                        /* (GMAC_EMAC_DCFGR) 8/4 Kbytes Memory Size  */
#define   GMAC_EMAC_DCFGR_RXBMS_HALF_Val      _UINT32_(0x2)                                        /* (GMAC_EMAC_DCFGR) 8/2 Kbytes Memory Size  */
#define   GMAC_EMAC_DCFGR_RXBMS_FULL_Val      _UINT32_(0x3)                                        /* (GMAC_EMAC_DCFGR) 8 Kbytes Memory Size  */
#define GMAC_EMAC_DCFGR_RXBMS_EIGHTH          (GMAC_EMAC_DCFGR_RXBMS_EIGHTH_Val << GMAC_EMAC_DCFGR_RXBMS_Pos) /* (GMAC_EMAC_DCFGR) 8/8 Kbyte Memory Size Position  */
#define GMAC_EMAC_DCFGR_RXBMS_QUARTER         (GMAC_EMAC_DCFGR_RXBMS_QUARTER_Val << GMAC_EMAC_DCFGR_RXBMS_Pos) /* (GMAC_EMAC_DCFGR) 8/4 Kbytes Memory Size Position  */
#define GMAC_EMAC_DCFGR_RXBMS_HALF            (GMAC_EMAC_DCFGR_RXBMS_HALF_Val << GMAC_EMAC_DCFGR_RXBMS_Pos) /* (GMAC_EMAC_DCFGR) 8/2 Kbytes Memory Size Position  */
#define GMAC_EMAC_DCFGR_RXBMS_FULL            (GMAC_EMAC_DCFGR_RXBMS_FULL_Val << GMAC_EMAC_DCFGR_RXBMS_Pos) /* (GMAC_EMAC_DCFGR) 8 Kbytes Memory Size Position  */
...
#define GMAC_EMAC_IPGS_MIN_IPG_Pos            _UINT32_(16)                                         /* (GMAC_EMAC_IPGS) Minimum Interpacket Gap Position */
#define GMAC_EMAC_IPGS_MIN_IPG_Msk            (_UINT32_(0xF) << GMAC_EMAC_IPGS_MIN_IPG_Pos)        /* (GMAC_EMAC_IPGS) Minimum Interpacket Gap Mask */
#define GMAC_EMAC_IPGS_MIN_IPG(value)         (GMAC_EMAC_IPGS_MIN_IPG_Msk & (_UINT32_(value) << GMAC_EMAC_IPGS_MIN_IPG_Pos)) /* Assigment of value for MIN_IPG in the GMAC_EMAC_IPGS register */
#define GMAC_EMAC_IPGS_IFG_32_Pos             _UINT32_(30)                                         /* (GMAC_EMAC_IPGS) Interframe Gap 32 bytes Position */
#define GMAC_EMAC_IPGS_IFG_32_Msk             (_UINT32_(0x1) << GMAC_EMAC_IPGS_IFG_32_Pos)         /* (GMAC_EMAC_IPGS) Interframe Gap 32 bytes Mask */
#define GMAC_EMAC_IPGS_IFG_32(value)          (GMAC_EMAC_IPGS_IFG_32_Msk & (_UINT32_(value) << GMAC_EMAC_IPGS_IFG_32_Pos)) /* Assigment of value for IFG_32 in the GMAC_EMAC_IPGS register */
#define   GMAC_EMAC_IPGS_IFG_32_0_Val         _UINT32_(0x0)                                        /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_24=0.  */
#define   GMAC_EMAC_IPGS_IFG_32_1_Val         _UINT32_(0x1)                                        /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 32 bytes when MIN_IPG=0.  */
#define GMAC_EMAC_IPGS_IFG_32_0               (GMAC_EMAC_IPGS_IFG_32_0_Val << GMAC_EMAC_IPGS_IFG_32_Pos) /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_24=0. Position  */
#define GMAC_EMAC_IPGS_IFG_32_1               (GMAC_EMAC_IPGS_IFG_32_1_Val << GMAC_EMAC_IPGS_IFG_32_Pos) /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 32 bytes when MIN_IPG=0. Position  */
#define GMAC_EMAC_IPGS_IFG_24_Pos             _UINT32_(31)                                         /* (GMAC_EMAC_IPGS) Interframe Gap 24 bytes Position */
#define GMAC_EMAC_IPGS_IFG_24_Msk             (_UINT32_(0x1) << GMAC_EMAC_IPGS_IFG_24_Pos)         /* (GMAC_EMAC_IPGS) Interframe Gap 24 bytes Mask */
#define GMAC_EMAC_IPGS_IFG_24(value)          (GMAC_EMAC_IPGS_IFG_24_Msk & (_UINT32_(value) << GMAC_EMAC_IPGS_IFG_24_Pos)) /* Assigment of value for IFG_24 in the GMAC_EMAC_IPGS register */
#define   GMAC_EMAC_IPGS_IFG_24_0_Val         _UINT32_(0x0)                                        /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_32=0.  */
#define   GMAC_EMAC_IPGS_IFG_24_1_Val         _UINT32_(0x1)                                        /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 24 bytes when MIN_IPG=0.  */
#define GMAC_EMAC_IPGS_IFG_24_0               (GMAC_EMAC_IPGS_IFG_24_0_Val << GMAC_EMAC_IPGS_IFG_24_Pos) /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 12 bytes when IFG_32=0. Position  */
#define GMAC_EMAC_IPGS_IFG_24_1               (GMAC_EMAC_IPGS_IFG_24_1_Val << GMAC_EMAC_IPGS_IFG_24_Pos) /* (GMAC_EMAC_IPGS) Defines a minimum interframe gap of 24 bytes when MIN_IPG=0. Position  */
#define GMAC_EMAC_IPGS_Msk                    _UINT32_(0xC00FFFFF)                                 /* (GMAC_EMAC_IPGS) Register Mask  */

#define GMAC_EMAC_IPGS_IFG__Pos               _UINT32_(30)                                         /* (GMAC_EMAC_IPGS Position) Interframe Gap 24 bytes */
#define GMAC_EMAC_IPGS_IFG__Msk               (_UINT32_(0x3) << GMAC_EMAC_IPGS_IFG__Pos)           /* (GMAC_EMAC_IPGS Mask) IFG_ */
#define GMAC_EMAC_IPGS_IFG_(value)            (GMAC_EMAC_IPGS_IFG__Msk & (_UINT32_(value) << GMAC_EMAC_IPGS_IFG__Pos)) 
...
#define GMAC_AMP_REG_OFST              _UINT32_(0x54)      /* (GMAC_AMP) System Bus Maximum Pipeline Offset */
...
#define GMAC_QOS_CFG0_REG_OFST         _UINT32_(0x2E0)     /* (GMAC_QOS_CFG0) System Bus QoS Configuration Register 0 Offset */
#define GMAC_QOS_CFG1_REG_OFST         _UINT32_(0x2E4)     /* (GMAC_QOS_CFG1) System Bus QoS Configuration Register 1 Offset */
...
#define GMAC_TQBWRL1_REG_OFST          _UINT32_(0x594)     /* (GMAC_TQBWRL1) Transmit Queue Bandwidth Rate Limit 1 Register Offset */
...
{  /* Gigabit Ethernet MAC */
  ...
  __IO  uint32_t                       GMAC_AMP;           /**< Offset: 0x54 (R/W  32) System Bus Maximum Pipeline */
  ...
  __I   uint8_t                        Reserved10[0x60];
  __IO  uint32_t                       GMAC_QOS_CFG0;      /**< Offset: 0x2E0 (R/W  32) System Bus QoS Configuration Register 0 */
  __IO  uint32_t                       GMAC_QOS_CFG1;      /**< Offset: 0x2E4 (R/W  32) System Bus QoS Configuration Register 1 */
  __I   uint8_t                        Reserved11[0x118];
  ...
  __IO  uint32_t                       GMAC_TQBWRL1;       /**< Offset: 0x594 (R/W  32) Transmit Queue Bandwidth Rate Limit 1 Register */
  __I   uint8_t                        Reserved20[0x08];
  __IO  uint32_t                       GMAC_TQSA;          /**< Offset: 0x5A0 (R/W  32) Transmit Queue Segment Allocation Register */
  __I   uint8_t                        Reserved21[0x5C];
...
#endif /* _SAMA7D6_GMAC_COMPONENT_H_ */
