...
#ifndef _SAMA7D6_TZC_COMPONENT_H_
#define _SAMA7D6_TZC_COMPONENT_H_
...
#define TZC_CPU_REGION_BASE_BASE_ADDRESS(value) (TZC_CPU_REGION_BASE_BASE_ADDRESS_Msk & (_UINT32_(value) << TZC_CPU_REGION_BASE_BASE_ADDRESS_Pos)) /* Assigment of value for BASE_ADDRESS in the TZC_CPU_REGION_BASE register */
...
#define TZC_CPU_REGION_TOP_TOP_ADDRESS(value) (TZC_CPU_REGION_TOP_TOP_ADDRESS_Msk & (_UINT32_(value) << TZC_CPU_REGION_TOP_TOP_ADDRESS_Pos)) /* Assigment of value for TOP_ADDRESS in the TZC_CPU_REGION_TOP register */
...
#define TZC_CPU_REGION_ATTRIBUTES_FILTER_EN(value) (TZC_CPU_REGION_ATTRIBUTES_FILTER_EN_Msk & (_UINT32_(value) << TZC_CPU_REGION_ATTRIBUTES_FILTER_EN_Pos)) /* Assigment of value for FILTER_EN in the TZC_CPU_REGION_ATTRIBUTES register */
...
#define TZC_CPU_REGION_ATTRIBUTES_S_RD_EN(value) (TZC_CPU_REGION_ATTRIBUTES_S_RD_EN_Msk & (_UINT32_(value) << TZC_CPU_REGION_ATTRIBUTES_S_RD_EN_Pos)) /* Assigment of value for S_RD_EN in the TZC_CPU_REGION_ATTRIBUTES register */
...
#define TZC_CPU_REGION_ATTRIBUTES_S_WR_EN(value) (TZC_CPU_REGION_ATTRIBUTES_S_WR_EN_Msk & (_UINT32_(value) << TZC_CPU_REGION_ATTRIBUTES_S_WR_EN_Pos)) /* Assigment of value for S_WR_EN in the TZC_CPU_REGION_ATTRIBUTES register */
...
#define TZC_CPU_REGION_ID_ACCESS_NS_RD_EN(value) (TZC_CPU_REGION_ID_ACCESS_NS_RD_EN_Msk & (_UINT32_(value) << TZC_CPU_REGION_ID_ACCESS_NS_RD_EN_Pos)) /* Assigment of value for NS_RD_EN in the TZC_CPU_REGION_ID_ACCESS register */
...
#define TZC_CPU_REGION_ID_ACCESS_NS_WR_EN(value) (TZC_CPU_REGION_ID_ACCESS_NS_WR_EN_Msk & (_UINT32_(value) << TZC_CPU_REGION_ID_ACCESS_NS_WR_EN_Pos)) /* Assigment of value for NS_WR_EN in the TZC_CPU_REGION_ID_ACCESS register */
...
#define TZC_SYS_FAIL_ADDRESS_FAIL_ADDRESS(value) (TZC_SYS_FAIL_ADDRESS_FAIL_ADDRESS_Msk & (_UINT32_(value) << TZC_SYS_FAIL_ADDRESS_FAIL_ADDRESS_Pos)) /* Assigment of value for FAIL_ADDRESS in the TZC_SYS_FAIL_ADDRESS register */
...
#define TZC_SYS_FAIL_CONTROL_PRIVILEGED(value) (TZC_SYS_FAIL_CONTROL_PRIVILEGED_Msk & (_UINT32_(value) << TZC_SYS_FAIL_CONTROL_PRIVILEGED_Pos)) /* Assigment of value for PRIVILEGED in the TZC_SYS_FAIL_CONTROL register */
...
#define TZC_SYS_FAIL_CONTROL_NONSECURE(value) (TZC_SYS_FAIL_CONTROL_NONSECURE_Msk & (_UINT32_(value) << TZC_SYS_FAIL_CONTROL_NONSECURE_Pos)) /* Assigment of value for NONSECURE in the TZC_SYS_FAIL_CONTROL register */
...
#define TZC_SYS_FAIL_CONTROL_DIRECTION(value) (TZC_SYS_FAIL_CONTROL_DIRECTION_Msk & (_UINT32_(value) << TZC_SYS_FAIL_CONTROL_DIRECTION_Pos)) /* Assigment of value for DIRECTION in the TZC_SYS_FAIL_CONTROL register */
...
#define TZC_SYS_FAIL_ID_FAIL_ID(value)        (TZC_SYS_FAIL_ID_FAIL_ID_Msk & (_UINT32_(value) << TZC_SYS_FAIL_ID_FAIL_ID_Pos)) /* Assigment of value for FAIL_ID in the TZC_SYS_FAIL_ID register */
...
#define TZC_SYS_REGION_BASE_BASE_ADDRESS(value) (TZC_SYS_REGION_BASE_BASE_ADDRESS_Msk & (_UINT32_(value) << TZC_SYS_REGION_BASE_BASE_ADDRESS_Pos)) /* Assigment of value for BASE_ADDRESS in the TZC_SYS_REGION_BASE register */
...
#define TZC_SYS_REGION_TOP_TOP_ADDRESS(value) (TZC_SYS_REGION_TOP_TOP_ADDRESS_Msk & (_UINT32_(value) << TZC_SYS_REGION_TOP_TOP_ADDRESS_Pos)) /* Assigment of value for TOP_ADDRESS in the TZC_SYS_REGION_TOP register */
...
#define TZC_SYS_REGION_ATTRIBUTES_FILTER_EN(value) (TZC_SYS_REGION_ATTRIBUTES_FILTER_EN_Msk & (_UINT32_(value) << TZC_SYS_REGION_ATTRIBUTES_FILTER_EN_Pos)) /* Assigment of value for FILTER_EN in the TZC_SYS_REGION_ATTRIBUTES register */
...
#define TZC_SYS_REGION_ATTRIBUTES_S_RD_EN(value) (TZC_SYS_REGION_ATTRIBUTES_S_RD_EN_Msk & (_UINT32_(value) << TZC_SYS_REGION_ATTRIBUTES_S_RD_EN_Pos)) /* Assigment of value for S_RD_EN in the TZC_SYS_REGION_ATTRIBUTES register */
...
#define TZC_SYS_REGION_ATTRIBUTES_S_WR_EN(value) (TZC_SYS_REGION_ATTRIBUTES_S_WR_EN_Msk & (_UINT32_(value) << TZC_SYS_REGION_ATTRIBUTES_S_WR_EN_Pos)) /* Assigment of value for S_WR_EN in the TZC_SYS_REGION_ATTRIBUTES register */
...
#define TZC_SYS_REGION_ID_ACCESS_NS_RD_EN(value) (TZC_SYS_REGION_ID_ACCESS_NS_RD_EN_Msk & (_UINT32_(value) << TZC_SYS_REGION_ID_ACCESS_NS_RD_EN_Pos)) /* Assigment of value for NS_RD_EN in the TZC_SYS_REGION_ID_ACCESS register */
...
#define TZC_SYS_REGION_ID_ACCESS_NS_WR_EN(value) (TZC_SYS_REGION_ID_ACCESS_NS_WR_EN_Msk & (_UINT32_(value) << TZC_SYS_REGION_ID_ACCESS_NS_WR_EN_Pos)) /* Assigment of value for NS_WR_EN in the TZC_SYS_REGION_ID_ACCESS register */
...
#define TZC_SYS_ACTION_REACTION_VALUE(value)  (TZC_SYS_ACTION_REACTION_VALUE_Msk & (_UINT32_(value) << TZC_SYS_ACTION_REACTION_VALUE_Pos)) /* Assigment of value for REACTION_VALUE in the TZC_SYS_ACTION register */
...
#define TZC_SYS_GATE_KEEPER_OPEN_REQUEST(value) (TZC_SYS_GATE_KEEPER_OPEN_REQUEST_Msk & (_UINT32_(value) << TZC_SYS_GATE_KEEPER_OPEN_REQUEST_Pos)) /* Assigment of value for OPEN_REQUEST in the TZC_SYS_GATE_KEEPER register */
...
#define TZC_SYS_GATE_KEEPER_OPEN_STATUS(value) (TZC_SYS_GATE_KEEPER_OPEN_STATUS_Msk & (_UINT32_(value) << TZC_SYS_GATE_KEEPER_OPEN_STATUS_Pos)) /* Assigment of value for OPEN_STATUS in the TZC_SYS_GATE_KEEPER register */
...
#define TZC_SYS_SPECULATION_CTRL_READ_SPEC_DISABLE(value) (TZC_SYS_SPECULATION_CTRL_READ_SPEC_DISABLE_Msk & (_UINT32_(value) << TZC_SYS_SPECULATION_CTRL_READ_SPEC_DISABLE_Pos)) /* Assigment of value for READ_SPEC_DISABLE in the TZC_SYS_SPECULATION_CTRL register */
...
#define TZC_SYS_SPECULATION_CTRL_WRITE_SPEC_DISABLE(value) (TZC_SYS_SPECULATION_CTRL_WRITE_SPEC_DISABLE_Msk & (_UINT32_(value) << TZC_SYS_SPECULATION_CTRL_WRITE_SPEC_DISABLE_Pos)) /* Assigment of value for WRITE_SPEC_DISABLE in the TZC_SYS_SPECULATION_CTRL register */
...
#define TZC_SYS_INT_STATUS_STATUS(value)      (TZC_SYS_INT_STATUS_STATUS_Msk & (_UINT32_(value) << TZC_SYS_INT_STATUS_STATUS_Pos)) /* Assigment of value for STATUS in the TZC_SYS_INT_STATUS register */
...
#define TZC_SYS_INT_STATUS_OVERRUN(value)     (TZC_SYS_INT_STATUS_OVERRUN_Msk & (_UINT32_(value) << TZC_SYS_INT_STATUS_OVERRUN_Pos)) /* Assigment of value for OVERRUN in the TZC_SYS_INT_STATUS register */
...
#define TZC_SYS_INT_STATUS_OVERLAP(value)     (TZC_SYS_INT_STATUS_OVERLAP_Msk & (_UINT32_(value) << TZC_SYS_INT_STATUS_OVERLAP_Pos)) /* Assigment of value for OVERLAP in the TZC_SYS_INT_STATUS register */
...
#define TZC_SYS_INT_CLEAR_CLEAR(value)        (TZC_SYS_INT_CLEAR_CLEAR_Msk & (_UINT32_(value) << TZC_SYS_INT_CLEAR_CLEAR_Pos)) /* Assigment of value for CLEAR in the TZC_SYS_INT_CLEAR register */
...
#define TZC_SYS_LPR_FILTER_LP_EN(value)       (TZC_SYS_LPR_FILTER_LP_EN_Msk & (_UINT32_(value) << TZC_SYS_LPR_FILTER_LP_EN_Pos)) /* Assigment of value for FILTER_LP_EN in the TZC_SYS_LPR register */
...
#define TZC_SYS_LPR_CU_LP_EN(value)           (TZC_SYS_LPR_CU_LP_EN_Msk & (_UINT32_(value) << TZC_SYS_LPR_CU_LP_EN_Pos)) /* Assigment of value for CU_LP_EN in the TZC_SYS_LPR register */
...
#define TZC_CPU_ACTION_REACTION_VALUE(value)  (TZC_CPU_ACTION_REACTION_VALUE_Msk & (_UINT32_(value) << TZC_CPU_ACTION_REACTION_VALUE_Pos)) /* Assigment of value for REACTION_VALUE in the TZC_CPU_ACTION register */
...
#define TZC_CPU_GATE_KEEPER_OPEN_REQUEST(value) (TZC_CPU_GATE_KEEPER_OPEN_REQUEST_Msk & (_UINT32_(value) << TZC_CPU_GATE_KEEPER_OPEN_REQUEST_Pos)) /* Assigment of value for OPEN_REQUEST in the TZC_CPU_GATE_KEEPER register */
...
#define TZC_CPU_GATE_KEEPER_OPEN_STATUS(value) (TZC_CPU_GATE_KEEPER_OPEN_STATUS_Msk & (_UINT32_(value) << TZC_CPU_GATE_KEEPER_OPEN_STATUS_Pos)) /* Assigment of value for OPEN_STATUS in the TZC_CPU_GATE_KEEPER register */
...
#define TZC_CPU_SPECULATION_CTRL_READ_SPEC_DISABLE(value) (TZC_CPU_SPECULATION_CTRL_READ_SPEC_DISABLE_Msk & (_UINT32_(value) << TZC_CPU_SPECULATION_CTRL_READ_SPEC_DISABLE_Pos)) /* Assigment of value for READ_SPEC_DISABLE in the TZC_CPU_SPECULATION_CTRL register */
...
#define TZC_CPU_SPECULATION_CTRL_WRITE_SPEC_DISABLE(value) (TZC_CPU_SPECULATION_CTRL_WRITE_SPEC_DISABLE_Msk & (_UINT32_(value) << TZC_CPU_SPECULATION_CTRL_WRITE_SPEC_DISABLE_Pos)) /* Assigment of value for WRITE_SPEC_DISABLE in the TZC_CPU_SPECULATION_CTRL register */
...
#define TZC_CPU_INT_STATUS_STATUS(value)      (TZC_CPU_INT_STATUS_STATUS_Msk & (_UINT32_(value) << TZC_CPU_INT_STATUS_STATUS_Pos)) /* Assigment of value for STATUS in the TZC_CPU_INT_STATUS register */
...
#define TZC_CPU_INT_STATUS_OVERRUN(value)     (TZC_CPU_INT_STATUS_OVERRUN_Msk & (_UINT32_(value) << TZC_CPU_INT_STATUS_OVERRUN_Pos)) /* Assigment of value for OVERRUN in the TZC_CPU_INT_STATUS register */
...
#define TZC_CPU_INT_STATUS_OVERLAP(value)     (TZC_CPU_INT_STATUS_OVERLAP_Msk & (_UINT32_(value) << TZC_CPU_INT_STATUS_OVERLAP_Pos)) /* Assigment of value for OVERLAP in the TZC_CPU_INT_STATUS register */
...
#define TZC_CPU_INT_CLEAR_CLEAR(value)        (TZC_CPU_INT_CLEAR_CLEAR_Msk & (_UINT32_(value) << TZC_CPU_INT_CLEAR_CLEAR_Pos)) /* Assigment of value for CLEAR in the TZC_CPU_INT_CLEAR register */
...
#define TZC_CPU_FAIL_ADDRESS0_FAIL_ADDRESS(value) (TZC_CPU_FAIL_ADDRESS0_FAIL_ADDRESS_Msk & (_UINT32_(value) << TZC_CPU_FAIL_ADDRESS0_FAIL_ADDRESS_Pos)) /* Assigment of value for FAIL_ADDRESS in the TZC_CPU_FAIL_ADDRESS0 register */
...
#define TZC_CPU_FAIL_CONTROL0_PRIVILEGED(value) (TZC_CPU_FAIL_CONTROL0_PRIVILEGED_Msk & (_UINT32_(value) << TZC_CPU_FAIL_CONTROL0_PRIVILEGED_Pos)) /* Assigment of value for PRIVILEGED in the TZC_CPU_FAIL_CONTROL0 register */
...
#define TZC_CPU_FAIL_CONTROL0_NONSECURE(value) (TZC_CPU_FAIL_CONTROL0_NONSECURE_Msk & (_UINT32_(value) << TZC_CPU_FAIL_CONTROL0_NONSECURE_Pos)) /* Assigment of value for NONSECURE in the TZC_CPU_FAIL_CONTROL0 register */
...
#define TZC_CPU_FAIL_CONTROL0_DIRECTION(value) (TZC_CPU_FAIL_CONTROL0_DIRECTION_Msk & (_UINT32_(value) << TZC_CPU_FAIL_CONTROL0_DIRECTION_Pos)) /* Assigment of value for DIRECTION in the TZC_CPU_FAIL_CONTROL0 register */
...
#define TZC_CPU_FAIL_ID0_FAIL_ID(value)       (TZC_CPU_FAIL_ID0_FAIL_ID_Msk & (_UINT32_(value) << TZC_CPU_FAIL_ID0_FAIL_ID_Pos)) /* Assigment of value for FAIL_ID in the TZC_CPU_FAIL_ID0 register */
...
#define TZC_CPU_LPR_FILTER_LP_EN(value)       (TZC_CPU_LPR_FILTER_LP_EN_Msk & (_UINT32_(value) << TZC_CPU_LPR_FILTER_LP_EN_Pos)) /* Assigment of value for FILTER_LP_EN in the TZC_CPU_LPR register */
...
#define TZC_CPU_LPR_CU_LP_EN(value)           (TZC_CPU_LPR_CU_LP_EN_Msk & (_UINT32_(value) << TZC_CPU_LPR_CU_LP_EN_Pos)) /* Assigment of value for CU_LP_EN in the TZC_CPU_LPR register */
...
/** \brief TZC_CPU_REGION register API structure */
typedef struct
{
...
/** \brief TZC_SYS_FAIL register API structure */
typedef struct
{
...
/** \brief TZC_SYS_REGION register API structure */
typedef struct
{
...
#endif /* _SAMA7D6_TZC_COMPONENT_H_ */
