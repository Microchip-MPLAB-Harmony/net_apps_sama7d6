...
#define TCPC_VID_RESETVALUE                   _UINT16_(0x4D8)                                      /*  (TCPC_VID) Vendor ID Register  Reset Value */
...
#define TCPC_PID_RESETVALUE                   _UINT16_(0xFFF)                                      /*  (TCPC_PID) Product ID Register  Reset Value */
...
#define TCPC_DID_RESETVALUE                   _UINT16_(0x100)                                      /*  (TCPC_DID) Device ID Register  Reset Value */
...
#define TCPC_UTCR_RESETVALUE                  _UINT16_(0x102)                                      /*  (TCPC_UTCR) USB Type-C Rev Register  Reset Value */
...
#define TCPC_PDIR_RESETVALUE                  _UINT16_(0x1012)                                     /*  (TCPC_PDIR) PD Interface Rev Register  Reset Value */
...
#define TCPC_AL_CCS_Pos                       _UINT16_(0)                                          /* (TCPC_AL) CC Status Position */
#define TCPC_AL_CCS_Msk                       (_UINT16_(0x1) << TCPC_AL_CCS_Pos)                   /* (TCPC_AL) CC Status Mask */
#define TCPC_AL_CCS(value)                    (TCPC_AL_CCS_Msk & (_UINT16_(value) << TCPC_AL_CCS_Pos)) /* Assigment of value for CCS in the TCPC_AL register */
#define   TCPC_AL_CCS_0_Val                   _UINT16_(0x0)                                        /* (TCPC_AL) CC status not changed.  */
#define   TCPC_AL_CCS_1_Val                   _UINT16_(0x1)                                        /* (TCPC_AL) CC status changed.  */
...
#define TCPC_AL_PWRS_Pos                      _UINT16_(1)                                          /* (TCPC_AL) Power Status Position */
#define TCPC_AL_PWRS_Msk                      (_UINT16_(0x1) << TCPC_AL_PWRS_Pos)                  /* (TCPC_AL) Power Status Mask */
#define TCPC_AL_PWRS(value)                   (TCPC_AL_PWRS_Msk & (_UINT16_(value) << TCPC_AL_PWRS_Pos)) /* Assigment of value for PWRS in the TCPC_AL register */
#define   TCPC_AL_PWRS_0_Val                  _UINT16_(0x0)                                        /* (TCPC_AL) Power status not changed.  */
#define   TCPC_AL_PWRS_1_Val                  _UINT16_(0x1)                                        /* (TCPC_AL) Power status changed.  */
...
#define TCPC_AL_VBUSHI_Pos                    _UINT16_(7)                                          /* (TCPC_AL) VBUS Voltage Alarm High Position */
#define TCPC_AL_VBUSHI_Msk                    (_UINT16_(0x1) << TCPC_AL_VBUSHI_Pos)                /* (TCPC_AL) VBUS Voltage Alarm High Mask */
#define TCPC_AL_VBUSHI(value)                 (TCPC_AL_VBUSHI_Msk & (_UINT16_(value) << TCPC_AL_VBUSHI_Pos)) /* Assigment of value for VBUSHI in the TCPC_AL register */
#define   TCPC_AL_VBUSHI_0_Val                _UINT16_(0x0)                                        /* (TCPC_AL) A high-voltage alarm has not occurred.  */
#define   TCPC_AL_VBUSHI_1_Val                _UINT16_(0x1)                                        /* (TCPC_AL) A high-voltage alarm has occurred.  */
...
#define TCPC_AL_VBUSLO_Pos                    _UINT16_(8)                                          /* (TCPC_AL) VBUS Voltage Alarm Low Position */
#define TCPC_AL_VBUSLO_Msk                    (_UINT16_(0x1) << TCPC_AL_VBUSLO_Pos)                /* (TCPC_AL) VBUS Voltage Alarm Low Mask */
#define TCPC_AL_VBUSLO(value)                 (TCPC_AL_VBUSLO_Msk & (_UINT16_(value) << TCPC_AL_VBUSLO_Pos)) /* Assigment of value for VBUSLO in the TCPC_AL register */
#define   TCPC_AL_VBUSLO_0_Val                _UINT16_(0x0)                                        /* (TCPC_AL) A low-voltage alarm has not occurred.  */
#define   TCPC_AL_VBUSLO_1_Val                _UINT16_(0x1)                                        /* (TCPC_AL) A low-voltage alarm has occurred.  */
...
#define TCPC_AL_FLT_Pos                       _UINT16_(9)                                          /* (TCPC_AL) Fault Position */
#define TCPC_AL_FLT_Msk                       (_UINT16_(0x1) << TCPC_AL_FLT_Pos)                   /* (TCPC_AL) Fault Mask */
#define TCPC_AL_FLT(value)                    (TCPC_AL_FLT_Msk & (_UINT16_(value) << TCPC_AL_FLT_Pos)) /* Assigment of value for FLT in the TCPC_AL register */
#define   TCPC_AL_FLT_0_Val                   _UINT16_(0x0)                                        /* (TCPC_AL) No fault has occurred.  */
#define   TCPC_AL_FLT_1_Val                   _UINT16_(0x1)                                        /* (TCPC_AL) A fault has occurred. Read TCPC_FS.  */
...
#define TCPC_AL_VBUSSNKDS_Pos                 _UINT16_(11)                                         /* (TCPC_AL) VBUS Sink Disconnect Detected Position */
#define TCPC_AL_VBUSSNKDS_Msk                 (_UINT16_(0x1) << TCPC_AL_VBUSSNKDS_Pos)             /* (TCPC_AL) VBUS Sink Disconnect Detected Mask */
#define TCPC_AL_VBUSSNKDS(value)              (TCPC_AL_VBUSSNKDS_Msk & (_UINT16_(value) << TCPC_AL_VBUSSNKDS_Pos)) /* Assigment of value for VBUSSNKDS in the TCPC_AL register */
#define   TCPC_AL_VBUSSNKDS_0_Val             _UINT16_(0x0)                                        /* (TCPC_AL) No VBUS sink disconnect threshold crossing has been detected.  */
#define   TCPC_AL_VBUSSNKDS_1_Val             _UINT16_(0x1)                                        /* (TCPC_AL) A VBUS sink disconnect threshold crossing has been detected.  */
...
#define TCPC_AL_VDA_Pos                       _UINT16_(15)                                         /* (TCPC_AL) Vendor Defined Alert Position */
#define TCPC_AL_VDA_Msk                       (_UINT16_(0x1) << TCPC_AL_VDA_Pos)                   /* (TCPC_AL) Vendor Defined Alert Mask */
#define TCPC_AL_VDA(value)                    (TCPC_AL_VDA_Msk & (_UINT16_(value) << TCPC_AL_VDA_Pos)) /* Assigment of value for VDA in the TCPC_AL register */
#define   TCPC_AL_VDA_0_Val                   _UINT16_(0x0)                                        /* (TCPC_AL) No vendor-defined alert has been detected.  */
#define   TCPC_AL_VDA_1_Val                   _UINT16_(0x1)                                        /* (TCPC_AL) A vendor-defined alert has been detected.  */
...
#define TCPC_AL_Msk                           _UINT16_(0x8B83)                                     /* (TCPC_AL) Register Mask  */


/* -------- TCPC_ALM : (TCPC Offset: 0x12) (R/W 16) Alert Mask Register -------- */
#define TCPC_ALM_RESETVALUE                   _UINT16_(0xFFF)                                      /*  (TCPC_ALM) Alert Mask Register  Reset Value */

#define TCPC_ALM_CCS_Pos                      _UINT16_(0)                                          /* (TCPC_ALM) CC Status Interrupt Mask Position */
#define TCPC_ALM_CCS_Msk                      (_UINT16_(0x1) << TCPC_ALM_CCS_Pos)                  /* (TCPC_ALM) CC Status Interrupt Mask Mask */
#define TCPC_ALM_CCS(value)                   (TCPC_ALM_CCS_Msk & (_UINT16_(value) << TCPC_ALM_CCS_Pos)) /* Assigment of value for CCS in the TCPC_ALM register */
#define TCPC_ALM_PWRS_Pos                     _UINT16_(1)                                          /* (TCPC_ALM) Power Status Interrupt Mask Position */
#define TCPC_ALM_PWRS_Msk                     (_UINT16_(0x1) << TCPC_ALM_PWRS_Pos)                 /* (TCPC_ALM) Power Status Interrupt Mask Mask */
#define TCPC_ALM_PWRS(value)                  (TCPC_ALM_PWRS_Msk & (_UINT16_(value) << TCPC_ALM_PWRS_Pos)) /* Assigment of value for PWRS in the TCPC_ALM register */
#define TCPC_ALM_VBUSHI_Pos                   _UINT16_(7)                                          /* (TCPC_ALM) VBUS Voltage Alarm High Interrupt Mask Position */
#define TCPC_ALM_VBUSHI_Msk                   (_UINT16_(0x1) << TCPC_ALM_VBUSHI_Pos)               /* (TCPC_ALM) VBUS Voltage Alarm High Interrupt Mask Mask */
#define TCPC_ALM_VBUSHI(value)                (TCPC_ALM_VBUSHI_Msk & (_UINT16_(value) << TCPC_ALM_VBUSHI_Pos)) /* Assigment of value for VBUSHI in the TCPC_ALM register */
#define TCPC_ALM_VBUSLO_Pos                   _UINT16_(8)                                          /* (TCPC_ALM) VBUS Voltage Alarm Low Interrupt Mask Position */
#define TCPC_ALM_VBUSLO_Msk                   (_UINT16_(0x1) << TCPC_ALM_VBUSLO_Pos)               /* (TCPC_ALM) VBUS Voltage Alarm Low Interrupt Mask Mask */
#define TCPC_ALM_VBUSLO(value)                (TCPC_ALM_VBUSLO_Msk & (_UINT16_(value) << TCPC_ALM_VBUSLO_Pos)) /* Assigment of value for VBUSLO in the TCPC_ALM register */
#define TCPC_ALM_FLT_Pos                      _UINT16_(9)                                          /* (TCPC_ALM) Fault Interrupt Mask Position */
#define TCPC_ALM_FLT_Msk                      (_UINT16_(0x1) << TCPC_ALM_FLT_Pos)                  /* (TCPC_ALM) Fault Interrupt Mask Mask */
#define TCPC_ALM_FLT(value)                   (TCPC_ALM_FLT_Msk & (_UINT16_(value) << TCPC_ALM_FLT_Pos)) /* Assigment of value for FLT in the TCPC_ALM register */
#define TCPC_ALM_VBUSSNKDS_Pos                _UINT16_(11)                                         /* (TCPC_ALM) VBUS Sink Disconnect Detected Interrupt Mask Position */
#define TCPC_ALM_VBUSSNKDS_Msk                (_UINT16_(0x1) << TCPC_ALM_VBUSSNKDS_Pos)            /* (TCPC_ALM) VBUS Sink Disconnect Detected Interrupt Mask Mask */
#define TCPC_ALM_VBUSSNKDS(value)             (TCPC_ALM_VBUSSNKDS_Msk & (_UINT16_(value) << TCPC_ALM_VBUSSNKDS_Pos)) /* Assigment of value for VBUSSNKDS in the TCPC_ALM register */
#define TCPC_ALM_VDA_Pos                      _UINT16_(15)                                         /* (TCPC_ALM) Vendor Defined Alert Interrupt Mask Position */
#define TCPC_ALM_VDA_Msk                      (_UINT16_(0x1) << TCPC_ALM_VDA_Pos)                  /* (TCPC_ALM) Vendor Defined Alert Interrupt Mask Mask */
#define TCPC_ALM_VDA(value)                   (TCPC_ALM_VDA_Msk & (_UINT16_(value) << TCPC_ALM_VDA_Pos)) /* Assigment of value for VDA in the TCPC_ALM register */
...
#define TCPC_CCS_CC1(value)                   (TCPC_CCS_CC1_Msk & (_UINT8_(value) << TCPC_CCS_CC1_Pos)) /* Assigment of value for CC1 in the TCPC_CCS register */
...
#define TCPC_CCS_CC2(value)                   (TCPC_CCS_CC2_Msk & (_UINT8_(value) << TCPC_CCS_CC2_Pos)) /* Assigment of value for CC2 in the TCPC_CCS register */
...
#define TCPC_CCS_CONRES(value)                (TCPC_CCS_CONRES_Msk & (_UINT8_(value) << TCPC_CCS_CONRES_Pos)) /* Assigment of value for CONRES in the TCPC_CCS register */
#define   TCPC_CCS_CONRES_0_Val               _UINT8_(0x0)                                         /* (TCPC_CCS) TCPC is presenting Rp.  */
#define   TCPC_CCS_CONRES_1_Val               _UINT8_(0x1)                                         /* (TCPC_CCS) TCPC is presenting Rd.  */
...
#define TCPC_CCS_LK4CNX_Pos                   _UINT8_(5)                                           /* (TCPC_CCS) Looking4Connection Position */
#define TCPC_CCS_LK4CNX_Msk                   (_UINT8_(0x1) << TCPC_CCS_LK4CNX_Pos)                /* (TCPC_CCS) Looking4Connection Mask */
#define TCPC_CCS_LK4CNX(value)                (TCPC_CCS_LK4CNX_Msk & (_UINT8_(value) << TCPC_CCS_LK4CNX_Pos)) /* Assigment of value for LK4CNX in the TCPC_CCS register */
#define   TCPC_CCS_LK4CNX_0_Val               _UINT8_(0x0)                                         /* (TCPC_CCS) TCPC is not actively looking for a connection. A transition from '1' to '0' indicates a potential connection has been found.  */
...
#define   TCPC_PS_INIT_1_Val                  _UINT8_(0x1)                                         /* (TCPC_PS) TCPC is still performing internal initialization and the only registers ensuring return of correct values are 00h..0Fh.  */
...
#define TCPC_PS_INIT_1                        (TCPC_PS_INIT_1_Val << TCPC_PS_INIT_Pos)             /* (TCPC_PS) TCPC is still performing internal initialization and the only registers ensuring return of correct values are 00h..0Fh. Position  */
...
#define   TCPC_FS_ALLREGRES_1_Val             _UINT8_(0x1)                                         /* (TCPC_FS) The TCPC has reset all registers to their default value. This happens at initial power-up or if an unexpected power reset occurs.  */
...
#define TCPC_FS_ALLREGRES_1                   (TCPC_FS_ALLREGRES_1_Val << TCPC_FS_ALLREGRES_Pos)   /* (TCPC_FS) The TCPC has reset all registers to their default value. This happens at initial power-up or if an unexpected power reset occurs. Position  */
...
#define TCPC_CMD_COMMAND_Pos                  _UINT8_(0)                                           /* (TCPC_CMD) Command Position */
#define TCPC_CMD_COMMAND_Msk                  (_UINT8_(0xFF) << TCPC_CMD_COMMAND_Pos)              /* (TCPC_CMD) Command Mask */
#define TCPC_CMD_COMMAND(value)               (TCPC_CMD_COMMAND_Msk & (_UINT8_(value) << TCPC_CMD_COMMAND_Pos)) /* Assigment of value for COMMAND in the TCPC_CMD register */
#define   TCPC_CMD_COMMAND_DISABLEVBUSDETECT_Val _UINT8_(0x22)                                        /* (TCPC_CMD) Disables Vbus present detection.  */
#define   TCPC_CMD_COMMAND_ENABLEVBUSDETECT_Val _UINT8_(0x33)                                        /* (TCPC_CMD) Enables Vbus present detection.  */
#define   TCPC_CMD_COMMAND_DISABLESINKVBUS_Val _UINT8_(0x44)                                        /* (TCPC_CMD) Disables sinking power over VBUS. This COMMAND does not disable TCPC_PS.VBUS detection. The TCPC must clear TCPC_FS.VBUSOCPF and TCPC_FS.VBUSOVPF.  */
#define   TCPC_CMD_COMMAND_SINKVBUS_Val       _UINT8_(0x55)                                        /* (TCPC_CMD) Enables sinking power over VBUS and enable VBUS present detection.  */
#define   TCPC_CMD_COMMAND_DISABLESOURCEVBUS_Val _UINT8_(0x66)                                        /* (TCPC_CMD) Disables sourcing power over VBUS. The TCPC shall stop reporting TCPC_FS. Internal or External OCP or OVP Faults. This COMMAND does not disable TCPC_PS.VBUS detection.  */
#define   TCPC_CMD_COMMAND_SOURCEVBUSDEFAULTVOLTAGE_Val _UINT8_(0x77)                                        /* (TCPC_CMD) Enables sourcing vSafe5V over VBUS and enable VBUS present detection. Source must transition to vSafe5V if at a high voltage.  */
#define   TCPC_CMD_COMMAND_LOOK4CONNECTION_Val _UINT8_(0x99)                                        /* (TCPC_CMD) Starts DRP toggling if TCPC_RCTL.DRP=1b. If TCPC_RCTL.CC1/CC2= 01b start with Rp, if TCPC_RCTL.CC1/CC2 =10b start with Rd. If TCPC_RCTL.CC1/CC2 are not both 01b or 10b, then do not start toggling. The TCPM must issue TCPC_CMD.Look4Connection to enable the TCPC to restart connection detection in cases where TCPC_RCTL contents will not change. An example of this is when a potential connection as a source occurred but was further debounced by the TCPM to find the sink disconnected. In this case, a source only or DRP should go back to its Unattached.Src state. This would result in TCPC_RCTL staying the same.  */
...
#define TCPC_DCP1_RESETVALUE                  _UINT16_(0x00)                                       /*  (TCPC_DCP1) Device Capabilities 1 Register  Reset Value */

#define TCPC_DCP1_SRCVBUS_Pos                 _UINT16_(0)                                          /* (TCPC_DCP1) Source VBUS Position */
#define TCPC_DCP1_SRCVBUS_Msk                 (_UINT16_(0x1) << TCPC_DCP1_SRCVBUS_Pos)             /* (TCPC_DCP1) Source VBUS Mask */
#define TCPC_DCP1_SRCVBUS(value)              (TCPC_DCP1_SRCVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SRCVBUS_Pos)) /* Assigment of value for SRCVBUS in the TCPC_DCP1 register */
#define   TCPC_DCP1_SRCVBUS_0_Val             _UINT16_(0x0)                                        /* (TCPC_DCP1) TCPC is not capable of controlling the source path to VBUS.  */
#define   TCPC_DCP1_SRCVBUS_1_Val             _UINT16_(0x1)                                        /* (TCPC_DCP1) TCPC is capable of controlling the source path to VBUS.  */
...
#define TCPC_DCP1_SRCHVBUS_Pos                _UINT16_(1)                                          /* (TCPC_DCP1) Source High Voltage VBUS Position */
#define TCPC_DCP1_SRCHVBUS_Msk                (_UINT16_(0x1) << TCPC_DCP1_SRCHVBUS_Pos)            /* (TCPC_DCP1) Source High Voltage VBUS Mask */
#define TCPC_DCP1_SRCHVBUS(value)             (TCPC_DCP1_SRCHVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SRCHVBUS_Pos)) /* Assigment of value for SRCHVBUS in the TCPC_DCP1 register */
#define   TCPC_DCP1_SRCHVBUS_0_Val            _UINT16_(0x0)                                        /* (TCPC_DCP1) TCPC is not capable of controlling the source high voltage path to VBUS.  */
#define   TCPC_DCP1_SRCHVBUS_1_Val            _UINT16_(0x1)                                        /* (TCPC_DCP1) TCPC is capable of controlling the source high voltage path to VBUS.  */
...
#define TCPC_DCP1_SNKVBUS_Pos                 _UINT16_(2)                                          /* (TCPC_DCP1) Sink VBUS Position */
#define TCPC_DCP1_SNKVBUS_Msk                 (_UINT16_(0x1) << TCPC_DCP1_SNKVBUS_Pos)             /* (TCPC_DCP1) Sink VBUS Mask */
#define TCPC_DCP1_SNKVBUS(value)              (TCPC_DCP1_SNKVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SNKVBUS_Pos)) /* Assigment of value for SNKVBUS in the TCPC_DCP1 register */
#define   TCPC_DCP1_SNKVBUS_0_Val             _UINT16_(0x0)                                        /* (TCPC_DCP1) TCPC is not capable controlling the sink path to the system load.  */
#define   TCPC_DCP1_SNKVBUS_1_Val             _UINT16_(0x1)                                        /* (TCPC_DCP1) TCPC is capable of controlling the sink path to the system load.  */
...
#define TCPC_DCP1_SRCVCN_Pos                  _UINT16_(3)                                          /* (TCPC_DCP1) Source VCONN Position */
#define TCPC_DCP1_SRCVCN_Msk                  (_UINT16_(0x1) << TCPC_DCP1_SRCVCN_Pos)              /* (TCPC_DCP1) Source VCONN Mask */
#define TCPC_DCP1_SRCVCN(value)               (TCPC_DCP1_SRCVCN_Msk & (_UINT16_(value) << TCPC_DCP1_SRCVCN_Pos)) /* Assigment of value for SRCVCN in the TCPC_DCP1 register */
#define   TCPC_DCP1_SRCVCN_0_Val              _UINT16_(0x0)                                        /* (TCPC_DCP1) TCPC is not capable of switching VCONN.  */
#define   TCPC_DCP1_SRCVCN_1_Val              _UINT16_(0x1)                                        /* (TCPC_DCP1) TCPC is capable of switching VCONN.  */
...
#define TCPC_DCP1_SOPDBG_Pos                  _UINT16_(4)                                          /* (TCPC_DCP1) SOP'_DBG/SOP''_DBG Support Position */
#define TCPC_DCP1_SOPDBG_Msk                  (_UINT16_(0x1) << TCPC_DCP1_SOPDBG_Pos)              /* (TCPC_DCP1) SOP'_DBG/SOP''_DBG Support Mask */
#define TCPC_DCP1_SOPDBG(value)               (TCPC_DCP1_SOPDBG_Msk & (_UINT16_(value) << TCPC_DCP1_SOPDBG_Pos)) /* Assigment of value for SOPDBG in the TCPC_DCP1 register */
#define TCPC_DCP1_ROLES_Pos                   _UINT16_(5)                                          /* (TCPC_DCP1) Roles Supported Position */
#define TCPC_DCP1_ROLES_Msk                   (_UINT16_(0x7) << TCPC_DCP1_ROLES_Pos)               /* (TCPC_DCP1) Roles Supported Mask */
#define TCPC_DCP1_ROLES(value)                (TCPC_DCP1_ROLES_Msk & (_UINT16_(value) << TCPC_DCP1_ROLES_Pos)) /* Assigment of value for ROLES in the TCPC_DCP1 register */
#define   TCPC_DCP1_ROLES_ROLE_SRCSNK_Val     _UINT16_(0x0)                                        /* (TCPC_DCP1) USB Type-C Port Manager can configure the Port as Source only or Sink only (not DRP)  */
#define   TCPC_DCP1_ROLES_ROLE_SRC_Val        _UINT16_(0x1)                                        /* (TCPC_DCP1) Source only  */
#define   TCPC_DCP1_ROLES_ROLE_SNK_Val        _UINT16_(0x2)                                        /* (TCPC_DCP1) Sink only  */
#define   TCPC_DCP1_ROLES_ROLE_SNK_ACC_Val    _UINT16_(0x3)                                        /* (TCPC_DCP1) Sink with accessory support  */
#define   TCPC_DCP1_ROLES_ROLE_DRP_Val        _UINT16_(0x4)                                        /* (TCPC_DCP1) DRP only  */
#define   TCPC_DCP1_ROLES_ROLE_ALL_Val        _UINT16_(0x5)                                        /* (TCPC_DCP1) Source, Sink, DRP, Adapter/Cable all supported  */
#define   TCPC_DCP1_ROLES_ROLE_SRCSNKDRP_Val  _UINT16_(0x6)                                        /* (TCPC_DCP1) Source, Sink, DRP  */
#define   TCPC_DCP1_ROLES_ROLE_INVALID_Val    _UINT16_(0x7)                                        /* (TCPC_DCP1) Not valid  */
...
#define TCPC_DCP1_SRCRES_Pos                  _UINT16_(8)                                          /* (TCPC_DCP1) Source Resistor Supported Position */
#define TCPC_DCP1_SRCRES_Msk                  (_UINT16_(0x3) << TCPC_DCP1_SRCRES_Pos)              /* (TCPC_DCP1) Source Resistor Supported Mask */
#define TCPC_DCP1_SRCRES(value)               (TCPC_DCP1_SRCRES_Msk & (_UINT16_(value) << TCPC_DCP1_SRCRES_Pos)) /* Assigment of value for SRCRES in the TCPC_DCP1 register */
#define   TCPC_DCP1_SRCRES_RES_RPDEF_Val      _UINT16_(0x0)                                        /* (TCPC_DCP1) Rp default only  */
#define   TCPC_DCP1_SRCRES_RES_RP1P5_Val      _UINT16_(0x1)                                        /* (TCPC_DCP1) Rp 1.5A and default  */
#define   TCPC_DCP1_SRCRES_RES_RP3_Val        _UINT16_(0x2)                                        /* (TCPC_DCP1) Rp 3.0A, 1.5A, and default  */
...
#define TCPC_DCP1_VBUSMSRAL_Pos               _UINT16_(10)                                         /* (TCPC_DCP1) VBUS Measurement and Alarm Capable Position */
#define TCPC_DCP1_VBUSMSRAL_Msk               (_UINT16_(0x1) << TCPC_DCP1_VBUSMSRAL_Pos)           /* (TCPC_DCP1) VBUS Measurement and Alarm Capable Mask */
#define TCPC_DCP1_VBUSMSRAL(value)            (TCPC_DCP1_VBUSMSRAL_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSMSRAL_Pos)) /* Assigment of value for VBUSMSRAL in the TCPC_DCP1 register */
#define   TCPC_DCP1_VBUSMSRAL_0_Val           _UINT16_(0x0)                                        /* (TCPC_DCP1) No VBUS voltage measurement nor VBUS alarms.  */
#define   TCPC_DCP1_VBUSMSRAL_1_Val           _UINT16_(0x1)                                        /* (TCPC_DCP1) VBUS voltage measurement and VBUS alarms.  */
...
#define TCPC_DCP1_FRCDCH_Pos                  _UINT16_(11)                                         /* (TCPC_DCP1) Force Discharge Position */
#define TCPC_DCP1_FRCDCH_Msk                  (_UINT16_(0x1) << TCPC_DCP1_FRCDCH_Pos)              /* (TCPC_DCP1) Force Discharge Mask */
#define TCPC_DCP1_FRCDCH(value)               (TCPC_DCP1_FRCDCH_Msk & (_UINT16_(value) << TCPC_DCP1_FRCDCH_Pos)) /* Assigment of value for FRCDCH in the TCPC_DCP1 register */
#define   TCPC_DCP1_FRCDCH_0_Val              _UINT16_(0x0)                                        /* (TCPC_DCP1) No force discharge implemented in TCPC.  */
#define   TCPC_DCP1_FRCDCH_1_Val              _UINT16_(0x1)                                        /* (TCPC_DCP1) Force discharge is implemented in the TCPC.  */
...
#define TCPC_DCP1_BLDDCH_Pos                  _UINT16_(12)                                         /* (TCPC_DCP1) Bleed Discharge Position */
#define TCPC_DCP1_BLDDCH_Msk                  (_UINT16_(0x1) << TCPC_DCP1_BLDDCH_Pos)              /* (TCPC_DCP1) Bleed Discharge Mask */
#define TCPC_DCP1_BLDDCH(value)               (TCPC_DCP1_BLDDCH_Msk & (_UINT16_(value) << TCPC_DCP1_BLDDCH_Pos)) /* Assigment of value for BLDDCH in the TCPC_DCP1 register */
#define   TCPC_DCP1_BLDDCH_0_Val              _UINT16_(0x0)                                        /* (TCPC_DCP1) No bleed discharge implemented in TCPC.  */
#define   TCPC_DCP1_BLDDCH_1_Val              _UINT16_(0x1)                                        /* (TCPC_DCP1) Bleed discharge is implemented in the TCPC.  */
...
#define TCPC_DCP1_VBUSOVPR_Pos                _UINT16_(13)                                         /* (TCPC_DCP1) VBUS OVP Reporting Position */
#define TCPC_DCP1_VBUSOVPR_Msk                (_UINT16_(0x1) << TCPC_DCP1_VBUSOVPR_Pos)            /* (TCPC_DCP1) VBUS OVP Reporting Mask */
#define TCPC_DCP1_VBUSOVPR(value)             (TCPC_DCP1_VBUSOVPR_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSOVPR_Pos)) /* Assigment of value for VBUSOVPR in the TCPC_DCP1 register */
#define   TCPC_DCP1_VBUSOVPR_0_Val            _UINT16_(0x0)                                        /* (TCPC_DCP1) VBUS OVP is not reported by the TCPC.  */
#define   TCPC_DCP1_VBUSOVPR_1_Val            _UINT16_(0x1)                                        /* (TCPC_DCP1) VBUS OVP is reported by the TCPC.  */
...
#define TCPC_DCP1_VBUSOCPR_Pos                _UINT16_(14)                                         /* (TCPC_DCP1) VBUS OCP Reporting Position */
#define TCPC_DCP1_VBUSOCPR_Msk                (_UINT16_(0x1) << TCPC_DCP1_VBUSOCPR_Pos)            /* (TCPC_DCP1) VBUS OCP Reporting Mask */
#define TCPC_DCP1_VBUSOCPR(value)             (TCPC_DCP1_VBUSOCPR_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSOCPR_Pos)) /* Assigment of value for VBUSOCPR in the TCPC_DCP1 register */
#define   TCPC_DCP1_VBUSOCPR_0_Val            _UINT16_(0x0)                                        /* (TCPC_DCP1) VBUS OCP is not reported by the TCPC.  */
#define   TCPC_DCP1_VBUSOCPR_1_Val            _UINT16_(0x1)                                        /* (TCPC_DCP1) VBUS OCP is reported by the TCPC.  */
...
#define TCPC_DCP1_Msk                         _UINT16_(0x7FFF)                                     /* (TCPC_DCP1) Register Mask  */


/* -------- TCPC_DCP2 : (TCPC Offset: 0x26) (R/W 16) Device Capabilities 2 Register -------- */
#define TCPC_DCP2_RESETVALUE                  _UINT16_(0x00)                                       /*  (TCPC_DCP2) Device Capabilities 2 Register  Reset Value */

#define TCPC_DCP2_VCOFC_Pos                   _UINT16_(0)                                          /* (TCPC_DCP2) VCONN Overcurrent Fault Capable Position */
#define TCPC_DCP2_VCOFC_Msk                   (_UINT16_(0x1) << TCPC_DCP2_VCOFC_Pos)               /* (TCPC_DCP2) VCONN Overcurrent Fault Capable Mask */
#define TCPC_DCP2_VCOFC(value)                (TCPC_DCP2_VCOFC_Msk & (_UINT16_(value) << TCPC_DCP2_VCOFC_Pos)) /* Assigment of value for VCOFC in the TCPC_DCP2 register */
#define TCPC_DCP2_VCPSP_Pos                   _UINT16_(1)                                          /* (TCPC_DCP2) VCONN Power Supported Position */
#define TCPC_DCP2_VCPSP_Msk                   (_UINT16_(0x7) << TCPC_DCP2_VCPSP_Pos)               /* (TCPC_DCP2) VCONN Power Supported Mask */
#define TCPC_DCP2_VCPSP(value)                (TCPC_DCP2_VCPSP_Msk & (_UINT16_(value) << TCPC_DCP2_VCPSP_Pos)) /* Assigment of value for VCPSP in the TCPC_DCP2 register */
#define TCPC_DCP2_VBUSVALSB_Pos               _UINT16_(4)                                          /* (TCPC_DCP2) VBUS Voltage Alarm LSB Position */
#define TCPC_DCP2_VBUSVALSB_Msk               (_UINT16_(0x3) << TCPC_DCP2_VBUSVALSB_Pos)           /* (TCPC_DCP2) VBUS Voltage Alarm LSB Mask */
#define TCPC_DCP2_VBUSVALSB(value)            (TCPC_DCP2_VBUSVALSB_Msk & (_UINT16_(value) << TCPC_DCP2_VBUSVALSB_Pos)) /* Assigment of value for VBUSVALSB in the TCPC_DCP2 register */
#define TCPC_DCP2_STPDSCHTH_Pos               _UINT16_(6)                                          /* (TCPC_DCP2) Stop Discharge Threshold Position */
#define TCPC_DCP2_STPDSCHTH_Msk               (_UINT16_(0x1) << TCPC_DCP2_STPDSCHTH_Pos)           /* (TCPC_DCP2) Stop Discharge Threshold Mask */
#define TCPC_DCP2_STPDSCHTH(value)            (TCPC_DCP2_STPDSCHTH_Msk & (_UINT16_(value) << TCPC_DCP2_STPDSCHTH_Pos)) /* Assigment of value for STPDSCHTH in the TCPC_DCP2 register */
#define TCPC_DCP2_SKDSCDET_Pos                _UINT16_(7)                                          /* (TCPC_DCP2) Sink Disconnect Detection Position */
#define TCPC_DCP2_SKDSCDET_Msk                (_UINT16_(0x1) << TCPC_DCP2_SKDSCDET_Pos)            /* (TCPC_DCP2) Sink Disconnect Detection Mask */
#define TCPC_DCP2_SKDSCDET(value)             (TCPC_DCP2_SKDSCDET_Msk & (_UINT16_(value) << TCPC_DCP2_SKDSCDET_Pos)) /* Assigment of value for SKDSCDET in the TCPC_DCP2 register */
#define   TCPC_DCP2_SKDSCDET_0_Val            _UINT16_(0x0)                                        /* (TCPC_DCP2) VBUS_SINK_DISCONNECT_THRESHOLD not implemented (default: Use TCPC_PS.VBUS=0b to indicate a Sink disconnect).  */
#define   TCPC_DCP2_SKDSCDET_1_Val            _UINT16_(0x1)                                        /* (TCPC_DCP2) VBUS_SINK_DISCONNECT_THRESHOLD implemented.  */
...
#define TCPC_DCP2_WDTMR_Pos                   _UINT16_(8)                                          /* (TCPC_DCP2) Watchdog Timer Position */
#define TCPC_DCP2_WDTMR_Msk                   (_UINT16_(0x1) << TCPC_DCP2_WDTMR_Pos)               /* (TCPC_DCP2) Watchdog Timer Mask */
#define TCPC_DCP2_WDTMR(value)                (TCPC_DCP2_WDTMR_Msk & (_UINT16_(value) << TCPC_DCP2_WDTMR_Pos)) /* Assigment of value for WDTMR in the TCPC_DCP2 register */
#define   TCPC_DCP2_WDTMR_0_Val               _UINT16_(0x0)                                        /* (TCPC_DCP2) Enable Watchdog Timer not implemented.  */
#define   TCPC_DCP2_WDTMR_1_Val               _UINT16_(0x1)                                        /* (TCPC_DCP2) Enable Watchdog Timer implemented.  */
...
#define TCPC_SIC_FOFVBUS_Pos                  _UINT8_(0)                                           /* (TCPC_SIC) Force Off VBUS (Source or Sink) Position */
#define TCPC_SIC_FOFVBUS_Msk                  (_UINT8_(0x1) << TCPC_SIC_FOFVBUS_Pos)               /* (TCPC_SIC) Force Off VBUS (Source or Sink) Mask */
#define TCPC_SIC_FOFVBUS(value)               (TCPC_SIC_FOFVBUS_Msk & (_UINT8_(value) << TCPC_SIC_FOFVBUS_Pos)) /* Assigment of value for FOFVBUS in the TCPC_SIC register */
#define   TCPC_SIC_FOFVBUS_0_Val              _UINT8_(0x0)                                         /* (TCPC_SIC) Not present in TCPC.  */
#define   TCPC_SIC_FOFVBUS_1_Val              _UINT8_(0x1)                                         /* (TCPC_SIC) Present in TCPC.  */
...
#define TCPC_SIC_VBUSEOCF_Pos                 _UINT8_(1)                                           /* (TCPC_SIC) VBUS External Over-Current Fault Position */
#define TCPC_SIC_VBUSEOCF_Msk                 (_UINT8_(0x1) << TCPC_SIC_VBUSEOCF_Pos)              /* (TCPC_SIC) VBUS External Over-Current Fault Mask */
#define TCPC_SIC_VBUSEOCF(value)              (TCPC_SIC_VBUSEOCF_Msk & (_UINT8_(value) << TCPC_SIC_VBUSEOCF_Pos)) /* Assigment of value for VBUSEOCF in the TCPC_SIC register */
#define   TCPC_SIC_VBUSEOCF_0_Val             _UINT8_(0x0)                                         /* (TCPC_SIC) Not present in TCPC.  */
#define   TCPC_SIC_VBUSEOCF_1_Val             _UINT8_(0x1)                                         /* (TCPC_SIC) Present in TCPC.  */
...
#define TCPC_SIC_VBUSEOVF_Pos                 _UINT8_(2)                                           /* (TCPC_SIC) VBUS External Over-Voltage Fault Position */
#define TCPC_SIC_VBUSEOVF_Msk                 (_UINT8_(0x1) << TCPC_SIC_VBUSEOVF_Pos)              /* (TCPC_SIC) VBUS External Over-Voltage Fault Mask */
#define TCPC_SIC_VBUSEOVF(value)              (TCPC_SIC_VBUSEOVF_Msk & (_UINT8_(value) << TCPC_SIC_VBUSEOVF_Pos)) /* Assigment of value for VBUSEOVF in the TCPC_SIC register */
#define   TCPC_SIC_VBUSEOVF_0_Val             _UINT8_(0x0)                                         /* (TCPC_SIC) Not present in TCPC.  */
#define   TCPC_SIC_VBUSEOVF_1_Val             _UINT8_(0x1)                                         /* (TCPC_SIC) Present in TCPC.  */
...
#define TCPC_SIC_Msk                          _UINT8_(0x07)                                        /* (TCPC_SIC) Register Mask  */


/* -------- TCPC_SOC : (TCPC Offset: 0x29) (R/W 8) Standard Output Capabilities Register -------- */
#define TCPC_SOC_RESETVALUE                   _UINT8_(0x00)                                        /*  (TCPC_SOC) Standard Output Capabilities Register  Reset Value */

#define TCPC_SOC_CNROR_Pos                    _UINT8_(0)                                           /* (TCPC_SOC) Connector Orientation Position */
#define TCPC_SOC_CNROR_Msk                    (_UINT8_(0x1) << TCPC_SOC_CNROR_Pos)                 /* (TCPC_SOC) Connector Orientation Mask */
#define TCPC_SOC_CNROR(value)                 (TCPC_SOC_CNROR_Msk & (_UINT8_(value) << TCPC_SOC_CNROR_Pos)) /* Assigment of value for CNROR in the TCPC_SOC register */
#define   TCPC_SOC_CNROR_0_Val                _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_CNROR_1_Val                _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SOC_CNXPR_Pos                    _UINT8_(1)                                           /* (TCPC_SOC) Connection Present Position */
#define TCPC_SOC_CNXPR_Msk                    (_UINT8_(0x1) << TCPC_SOC_CNXPR_Pos)                 /* (TCPC_SOC) Connection Present Mask */
#define TCPC_SOC_CNXPR(value)                 (TCPC_SOC_CNXPR_Msk & (_UINT8_(value) << TCPC_SOC_CNXPR_Pos)) /* Assigment of value for CNXPR in the TCPC_SOC register */
#define   TCPC_SOC_CNXPR_0_Val                _UINT8_(0x0)                                         /* (TCPC_SOC) No connection.  */
#define   TCPC_SOC_CNXPR_1_Val                _UINT8_(0x1)                                         /* (TCPC_SOC) Connection.  */
...
#define TCPC_SOC_MXCFGCTL_Pos                 _UINT8_(2)                                           /* (TCPC_SOC) MUX Configuration Control Position */
#define TCPC_SOC_MXCFGCTL_Msk                 (_UINT8_(0x1) << TCPC_SOC_MXCFGCTL_Pos)              /* (TCPC_SOC) MUX Configuration Control Mask */
#define TCPC_SOC_MXCFGCTL(value)              (TCPC_SOC_MXCFGCTL_Msk & (_UINT8_(value) << TCPC_SOC_MXCFGCTL_Pos)) /* Assigment of value for MXCFGCTL in the TCPC_SOC register */
#define   TCPC_SOC_MXCFGCTL_0_Val             _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_MXCFGCTL_1_Val             _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SOC_ACI_Pos                      _UINT8_(3)                                           /* (TCPC_SOC) Active Cable Indicator Position */
#define TCPC_SOC_ACI_Msk                      (_UINT8_(0x1) << TCPC_SOC_ACI_Pos)                   /* (TCPC_SOC) Active Cable Indicator Mask */
#define TCPC_SOC_ACI(value)                   (TCPC_SOC_ACI_Msk & (_UINT8_(value) << TCPC_SOC_ACI_Pos)) /* Assigment of value for ACI in the TCPC_SOC register */
#define   TCPC_SOC_ACI_0_Val                  _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_ACI_1_Val                  _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SOC_AAAI_Pos                     _UINT8_(4)                                           /* (TCPC_SOC) Audio Adapter Accessory Indicator Position */
#define TCPC_SOC_AAAI_Msk                     (_UINT8_(0x1) << TCPC_SOC_AAAI_Pos)                  /* (TCPC_SOC) Audio Adapter Accessory Indicator Mask */
#define TCPC_SOC_AAAI(value)                  (TCPC_SOC_AAAI_Msk & (_UINT8_(value) << TCPC_SOC_AAAI_Pos)) /* Assigment of value for AAAI in the TCPC_SOC register */
#define   TCPC_SOC_AAAI_0_Val                 _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_AAAI_1_Val                 _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SOC_VBUSPM_Pos                   _UINT8_(5)                                           /* (TCPC_SOC) VBUS Present Monitor Position */
#define TCPC_SOC_VBUSPM_Msk                   (_UINT8_(0x1) << TCPC_SOC_VBUSPM_Pos)                /* (TCPC_SOC) VBUS Present Monitor Mask */
#define TCPC_SOC_VBUSPM(value)                (TCPC_SOC_VBUSPM_Msk & (_UINT8_(value) << TCPC_SOC_VBUSPM_Pos)) /* Assigment of value for VBUSPM in the TCPC_SOC register */
#define   TCPC_SOC_VBUSPM_0_Val               _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_VBUSPM_1_Val               _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SOC_DBGAI_Pos                    _UINT8_(6)                                           /* (TCPC_SOC) Debug Accessory Indicator Position */
#define TCPC_SOC_DBGAI_Msk                    (_UINT8_(0x1) << TCPC_SOC_DBGAI_Pos)                 /* (TCPC_SOC) Debug Accessory Indicator Mask */
#define TCPC_SOC_DBGAI(value)                 (TCPC_SOC_DBGAI_Msk & (_UINT8_(value) << TCPC_SOC_DBGAI_Pos)) /* Assigment of value for DBGAI in the TCPC_SOC register */
#define   TCPC_SOC_DBGAI_0_Val                _UINT8_(0x0)                                         /* (TCPC_SOC) Not present in TCPC.  */
#define   TCPC_SOC_DBGAI_1_Val                _UINT8_(0x1)                                         /* (TCPC_SOC) Present in TCPC.  */
...
#define TCPC_SSR_CC_STATUS(value)             (TCPC_SSR_CC_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_CC_STATUS_Pos)) /* Assigment of value for CC_STATUS in the TCPC_SSR register */
#define   TCPC_SSR_CC_STATUS_0_Val            _UINT32_(0x0)                                        /* (TCPC_SSR) No effect.  */
#define   TCPC_SSR_CC_STATUS_1_Val            _UINT32_(0x1)                                        /* (TCPC_SSR) Sets the corresponding bit in TCPC_CCS and the CC_ST bit in TCPC_AL.  */
...
#define TCPC_SSR_POWER_STATUS_Pos             _UINT32_(16)                                         /* (TCPC_SSR) Power Status Register Set Position */
#define TCPC_SSR_POWER_STATUS_Msk             (_UINT32_(0xFF) << TCPC_SSR_POWER_STATUS_Pos)        /* (TCPC_SSR) Power Status Register Set Mask */
#define TCPC_SSR_POWER_STATUS(value)          (TCPC_SSR_POWER_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_POWER_STATUS_Pos)) /* Assigment of value for POWER_STATUS in the TCPC_SSR register */
#define   TCPC_SSR_POWER_STATUS_0_Val         _UINT32_(0x0)                                        /* (TCPC_SSR) No effect.  */
#define   TCPC_SSR_POWER_STATUS_1_Val         _UINT32_(0x1)                                        /* (TCPC_SSR) Sets the corresponding bit in TCPC_PS and the PWR_ST bit in TCPC_AL.  */
...
#define TCPC_SSR_FAULT_STATUS_Pos             _UINT32_(24)                                         /* (TCPC_SSR) Fault Status Register Set Position */
#define TCPC_SSR_FAULT_STATUS_Msk             (_UINT32_(0xFF) << TCPC_SSR_FAULT_STATUS_Pos)        /* (TCPC_SSR) Fault Status Register Set Mask */
#define TCPC_SSR_FAULT_STATUS(value)          (TCPC_SSR_FAULT_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_FAULT_STATUS_Pos)) /* Assigment of value for FAULT_STATUS in the TCPC_SSR register */
#define   TCPC_SSR_FAULT_STATUS_0_Val         _UINT32_(0x0)                                        /* (TCPC_SSR) No effect.  */
#define   TCPC_SSR_FAULT_STATUS_1_Val         _UINT32_(0x1)                                        /* (TCPC_SSR) Sets the corresponding bit in TCPC_FS and the FLT_ST bit in TCPC_AL.  */
...
#define TCPC_UPC_RESETVALUE                   _UINT32_(0x00)                                       /*  (TCPC_UPC) USB PHY Control Register  Reset Value */

#define TCPC_UPC_TCCE_Pos                     _UINT32_(0)                                          /* (TCPC_UPC) Type-C Cell Enable Position */
#define TCPC_UPC_TCCE_Msk                     (_UINT32_(0x1) << TCPC_UPC_TCCE_Pos)                 /* (TCPC_UPC) Type-C Cell Enable Mask */
#define TCPC_UPC_TCCE(value)                  (TCPC_UPC_TCCE_Msk & (_UINT32_(value) << TCPC_UPC_TCCE_Pos)) /* Assigment of value for TCCE in the TCPC_UPC register */
#define   TCPC_UPC_TCCE_0_Val                 _UINT32_(0x0)                                        /* (TCPC_UPC) USB Type-C cell is disabled; CC1 and CC2 are disconnected.  */
#define   TCPC_UPC_TCCE_1_Val                 _UINT32_(0x1)                                        /* (TCPC_UPC) USB Type-C cell is enabled.  */
#define TCPC_UPC_TCCE_0                       (TCPC_UPC_TCCE_0_Val << TCPC_UPC_TCCE_Pos)           /* (TCPC_UPC) USB Type-C cell is disabled; CC1 and CC2 are disconnected. Position  */
#define TCPC_UPC_TCCE_1                       (TCPC_UPC_TCCE_1_Val << TCPC_UPC_TCCE_Pos)           /* (TCPC_UPC) USB Type-C cell is enabled. Position  */
#define TCPC_UPC_TCIDSEL_Pos                  _UINT32_(1)                                          /* (TCPC_UPC) Type-C or ID Selection Position */
#define TCPC_UPC_TCIDSEL_Msk                  (_UINT32_(0x1) << TCPC_UPC_TCIDSEL_Pos)              /* (TCPC_UPC) Type-C or ID Selection Mask */
#define TCPC_UPC_TCIDSEL(value)               (TCPC_UPC_TCIDSEL_Msk & (_UINT32_(value) << TCPC_UPC_TCIDSEL_Pos)) /* Assigment of value for TCIDSEL in the TCPC_UPC register */
#define   TCPC_UPC_TCIDSEL_0_Val              _UINT32_(0x0)                                        /* (TCPC_UPC) CC1 comparator is used for ID detection for OTG or for Battery Charging. CC1 is connected and CC2 is disconnected.  */
#define   TCPC_UPC_TCIDSEL_1_Val              _UINT32_(0x1)                                        /* (TCPC_UPC) CC1 and CC2 comparators are used to determine the power capability advertised by the facing source.  */
#define TCPC_UPC_TCIDSEL_0                    (TCPC_UPC_TCIDSEL_0_Val << TCPC_UPC_TCIDSEL_Pos)     /* (TCPC_UPC) CC1 comparator is used for ID detection for OTG or for Battery Charging. CC1 is connected and CC2 is disconnected. Position  */
#define TCPC_UPC_TCIDSEL_1                    (TCPC_UPC_TCIDSEL_1_Val << TCPC_UPC_TCIDSEL_Pos)     /* (TCPC_UPC) CC1 and CC2 comparators are used to determine the power capability advertised by the facing source. Position  */
#define TCPC_UPC_TCIDCTSEL_Pos                _UINT32_(8)                                          /* (TCPC_UPC) Type-C or ID Comparator Threshold Selection Position */
#define TCPC_UPC_TCIDCTSEL_Msk                (_UINT32_(0x7) << TCPC_UPC_TCIDCTSEL_Pos)            /* (TCPC_UPC) Type-C or ID Comparator Threshold Selection Mask */
#define TCPC_UPC_TCIDCTSEL(value)             (TCPC_UPC_TCIDCTSEL_Msk & (_UINT32_(value) << TCPC_UPC_TCIDCTSEL_Pos)) /* Assigment of value for TCIDCTSEL in the TCPC_UPC register */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_0_Val  _UINT32_(0x0)                                        /* (TCPC_UPC) Threshold above VRid_gnd for ID determination or Type-C VRa  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_1_Val  _UINT32_(0x1)                                        /* (TCPC_UPC) Threshold above VRid_c for ID determination or Type-C VRd-USB  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_2_Val  _UINT32_(0x2)                                        /* (TCPC_UPC) Threshold above VRid_b for ID determination or Type-C VRd-1.5  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_3_Val  _UINT32_(0x3)                                        /* (TCPC_UPC) Threshold above VRid_a for ID determination or Type-C VRd  */
#define TCPC_UPC_TCIDCTSEL_THRESHOLD_0        (TCPC_UPC_TCIDCTSEL_THRESHOLD_0_Val << TCPC_UPC_TCIDCTSEL_Pos) /* (TCPC_UPC) Threshold above VRid_gnd for ID determination or Type-C VRa Position  */
#define TCPC_UPC_TCIDCTSEL_THRESHOLD_1        (TCPC_UPC_TCIDCTSEL_THRESHOLD_1_Val << TCPC_UPC_TCIDCTSEL_Pos) /* (TCPC_UPC) Threshold above VRid_c for ID determination or Type-C VRd-USB Position  */
#define TCPC_UPC_TCIDCTSEL_THRESHOLD_2        (TCPC_UPC_TCIDCTSEL_THRESHOLD_2_Val << TCPC_UPC_TCIDCTSEL_Pos) /* (TCPC_UPC) Threshold above VRid_b for ID determination or Type-C VRd-1.5 Position  */
#define TCPC_UPC_TCIDCTSEL_THRESHOLD_3        (TCPC_UPC_TCIDCTSEL_THRESHOLD_3_Val << TCPC_UPC_TCIDCTSEL_Pos) /* (TCPC_UPC) Threshold above VRid_a for ID determination or Type-C VRd Position  */
#define TCPC_UPC_RDIPSEL_Pos                  _UINT32_(12)                                         /* (TCPC_UPC) Type-C Rd or Ip Pull-up Current Selection Position */
#define TCPC_UPC_RDIPSEL_Msk                  (_UINT32_(0x3) << TCPC_UPC_RDIPSEL_Pos)              /* (TCPC_UPC) Type-C Rd or Ip Pull-up Current Selection Mask */
#define TCPC_UPC_RDIPSEL(value)               (TCPC_UPC_RDIPSEL_Msk & (_UINT32_(value) << TCPC_UPC_RDIPSEL_Pos)) /* Assigment of value for RDIPSEL in the TCPC_UPC register */
#define   TCPC_UPC_RDIPSEL_IP_OFF_Val         _UINT32_(0x0)                                        /* (TCPC_UPC) Type-C pull-up current source Ip is off, Rd pull-down is selected.  */
#define   TCPC_UPC_RDIPSEL_IP_0P5_Val         _UINT32_(0x1)                                        /* (TCPC_UPC) Type-C pull-up current source Ip is advertising 0.5A as VBUS sourcing capability.  */
#define   TCPC_UPC_RDIPSEL_IP_1P5_Val         _UINT32_(0x2)                                        /* (TCPC_UPC) Type-C pull-up current source Ip is advertising 1.5A as VBUS sourcing capability.  */
#define   TCPC_UPC_RDIPSEL_IP_3P0_Val         _UINT32_(0x3)                                        /* (TCPC_UPC) Type-C pull-up current source Ip is advertising 3.0A as VBUS sourcing capability.  */
...
#define TCPC_UPC_RDIPSEL_IP_1P5               (TCPC_UPC_RDIPSEL_IP_1P5_Val << TCPC_UPC_RDIPSEL_Pos) /* (TCPC_UPC) Type-C pull-up current source Ip is advertising 1.5A as VBUS sourcing capability. Position  */
#define TCPC_UPC_RDIPSEL_IP_3P0               (TCPC_UPC_RDIPSEL_IP_3P0_Val << TCPC_UPC_RDIPSEL_Pos) /* (TCPC_UPC) Type-C pull-up current source Ip is advertising 3.0A as VBUS sourcing capability. Position  */
#define TCPC_UPC_RDSEL_Pos                    _UINT32_(16)                                         /* (TCPC_UPC) Type-C Rd Resistor Trim Selection Position */
#define TCPC_UPC_RDSEL_Msk                    (_UINT32_(0x3) << TCPC_UPC_RDSEL_Pos)                /* (TCPC_UPC) Type-C Rd Resistor Trim Selection Mask */
#define TCPC_UPC_RDSEL(value)                 (TCPC_UPC_RDSEL_Msk & (_UINT32_(value) << TCPC_UPC_RDSEL_Pos)) /* Assigment of value for RDSEL in the TCPC_UPC register */
#define   TCPC_UPC_RDSEL_RDSEL_OFF_Val        _UINT32_(0x0)                                        /* (TCPC_UPC) Rd pull-down is disabled.  */
#define   TCPC_UPC_RDSEL_RDSEL_MINUS_10P_Val  _UINT32_(0x1)                                        /* (TCPC_UPC) Rd pull-down resistor value decreased by 10% is selected.  */
#define   TCPC_UPC_RDSEL_RDSEL_DEFAULT_Val    _UINT32_(0x2)                                        /* (TCPC_UPC) Rd pull-down resistor default value is selected.  */
#define   TCPC_UPC_RDSEL_RDSEL_PLUS_10P_Val   _UINT32_(0x3)                                        /* (TCPC_UPC) Rd pull-down resistor value increased by 10% is selected.  */
#define TCPC_UPC_RDSEL_RDSEL_OFF              (TCPC_UPC_RDSEL_RDSEL_OFF_Val << TCPC_UPC_RDSEL_Pos) /* (TCPC_UPC) Rd pull-down is disabled. Position  */
#define TCPC_UPC_RDSEL_RDSEL_MINUS_10P        (TCPC_UPC_RDSEL_RDSEL_MINUS_10P_Val << TCPC_UPC_RDSEL_Pos) /* (TCPC_UPC) Rd pull-down resistor value decreased by 10% is selected. Position  */
#define TCPC_UPC_RDSEL_RDSEL_DEFAULT          (TCPC_UPC_RDSEL_RDSEL_DEFAULT_Val << TCPC_UPC_RDSEL_Pos) /* (TCPC_UPC) Rd pull-down resistor default value is selected. Position  */
#define TCPC_UPC_RDSEL_RDSEL_PLUS_10P         (TCPC_UPC_RDSEL_RDSEL_PLUS_10P_Val << TCPC_UPC_RDSEL_Pos) /* (TCPC_UPC) Rd pull-down resistor value increased by 10% is selected. Position  */
#define TCPC_UPC_RDTRME_Pos                   _UINT32_(18)                                         /* (TCPC_UPC) Type-C Rd Resistor Trim Enable Position */
#define TCPC_UPC_RDTRME_Msk                   (_UINT32_(0x1) << TCPC_UPC_RDTRME_Pos)               /* (TCPC_UPC) Type-C Rd Resistor Trim Enable Mask */
#define TCPC_UPC_RDTRME(value)                (TCPC_UPC_RDTRME_Msk & (_UINT32_(value) << TCPC_UPC_RDTRME_Pos)) /* Assigment of value for RDTRME in the TCPC_UPC register */
#define   TCPC_UPC_RDTRME_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPC) Rd resistor software trim is disabled. The Rd resistor pull-down can be used for Type-C attach detection.  */
#define   TCPC_UPC_RDTRME_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPC) Rd resistor software trim is enabled. CC2 is disconnected. RDSEL is enforced for Rd resistor value.  */
#define TCPC_UPC_RDTRME_0                     (TCPC_UPC_RDTRME_0_Val << TCPC_UPC_RDTRME_Pos)       /* (TCPC_UPC) Rd resistor software trim is disabled. The Rd resistor pull-down can be used for Type-C attach detection. Position  */
#define TCPC_UPC_RDTRME_1                     (TCPC_UPC_RDTRME_1_Val << TCPC_UPC_RDTRME_Pos)       /* (TCPC_UPC) Rd resistor software trim is enabled. CC2 is disconnected. RDSEL is enforced for Rd resistor value. Position  */
#define TCPC_UPC_RDSRC_Pos                    _UINT32_(20)                                         /* (TCPC_UPC) Type-C Rd Resistor Value Source Position */
#define TCPC_UPC_RDSRC_Msk                    (_UINT32_(0x3) << TCPC_UPC_RDSRC_Pos)                /* (TCPC_UPC) Type-C Rd Resistor Value Source Mask */
#define TCPC_UPC_RDSRC(value)                 (TCPC_UPC_RDSRC_Msk & (_UINT32_(value) << TCPC_UPC_RDSRC_Pos)) /* Assigment of value for RDSRC in the TCPC_UPC register */
#define   TCPC_UPC_RDSRC_RDSRC_CFG_Val        _UINT32_(0x0)                                        /* (TCPC_UPC) Software configuration value RDSEL is selected for Rd pull-down resistor.  */
#define   TCPC_UPC_RDSRC_RDSRC_OTP_Val        _UINT32_(0x1)                                        /* (TCPC_UPC) OTP value is selected for Rd pull-down resistor.  */
#define   TCPC_UPC_RDSRC_RDSRC_CAL_Val        _UINT32_(0x2)                                        /* (TCPC_UPC) Calibration value TCPC_CALST.RDCAL is selected for Rd pull-down resistor.  */
#define   TCPC_UPC_RDSRC_RDSRC_DIS_Val        _UINT32_(0x3)                                        /* (TCPC_UPC) Rd pull-down is disabled.  */
#define TCPC_UPC_RDSRC_RDSRC_CFG              (TCPC_UPC_RDSRC_RDSRC_CFG_Val << TCPC_UPC_RDSRC_Pos) /* (TCPC_UPC) Software configuration value RDSEL is selected for Rd pull-down resistor. Position  */
#define TCPC_UPC_RDSRC_RDSRC_OTP              (TCPC_UPC_RDSRC_RDSRC_OTP_Val << TCPC_UPC_RDSRC_Pos) /* (TCPC_UPC) OTP value is selected for Rd pull-down resistor. Position  */
#define TCPC_UPC_RDSRC_RDSRC_CAL              (TCPC_UPC_RDSRC_RDSRC_CAL_Val << TCPC_UPC_RDSRC_Pos) /* (TCPC_UPC) Calibration value TCPC_CALST.RDCAL is selected for Rd pull-down resistor. Position  */
#define TCPC_UPC_RDSRC_RDSRC_DIS              (TCPC_UPC_RDSRC_RDSRC_DIS_Val << TCPC_UPC_RDSRC_Pos) /* (TCPC_UPC) Rd pull-down is disabled. Position  */
#define TCPC_UPC_DMPDFD_Pos                   _UINT32_(24)                                         /* (TCPC_UPC) DM Pull-down Force Disable Position */
#define TCPC_UPC_DMPDFD_Msk                   (_UINT32_(0x1) << TCPC_UPC_DMPDFD_Pos)               /* (TCPC_UPC) DM Pull-down Force Disable Mask */
#define TCPC_UPC_DMPDFD(value)                (TCPC_UPC_DMPDFD_Msk & (_UINT32_(value) << TCPC_UPC_DMPDFD_Pos)) /* Assigment of value for DMPDFD in the TCPC_UPC register */
#define   TCPC_UPC_DMPDFD_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPC) DM pull-down is not forced to the inactive state by the TCPC.  */
#define   TCPC_UPC_DMPDFD_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPC) DM pull-down is forced to the inactive state by the TCPC.  */
...
#define TCPC_UPC_DMPDFE_Pos                   _UINT32_(25)                                         /* (TCPC_UPC) DM Pull-down Force Enable Position */
#define TCPC_UPC_DMPDFE_Msk                   (_UINT32_(0x1) << TCPC_UPC_DMPDFE_Pos)               /* (TCPC_UPC) DM Pull-down Force Enable Mask */
#define TCPC_UPC_DMPDFE(value)                (TCPC_UPC_DMPDFE_Msk & (_UINT32_(value) << TCPC_UPC_DMPDFE_Pos)) /* Assigment of value for DMPDFE in the TCPC_UPC register */
#define   TCPC_UPC_DMPDFE_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPC) DM pull-down is not forced to the active state by the TCPC.  */
#define   TCPC_UPC_DMPDFE_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPC) DM pull-down is forced to the active state by the TCPC for battery charging data contact detection.  */
...
#define TCPC_UPC_BCIDPSRCE_Pos                _UINT32_(26)                                         /* (TCPC_UPC) Battery Charging IDP Source Enable Position */
#define TCPC_UPC_BCIDPSRCE_Msk                (_UINT32_(0x1) << TCPC_UPC_BCIDPSRCE_Pos)            /* (TCPC_UPC) Battery Charging IDP Source Enable Mask */
#define TCPC_UPC_BCIDPSRCE(value)             (TCPC_UPC_BCIDPSRCE_Msk & (_UINT32_(value) << TCPC_UPC_BCIDPSRCE_Pos)) /* Assigment of value for BCIDPSRCE in the TCPC_UPC register */
#define   TCPC_UPC_BCIDPSRCE_0_Val            _UINT32_(0x0)                                        /* (TCPC_UPC) Battery charging IDP current source is disabled.  */
#define   TCPC_UPC_BCIDPSRCE_1_Val            _UINT32_(0x1)                                        /* (TCPC_UPC) Battery charging IDP current source is enabled for data contact detection.  */
...
#define TCPC_UPC_BCDETSEL_Pos                 _UINT32_(27)                                         /* (TCPC_UPC) Battery Charging Detection Selection Position */
#define TCPC_UPC_BCDETSEL_Msk                 (_UINT32_(0x1) << TCPC_UPC_BCDETSEL_Pos)             /* (TCPC_UPC) Battery Charging Detection Selection Mask */
#define TCPC_UPC_BCDETSEL(value)              (TCPC_UPC_BCDETSEL_Msk & (_UINT32_(value) << TCPC_UPC_BCDETSEL_Pos)) /* Assigment of value for BCDETSEL in the TCPC_UPC register */
#define   TCPC_UPC_BCDETSEL_0_Val             _UINT32_(0x0)                                        /* (TCPC_UPC) Battery charging primary detection is selected.  */
#define   TCPC_UPC_BCDETSEL_1_Val             _UINT32_(0x1)                                        /* (TCPC_UPC) Battery charging secondary detection is selected.  */
...
#define TCPC_UPC_BCVSRCE_Pos                  _UINT32_(28)                                         /* (TCPC_UPC) Battery Charging Voltage Source Enable Position */
#define TCPC_UPC_BCVSRCE_Msk                  (_UINT32_(0x1) << TCPC_UPC_BCVSRCE_Pos)              /* (TCPC_UPC) Battery Charging Voltage Source Enable Mask */
#define TCPC_UPC_BCVSRCE(value)               (TCPC_UPC_BCVSRCE_Msk & (_UINT32_(value) << TCPC_UPC_BCVSRCE_Pos)) /* Assigment of value for BCVSRCE in the TCPC_UPC register */
#define   TCPC_UPC_BCVSRCE_0_Val              _UINT32_(0x0)                                        /* (TCPC_UPC) Battery charging VDP_SRC and VDM_SRC voltage sources are disabled.  */
#define   TCPC_UPC_BCVSRCE_1_Val              _UINT32_(0x1)                                        /* (TCPC_UPC) Battery charging voltage source enable:  */
...
#define TCPC_UPC_BCDETE_Pos                   _UINT32_(29)                                         /* (TCPC_UPC) Battery Charging Detection Enable Position */
#define TCPC_UPC_BCDETE_Msk                   (_UINT32_(0x1) << TCPC_UPC_BCDETE_Pos)               /* (TCPC_UPC) Battery Charging Detection Enable Mask */
#define TCPC_UPC_BCDETE(value)                (TCPC_UPC_BCDETE_Msk & (_UINT32_(value) << TCPC_UPC_BCDETE_Pos)) /* Assigment of value for BCDETE in the TCPC_UPC register */
#define   TCPC_UPC_BCDETE_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPC) Battery charging detection is disabled.  */
#define   TCPC_UPC_BCDETE_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPC) Battery charging detection is enabled.  */
...
#define TCPC_UPC_Msk                          _UINT32_(0x3F373703)                                 /* (TCPC_UPC) Register Mask  */
...
#define TCPC_UPS_DP_Pos                       _UINT32_(0)                                          /* (TCPC_UPS) USB Differential line Plus Position */
#define TCPC_UPS_DP_Msk                       (_UINT32_(0x1) << TCPC_UPS_DP_Pos)                   /* (TCPC_UPS) USB Differential line Plus Mask */
#define TCPC_UPS_DP(value)                    (TCPC_UPS_DP_Msk & (_UINT32_(value) << TCPC_UPS_DP_Pos)) /* Assigment of value for DP in the TCPC_UPS register */
#define   TCPC_UPS_DP_0_Val                   _UINT32_(0x0)                                        /* (TCPC_UPS) DP is low.  */
#define   TCPC_UPS_DP_1_Val                   _UINT32_(0x1)                                        /* (TCPC_UPS) DP is high.  */
...
#define TCPC_UPS_DM_Pos                       _UINT32_(1)                                          /* (TCPC_UPS) USB Differential line Minus Position */
#define TCPC_UPS_DM_Msk                       (_UINT32_(0x1) << TCPC_UPS_DM_Pos)                   /* (TCPC_UPS) USB Differential line Minus Mask */
#define TCPC_UPS_DM(value)                    (TCPC_UPS_DM_Msk & (_UINT32_(value) << TCPC_UPS_DM_Pos)) /* Assigment of value for DM in the TCPC_UPS register */
#define   TCPC_UPS_DM_0_Val                   _UINT32_(0x0)                                        /* (TCPC_UPS) DM is low.  */
#define   TCPC_UPS_DM_1_Val                   _UINT32_(0x1)                                        /* (TCPC_UPS) DM is high.  */
...
#define TCPC_UPS_CHGDCP_Pos                   _UINT32_(2)                                          /* (TCPC_UPS) Charging Port Detection, Dedicated Charging Port Detection Position */
#define TCPC_UPS_CHGDCP_Msk                   (_UINT32_(0x1) << TCPC_UPS_CHGDCP_Pos)               /* (TCPC_UPS) Charging Port Detection, Dedicated Charging Port Detection Mask */
#define TCPC_UPS_CHGDCP(value)                (TCPC_UPS_CHGDCP_Msk & (_UINT32_(value) << TCPC_UPS_CHGDCP_Pos)) /* Assigment of value for CHGDCP in the TCPC_UPS register */
#define   TCPC_UPS_CHGDCP_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPS) No charging port detected  */
#define   TCPC_UPS_CHGDCP_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPS) Charging port detected  */
...
#define TCPC_UPS_CC1ID_Pos                    _UINT32_(3)                                          /* (TCPC_UPS) Type-C CC1 Comparator or ID comparator Position */
#define TCPC_UPS_CC1ID_Msk                    (_UINT32_(0x1) << TCPC_UPS_CC1ID_Pos)                /* (TCPC_UPS) Type-C CC1 Comparator or ID comparator Mask */
#define TCPC_UPS_CC1ID(value)                 (TCPC_UPS_CC1ID_Msk & (_UINT32_(value) << TCPC_UPS_CC1ID_Pos)) /* Assigment of value for CC1ID in the TCPC_UPS register */
#define   TCPC_UPS_CC1ID_0_Val                _UINT32_(0x0)                                        /* (TCPC_UPS) CC1 or ID comparator output is low for Power Source Detection at Sink and is high for Sink Detection at Power Source. Voltage is below the selected TCPC_UPC.TCIDCTSEL threshold.  */
#define   TCPC_UPS_CC1ID_1_Val                _UINT32_(0x1)                                        /* (TCPC_UPS) CC1 or ID comparator output is high for Power Source Detection at Sink and is low for Sink Detection at Power Source. Voltage is above the selected TCPC_UPC.TCIDCTSEL threshold.  */
#define TCPC_UPS_CC1ID_0                      (TCPC_UPS_CC1ID_0_Val << TCPC_UPS_CC1ID_Pos)         /* (TCPC_UPS) CC1 or ID comparator output is low for Power Source Detection at Sink and is high for Sink Detection at Power Source. Voltage is below the selected TCPC_UPC.TCIDCTSEL threshold. Position  */
#define TCPC_UPS_CC1ID_1                      (TCPC_UPS_CC1ID_1_Val << TCPC_UPS_CC1ID_Pos)         /* (TCPC_UPS) CC1 or ID comparator output is high for Power Source Detection at Sink and is low for Sink Detection at Power Source. Voltage is above the selected TCPC_UPC.TCIDCTSEL threshold. Position  */
#define TCPC_UPS_CC2RDT_Pos                   _UINT32_(4)                                          /* (TCPC_UPS) Type-C CC2 Comparator or Rd Trim comparator Position */
#define TCPC_UPS_CC2RDT_Msk                   (_UINT32_(0x1) << TCPC_UPS_CC2RDT_Pos)               /* (TCPC_UPS) Type-C CC2 Comparator or Rd Trim comparator Mask */
#define TCPC_UPS_CC2RDT(value)                (TCPC_UPS_CC2RDT_Msk & (_UINT32_(value) << TCPC_UPS_CC2RDT_Pos)) /* Assigment of value for CC2RDT in the TCPC_UPS register */
#define   TCPC_UPS_CC2RDT_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPS) CC2 or Rd Trim comparator output is low for Power Source Detection at Sink and is high for Sink Detection at Power Source. Voltage is below the selected TCUPC.TCIDCTSEL threshold.  */
#define   TCPC_UPS_CC2RDT_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPS) CC2 or Rd Trim comparator output is high for Power Source Detection at Sink and is low for Sink Detection at Power Source. Voltage is above the selected TCUPC.TCIDCTSEL threshold.  */
#define TCPC_UPS_CC2RDT_0                     (TCPC_UPS_CC2RDT_0_Val << TCPC_UPS_CC2RDT_Pos)       /* (TCPC_UPS) CC2 or Rd Trim comparator output is low for Power Source Detection at Sink and is high for Sink Detection at Power Source. Voltage is below the selected TCUPC.TCIDCTSEL threshold. Position  */
#define TCPC_UPS_CC2RDT_1                     (TCPC_UPS_CC2RDT_1_Val << TCPC_UPS_CC2RDT_Pos)       /* (TCPC_UPS) CC2 or Rd Trim comparator output is high for Power Source Detection at Sink and is low for Sink Detection at Power Source. Voltage is above the selected TCUPC.TCIDCTSEL threshold. Position  */
#define TCPC_UPS_Msk                          _UINT32_(0x0000001F)                                 /* (TCPC_UPS) Register Mask  */


/* -------- TCPC_CALVREF : (TCPC Offset: 0xA8) (R/W 32) Calibration Voltage Reference Register -------- */
#define TCPC_CALVREF_RESETVALUE               _UINT32_(0x807)                                      /*  (TCPC_CALVREF) Calibration Voltage Reference Register  Reset Value */

#define TCPC_CALVREF_CALVREFL_Pos             _UINT32_(0)                                          /* (TCPC_CALVREF) Calibration Voltage Reference Low Value Position */
#define TCPC_CALVREF_CALVREFL_Msk             (_UINT32_(0x1F) << TCPC_CALVREF_CALVREFL_Pos)        /* (TCPC_CALVREF) Calibration Voltage Reference Low Value Mask */
#define TCPC_CALVREF_CALVREFL(value)          (TCPC_CALVREF_CALVREFL_Msk & (_UINT32_(value) << TCPC_CALVREF_CALVREFL_Pos)) /* Assigment of value for CALVREFL in the TCPC_CALVREF register */
#define TCPC_CALVREF_CALVREFH_Pos             _UINT32_(8)                                          /* (TCPC_CALVREF) Calibration Voltage Reference High Value Position */
#define TCPC_CALVREF_CALVREFH_Msk             (_UINT32_(0x1F) << TCPC_CALVREF_CALVREFH_Pos)        /* (TCPC_CALVREF) Calibration Voltage Reference High Value Mask */
#define TCPC_CALVREF_CALVREFH(value)          (TCPC_CALVREF_CALVREFH_Msk & (_UINT32_(value) << TCPC_CALVREF_CALVREFH_Pos)) /* Assigment of value for CALVREFH in the TCPC_CALVREF register */
#define TCPC_CALVREF_Msk                      _UINT32_(0x00001F1F)                                 /* (TCPC_CALVREF) Register Mask  */


/* -------- TCPC_CALST : (TCPC Offset: 0xAC) ( R/ 32) Calibration Status Register -------- */
#define TCPC_CALST_CALNST_Pos                 _UINT32_(0)                                          /* (TCPC_CALST) Calibration Input Status Position */
#define TCPC_CALST_CALNST_Msk                 (_UINT32_(0x1F) << TCPC_CALST_CALNST_Pos)            /* (TCPC_CALST) Calibration Input Status Mask */
#define TCPC_CALST_CALNST(value)              (TCPC_CALST_CALNST_Msk & (_UINT32_(value) << TCPC_CALST_CALNST_Pos)) /* Assigment of value for CALNST in the TCPC_CALST register */
#define TCPC_CALST_RDCAL_Pos                  _UINT32_(8)                                          /* (TCPC_CALST) Rd From Calibration Position */
#define TCPC_CALST_RDCAL_Msk                  (_UINT32_(0x3) << TCPC_CALST_RDCAL_Pos)              /* (TCPC_CALST) Rd From Calibration Mask */
#define TCPC_CALST_RDCAL(value)               (TCPC_CALST_RDCAL_Msk & (_UINT32_(value) << TCPC_CALST_RDCAL_Pos)) /* Assigment of value for RDCAL in the TCPC_CALST register */
#define TCPC_CALST_Msk                        _UINT32_(0x0000031F)                                 /* (TCPC_CALST) Register Mask  */


/* -------- TCPC_CALIST : (TCPC Offset: 0xB0) ( R/ 32) Calibration Interrupt Status Register -------- */
#define TCPC_CALIST_RESETVALUE                _UINT32_(0x00)                                       /*  (TCPC_CALIST) Calibration Interrupt Status Register  Reset Value */

#define TCPC_CALIST_CALNIST_Pos               _UINT32_(0)                                          /* (TCPC_CALIST) Calibration Interrupt Status Position */
#define TCPC_CALIST_CALNIST_Msk               (_UINT32_(0x1) << TCPC_CALIST_CALNIST_Pos)           /* (TCPC_CALIST) Calibration Interrupt Status Mask */
#define TCPC_CALIST_CALNIST(value)            (TCPC_CALIST_CALNIST_Msk & (_UINT32_(value) << TCPC_CALIST_CALNIST_Pos)) /* Assigment of value for CALNIST in the TCPC_CALIST register */
#define   TCPC_CALIST_CALNIST_0_Val           _UINT32_(0x0)                                        /* (TCPC_CALIST) No TCPC calibration input change has occurred in TCPC_CALST since the last read of the TCPC_CALIST register.  */
#define   TCPC_CALIST_CALNIST_1_Val           _UINT32_(0x1)                                        /* (TCPC_CALIST) At least one TCPC calibration input change has occurred in TCPC_CALST since the last read of the TCPC_CALIST register.  */
#define TCPC_CALIST_CALNIST_0                 (TCPC_CALIST_CALNIST_0_Val << TCPC_CALIST_CALNIST_Pos) /* (TCPC_CALIST) No TCPC calibration input change has occurred in TCPC_CALST since the last read of the TCPC_CALIST register. Position  */
#define TCPC_CALIST_CALNIST_1                 (TCPC_CALIST_CALNIST_1_Val << TCPC_CALIST_CALNIST_Pos) /* (TCPC_CALIST) At least one TCPC calibration input change has occurred in TCPC_CALST since the last read of the TCPC_CALIST register. Position  */
#define TCPC_CALIST_Msk                       _UINT32_(0x00000001)                                 /* (TCPC_CALIST) Register Mask  */


/* -------- TCPC_CALIM : (TCPC Offset: 0xB4) (R/W 32) Calibration Interrupt Mask Register -------- */
#define TCPC_CALIM_RESETVALUE                 _UINT32_(0x00)                                       /*  (TCPC_CALIM) Calibration Interrupt Mask Register  Reset Value */

#define TCPC_CALIM_CALIM_Pos                  _UINT32_(0)                                          /* (TCPC_CALIM) Calibration Interrupt Mask Position */
#define TCPC_CALIM_CALIM_Msk                  (_UINT32_(0x1) << TCPC_CALIM_CALIM_Pos)              /* (TCPC_CALIM) Calibration Interrupt Mask Mask */
#define TCPC_CALIM_CALIM(value)               (TCPC_CALIM_CALIM_Msk & (_UINT32_(value) << TCPC_CALIM_CALIM_Pos)) /* Assigment of value for CALIM in the TCPC_CALIM register */
#define   TCPC_CALIM_CALIM_0_Val              _UINT32_(0x0)                                        /* (TCPC_CALIM) The TCPC calibration interrupt status TCPC_CALIST.CALIST does not trigger any TCPC interrupt when set.  */
#define   TCPC_CALIM_CALIM_1_Val              _UINT32_(0x1)                                        /* (TCPC_CALIM) The TCPC calibration interrupt status TCPC_CALIST.CALIST triggers the TCPC interrupt line when set.  */
#define TCPC_CALIM_CALIM_0                    (TCPC_CALIM_CALIM_0_Val << TCPC_CALIM_CALIM_Pos)     /* (TCPC_CALIM) The TCPC calibration interrupt status TCPC_CALIST.CALIST does not trigger any TCPC interrupt when set. Position  */
#define TCPC_CALIM_CALIM_1                    (TCPC_CALIM_CALIM_1_Val << TCPC_CALIM_CALIM_Pos)     /* (TCPC_CALIM) The TCPC calibration interrupt status TCPC_CALIST.CALIST triggers the TCPC interrupt line when set. Position  */
#define TCPC_CALIM_Msk                        _UINT32_(0x00000001)                                 /* (TCPC_CALIM) Register Mask  */
...
#define TCPC_CALVREF_REG_OFST          _UINT32_(0xA8)      /* (TCPC_CALVREF) Calibration Voltage Reference Register Offset */
#define TCPC_CALST_REG_OFST            _UINT32_(0xAC)      /* (TCPC_CALST) Calibration Status Register Offset */
#define TCPC_CALIST_REG_OFST           _UINT32_(0xB0)      /* (TCPC_CALIST) Calibration Interrupt Status Register Offset */
#define TCPC_CALIM_REG_OFST            _UINT32_(0xB4)      /* (TCPC_CALIM) Calibration Interrupt Mask Register Offset */
...
{  /* Battery Charging and Type-C Port Controller */
  ...
  __IO  uint32_t                       TCPC_CALVREF;       /**< Offset: 0xA8 (R/W  32) Calibration Voltage Reference Register */
  __I   uint32_t                       TCPC_CALST;         /**< Offset: 0xAC (R/   32) Calibration Status Register */
  __I   uint32_t                       TCPC_CALIST;        /**< Offset: 0xB0 (R/   32) Calibration Interrupt Status Register */
  __IO  uint32_t                       TCPC_CALIM;         /**< Offset: 0xB4 (R/W  32) Calibration Interrupt Mask Register */
} tcpc_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _SAMA7D6_TCPC_COMPONENT_H_ */
