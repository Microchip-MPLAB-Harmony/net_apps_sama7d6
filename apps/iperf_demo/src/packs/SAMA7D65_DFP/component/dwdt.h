...
#ifndef _SAMA7D6_DWDT_COMPONENT_H_
#define _SAMA7D6_DWDT_COMPONENT_H_
...
#define DWDT_NS_WDT_CR_WDRSTT(value)          (DWDT_NS_WDT_CR_WDRSTT_Msk & (_UINT32_(value) << DWDT_NS_WDT_CR_WDRSTT_Pos)) /* Assigment of value for WDRSTT in the DWDT_NS_WDT_CR register */
...
#define DWDT_NS_WDT_CR_LOCKMR(value)          (DWDT_NS_WDT_CR_LOCKMR_Msk & (_UINT32_(value) << DWDT_NS_WDT_CR_LOCKMR_Pos)) /* Assigment of value for LOCKMR in the DWDT_NS_WDT_CR register */
...
#define DWDT_NS_WDT_CR_KEY(value)             (DWDT_NS_WDT_CR_KEY_Msk & (_UINT32_(value) << DWDT_NS_WDT_CR_KEY_Pos)) /* Assigment of value for KEY in the DWDT_NS_WDT_CR register */
...
#define DWDT_NS_WDT_MR_RPTHALM(value)         (DWDT_NS_WDT_MR_RPTHALM_Msk & (_UINT32_(value) << DWDT_NS_WDT_MR_RPTHALM_Pos)) /* Assigment of value for RPTHALM in the DWDT_NS_WDT_MR register */
...
#define DWDT_NS_WDT_MR_WDDIS(value)           (DWDT_NS_WDT_MR_WDDIS_Msk & (_UINT32_(value) << DWDT_NS_WDT_MR_WDDIS_Pos)) /* Assigment of value for WDDIS in the DWDT_NS_WDT_MR register */
...
#define DWDT_NS_WDT_MR_WDIDLEHLT(value)       (DWDT_NS_WDT_MR_WDIDLEHLT_Msk & (_UINT32_(value) << DWDT_NS_WDT_MR_WDIDLEHLT_Pos)) /* Assigment of value for WDIDLEHLT in the DWDT_NS_WDT_MR register */
...
#define DWDT_NS_WDT_MR_WDDBGHLT(value)        (DWDT_NS_WDT_MR_WDDBGHLT_Msk & (_UINT32_(value) << DWDT_NS_WDT_MR_WDDBGHLT_Pos)) /* Assigment of value for WDDBGHLT in the DWDT_NS_WDT_MR register */
...
#define DWDT_NS_WDT_VR_COUNTER(value)         (DWDT_NS_WDT_VR_COUNTER_Msk & (_UINT32_(value) << DWDT_NS_WDT_VR_COUNTER_Pos)) /* Assigment of value for COUNTER in the DWDT_NS_WDT_VR register */
...
#define DWDT_NS_WDT_WL_PERIOD(value)          (DWDT_NS_WDT_WL_PERIOD_Msk & (_UINT32_(value) << DWDT_NS_WDT_WL_PERIOD_Pos)) /* Assigment of value for PERIOD in the DWDT_NS_WDT_WL register */
...
#define DWDT_PS_WDT_CR_WDRSTT(value)          (DWDT_PS_WDT_CR_WDRSTT_Msk & (_UINT32_(value) << DWDT_PS_WDT_CR_WDRSTT_Pos)) /* Assigment of value for WDRSTT in the DWDT_PS_WDT_CR register */
...
#define DWDT_PS_WDT_CR_LOCKMR(value)          (DWDT_PS_WDT_CR_LOCKMR_Msk & (_UINT32_(value) << DWDT_PS_WDT_CR_LOCKMR_Pos)) /* Assigment of value for LOCKMR in the DWDT_PS_WDT_CR register */
...
#define DWDT_PS_WDT_CR_KEY(value)             (DWDT_PS_WDT_CR_KEY_Msk & (_UINT32_(value) << DWDT_PS_WDT_CR_KEY_Pos)) /* Assigment of value for KEY in the DWDT_PS_WDT_CR register */
...
#define DWDT_PS_WDT_MR_PERIODRST(value)       (DWDT_PS_WDT_MR_PERIODRST_Msk & (_UINT32_(value) << DWDT_PS_WDT_MR_PERIODRST_Pos)) /* Assigment of value for PERIODRST in the DWDT_PS_WDT_MR register */
...
#define DWDT_PS_WDT_MR_RPTHRST(value)         (DWDT_PS_WDT_MR_RPTHRST_Msk & (_UINT32_(value) << DWDT_PS_WDT_MR_RPTHRST_Pos)) /* Assigment of value for RPTHRST in the DWDT_PS_WDT_MR register */
...
#define DWDT_PS_WDT_MR_WDDIS(value)           (DWDT_PS_WDT_MR_WDDIS_Msk & (_UINT32_(value) << DWDT_PS_WDT_MR_WDDIS_Pos)) /* Assigment of value for WDDIS in the DWDT_PS_WDT_MR register */
...
#define DWDT_PS_WDT_MR_WDIDLEHLT(value)       (DWDT_PS_WDT_MR_WDIDLEHLT_Msk & (_UINT32_(value) << DWDT_PS_WDT_MR_WDIDLEHLT_Pos)) /* Assigment of value for WDIDLEHLT in the DWDT_PS_WDT_MR register */
...
#define DWDT_PS_WDT_MR_WDDBGHLT(value)        (DWDT_PS_WDT_MR_WDDBGHLT_Msk & (_UINT32_(value) << DWDT_PS_WDT_MR_WDDBGHLT_Pos)) /* Assigment of value for WDDBGHLT in the DWDT_PS_WDT_MR register */
...
#define DWDT_PS_WDT_VR_COUNTER(value)         (DWDT_PS_WDT_VR_COUNTER_Msk & (_UINT32_(value) << DWDT_PS_WDT_VR_COUNTER_Pos)) /* Assigment of value for COUNTER in the DWDT_PS_WDT_VR register */
...
#define DWDT_PS_WDT_WL_PERIOD(value)          (DWDT_PS_WDT_WL_PERIOD_Msk & (_UINT32_(value) << DWDT_PS_WDT_WL_PERIOD_Pos)) /* Assigment of value for PERIOD in the DWDT_PS_WDT_WL register */
...
#define DWDT_PS_WDT_WL_RPTH(value)            (DWDT_PS_WDT_WL_RPTH_Msk & (_UINT32_(value) << DWDT_PS_WDT_WL_RPTH_Pos)) /* Assigment of value for RPTH in the DWDT_PS_WDT_WL register */
...
#endif /* _SAMA7D6_DWDT_COMPONENT_H_ */
