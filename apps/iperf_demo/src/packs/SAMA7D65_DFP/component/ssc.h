...
#define SSC_RHFR_RDAT(value)                  (SSC_RHFR_RDAT_Msk & (_UINT32_(value) << SSC_RHFR_RDAT_Pos)) /* Assigment of value for RDAT in the SSC_RHFR register */
...
#define SSC_THFR_TDAT(value)                  (SSC_THFR_TDAT_Msk & (_UINT32_(value) << SSC_THFR_TDAT_Pos)) /* Assigment of value for TDAT in the SSC_THFR register */
...
#define SSC_FFMR_TXFIFODIS(value)             (SSC_FFMR_TXFIFODIS_Msk & (_UINT32_(value) << SSC_FFMR_TXFIFODIS_Pos)) /* Assigment of value for TXFIFODIS in the SSC_FFMR register */
...
#define SSC_FFMR_THRS(value)                  (SSC_FFMR_THRS_Msk & (_UINT32_(value) << SSC_FFMR_THRS_Pos)) /* Assigment of value for THRS in the SSC_FFMR register */
...
#define SSC_FFMR_RXFIFODIS(value)             (SSC_FFMR_RXFIFODIS_Msk & (_UINT32_(value) << SSC_FFMR_RXFIFODIS_Pos)) /* Assigment of value for RXFIFODIS in the SSC_FFMR register */
...
#define SSC_DAMR_DATXEN(value)                (SSC_DAMR_DATXEN_Msk & (_UINT32_(value) << SSC_DAMR_DATXEN_Pos)) /* Assigment of value for DATXEN in the SSC_DAMR register */
...
#define SSC_DAMR_DARXEN(value)                (SSC_DAMR_DARXEN_Msk & (_UINT32_(value) << SSC_DAMR_DARXEN_Pos)) /* Assigment of value for DARXEN in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN0(value)               (SSC_DAMR_DATCEN0_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN0_Pos)) /* Assigment of value for DATCEN0 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN1(value)               (SSC_DAMR_DATCEN1_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN1_Pos)) /* Assigment of value for DATCEN1 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN2(value)               (SSC_DAMR_DATCEN2_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN2_Pos)) /* Assigment of value for DATCEN2 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN3(value)               (SSC_DAMR_DATCEN3_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN3_Pos)) /* Assigment of value for DATCEN3 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN4(value)               (SSC_DAMR_DATCEN4_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN4_Pos)) /* Assigment of value for DATCEN4 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN5(value)               (SSC_DAMR_DATCEN5_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN5_Pos)) /* Assigment of value for DATCEN5 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN6(value)               (SSC_DAMR_DATCEN6_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN6_Pos)) /* Assigment of value for DATCEN6 in the SSC_DAMR register */
...
#define SSC_DAMR_DATCEN7(value)               (SSC_DAMR_DATCEN7_Msk & (_UINT32_(value) << SSC_DAMR_DATCEN7_Pos)) /* Assigment of value for DATCEN7 in the SSC_DAMR register */
...
#define SSC_SR_TXFRECNT(value)                (SSC_SR_TXFRECNT_Msk & (_UINT32_(value) << SSC_SR_TXFRECNT_Pos)) /* Assigment of value for TXFRECNT in the SSC_SR register */
...
#define SSC_SR_RXURWCNT(value)                (SSC_SR_RXURWCNT_Msk & (_UINT32_(value) << SSC_SR_RXURWCNT_Pos)) /* Assigment of value for RXURWCNT in the SSC_SR register */
...
#define SSC_WPMR_WPITEN(value)                (SSC_WPMR_WPITEN_Msk & (_UINT32_(value) << SSC_WPMR_WPITEN_Pos)) /* Assigment of value for WPITEN in the SSC_WPMR register */
...
#define SSC_WPMR_WPCREN(value)                (SSC_WPMR_WPCREN_Msk & (_UINT32_(value) << SSC_WPMR_WPCREN_Pos)) /* Assigment of value for WPCREN in the SSC_WPMR register */
...
#endif /* _SAMA7D6_SSC_COMPONENT_H_ */
