...
#ifndef _SAMA7D6_SHA_COMPONENT_H_
#define _SAMA7D6_SHA_COMPONENT_H_
...
#define   SHA_CR_START_0_Val                  _UINT32_(0x0)                                        /* (SHA_CR) No effect.  */
#define   SHA_CR_START_1_Val                  _UINT32_(0x1)                                        /* (SHA_CR) Starts manual hash algorithm process.  */
...
#define   SHA_CR_SWRST_0_Val                  _UINT32_(0x0)                                        /* (SHA_CR) No effect.  */
#define   SHA_CR_SWRST_1_Val                  _UINT32_(0x1)                                        /* (SHA_CR) Resets the SHA. A software-triggered hardware reset of the SHA interface is performed.  */
...
#define   SHA_CR_WUIHV_0_Val                  _UINT32_(0x0)                                        /* (SHA_CR) SHA_IDATARx accesses are routed to the data registers.  */
#define   SHA_CR_WUIHV_1_Val                  _UINT32_(0x1)                                        /* (SHA_CR) SHA_IDATARx accesses are routed to the internal registers (IR0).  */
...
#define   SHA_CR_WUIEHV_0_Val                 _UINT32_(0x0)                                        /* (SHA_CR) SHA_IDATARx accesses are routed to the data registers.  */
#define   SHA_CR_WUIEHV_1_Val                 _UINT32_(0x1)                                        /* (SHA_CR) SHA_IDATARx accesses are routed to the internal registers (IR1).  */
...
#define   SHA_CR_UNLOCK_0_Val                 _UINT32_(0x0)                                        /* (SHA_CR) No effect.  */
#define   SHA_CR_UNLOCK_1_Val                 _UINT32_(0x1)                                        /* (SHA_CR) Unlocks the processing in case of abnormal event detection if SHA_WPMR.ACTION > 0.  */
...
#define SHA_MR_RESETVALUE                     _UINT32_(0x100)                                      /*  (SHA_MR) Mode Register  Reset Value */
...
#define   SHA_MR_AOE_0_Val                    _UINT32_(0x0)                                        /* (SHA_MR) The SHA operates in functional operating modes.  */
#define   SHA_MR_AOE_1_Val                    _UINT32_(0x1)                                        /* (SHA_MR) As soon as a START command is written, the SHA processes dummy calculations until AOE=0, without software intervention. This can be used to create an additional current consumption when AES is used to encrypt/decrypt.  */
...
#define   SHA_MR_BPE_0_Val                    _UINT32_(0x0)                                        /* (SHA_MR) BPE must be cleared when a DMA transfers data. When SMOD=2, SHA_ISR.DATRDY flag rises only when the SHA or HMAC processing cycle has completed. No intermediate block processing is reported.  */
#define   SHA_MR_BPE_1_Val                    _UINT32_(0x1)                                        /* (SHA_MR) When processing small messages, data transfer by software can improve performance compared to DMA. In this case, BPE can be written to 1, forcing the SHA_ISR.DATRDY to rise when a data must be loaded into SHA_IDATARx.  */
...
#define   SHA_MR_TMPLCK_0_Val                 _UINT32_(0x0)                                        /* (SHA_MR) A tamper event has no effect.  */
#define   SHA_MR_TMPLCK_1_Val                 _UINT32_(0x1)                                        /* (SHA_MR) A tamper event locks the SHA until the tamper root cause is cleared and SHA_CR.UNLOCK is written to 1.  */
...
#define SHA_IER_Msk                           _UINT32_(0x01010101)                                 /* (SHA_IER) Register Mask  */
...
#define SHA_IDR_Msk                           _UINT32_(0x01010101)                                 /* (SHA_IDR) Register Mask  */


/* -------- SHA_IMR : (SHA Offset: 0x18) ( R/ 32) Interrupt Mask Register -------- */
#define SHA_IMR_RESETVALUE                    _UINT32_(0x00)                                       /*  (SHA_IMR) Interrupt Mask Register  Reset Value */
...
#define SHA_IMR_Msk                           _UINT32_(0x01010101)                                 /* (SHA_IMR) Register Mask  */


/* -------- SHA_ISR : (SHA Offset: 0x1C) ( R/ 32) Interrupt Status Register -------- */
#define SHA_ISR_RESETVALUE                    _UINT32_(0x00)                                       /*  (SHA_ISR) Interrupt Status Register  Reset Value */
...
#define   SHA_ISR_DATRDY_0_Val                _UINT32_(0x0)                                        /* (SHA_ISR) Output data is not valid.  */
#define   SHA_ISR_DATRDY_1_Val                _UINT32_(0x1)                                        /* (SHA_ISR) 512/1024-bit block process is completed.  */
...
#define   SHA_ISR_WRDY_0_Val                  _UINT32_(0x0)                                        /* (SHA_ISR) SHA_IDATAR0 cannot be written  */
#define   SHA_ISR_WRDY_1_Val                  _UINT32_(0x1)                                        /* (SHA_ISR) SHA_IDATAR0 can be written  */
...
#define   SHA_ISR_URAD_0_Val                  _UINT32_(0x0)                                        /* (SHA_ISR) No unspecified register access has been detected since the last SWRST.  */
#define   SHA_ISR_URAD_1_Val                  _UINT32_(0x1)                                        /* (SHA_ISR) At least one unspecified register access has been detected since the last SWRST.  */
...
#define   SHA_ISR_CHECKF_0_Val                _UINT32_(0x0)                                        /* (SHA_ISR) Hash check has not been computed.  */
#define   SHA_ISR_CHECKF_1_Val                _UINT32_(0x1)                                        /* (SHA_ISR) Hash check has been computed, status is available in the CHKST bits.  */
...
#define   SHA_ISR_SECE_0_Val                  _UINT32_(0x0)                                        /* (SHA_ISR) There is no report in SHA_WPSR.  */
#define   SHA_ISR_SECE_1_Val                  _UINT32_(0x1)                                        /* (SHA_ISR) There is a Security and/or Safety Event reported in SHA_WPSR.  */
...
#define SHA_ISR_Msk                           _UINT32_(0x01F17111)                                 /* (SHA_ISR) Register Mask  */


/* -------- SHA_MSR : (SHA Offset: 0x20) (R/W 32) Message Size Register -------- */
#define SHA_MSR_RESETVALUE                    _UINT32_(0x00)                                       /*  (SHA_MSR) Message Size Register  Reset Value */
...
#define SHA_BCR_RESETVALUE                    _UINT32_(0x00)                                       /*  (SHA_BCR) Bytes Count Register  Reset Value */
...
#define SHA_IODATAR_RESETVALUE                _UINT32_(0x00)                                       /*  (SHA_IODATAR) Input/Output Data x Register  Reset Value */
...
#define SHA_WPMR_RESETVALUE                   _UINT32_(0x00)                                       /*  (SHA_WPMR) Write Protection Mode Register  Reset Value */
...
#define   SHA_WPMR_WPEN_0_Val                 _UINT32_(0x0)                                        /* (SHA_WPMR) Disables the write protection on configuration registers if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
#define   SHA_WPMR_WPEN_1_Val                 _UINT32_(0x1)                                        /* (SHA_WPMR) Enables the write protection on configuration registers if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
...
#define   SHA_WPMR_WPITEN_0_Val               _UINT32_(0x0)                                        /* (SHA_WPMR) Disables the write protection on interrupt registers if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
#define   SHA_WPMR_WPITEN_1_Val               _UINT32_(0x1)                                        /* (SHA_WPMR) Enables the write protection on interrupt registers if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
...
#define   SHA_WPMR_WPCREN_0_Val               _UINT32_(0x0)                                        /* (SHA_WPMR) Disables the write protection on control register if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
#define   SHA_WPMR_WPCREN_1_Val               _UINT32_(0x1)                                        /* (SHA_WPMR) Enables the write protection on control register if WPKEY corresponds to 0x534841 ("SHA" in ASCII).  */
...
#define   SHA_WPMR_FIRSTE_0_Val               _UINT32_(0x0)                                        /* (SHA_WPMR) The last write protection violation source is reported in SHA_WPSR.WPVSRC and the last software control error type is reported in SHA_WPSR.SWETYP. The SHA_ISR.SECE flag is set at the first error occurrence within a series.  */
#define   SHA_WPMR_FIRSTE_1_Val               _UINT32_(0x1)                                        /* (SHA_WPMR) Only the first write protection violation source is reported in SHA_WPSR.WPVSRC and only the first software control error type is reported in SHA_WPSR.SWETYP. The SHA_ISR.SECE flag is set at the first error occurrence within a series.  */
...
#define SHA_WPSR_RESETVALUE                   _UINT32_(0x00)                                       /*  (SHA_WPSR) Write Protection Status Register  Reset Value */
...
#define   SHA_WPSR_WPVS_0_Val                 _UINT32_(0x0)                                        /* (SHA_WPSR) No write protect violation has occurred since the last read of SHA_WPSR.  */
#define   SHA_WPSR_WPVS_1_Val                 _UINT32_(0x1)                                        /* (SHA_WPSR) A write protect violation has occurred since the last read of SHA_WPSR. The address offset of the violated register is reported into field WPVSRC.  */
...
#define   SHA_WPSR_CGD_0_Val                  _UINT32_(0x0)                                        /* (SHA_WPSR) The clock monitoring circuitry has not been corrupted since the last read of SHA_WPSR. Under normal operating conditions, this bit is always cleared.  */
#define   SHA_WPSR_CGD_1_Val                  _UINT32_(0x1)                                        /* (SHA_WPSR) The clock monitoring circuitry has been corrupted since the last read of SHA_WPSR. This flag can only be set in case of an abnormal clock signal waveform (glitch).  */
...
#define   SHA_WPSR_SEQE_0_Val                 _UINT32_(0x0)                                        /* (SHA_WPSR) No peripheral internal sequencer error has occurred since the last read of SHA_WPSR.  */
#define   SHA_WPSR_SEQE_1_Val                 _UINT32_(0x1)                                        /* (SHA_WPSR) A peripheral internal sequencer error has occurred since the last read of SHA_WPSR. This flag can only be set under abnormal operating conditions.  */
...
#define   SHA_WPSR_SWE_0_Val                  _UINT32_(0x0)                                        /* (SHA_WPSR) No software error has occurred since the last read of SHA_WPSR.  */
#define   SHA_WPSR_SWE_1_Val                  _UINT32_(0x1)                                        /* (SHA_WPSR) A software error has occurred since the last read of SHA_WPSR. The field SWETYP details the type of software error; the associated incorrect software access is reported in the field WPVSRC (if WPVS=0).  */
...
#define SHA_IDATAR_REG_OFST            _UINT32_(0x40)      /* (SHA_IDATAR) Input Data x Register Offset */
#define SHA_IDATAR0_REG_OFST           _UINT32_(0x40)      /* (SHA_IDATAR0) Input Data x Register Offset */
#define SHA_IDATAR1_REG_OFST           _UINT32_(0x44)      /* (SHA_IDATAR1) Input Data x Register Offset */
#define SHA_IDATAR2_REG_OFST           _UINT32_(0x48)      /* (SHA_IDATAR2) Input Data x Register Offset */
#define SHA_IDATAR3_REG_OFST           _UINT32_(0x4C)      /* (SHA_IDATAR3) Input Data x Register Offset */
#define SHA_IDATAR4_REG_OFST           _UINT32_(0x50)      /* (SHA_IDATAR4) Input Data x Register Offset */
#define SHA_IDATAR5_REG_OFST           _UINT32_(0x54)      /* (SHA_IDATAR5) Input Data x Register Offset */
#define SHA_IDATAR6_REG_OFST           _UINT32_(0x58)      /* (SHA_IDATAR6) Input Data x Register Offset */
#define SHA_IDATAR7_REG_OFST           _UINT32_(0x5C)      /* (SHA_IDATAR7) Input Data x Register Offset */
#define SHA_IDATAR8_REG_OFST           _UINT32_(0x60)      /* (SHA_IDATAR8) Input Data x Register Offset */
#define SHA_IDATAR9_REG_OFST           _UINT32_(0x64)      /* (SHA_IDATAR9) Input Data x Register Offset */
#define SHA_IDATAR10_REG_OFST          _UINT32_(0x68)      /* (SHA_IDATAR10) Input Data x Register Offset */
#define SHA_IDATAR11_REG_OFST          _UINT32_(0x6C)      /* (SHA_IDATAR11) Input Data x Register Offset */
#define SHA_IDATAR12_REG_OFST          _UINT32_(0x70)      /* (SHA_IDATAR12) Input Data x Register Offset */
#define SHA_IDATAR13_REG_OFST          _UINT32_(0x74)      /* (SHA_IDATAR13) Input Data x Register Offset */
#define SHA_IDATAR14_REG_OFST          _UINT32_(0x78)      /* (SHA_IDATAR14) Input Data x Register Offset */
#define SHA_IDATAR15_REG_OFST          _UINT32_(0x7C)      /* (SHA_IDATAR15) Input Data x Register Offset */
#define SHA_IODATAR_REG_OFST           _UINT32_(0x80)      /* (SHA_IODATAR) Input/Output Data x Register Offset */
#define SHA_IODATAR0_REG_OFST          _UINT32_(0x80)      /* (SHA_IODATAR0) Input/Output Data x Register Offset */
#define SHA_IODATAR1_REG_OFST          _UINT32_(0x84)      /* (SHA_IODATAR1) Input/Output Data x Register Offset */
#define SHA_IODATAR2_REG_OFST          _UINT32_(0x88)      /* (SHA_IODATAR2) Input/Output Data x Register Offset */
#define SHA_IODATAR3_REG_OFST          _UINT32_(0x8C)      /* (SHA_IODATAR3) Input/Output Data x Register Offset */
#define SHA_IODATAR4_REG_OFST          _UINT32_(0x90)      /* (SHA_IODATAR4) Input/Output Data x Register Offset */
#define SHA_IODATAR5_REG_OFST          _UINT32_(0x94)      /* (SHA_IODATAR5) Input/Output Data x Register Offset */
#define SHA_IODATAR6_REG_OFST          _UINT32_(0x98)      /* (SHA_IODATAR6) Input/Output Data x Register Offset */
#define SHA_IODATAR7_REG_OFST          _UINT32_(0x9C)      /* (SHA_IODATAR7) Input/Output Data x Register Offset */
#define SHA_IODATAR8_REG_OFST          _UINT32_(0xA0)      /* (SHA_IODATAR8) Input/Output Data x Register Offset */
#define SHA_IODATAR9_REG_OFST          _UINT32_(0xA4)      /* (SHA_IODATAR9) Input/Output Data x Register Offset */
#define SHA_IODATAR10_REG_OFST         _UINT32_(0xA8)      /* (SHA_IODATAR10) Input/Output Data x Register Offset */
#define SHA_IODATAR11_REG_OFST         _UINT32_(0xAC)      /* (SHA_IODATAR11) Input/Output Data x Register Offset */
#define SHA_IODATAR12_REG_OFST         _UINT32_(0xB0)      /* (SHA_IODATAR12) Input/Output Data x Register Offset */
#define SHA_IODATAR13_REG_OFST         _UINT32_(0xB4)      /* (SHA_IODATAR13) Input/Output Data x Register Offset */
#define SHA_IODATAR14_REG_OFST         _UINT32_(0xB8)      /* (SHA_IODATAR14) Input/Output Data x Register Offset */
#define SHA_IODATAR15_REG_OFST         _UINT32_(0xBC)      /* (SHA_IODATAR15) Input/Output Data x Register Offset */
...
#endif /* _SAMA7D6_SHA_COMPONENT_H_ */
