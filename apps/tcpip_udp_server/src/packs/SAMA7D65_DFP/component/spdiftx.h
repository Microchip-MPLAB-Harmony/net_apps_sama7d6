...
#ifndef _SAMA7D6_SPDIFTX_COMPONENT_H_
#define _SAMA7D6_SPDIFTX_COMPONENT_H_
...
#define SPDIFTX_MR_TXDIRECT(value)            (SPDIFTX_MR_TXDIRECT_Msk & (_UINT32_(value) << SPDIFTX_MR_TXDIRECT_Pos)) /* Assigment of value for TXDIRECT in the SPDIFTX_MR register */
...
#define SPDIFTX_EMR_DTCEN0(value)             (SPDIFTX_EMR_DTCEN0_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN0_Pos)) /* Assigment of value for DTCEN0 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN1(value)             (SPDIFTX_EMR_DTCEN1_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN1_Pos)) /* Assigment of value for DTCEN1 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN2(value)             (SPDIFTX_EMR_DTCEN2_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN2_Pos)) /* Assigment of value for DTCEN2 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN3(value)             (SPDIFTX_EMR_DTCEN3_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN3_Pos)) /* Assigment of value for DTCEN3 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN4(value)             (SPDIFTX_EMR_DTCEN4_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN4_Pos)) /* Assigment of value for DTCEN4 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN5(value)             (SPDIFTX_EMR_DTCEN5_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN5_Pos)) /* Assigment of value for DTCEN5 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN6(value)             (SPDIFTX_EMR_DTCEN6_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN6_Pos)) /* Assigment of value for DTCEN6 in the SPDIFTX_EMR register */
...
#define SPDIFTX_EMR_DTCEN7(value)             (SPDIFTX_EMR_DTCEN7_Msk & (_UINT32_(value) << SPDIFTX_EMR_DTCEN7_Pos)) /* Assigment of value for DTCEN7 in the SPDIFTX_EMR register */
...
#define SPDIFTX_FIR_F0(value)                 (SPDIFTX_FIR_F0_Msk & (_UINT32_(value) << SPDIFTX_FIR_F0_Pos)) /* Assigment of value for F0 in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_F1(value)                 (SPDIFTX_FIR_F1_Msk & (_UINT32_(value) << SPDIFTX_FIR_F1_Pos)) /* Assigment of value for F1 in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_F2(value)                 (SPDIFTX_FIR_F2_Msk & (_UINT32_(value) << SPDIFTX_FIR_F2_Pos)) /* Assigment of value for F2 in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_F3(value)                 (SPDIFTX_FIR_F3_Msk & (_UINT32_(value) << SPDIFTX_FIR_F3_Pos)) /* Assigment of value for F3 in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_F4(value)                 (SPDIFTX_FIR_F4_Msk & (_UINT32_(value) << SPDIFTX_FIR_F4_Pos)) /* Assigment of value for F4 in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_FNBR(value)               (SPDIFTX_FIR_FNBR_Msk & (_UINT32_(value) << SPDIFTX_FIR_FNBR_Pos)) /* Assigment of value for FNBR in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_FIRDIS(value)             (SPDIFTX_FIR_FIRDIS_Msk & (_UINT32_(value) << SPDIFTX_FIR_FIRDIS_Pos)) /* Assigment of value for FIRDIS in the SPDIFTX_FIR register */
...
#define SPDIFTX_FIR_FIKEY(value)              (SPDIFTX_FIR_FIKEY_Msk & (_UINT32_(value) << SPDIFTX_FIR_FIKEY_Pos)) /* Assigment of value for FIKEY in the SPDIFTX_FIR register */
...
#define SPDIFTX_WPSR_SDEE(value)              (SPDIFTX_WPSR_SDEE_Msk & (_UINT32_(value) << SPDIFTX_WPSR_SDEE_Pos)) /* Assigment of value for SDEE in the SPDIFTX_WPSR register */
...
#define SPDIFTX_WPSR_NCE(value)               (SPDIFTX_WPSR_NCE_Msk & (_UINT32_(value) << SPDIFTX_WPSR_NCE_Pos)) /* Assigment of value for NCE in the SPDIFTX_WPSR register */
...
#endif /* _SAMA7D6_SPDIFTX_COMPONENT_H_ */
