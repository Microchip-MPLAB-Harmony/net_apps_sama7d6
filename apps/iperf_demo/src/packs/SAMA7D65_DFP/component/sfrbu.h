...
#ifndef _SAMA7D6_SFRBU_COMPONENT_H_
#define _SAMA7D6_SFRBU_COMPONENT_H_
...
#define SFRBU_DDRPWR_RETENTION(value)         (SFRBU_DDRPWR_RETENTION_Msk & (_UINT32_(value) << SFRBU_DDRPWR_RETENTION_Pos)) /* Assigment of value for RETENTION in the SFRBU_DDRPWR register */
...
#endif /* _SAMA7D6_SFRBU_COMPONENT_H_ */
