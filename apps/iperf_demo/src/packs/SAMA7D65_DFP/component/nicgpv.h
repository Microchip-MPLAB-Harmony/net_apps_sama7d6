...
#ifndef _SAMA7D6_NICGPV_COMPONENT_H_
#define _SAMA7D6_NICGPV_COMPONENT_H_
...
/** \brief NICGPV_AMIB_FN_MOD_BM_ISS register API structure */
typedef struct
{
...
#endif /* _SAMA7D6_NICGPV_COMPONENT_H_ */
