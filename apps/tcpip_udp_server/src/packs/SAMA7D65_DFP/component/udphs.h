...
#ifndef _SAMA7D6_UDPHS_COMPONENT_H_
#define _SAMA7D6_UDPHS_COMPONENT_H_
...
#define UDPHS_DMACONTROL_RESETVALUE           _UINT32_(0x00)                                       /*  (UDPHS_DMACONTROL) UDPHS DMA Channel Control Register   Reset Value */
...
#define   UDPHS_DMACONTROL_CHANN_ENB_0_Val    _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) DMA channel is disabled at and no transfer will occur upon request. This bit is also cleared by hardware when the channel source bus is disabled at end of buffer.  */
#define   UDPHS_DMACONTROL_CHANN_ENB_1_Val    _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) UDPHS_DMASTATUS register CHANN_ENB bit will be set, thus enabling DMA channel data transfer. Then any pending request will start the transfer. This may be used to start or resume any requested transfer.  */
...
#define   UDPHS_DMACONTROL_LDNXT_DSC_0_Val    _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) No channel register is loaded after the end of the channel transfer.  */
#define   UDPHS_DMACONTROL_LDNXT_DSC_1_Val    _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) The channel controller loads the next descriptor after the end of the current transfer, i.e., when the UDPHS_DMASTATUS/CHANN_ENB bit is reset.  */
...
#define   UDPHS_DMACONTROL_END_TR_EN_0_Val    _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) USB end of transfer is ignored.  */
#define   UDPHS_DMACONTROL_END_TR_EN_1_Val    _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) UDPHS device can put an end to the current buffer transfer.  */
...
#define   UDPHS_DMACONTROL_END_B_EN_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) DMA Buffer End has no impact on USB packet transfer.  */
#define   UDPHS_DMACONTROL_END_B_EN_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) Endpoint can validate the packet (according to the values programmed in the UDPHS_EPTCTLx register AUTO_VALID and SHRT_PCKT fields) at DMA Buffer End, i.e., when the UDPHS_DMASTATUS register BUFF_COUNT reaches 0.  */
...
#define   UDPHS_DMACONTROL_END_TR_IT_0_Val    _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) UDPHS device initiated buffer transfer completion will not trigger any interrupt at UDPHS_STATUSx/END_TR_ST rising.  */
#define   UDPHS_DMACONTROL_END_TR_IT_1_Val    _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) An interrupt is sent after the buffer transfer is complete, if the UDPHS device has ended the buffer transfer.  */
...
#define   UDPHS_DMACONTROL_END_BUFFIT_0_Val   _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) UDPHS_DMA_STATUSx/END_BF_ST rising will not trigger any interrupt.  */
#define   UDPHS_DMACONTROL_END_BUFFIT_1_Val   _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) An interrupt is generated when the UDPHS_DMASTATUSx register BUFF_COUNT reaches zero.  */
...
#define   UDPHS_DMACONTROL_DESC_LD_IT_0_Val   _UINT32_(0x0)                                        /* (UDPHS_DMACONTROL) UDPHS_DMASTATUSx/DESC_LDST rising will not trigger any interrupt.  */
#define   UDPHS_DMACONTROL_DESC_LD_IT_1_Val   _UINT32_(0x1)                                        /* (UDPHS_DMACONTROL) An interrupt is generated when a descriptor has been loaded from the bus.  */
...
#define UDPHS_DMASTATUS_RESETVALUE            _UINT32_(0x00)                                       /*  (UDPHS_DMASTATUS) UDPHS DMA Channel Status Register   Reset Value */
...
#define   UDPHS_DMASTATUS_CHANN_ENB_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMASTATUS) The DMA channel no longer transfers data, and may load the next descriptor if the UDPHS_DMACONTROLx register LDNXT_DSC bit is set.  */
#define   UDPHS_DMASTATUS_CHANN_ENB_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMASTATUS) The DMA channel is currently enabled and transfers data upon request.  */
...
#define   UDPHS_DMASTATUS_CHANN_ACT_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMASTATUS) The DMA channel is no longer trying to source the packet data.  */
#define   UDPHS_DMASTATUS_CHANN_ACT_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMASTATUS) The DMA channel is currently trying to source packet data, i.e., selected as the highest-priority requesting channel.  */
...
#define   UDPHS_DMASTATUS_END_TR_ST_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMASTATUS) Cleared automatically when read by software.  */
#define   UDPHS_DMASTATUS_END_TR_ST_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMASTATUS) Set by hardware when the last packet transfer is complete, if the UDPHS device has ended the transfer.  */
...
#define   UDPHS_DMASTATUS_END_BF_ST_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMASTATUS) Cleared automatically when read by software.  */
#define   UDPHS_DMASTATUS_END_BF_ST_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMASTATUS) Set by hardware when the BUFF_COUNT countdown reaches zero.  */
...
#define   UDPHS_DMASTATUS_DESC_LDST_0_Val     _UINT32_(0x0)                                        /* (UDPHS_DMASTATUS) Cleared automatically when read by software.  */
#define   UDPHS_DMASTATUS_DESC_LDST_1_Val     _UINT32_(0x1)                                        /* (UDPHS_DMASTATUS) Set by hardware when a descriptor has been loaded from the system bus.  */
...
#define UDPHS_EPTCFG_RESETVALUE               _UINT32_(0x00)                                       /*  (UDPHS_EPTCFG) UDPHS Endpoint Configuration Register   Reset Value */
...
#define   UDPHS_EPTCFG_EPT_DIR_0_Val          _UINT32_(0x0)                                        /* (UDPHS_EPTCFG) Clear this bit to configure OUT direction for Bulk, Interrupt and Isochronous endpoints.  */
#define   UDPHS_EPTCFG_EPT_DIR_1_Val          _UINT32_(0x1)                                        /* (UDPHS_EPTCFG) Set this bit to configure IN direction for Bulk, Interrupt and Isochronous endpoints.  */
...
#define UDPHS_EPTCFG_NB_TRANS_Pos             _UINT32_(8)                                          /* (UDPHS_EPTCFG) Number Of Transactions per Microframe (cleared upon USB reset) Position */
#define UDPHS_EPTCFG_NB_TRANS_Msk             (_UINT32_(0x3) << UDPHS_EPTCFG_NB_TRANS_Pos)         /* (UDPHS_EPTCFG) Number Of Transactions per Microframe (cleared upon USB reset) Mask */
...
#define   UDPHS_EPTCFG_EPT_MAPD_0_Val         _UINT32_(0x0)                                        /* (UDPHS_EPTCFG) The user should reprogram the register with correct values.  */
#define   UDPHS_EPTCFG_EPT_MAPD_1_Val         _UINT32_(0x1)                                        /* (UDPHS_EPTCFG) Set by hardware when the endpoint size (EPT_SIZE) and the number of banks (BK_NUMBER) are correct regarding:  */
...
#define   UDPHS_EPTCTLDIS_EPT_DISABL_0_Val    _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_EPT_DISABL_1_Val    _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable endpoint.  */
...
#define   UDPHS_EPTCTLDIS_AUTO_VALID_0_Val    _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_AUTO_VALID_1_Val    _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable this bit to not automatically validate the current packet.  */
...
#define   UDPHS_EPTCTLDIS_INTDIS_DMA_0_Val    _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_INTDIS_DMA_1_Val    _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable the "Interrupts Disable DMA".  */
...
#define   UDPHS_EPTCTLDIS_NYET_DIS_0_Val      _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_NYET_DIS_1_Val      _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Let the hardware handle the handshake response for the High Speed Bulk OUT transfer.  */
...
#define   UDPHS_EPTCTLDIS_ERR_OVFLW_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ERR_OVFLW_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Overflow Error Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_RXRDY_TXKL_0_Val    _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_RXRDY_TXKL_1_Val    _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Received OUT Data Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_TX_COMPLT_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_TX_COMPLT_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Transmitted IN Data Complete Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_TXRDY_0_Val         _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_TXRDY_1_Val         _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable TX Packet Ready/Transaction Error Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_RX_SETUP_0_Val      _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_RX_SETUP_1_Val      _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable RX_SETUP Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_STALL_SNT_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_STALL_SNT_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Stall Sent Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_NAK_IN_0_Val        _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_NAK_IN_1_Val        _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable NAKIN Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_NAK_OUT_0_Val       _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_NAK_OUT_1_Val       _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable NAKOUT Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_BUSY_BANK_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_BUSY_BANK_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Busy Bank Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_SHRT_PCKT_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_SHRT_PCKT_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Short Packet Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_DATAX_RX_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_DATAX_RX_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable DATAx Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_MDATA_RX_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_MDATA_RX_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable MDATA Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_TXRDY_TRER_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_TXRDY_TRER_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable TX Packet Ready/Transaction Error Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_FL_ISO_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_FL_ISO_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Error Flow ISO Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_CRC_NTR_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_CRC_NTR_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Error CRC ISO/Error Number of Transaction Interrupt.  */
...
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_FLUSH_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTCTLDIS) No effect.  */
#define   UDPHS_EPTCTLDIS_ISOENDPT_ERR_FLUSH_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTCTLDIS) Disable Bank Flush Error Interrupt.  */
...
#define   UDPHS_EPTSETSTA_FRCESTALL_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTSETSTA) No effect.  */
#define   UDPHS_EPTSETSTA_FRCESTALL_1_Val     _UINT32_(0x1)                                        /* (UDPHS_EPTSETSTA) Set this bit to request a STALL answer to the host for the next handshake  */
...
#define   UDPHS_EPTSETSTA_RXRDY_TXKL_0_Val    _UINT32_(0x0)                                        /* (UDPHS_EPTSETSTA) No effect.  */
#define   UDPHS_EPTSETSTA_RXRDY_TXKL_1_Val    _UINT32_(0x1)                                        /* (UDPHS_EPTSETSTA) Kill the last written bank.  */
...
#define   UDPHS_EPTSETSTA_TXRDY_0_Val         _UINT32_(0x0)                                        /* (UDPHS_EPTSETSTA) No effect.  */
#define   UDPHS_EPTSETSTA_TXRDY_1_Val         _UINT32_(0x1)                                        /* (UDPHS_EPTSETSTA) Set this bit after a packet has been written into the endpoint FIFO for IN data transfers  */
...
#define   UDPHS_EPTSETSTA_ISOENDPT_TXRDY_TRER_0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTSETSTA) No effect.  */
#define   UDPHS_EPTSETSTA_ISOENDPT_TXRDY_TRER_1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTSETSTA) Set this bit after a packet has been written into the endpoint FIFO for IN data transfers  */
...
#define UDPHS_EPTSTA_RESETVALUE               _UINT32_(0x40)                                       /*  (UDPHS_EPTSTA) UDPHS Endpoint Status Register   Reset Value */
...
#define   UDPHS_EPTSTA_FRCESTALL_0_Val        _UINT32_(0x0)                                        /* (UDPHS_EPTSTA) No effect.  */
#define   UDPHS_EPTSTA_FRCESTALL_1_Val        _UINT32_(0x1)                                        /* (UDPHS_EPTSTA) If set a STALL answer will be done to the host for the next handshake.  */
...
#define   UDPHS_CTRL_FADDR_EN_0_Val           _UINT32_(0x0)                                        /* (UDPHS_CTRL) The device is not in Address state (read), or only the default function address is used (write).  */
#define   UDPHS_CTRL_FADDR_EN_1_Val           _UINT32_(0x1)                                        /* (UDPHS_CTRL) The device is in Address state (read), or this bit is set by the device firmware after a successful status phase of a SET_ADDRESS transaction (write). When set, the only address accepted by the UDPHS controller is the one stored in the UDPHS Address field. It will not be cleared afterwards by the device firmware. It is cleared by hardware on hardware reset, or when UDPHS bus reset is received.  */
#define UDPHS_CTRL_FADDR_EN_0                 (UDPHS_CTRL_FADDR_EN_0_Val << UDPHS_CTRL_FADDR_EN_Pos) /* (UDPHS_CTRL) The device is not in Address state (read), or only the default function address is used (write). Position  */
#define UDPHS_CTRL_FADDR_EN_1                 (UDPHS_CTRL_FADDR_EN_1_Val << UDPHS_CTRL_FADDR_EN_Pos) /* (UDPHS_CTRL) The device is in Address state (read), or this bit is set by the device firmware after a successful status phase of a SET_ADDRESS transaction (write). When set, the only address accepted by the UDPHS controller is the one stored in the UDPHS Address field. It will not be cleared afterwards by the device firmware. It is cleared by hardware on hardware reset, or when UDPHS bus reset is received. Position  */
...
#define   UDPHS_CTRL_DETACH_0_Val             _UINT32_(0x0)                                        /* (UDPHS_CTRL) UDPHS is attached (read), or this bit pulls up the DP line (attach command) (write).  */
...
#define UDPHS_IEN_RESETVALUE                  _UINT32_(0x10)                                       /*  (UDPHS_IEN) UDPHS Interrupt Enable Register  Reset Value */
...
#define   UDPHS_IEN_DET_SUSPD_0_Val           _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable Suspend Interrupt.  */
#define   UDPHS_IEN_DET_SUSPD_1_Val           _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable Suspend Interrupt.  */
...
#define   UDPHS_IEN_MICRO_SOF_0_Val           _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable Micro-SOF Interrupt.  */
#define   UDPHS_IEN_MICRO_SOF_1_Val           _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable Micro-SOF Interrupt.  */
...
#define   UDPHS_IEN_INT_SOF_0_Val             _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable SOF Interrupt.  */
#define   UDPHS_IEN_INT_SOF_1_Val             _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable SOF Interrupt.  */
...
#define   UDPHS_IEN_ENDRESET_0_Val            _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable End Of Reset Interrupt.  */
#define   UDPHS_IEN_ENDRESET_1_Val            _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable End Of Reset Interrupt. Automatically enabled after USB reset.  */
...
#define   UDPHS_IEN_ENDOFRSM_0_Val            _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable Resume Interrupt.  */
#define   UDPHS_IEN_ENDOFRSM_1_Val            _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable Resume Interrupt.  */
...
#define   UDPHS_IEN_UPSTR_RES_0_Val           _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable Upstream Resume Interrupt.  */
#define   UDPHS_IEN_UPSTR_RES_1_Val           _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable Upstream Resume Interrupt.  */
...
#define   UDPHS_IEN_EPT_0_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_0_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_1_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_1_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_2_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_2_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_3_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_3_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_4_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_4_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_5_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_5_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_6_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_6_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_7_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_7_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_8_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_8_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_9_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_9_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_10_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_10_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_11_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_11_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_12_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_12_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_13_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_13_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_14_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_14_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_EPT_15_0_Val              _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this endpoint.  */
#define   UDPHS_IEN_EPT_15_1_Val              _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this endpoint.  */
...
#define   UDPHS_IEN_DMA_1_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
#define   UDPHS_IEN_DMA_1_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this channel.  */
...
#define   UDPHS_IEN_DMA_2_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
#define   UDPHS_IEN_DMA_2_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this channel.  */
...
#define   UDPHS_IEN_DMA_3_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
#define   UDPHS_IEN_DMA_3_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this channel.  */
...
#define   UDPHS_IEN_DMA_4_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
#define   UDPHS_IEN_DMA_4_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this channel.  */
...
#define   UDPHS_IEN_DMA_5_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
#define   UDPHS_IEN_DMA_5_1_Val               _UINT32_(0x1)                                        /* (UDPHS_IEN) Enable the interrupts for this channel.  */
...
#define   UDPHS_IEN_DMA_6_0_Val               _UINT32_(0x0)                                        /* (UDPHS_IEN) Disable the interrupts for this channel.  */
...
#define UDPHS_INTSTA_RESETVALUE               _UINT32_(0x00)                                       /*  (UDPHS_INTSTA) UDPHS Interrupt Status Register  Reset Value */
...
#define   UDPHS_INTSTA_SPEED_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset by hardware when the hardware is in Full Speed mode.  */
#define   UDPHS_INTSTA_SPEED_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when the hardware is in High Speed mode.  */
...
#define   UDPHS_INTSTA_DET_SUSPD_0_Val        _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Cleared by setting the DET_SUSPD bit in UDPHS_CLRINT register.  */
#define   UDPHS_INTSTA_DET_SUSPD_1_Val        _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when a UDPHS Suspend (Idle bus for three frame periods, a J state for 3 ms) is detected. This triggers a UDPHS interrupt when the DET_SUSPD bit is set in UDPHS_IEN register.  */
...
#define   UDPHS_INTSTA_ENDRESET_0_Val         _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Cleared by setting the ENDRESET bit in UDPHS_CLRINT.  */
#define   UDPHS_INTSTA_ENDRESET_1_Val         _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an End Of Reset has been detected by the UDPHS controller. This triggers a UDPHS interrupt when the ENDRESET bit is set in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_ENDOFRSM_0_Val         _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Cleared by setting the ENDOFRSM bit in UDPHS_CLRINT.  */
#define   UDPHS_INTSTA_ENDOFRSM_1_Val         _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when the UDPHS controller detects a good end of resume signal initiated by the host. This triggers a UDPHS interrupt when the ENDOFRSM bit is set in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_UPSTR_RES_0_Val        _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Cleared by setting the UPSTR_RES bit in UDPHS_CLRINT.  */
#define   UDPHS_INTSTA_UPSTR_RES_1_Val        _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when the UDPHS controller is sending a resume signal called "upstream resume". This triggers a UDPHS interrupt when the UPSTR_RES bit is set in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_0_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_0_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_1_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_1_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_2_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_2_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_3_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_3_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_4_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_4_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_5_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_5_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_6_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_6_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_7_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_7_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_8_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_8_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_9_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_9_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_10_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_10_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_11_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_11_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_12_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_12_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_13_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_13_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_14_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_14_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_EPT_15_0_Val           _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_EPTSTAx interrupt source is cleared.  */
#define   UDPHS_INTSTA_EPT_15_1_Val           _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the UDPHS_EPTSTAx register and this endpoint interrupt is enabled by the EPT_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_1_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
#define   UDPHS_INTSTA_DMA_1_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the DMA Channelx and this endpoint interrupt is enabled by the DMA_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_2_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
#define   UDPHS_INTSTA_DMA_2_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the DMA Channelx and this endpoint interrupt is enabled by the DMA_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_3_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
#define   UDPHS_INTSTA_DMA_3_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the DMA Channelx and this endpoint interrupt is enabled by the DMA_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_4_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
#define   UDPHS_INTSTA_DMA_4_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the DMA Channelx and this endpoint interrupt is enabled by the DMA_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_5_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
#define   UDPHS_INTSTA_DMA_5_1_Val            _UINT32_(0x1)                                        /* (UDPHS_INTSTA) Set by hardware when an interrupt is triggered by the DMA Channelx and this endpoint interrupt is enabled by the DMA_x bit in UDPHS_IEN.  */
...
#define   UDPHS_INTSTA_DMA_6_0_Val            _UINT32_(0x0)                                        /* (UDPHS_INTSTA) Reset when the UDPHS_DMASTATUSx interrupt source is cleared.  */
...
#define   UDPHS_TST_TST_J_0_Val               _UINT32_(0x0)                                        /* (UDPHS_TST) No effect.  */
#define   UDPHS_TST_TST_J_1_Val               _UINT32_(0x1)                                        /* (UDPHS_TST) Set to send the J state on the UDPHS line. This enables the testing of the high output drive level on the D+ line.  */
...
#define   UDPHS_TST_TST_K_0_Val               _UINT32_(0x0)                                        /* (UDPHS_TST) No effect.  */
#define   UDPHS_TST_TST_K_1_Val               _UINT32_(0x1)                                        /* (UDPHS_TST) Set to send the K state on the UDPHS line. This enables the testing of the high output drive level on the D- line.  */
...
#define   UDPHS_TST_TST_PKT_0_Val             _UINT32_(0x0)                                        /* (UDPHS_TST) No effect.  */
#define   UDPHS_TST_TST_PKT_1_Val             _UINT32_(0x1)                                        /* (UDPHS_TST) Set to repetitively transmit the packet stored in the current bank. This enables the testing of rise and fall times, eye patterns, jitter, and any other dynamic waveform specifications.  */
...
#define   UDPHS_TST_OPMODE2_0_Val             _UINT32_(0x0)                                        /* (UDPHS_TST) No effect.  */
#define   UDPHS_TST_OPMODE2_1_Val             _UINT32_(0x1)                                        /* (UDPHS_TST) Set to force the OpMode signal (UTMI interface) to "10", to disable the bit-stuffing and the NRZI encoding.  */
...
#endif /* _SAMA7D6_UDPHS_COMPONENT_H_ */
